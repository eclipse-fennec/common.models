...
public class PersistenceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PersistencePackage.PERSISTENCE_TYPE: {
				PersistenceType persistenceType = (PersistenceType)theEObject;
				T result = casePersistenceType(persistenceType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PersistencePackage.PERSISTENCE_UNIT_TYPE: {
				PersistenceUnitType persistenceUnitType = (PersistenceUnitType)theEObject;
				T result = casePersistenceUnitType(persistenceUnitType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T casePersistenceType(PersistenceType object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePersistenceUnitType(PersistenceUnitType object) {
		return null;
	}
