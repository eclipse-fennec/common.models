...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,ee.jakarta.xml.ns.persistence\"" })
...
public class PersistenceConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(PersistencePackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(PersistencePackage.eNS_URI, ePackage);
		}
