 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.impl.DocumentRootImpl#getPersistence <em>Persistence</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
	...
	public PersistenceType getPersistence() {
		return (PersistenceType)getMixed().get(PersistencePackage.Literals.DOCUMENT_ROOT__PERSISTENCE, true);
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPersistence(PersistenceType newPersistence, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(PersistencePackage.Literals.DOCUMENT_ROOT__PERSISTENCE, newPersistence, msgs);
	}
	...
	public void setPersistence(PersistenceType newPersistence) {
		((FeatureMap.Internal)getMixed()).set(PersistencePackage.Literals.DOCUMENT_ROOT__PERSISTENCE, newPersistence);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case PersistencePackage.DOCUMENT_ROOT__PERSISTENCE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case PersistencePackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION:
				...
				return;
			case PersistencePackage.DOCUMENT_ROOT__PERSISTENCE:
				setPersistence((PersistenceType)null);
				return;
		}
