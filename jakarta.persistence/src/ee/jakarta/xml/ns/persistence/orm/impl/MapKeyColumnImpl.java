 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyColumnImpl#getColumnDefinition <em>Column Definition</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyColumnImpl#isInsertable <em>Insertable</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyColumnImpl#getLength <em>Length</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyColumnImpl#isNullable <em>Nullable</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyColumnImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyColumnImpl#getPrecision <em>Precision</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyColumnImpl#getScale <em>Scale</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyColumnImpl#getTable <em>Table</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyColumnImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyColumnImpl#isUpdatable <em>Updatable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapKeyColumnImpl extends MinimalEObjectImpl.Container implements MapKeyColumn {
	...
	public void setOptions(String newOptions) {
		...
		options = newOptions;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.MAP_KEY_COLUMN__OPTIONS, oldOptions, options));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OrmPackage.MAP_KEY_COLUMN__NULLABLE:
				return isNullable();
			case OrmPackage.MAP_KEY_COLUMN__OPTIONS:
				return getOptions();
