...
import ee.jakarta.xml.ns.persistence.orm.Converter;
import ee.jakarta.xml.ns.persistence.orm.Embeddable;
import ee.jakarta.xml.ns.persistence.orm.Entity;
import ee.jakarta.xml.ns.persistence.orm.EntityMappingsType;
...
import ee.jakarta.xml.ns.persistence.orm.PersistenceUnitMetadata;
 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getPersistenceUnitMetadata <em>Persistence Unit Metadata</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getSchema <em>Schema</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getSequenceGenerator <em>Sequence Generator</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getTableGenerator <em>Table Generator</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getNamedQuery <em>Named Query</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getNamedNativeQuery <em>Named Native Query</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getNamedStoredProcedureQuery <em>Named Stored Procedure Query</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getSqlResultSetMapping <em>Sql Result Set Mapping</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getMappedSuperclass <em>Mapped Superclass</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getEmbeddable <em>Embeddable</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getConverter <em>Converter</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityMappingsTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
