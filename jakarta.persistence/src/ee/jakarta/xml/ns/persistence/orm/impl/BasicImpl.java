 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.BasicImpl#getColumn <em>Column</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.BasicImpl#getLob <em>Lob</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.BasicImpl#getTemporal <em>Temporal</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.BasicImpl#getEnumerated <em>Enumerated</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.BasicImpl#getConvert <em>Convert</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.BasicImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.BasicImpl#getFetch <em>Fetch</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.BasicImpl#getName <em>Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.BasicImpl#isOptional <em>Optional</em>}</li>
 * </ul>
 *
 * @generated
 */
