 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableGeneratorImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableGeneratorImpl#getUniqueConstraint <em>Unique Constraint</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableGeneratorImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableGeneratorImpl#getCheckConstraint <em>Check Constraint</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableGeneratorImpl#getAllocationSize <em>Allocation Size</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableGeneratorImpl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableGeneratorImpl#getInitialValue <em>Initial Value</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableGeneratorImpl#getName <em>Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableGeneratorImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableGeneratorImpl#getPkColumnName <em>Pk Column Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableGeneratorImpl#getPkColumnValue <em>Pk Column Value</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableGeneratorImpl#getSchema <em>Schema</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableGeneratorImpl#getTable <em>Table</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableGeneratorImpl#getValueColumnName <em>Value Column Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableGeneratorImpl extends MinimalEObjectImpl.Container implements TableGenerator {
	...
	public EList<CheckConstraint> getCheckConstraint() {
		if (checkConstraint == null) {
			checkConstraint = new EObjectContainmentEList<CheckConstraint>(CheckConstraint.class, this, OrmPackage.TABLE_GENERATOR__CHECK_CONSTRAINT);
		}
	...
	public void setOptions(String newOptions) {
		...
		options = newOptions;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.TABLE_GENERATOR__OPTIONS, oldOptions, options));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case OrmPackage.TABLE_GENERATOR__CHECK_CONSTRAINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OrmPackage.TABLE_GENERATOR__NAME:
				return getName();
			case OrmPackage.TABLE_GENERATOR__OPTIONS:
				return getOptions();
