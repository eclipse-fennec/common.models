...
import ee.jakarta.xml.ns.persistence.orm.AccessType;
...
import ee.jakarta.xml.ns.persistence.orm.Convert;
import ee.jakarta.xml.ns.persistence.orm.DiscriminatorColumn;
import ee.jakarta.xml.ns.persistence.orm.EmptyType;
import ee.jakarta.xml.ns.persistence.orm.Entity;
import ee.jakarta.xml.ns.persistence.orm.EntityListeners;
...
import ee.jakarta.xml.ns.persistence.orm.PostLoad;
import ee.jakarta.xml.ns.persistence.orm.PostPersist;
import ee.jakarta.xml.ns.persistence.orm.PostRemove;
import ee.jakarta.xml.ns.persistence.orm.PostUpdate;
import ee.jakarta.xml.ns.persistence.orm.PrePersist;
import ee.jakarta.xml.ns.persistence.orm.PreRemove;
import ee.jakarta.xml.ns.persistence.orm.PreUpdate;
 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getTable <em>Table</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getSecondaryTable <em>Secondary Table</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getPrimaryKeyJoinColumn <em>Primary Key Join Column</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getPrimaryKeyForeignKey <em>Primary Key Foreign Key</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getIdClass <em>Id Class</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getInheritance <em>Inheritance</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getDiscriminatorValue <em>Discriminator Value</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getDiscriminatorColumn <em>Discriminator Column</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getSequenceGenerator <em>Sequence Generator</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getTableGenerator <em>Table Generator</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getNamedQuery <em>Named Query</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getNamedNativeQuery <em>Named Native Query</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getNamedStoredProcedureQuery <em>Named Stored Procedure Query</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getSqlResultSetMapping <em>Sql Result Set Mapping</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getExcludeDefaultListeners <em>Exclude Default Listeners</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getExcludeSuperclassListeners <em>Exclude Superclass Listeners</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getEntityListeners <em>Entity Listeners</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getPrePersist <em>Pre Persist</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getPostPersist <em>Post Persist</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getPreRemove <em>Pre Remove</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getPostRemove <em>Post Remove</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getPreUpdate <em>Pre Update</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getPostUpdate <em>Post Update</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getPostLoad <em>Post Load</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getAttributeOverride <em>Attribute Override</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getAssociationOverride <em>Association Override</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getConvert <em>Convert</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getNamedEntityGraph <em>Named Entity Graph</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#isCacheable <em>Cacheable</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#isMetadataComplete <em>Metadata Complete</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
