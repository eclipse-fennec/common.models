 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.CascadeType#getCascadeAll <em>Cascade All</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.CascadeType#getCascadePersist <em>Cascade Persist</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.CascadeType#getCascadeMerge <em>Cascade Merge</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.CascadeType#getCascadeRemove <em>Cascade Remove</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.CascadeType#getCascadeRefresh <em>Cascade Refresh</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.CascadeType#getCascadeDetach <em>Cascade Detach</em>}</li>
 * </ul>
 *
 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getCascadeType()
...
public interface CascadeType extends EObject {
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getCascadeType_CascadeAll()
	...
	/**
	 * Sets the value of the '{@link ee.jakarta.xml.ns.persistence.orm.CascadeType#getCascadeAll <em>Cascade All</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getCascadeType_CascadePersist()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link ee.jakarta.xml.ns.persistence.orm.CascadeType#getCascadePersist <em>Cascade Persist</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getCascadeType_CascadeMerge()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link ee.jakarta.xml.ns.persistence.orm.CascadeType#getCascadeMerge <em>Cascade Merge</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getCascadeType_CascadeRemove()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link ee.jakarta.xml.ns.persistence.orm.CascadeType#getCascadeRemove <em>Cascade Remove</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getCascadeType_CascadeRefresh()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link ee.jakarta.xml.ns.persistence.orm.CascadeType#getCascadeRefresh <em>Cascade Refresh</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getCascadeType_CascadeDetach()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link ee.jakarta.xml.ns.persistence.orm.CascadeType#getCascadeDetach <em>Cascade Detach</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
