 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyJoinColumnImpl#getForeignKey <em>Foreign Key</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyJoinColumnImpl#getColumnDefinition <em>Column Definition</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyJoinColumnImpl#isInsertable <em>Insertable</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyJoinColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyJoinColumnImpl#isNullable <em>Nullable</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyJoinColumnImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyJoinColumnImpl#getReferencedColumnName <em>Referenced Column Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyJoinColumnImpl#getTable <em>Table</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyJoinColumnImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.MapKeyJoinColumnImpl#isUpdatable <em>Updatable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapKeyJoinColumnImpl extends MinimalEObjectImpl.Container implements MapKeyJoinColumn {
	...
	public NotificationChain basicSetForeignKey(ForeignKey newForeignKey, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrmPackage.MAP_KEY_JOIN_COLUMN__FOREIGN_KEY, oldForeignKey, newForeignKey);
	...
	public void setForeignKey(ForeignKey newForeignKey) {
		if (newForeignKey != foreignKey) {
			...
			if (foreignKey != null)
				msgs = ((InternalEObject)foreignKey).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrmPackage.MAP_KEY_JOIN_COLUMN__FOREIGN_KEY, null, msgs);
			if (newForeignKey != null)
				msgs = ((InternalEObject)newForeignKey).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrmPackage.MAP_KEY_JOIN_COLUMN__FOREIGN_KEY, null, msgs);
			msgs = basicSetForeignKey(newForeignKey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.MAP_KEY_JOIN_COLUMN__FOREIGN_KEY, newForeignKey, newForeignKey));
	}
	...
	public void setOptions(String newOptions) {
		...
		options = newOptions;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.MAP_KEY_JOIN_COLUMN__OPTIONS, oldOptions, options));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OrmPackage.MAP_KEY_JOIN_COLUMN__FOREIGN_KEY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OrmPackage.MAP_KEY_JOIN_COLUMN__NULLABLE:
				return isNullable();
			case OrmPackage.MAP_KEY_JOIN_COLUMN__OPTIONS:
				return getOptions();
