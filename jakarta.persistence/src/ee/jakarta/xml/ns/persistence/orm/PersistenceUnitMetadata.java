 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.PersistenceUnitMetadata#getDescription <em>Description</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.PersistenceUnitMetadata#getXmlMappingMetadataComplete <em>Xml Mapping Metadata Complete</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.PersistenceUnitMetadata#getPersistenceUnitDefaults <em>Persistence Unit Defaults</em>}</li>
 * </ul>
 *
 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getPersistenceUnitMetadata()
...
public interface PersistenceUnitMetadata extends EObject {
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getPersistenceUnitMetadata_Description()
	...
	/**
	 * Sets the value of the '{@link ee.jakarta.xml.ns.persistence.orm.PersistenceUnitMetadata#getDescription <em>Description</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getPersistenceUnitMetadata_XmlMappingMetadataComplete()
	...
	/**
	 * Sets the value of the '{@link ee.jakarta.xml.ns.persistence.orm.PersistenceUnitMetadata#getXmlMappingMetadataComplete <em>Xml Mapping Metadata Complete</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getPersistenceUnitMetadata_PersistenceUnitDefaults()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link ee.jakarta.xml.ns.persistence.orm.PersistenceUnitMetadata#getPersistenceUnitDefaults <em>Persistence Unit Defaults</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
