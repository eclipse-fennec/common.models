 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getOrderBy <em>Order By</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getOrderColumn <em>Order Column</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getMapKey <em>Map Key</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getMapKeyClass <em>Map Key Class</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getMapKeyTemporal <em>Map Key Temporal</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getMapKeyEnumerated <em>Map Key Enumerated</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getMapKeyAttributeOverride <em>Map Key Attribute Override</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getMapKeyConvert <em>Map Key Convert</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getMapKeyColumn <em>Map Key Column</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getMapKeyJoinColumn <em>Map Key Join Column</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getMapKeyForeignKey <em>Map Key Foreign Key</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getJoinTable <em>Join Table</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getJoinColumn <em>Join Column</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getForeignKey <em>Foreign Key</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getCascade <em>Cascade</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getFetch <em>Fetch</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getMappedBy <em>Mapped By</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getName <em>Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#isOrphanRemoval <em>Orphan Removal</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OneToManyImpl#getTargetEntity <em>Target Entity</em>}</li>
 * </ul>
 *
 * @generated
 */
