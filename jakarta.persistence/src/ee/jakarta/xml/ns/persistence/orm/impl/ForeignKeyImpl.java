...
import ee.jakarta.xml.ns.persistence.orm.ConstraintMode;
 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ForeignKeyImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ForeignKeyImpl#getConstraintMode <em>Constraint Mode</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ForeignKeyImpl#getForeignKeyDefinition <em>Foreign Key Definition</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ForeignKeyImpl#getName <em>Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ForeignKeyImpl#getOptions <em>Options</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForeignKeyImpl extends MinimalEObjectImpl.Container implements ForeignKey {
	...
	public void setOptions(String newOptions) {
		...
		options = newOptions;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.FOREIGN_KEY__OPTIONS, oldOptions, options));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OrmPackage.FOREIGN_KEY__NAME:
				return getName();
			case OrmPackage.FOREIGN_KEY__OPTIONS:
				return getOptions();
		}
