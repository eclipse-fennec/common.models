 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getOrderBy <em>Order By</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getOrderColumn <em>Order Column</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getMapKey <em>Map Key</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getMapKeyClass <em>Map Key Class</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getMapKeyTemporal <em>Map Key Temporal</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getMapKeyEnumerated <em>Map Key Enumerated</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getMapKeyAttributeOverride <em>Map Key Attribute Override</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getMapKeyConvert <em>Map Key Convert</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getMapKeyColumn <em>Map Key Column</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getMapKeyJoinColumn <em>Map Key Join Column</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getMapKeyForeignKey <em>Map Key Foreign Key</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getJoinTable <em>Join Table</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getCascade <em>Cascade</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getFetch <em>Fetch</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getMappedBy <em>Mapped By</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getName <em>Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ManyToManyImpl#getTargetEntity <em>Target Entity</em>}</li>
 * </ul>
 *
 * @generated
 */
