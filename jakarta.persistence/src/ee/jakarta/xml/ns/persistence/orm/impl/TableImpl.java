 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableImpl#getUniqueConstraint <em>Unique Constraint</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableImpl#getCheckConstraint <em>Check Constraint</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableImpl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableImpl#getName <em>Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.TableImpl#getSchema <em>Schema</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableImpl extends MinimalEObjectImpl.Container implements Table {
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.TABLE__COMMENT, oldComment, comment));
	}
	...
	public EList<CheckConstraint> getCheckConstraint() {
		if (checkConstraint == null) {
			checkConstraint = new EObjectContainmentEList<CheckConstraint>(CheckConstraint.class, this, OrmPackage.TABLE__CHECK_CONSTRAINT);
		}
	...
	public void setOptions(String newOptions) {
		...
		options = newOptions;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.TABLE__OPTIONS, oldOptions, options));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case OrmPackage.TABLE__CHECK_CONSTRAINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OrmPackage.TABLE__COMMENT:
				return getComment();
			case OrmPackage.TABLE__UNIQUE_CONSTRAINT:
			...
			case OrmPackage.TABLE__NAME:
				return getName();
			case OrmPackage.TABLE__OPTIONS:
				return getOptions();
