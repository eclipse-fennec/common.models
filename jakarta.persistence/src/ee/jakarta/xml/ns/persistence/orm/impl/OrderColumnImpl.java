 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OrderColumnImpl#getColumnDefinition <em>Column Definition</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OrderColumnImpl#isInsertable <em>Insertable</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OrderColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OrderColumnImpl#isNullable <em>Nullable</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OrderColumnImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.OrderColumnImpl#isUpdatable <em>Updatable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrderColumnImpl extends MinimalEObjectImpl.Container implements OrderColumn {
	...
	public void setOptions(String newOptions) {
		...
		options = newOptions;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.ORDER_COLUMN__OPTIONS, oldOptions, options));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OrmPackage.ORDER_COLUMN__NULLABLE:
				return isNullable();
			case OrmPackage.ORDER_COLUMN__OPTIONS:
				return getOptions();
