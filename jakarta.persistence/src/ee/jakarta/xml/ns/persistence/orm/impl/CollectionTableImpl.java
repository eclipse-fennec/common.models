 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.CollectionTableImpl#getJoinColumn <em>Join Column</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.CollectionTableImpl#getForeignKey <em>Foreign Key</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.CollectionTableImpl#getUniqueConstraint <em>Unique Constraint</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.CollectionTableImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.CollectionTableImpl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.CollectionTableImpl#getName <em>Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.CollectionTableImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.CollectionTableImpl#getSchema <em>Schema</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionTableImpl extends MinimalEObjectImpl.Container implements CollectionTable {
	...
	public void setOptions(String newOptions) {
		...
		options = newOptions;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.COLLECTION_TABLE__OPTIONS, oldOptions, options));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OrmPackage.COLLECTION_TABLE__NAME:
				return getName();
			case OrmPackage.COLLECTION_TABLE__OPTIONS:
				return getOptions();
