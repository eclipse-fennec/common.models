 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.SequenceGeneratorImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.SequenceGeneratorImpl#getAllocationSize <em>Allocation Size</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.SequenceGeneratorImpl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.SequenceGeneratorImpl#getInitialValue <em>Initial Value</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.SequenceGeneratorImpl#getName <em>Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.SequenceGeneratorImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.SequenceGeneratorImpl#getSchema <em>Schema</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.SequenceGeneratorImpl#getSequenceName <em>Sequence Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SequenceGeneratorImpl extends MinimalEObjectImpl.Container implements SequenceGenerator {
	...
	public void setOptions(String newOptions) {
		...
		options = newOptions;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.SEQUENCE_GENERATOR__OPTIONS, oldOptions, options));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OrmPackage.SEQUENCE_GENERATOR__NAME:
				return getName();
			case OrmPackage.SEQUENCE_GENERATOR__OPTIONS:
				return getOptions();
