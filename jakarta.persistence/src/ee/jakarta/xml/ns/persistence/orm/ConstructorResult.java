 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.ConstructorResult#getColumn <em>Column</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.ConstructorResult#getTargetClass <em>Target Class</em>}</li>
 * </ul>
 *
 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getConstructorResult()
...
public interface ConstructorResult extends EObject {
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getConstructorResult_Column()
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getConstructorResult_TargetClass()
	...
	/**
	 * Sets the value of the '{@link ee.jakarta.xml.ns.persistence.orm.ConstructorResult#getTargetClass <em>Target Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
