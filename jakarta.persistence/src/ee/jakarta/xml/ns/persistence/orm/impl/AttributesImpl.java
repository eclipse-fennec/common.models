 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.AttributesImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.AttributesImpl#getId <em>Id</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.AttributesImpl#getEmbeddedId <em>Embedded Id</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.AttributesImpl#getBasic <em>Basic</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.AttributesImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.AttributesImpl#getManyToOne <em>Many To One</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.AttributesImpl#getOneToMany <em>One To Many</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.AttributesImpl#getOneToOne <em>One To One</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.AttributesImpl#getManyToMany <em>Many To Many</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.AttributesImpl#getElementCollection <em>Element Collection</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.AttributesImpl#getEmbedded <em>Embedded</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.AttributesImpl#getTransient <em>Transient</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributesImpl extends MinimalEObjectImpl.Container implements Attributes {
	...
	public NotificationChain basicSetVersion(Version newVersion, NotificationChain msgs) {
		...
		version = newVersion;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrmPackage.ATTRIBUTES__VERSION, oldVersion, newVersion);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVersion(Version newVersion) {
		if (newVersion != version) {
			NotificationChain msgs = null;
			if (version != null)
				msgs = ((InternalEObject)version).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OrmPackage.ATTRIBUTES__VERSION, null, msgs);
			if (newVersion != null)
				msgs = ((InternalEObject)newVersion).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OrmPackage.ATTRIBUTES__VERSION, null, msgs);
			msgs = basicSetVersion(newVersion, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.ATTRIBUTES__VERSION, newVersion, newVersion));
	}
