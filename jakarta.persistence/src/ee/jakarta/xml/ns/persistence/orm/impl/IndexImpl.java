 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.IndexImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.IndexImpl#getColumnList <em>Column List</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.IndexImpl#getName <em>Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.IndexImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.IndexImpl#isUnique <em>Unique</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IndexImpl extends MinimalEObjectImpl.Container implements Index {
	...
	public void setOptions(String newOptions) {
		...
		options = newOptions;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.INDEX__OPTIONS, oldOptions, options));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OrmPackage.INDEX__NAME:
				return getName();
			case OrmPackage.INDEX__OPTIONS:
				return getOptions();
