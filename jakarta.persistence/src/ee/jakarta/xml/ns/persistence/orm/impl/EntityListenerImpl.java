...
import ee.jakarta.xml.ns.persistence.orm.EntityListener;
 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityListenerImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityListenerImpl#getPrePersist <em>Pre Persist</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityListenerImpl#getPostPersist <em>Post Persist</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityListenerImpl#getPreRemove <em>Pre Remove</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityListenerImpl#getPostRemove <em>Post Remove</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityListenerImpl#getPreUpdate <em>Pre Update</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityListenerImpl#getPostUpdate <em>Post Update</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityListenerImpl#getPostLoad <em>Post Load</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.EntityListenerImpl#getClass_ <em>Class</em>}</li>
 * </ul>
 *
 * @generated
 */
