...
import ee.jakarta.xml.ns.persistence.orm.GeneratedValue;
 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.IdImpl#getColumn <em>Column</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.IdImpl#getGeneratedValue <em>Generated Value</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.IdImpl#getTemporal <em>Temporal</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.IdImpl#getTableGenerator <em>Table Generator</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.IdImpl#getSequenceGenerator <em>Sequence Generator</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.IdImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.IdImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
