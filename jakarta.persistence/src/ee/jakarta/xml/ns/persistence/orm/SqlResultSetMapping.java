 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.SqlResultSetMapping#getDescription <em>Description</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.SqlResultSetMapping#getEntityResult <em>Entity Result</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.SqlResultSetMapping#getConstructorResult <em>Constructor Result</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.SqlResultSetMapping#getColumnResult <em>Column Result</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.SqlResultSetMapping#getName <em>Name</em>}</li>
 * </ul>
 *
 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getSqlResultSetMapping()
...
public interface SqlResultSetMapping extends EObject {
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getSqlResultSetMapping_Description()
	...
	/**
	 * Sets the value of the '{@link ee.jakarta.xml.ns.persistence.orm.SqlResultSetMapping#getDescription <em>Description</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getSqlResultSetMapping_EntityResult()
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getSqlResultSetMapping_ConstructorResult()
	 * @model containment="true"
	 ...
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getSqlResultSetMapping_ColumnResult()
	 * @model containment="true"
	 ...
	 * @see #setName(String)
	 * @see ee.jakarta.xml.ns.persistence.orm.OrmPackage#getSqlResultSetMapping_Name()
	...
	/**
	 * Sets the value of the '{@link ee.jakarta.xml.ns.persistence.orm.SqlResultSetMapping#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
