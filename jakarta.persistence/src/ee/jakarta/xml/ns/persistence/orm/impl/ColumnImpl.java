 ...
 * </p>
 * <ul>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ColumnImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ColumnImpl#getCheckConstraint <em>Check Constraint</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ColumnImpl#getColumnDefinition <em>Column Definition</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ColumnImpl#isInsertable <em>Insertable</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ColumnImpl#getLength <em>Length</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ColumnImpl#isNullable <em>Nullable</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ColumnImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ColumnImpl#getPrecision <em>Precision</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ColumnImpl#getScale <em>Scale</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ColumnImpl#getSecondPrecision <em>Second Precision</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ColumnImpl#getTable <em>Table</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ColumnImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link ee.jakarta.xml.ns.persistence.orm.impl.ColumnImpl#isUpdatable <em>Updatable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnImpl extends MinimalEObjectImpl.Container implements Column {
	...
	/**
	 * This is true if the Second Precision attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	protected boolean secondPrecisionESet;
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.COLUMN__COMMENT, oldComment, comment));
	}
	...
	public EList<CheckConstraint> getCheckConstraint() {
		if (checkConstraint == null) {
			checkConstraint = new EObjectContainmentEList<CheckConstraint>(CheckConstraint.class, this, OrmPackage.COLUMN__CHECK_CONSTRAINT);
		}
	...
	public void setOptions(String newOptions) {
		...
		options = newOptions;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.COLUMN__OPTIONS, oldOptions, options));
	}
	...
	public void setSecondPrecision(int newSecondPrecision) {
		...
		boolean oldSecondPrecisionESet = secondPrecisionESet;
		secondPrecisionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.COLUMN__SECOND_PRECISION, oldSecondPrecision, secondPrecision, !oldSecondPrecisionESet));
	}
	 ...
	 */
	@Override
	public void unsetSecondPrecision() {
		int oldSecondPrecision = secondPrecision;
		boolean oldSecondPrecisionESet = secondPrecisionESet;
		secondPrecision = SECOND_PRECISION_EDEFAULT;
		secondPrecisionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OrmPackage.COLUMN__SECOND_PRECISION, oldSecondPrecision, SECOND_PRECISION_EDEFAULT, oldSecondPrecisionESet));
	}
	 ...
	 */
	@Override
	public boolean isSetSecondPrecision() {
		return secondPrecisionESet;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OrmPackage.COLUMN__CHECK_CONSTRAINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OrmPackage.COLUMN__COMMENT:
				return getComment();
			case OrmPackage.COLUMN__CHECK_CONSTRAINT:
			...
			case OrmPackage.COLUMN__NULLABLE:
				return isNullable();
			case OrmPackage.COLUMN__OPTIONS:
				return getOptions();
			case OrmPackage.COLUMN__PRECISION:
				return getPrecision();
			case OrmPackage.COLUMN__SCALE:
				return getScale();
			case OrmPackage.COLUMN__SECOND_PRECISION:
	...
	public String toString() {
		...
		if (secondPrecisionESet) result.append(secondPrecision); else result.append("<unset>");
		result.append(", table: ");
		result.append(table);
