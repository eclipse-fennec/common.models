...
import org.omg.spec.bpmn.bpmn.TItemKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TItemDefinitionImpl#isIsCollection <em>Is Collection</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TItemDefinitionImpl#getItemKind <em>Item Kind</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TItemDefinitionImpl#getStructureRef <em>Structure Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TItemDefinitionImpl extends TRootElementImpl implements TItemDefinition {
	...
	public void setIsCollection(boolean newIsCollection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TITEM_DEFINITION__IS_COLLECTION, oldIsCollection, isCollection, !oldIsCollectionESet));
	}
	...
	public void unsetIsCollection() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TITEM_DEFINITION__IS_COLLECTION, oldIsCollection, IS_COLLECTION_EDEFAULT, oldIsCollectionESet));
	}
	...
	public void setItemKind(TItemKind newItemKind) {
		...
		itemKindESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TITEM_DEFINITION__ITEM_KIND, oldItemKind, itemKind, !oldItemKindESet));
	}
	...
	public void unsetItemKind() {
		...
		itemKindESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TITEM_DEFINITION__ITEM_KIND, oldItemKind, ITEM_KIND_EDEFAULT, oldItemKindESet));
	}
	...
	public void setStructureRef(QName newStructureRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TITEM_DEFINITION__STRUCTURE_REF, oldStructureRef, structureRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TITEM_DEFINITION__IS_COLLECTION:
				return isIsCollection();
			case BPMNPackage.TITEM_DEFINITION__ITEM_KIND:
				return getItemKind();
			case BPMNPackage.TITEM_DEFINITION__STRUCTURE_REF:
