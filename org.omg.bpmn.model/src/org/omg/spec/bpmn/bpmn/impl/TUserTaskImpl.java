 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TUserTaskImpl#getRendering <em>Rendering</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TUserTaskImpl#getImplementation <em>Implementation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TUserTaskImpl extends TTaskImpl implements TUserTask {
	...
	protected EClass eStaticClass() {
		return BPMNPackage.eINSTANCE.getTUserTask();
	}
	...
	public EList<TRendering> getRendering() {
		if (rendering == null) {
			rendering = new EObjectContainmentEList<TRendering>(TRendering.class, this, BPMNPackage.TUSER_TASK__RENDERING);
		}
		return rendering;
	}
	...
	public void setImplementation(Object newImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TUSER_TASK__IMPLEMENTATION, oldImplementation, implementation, !oldImplementationESet));
	}
	...
	public void unsetImplementation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TUSER_TASK__IMPLEMENTATION, oldImplementation, IMPLEMENTATION_EDEFAULT, oldImplementationESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNPackage.TUSER_TASK__RENDERING:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TUSER_TASK__RENDERING:
				return getRendering();
			case BPMNPackage.TUSER_TASK__IMPLEMENTATION:
