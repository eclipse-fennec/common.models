...
import org.omg.spec.bpmn.bpmn.util.BPMNValidator;
...
public class BPMNPackageImpl extends EPackageImpl implements BPMNPackage {
	 ...
	 * @generated
	 */
	protected String packageFilename = "bpmn.ecore";
	 ...
	 * @generated
	 */
	private EClass bpmnRootEClass = null;
	 ...
	 * @see org.omg.spec.bpmn.bpmn.BPMNPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EClass getBPMNRoot() {
		if (bpmnRootEClass == null) {
			bpmnRootEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(0);
		}
		return bpmnRootEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getBPMNRoot_Mixed() {
        return (EAttribute)getBPMNRoot().getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_XMLNSPrefixMap() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_XSISchemaLocation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Activity() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_AdHocSubProcess() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_FlowElement() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Artifact() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Assignment() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Association() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(8);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Auditing() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(9);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_BaseElement() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(10);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_BaseElementWithMixedContent() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(11);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_BoundaryEvent() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(12);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_BusinessRuleTask() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(13);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_CallableElement() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(14);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_CallActivity() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(15);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_CallChoreography() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(16);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_CallConversation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(17);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ConversationNode() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(18);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_CancelEventDefinition() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(19);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_EventDefinition() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(20);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_RootElement() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(21);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_CatchEvent() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(22);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Category() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(23);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_CategoryValue() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(24);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Choreography() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(25);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Collaboration() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(26);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ChoreographyActivity() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(27);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ChoreographyTask() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(28);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_CompensateEventDefinition() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(29);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ComplexBehaviorDefinition() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(30);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ComplexGateway() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(31);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ConditionalEventDefinition() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(32);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Conversation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(33);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ConversationAssociation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(34);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ConversationLink() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(35);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_CorrelationKey() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(36);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_CorrelationProperty() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(37);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_CorrelationPropertyBinding() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(38);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_CorrelationPropertyRetrievalExpression() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(39);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_CorrelationSubscription() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(40);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_DataAssociation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(41);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_DataInput() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(42);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_DataInputAssociation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(43);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_DataObject() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(44);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_DataObjectReference() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(45);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_DataOutput() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(46);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_DataOutputAssociation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(47);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_DataState() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(48);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_DataStore() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(49);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_DataStoreReference() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(50);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Definitions() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(51);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Documentation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(52);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_EndEvent() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(53);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_EndPoint() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(54);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Error() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(55);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ErrorEventDefinition() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(56);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Escalation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(57);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_EscalationEventDefinition() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(58);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Event() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(59);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_EventBasedGateway() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(60);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ExclusiveGateway() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(61);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Expression() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(62);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Extension() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(63);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ExtensionElements() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(64);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_FlowNode() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(65);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_FormalExpression() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(66);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Gateway() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(67);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_GlobalBusinessRuleTask() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(68);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_GlobalChoreographyTask() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(69);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_GlobalConversation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(70);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_GlobalManualTask() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(71);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_GlobalScriptTask() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(72);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_GlobalTask() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(73);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_GlobalUserTask() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(74);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Group() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(75);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_HumanPerformer() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(76);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Performer() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(77);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ResourceRole() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(78);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ImplicitThrowEvent() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(79);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Import() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(80);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_InclusiveGateway() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(81);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_InputSet() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(82);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Interface() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(83);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_IntermediateCatchEvent() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(84);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_IntermediateThrowEvent() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(85);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_IoBinding() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(86);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_IoSpecification() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(87);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ItemDefinition() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(88);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Lane() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(89);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_LaneSet() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(90);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_LinkEventDefinition() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(91);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_LoopCharacteristics() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(92);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ManualTask() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(93);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Message() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(94);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_MessageEventDefinition() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(95);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_MessageFlow() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(96);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_MessageFlowAssociation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(97);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Monitoring() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(98);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_MultiInstanceLoopCharacteristics() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(99);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Operation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(100);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_OutputSet() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(101);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ParallelGateway() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(102);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Participant() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(103);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ParticipantAssociation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(104);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ParticipantMultiplicity() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(105);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_PartnerEntity() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(106);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_PartnerRole() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(107);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_PotentialOwner() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(108);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Process() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(109);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Property() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(110);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ReceiveTask() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(111);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Relationship() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(112);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Rendering() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(113);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Resource() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(114);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ResourceAssignmentExpression() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(115);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ResourceParameter() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(116);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ResourceParameterBinding() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(117);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Script() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(118);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ScriptTask() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(119);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_SendTask() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(120);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_SequenceFlow() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(121);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ServiceTask() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(122);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Signal() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(123);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_SignalEventDefinition() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(124);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_StandardLoopCharacteristics() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(125);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_StartEvent() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(126);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_SubChoreography() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(127);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_SubConversation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(128);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_SubProcess() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(129);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Task() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(130);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_TerminateEventDefinition() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(131);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Text() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(132);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_TextAnnotation() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(133);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_ThrowEvent() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(134);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_TimerEventDefinition() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(135);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_Transaction() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(136);
	}
	 ...
	 */
	@Override
	public EReference getBPMNRoot_UserTask() {
        return (EReference)getBPMNRoot().getEStructuralFeatures().get(137);
	}
	...
	public EClass getTActivity() {
		if (tActivityEClass == null) {
			tActivityEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(1);
		}
	...
	public EClass getTAdHocSubProcess() {
		if (tAdHocSubProcessEClass == null) {
			tAdHocSubProcessEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(4);
		}
	...
	public EClass getTArtifact() {
		if (tArtifactEClass == null) {
			tArtifactEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(5);
		}
	...
	public EClass getTAssignment() {
		if (tAssignmentEClass == null) {
			tAssignmentEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(6);
		}
	...
	public EClass getTAssociation() {
		if (tAssociationEClass == null) {
			tAssociationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(7);
		}
	...
	public EClass getTAuditing() {
		if (tAuditingEClass == null) {
			tAuditingEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(10);
		}
	...
	public EClass getTBaseElement() {
		if (tBaseElementEClass == null) {
			tBaseElementEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(11);
		}
	...
	public EClass getTBaseElementWithMixedContent() {
		if (tBaseElementWithMixedContentEClass == null) {
			tBaseElementWithMixedContentEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(12);
		}
	...
	public EClass getTBoundaryEvent() {
		if (tBoundaryEventEClass == null) {
			tBoundaryEventEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(13);
		}
	...
	public EClass getTBusinessRuleTask() {
		if (tBusinessRuleTaskEClass == null) {
			tBusinessRuleTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(14);
		}
	...
	public EClass getTCallableElement() {
		if (tCallableElementEClass == null) {
			tCallableElementEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(15);
		}
	...
	public EClass getTCallActivity() {
		if (tCallActivityEClass == null) {
			tCallActivityEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(16);
		}
	...
	public EClass getTCallChoreography() {
		if (tCallChoreographyEClass == null) {
			tCallChoreographyEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(17);
		}
	...
	public EClass getTCallConversation() {
		if (tCallConversationEClass == null) {
			tCallConversationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(18);
		}
	...
	public EClass getTCancelEventDefinition() {
		if (tCancelEventDefinitionEClass == null) {
			tCancelEventDefinitionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(19);
		}
	...
	public EClass getTCatchEvent() {
		if (tCatchEventEClass == null) {
			tCatchEventEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(20);
		}
	...
	public EClass getTCategory() {
		if (tCategoryEClass == null) {
			tCategoryEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(21);
		}
	...
	public EClass getTCategoryValue() {
		if (tCategoryValueEClass == null) {
			tCategoryValueEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(22);
		}
	...
	public EClass getTChoreography() {
		if (tChoreographyEClass == null) {
			tChoreographyEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(23);
		}
	...
	public EClass getTChoreographyActivity() {
		if (tChoreographyActivityEClass == null) {
			tChoreographyActivityEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(24);
		}
	...
	public EClass getTChoreographyTask() {
		if (tChoreographyTaskEClass == null) {
			tChoreographyTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(27);
		}
	...
	public EClass getTCollaboration() {
		if (tCollaborationEClass == null) {
			tCollaborationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(28);
		}
	...
	public EClass getTCompensateEventDefinition() {
		if (tCompensateEventDefinitionEClass == null) {
			tCompensateEventDefinitionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(29);
		}
	...
	public EClass getTComplexBehaviorDefinition() {
		if (tComplexBehaviorDefinitionEClass == null) {
			tComplexBehaviorDefinitionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(30);
		}
	...
	public EClass getTComplexGateway() {
		if (tComplexGatewayEClass == null) {
			tComplexGatewayEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(31);
		}
	...
	public EClass getTConditionalEventDefinition() {
		if (tConditionalEventDefinitionEClass == null) {
			tConditionalEventDefinitionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(32);
		}
	...
	public EClass getTConversation() {
		if (tConversationEClass == null) {
			tConversationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(33);
		}
	...
	public EClass getTConversationAssociation() {
		if (tConversationAssociationEClass == null) {
			tConversationAssociationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(34);
		}
	...
	public EClass getTConversationLink() {
		if (tConversationLinkEClass == null) {
			tConversationLinkEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(35);
		}
	...
	public EClass getTConversationNode() {
		if (tConversationNodeEClass == null) {
			tConversationNodeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(36);
		}
	...
	public EClass getTCorrelationKey() {
		if (tCorrelationKeyEClass == null) {
			tCorrelationKeyEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(37);
		}
	...
	public EClass getTCorrelationProperty() {
		if (tCorrelationPropertyEClass == null) {
			tCorrelationPropertyEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(38);
		}
	...
	public EClass getTCorrelationPropertyBinding() {
		if (tCorrelationPropertyBindingEClass == null) {
			tCorrelationPropertyBindingEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(39);
		}
	...
	public EClass getTCorrelationPropertyRetrievalExpression() {
		if (tCorrelationPropertyRetrievalExpressionEClass == null) {
			tCorrelationPropertyRetrievalExpressionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(40);
		}
	...
	public EClass getTCorrelationSubscription() {
		if (tCorrelationSubscriptionEClass == null) {
			tCorrelationSubscriptionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(41);
		}
	...
	public EClass getTDataAssociation() {
		if (tDataAssociationEClass == null) {
			tDataAssociationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(42);
		}
	...
	public EClass getTDataInput() {
		if (tDataInputEClass == null) {
			tDataInputEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(43);
		}
	...
	public EClass getTDataInputAssociation() {
		if (tDataInputAssociationEClass == null) {
			tDataInputAssociationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(44);
		}
	...
	public EClass getTDataObject() {
		if (tDataObjectEClass == null) {
			tDataObjectEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(45);
		}
	...
	public EClass getTDataObjectReference() {
		if (tDataObjectReferenceEClass == null) {
			tDataObjectReferenceEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(46);
		}
	...
	public EClass getTDataOutput() {
		if (tDataOutputEClass == null) {
			tDataOutputEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(47);
		}
	...
	public EClass getTDataOutputAssociation() {
		if (tDataOutputAssociationEClass == null) {
			tDataOutputAssociationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(48);
		}
	...
	public EClass getTDataState() {
		if (tDataStateEClass == null) {
			tDataStateEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(49);
		}
	...
	public EClass getTDataStore() {
		if (tDataStoreEClass == null) {
			tDataStoreEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(50);
		}
	...
	public EClass getTDataStoreReference() {
		if (tDataStoreReferenceEClass == null) {
			tDataStoreReferenceEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(51);
		}
	...
	public EClass getTDefinitions() {
		if (tDefinitionsEClass == null) {
			tDefinitionsEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(52);
		}
	...
	public EClass getTDocumentation() {
		if (tDocumentationEClass == null) {
			tDocumentationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(53);
		}
	...
	public EClass getTEndEvent() {
		if (tEndEventEClass == null) {
			tEndEventEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(54);
		}
	...
	public EClass getTEndPoint() {
		if (tEndPointEClass == null) {
			tEndPointEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(55);
		}
	...
	public EClass getTError() {
		if (tErrorEClass == null) {
			tErrorEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(56);
		}
		return tErrorEClass;
	}
	...
	public EClass getTErrorEventDefinition() {
		if (tErrorEventDefinitionEClass == null) {
			tErrorEventDefinitionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(57);
		}
	...
	public EClass getTEscalation() {
		if (tEscalationEClass == null) {
			tEscalationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(58);
		}
	...
	public EClass getTEscalationEventDefinition() {
		if (tEscalationEventDefinitionEClass == null) {
			tEscalationEventDefinitionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(59);
		}
	...
	public EClass getTEvent() {
		if (tEventEClass == null) {
			tEventEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(60);
		}
		return tEventEClass;
	}
	...
	public EClass getTEventBasedGateway() {
		if (tEventBasedGatewayEClass == null) {
			tEventBasedGatewayEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(61);
		}
	...
	public EClass getTEventDefinition() {
		if (tEventDefinitionEClass == null) {
			tEventDefinitionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(64);
		}
	...
	public EClass getTExclusiveGateway() {
		if (tExclusiveGatewayEClass == null) {
			tExclusiveGatewayEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(65);
		}
	...
	public EClass getTExpression() {
		if (tExpressionEClass == null) {
			tExpressionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(66);
		}
	...
	public EClass getTExtension() {
		if (tExtensionEClass == null) {
			tExtensionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(67);
		}
	...
	public EClass getTExtensionElements() {
		if (tExtensionElementsEClass == null) {
			tExtensionElementsEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(68);
		}
	...
	public EClass getTFlowElement() {
		if (tFlowElementEClass == null) {
			tFlowElementEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(69);
		}
	...
	public EClass getTFlowNode() {
		if (tFlowNodeEClass == null) {
			tFlowNodeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(70);
		}
	...
	public EClass getTFormalExpression() {
		if (tFormalExpressionEClass == null) {
			tFormalExpressionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(71);
		}
	...
	public EClass getTGateway() {
		if (tGatewayEClass == null) {
			tGatewayEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(72);
		}
	...
	public EClass getTGlobalBusinessRuleTask() {
		if (tGlobalBusinessRuleTaskEClass == null) {
			tGlobalBusinessRuleTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(75);
		}
	...
	public EClass getTGlobalChoreographyTask() {
		if (tGlobalChoreographyTaskEClass == null) {
			tGlobalChoreographyTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(76);
		}
	...
	public EClass getTGlobalConversation() {
		if (tGlobalConversationEClass == null) {
			tGlobalConversationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(77);
		}
	...
	public EClass getTGlobalManualTask() {
		if (tGlobalManualTaskEClass == null) {
			tGlobalManualTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(78);
		}
	...
	public EClass getTGlobalScriptTask() {
		if (tGlobalScriptTaskEClass == null) {
			tGlobalScriptTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(79);
		}
	...
	public EClass getTGlobalTask() {
		if (tGlobalTaskEClass == null) {
			tGlobalTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(80);
		}
	...
	public EClass getTGlobalUserTask() {
		if (tGlobalUserTaskEClass == null) {
			tGlobalUserTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(81);
		}
	...
	public EClass getTGroup() {
		if (tGroupEClass == null) {
			tGroupEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(82);
		}
		return tGroupEClass;
	}
	...
	public EClass getTHumanPerformer() {
		if (tHumanPerformerEClass == null) {
			tHumanPerformerEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(83);
		}
	...
	public EClass getTImplicitThrowEvent() {
		if (tImplicitThrowEventEClass == null) {
			tImplicitThrowEventEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(87);
		}
	...
	public EClass getTImport() {
		if (tImportEClass == null) {
			tImportEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(88);
		}
	...
	public EClass getTInclusiveGateway() {
		if (tInclusiveGatewayEClass == null) {
			tInclusiveGatewayEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(89);
		}
	...
	public EClass getTInputOutputBinding() {
		if (tInputOutputBindingEClass == null) {
			tInputOutputBindingEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(90);
		}
	...
	public EClass getTInputOutputSpecification() {
		if (tInputOutputSpecificationEClass == null) {
			tInputOutputSpecificationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(91);
		}
	...
	public EClass getTInputSet() {
		if (tInputSetEClass == null) {
			tInputSetEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(92);
		}
	...
	public EClass getTInterface() {
		if (tInterfaceEClass == null) {
			tInterfaceEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(93);
		}
	...
	public EClass getTIntermediateCatchEvent() {
		if (tIntermediateCatchEventEClass == null) {
			tIntermediateCatchEventEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(94);
		}
	...
	public EClass getTIntermediateThrowEvent() {
		if (tIntermediateThrowEventEClass == null) {
			tIntermediateThrowEventEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(95);
		}
	...
	public EClass getTItemDefinition() {
		if (tItemDefinitionEClass == null) {
			tItemDefinitionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(96);
		}
	...
	public EClass getTLane() {
		if (tLaneEClass == null) {
			tLaneEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(99);
		}
		return tLaneEClass;
	}
	...
	public EClass getTLaneSet() {
		if (tLaneSetEClass == null) {
			tLaneSetEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(100);
		}
	...
	public EClass getTLinkEventDefinition() {
		if (tLinkEventDefinitionEClass == null) {
			tLinkEventDefinitionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(101);
		}
	...
	public EClass getTLoopCharacteristics() {
		if (tLoopCharacteristicsEClass == null) {
			tLoopCharacteristicsEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(102);
		}
	...
	public EClass getTManualTask() {
		if (tManualTaskEClass == null) {
			tManualTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(103);
		}
	...
	public EClass getTMessage() {
		if (tMessageEClass == null) {
			tMessageEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(104);
		}
	...
	public EClass getTMessageEventDefinition() {
		if (tMessageEventDefinitionEClass == null) {
			tMessageEventDefinitionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(105);
		}
	...
	public EClass getTMessageFlow() {
		if (tMessageFlowEClass == null) {
			tMessageFlowEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(106);
		}
	...
	public EClass getTMessageFlowAssociation() {
		if (tMessageFlowAssociationEClass == null) {
			tMessageFlowAssociationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(107);
		}
	...
	public EClass getTMonitoring() {
		if (tMonitoringEClass == null) {
			tMonitoringEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(108);
		}
	...
	public EClass getTMultiInstanceLoopCharacteristics() {
		if (tMultiInstanceLoopCharacteristicsEClass == null) {
			tMultiInstanceLoopCharacteristicsEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(111);
		}
	...
	public EClass getTOperation() {
		if (tOperationEClass == null) {
			tOperationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(112);
		}
	...
	public EClass getTOutputSet() {
		if (tOutputSetEClass == null) {
			tOutputSetEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(113);
		}
	...
	public EClass getTParallelGateway() {
		if (tParallelGatewayEClass == null) {
			tParallelGatewayEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(114);
		}
	...
	public EClass getTParticipant() {
		if (tParticipantEClass == null) {
			tParticipantEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(115);
		}
	...
	public EClass getTParticipantAssociation() {
		if (tParticipantAssociationEClass == null) {
			tParticipantAssociationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(116);
		}
	...
	public EClass getTParticipantMultiplicity() {
		if (tParticipantMultiplicityEClass == null) {
			tParticipantMultiplicityEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(117);
		}
	...
	public EClass getTPartnerEntity() {
		if (tPartnerEntityEClass == null) {
			tPartnerEntityEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(118);
		}
	...
	public EClass getTPartnerRole() {
		if (tPartnerRoleEClass == null) {
			tPartnerRoleEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(119);
		}
	...
	public EClass getTPerformer() {
		if (tPerformerEClass == null) {
			tPerformerEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(120);
		}
	...
	public EClass getTPotentialOwner() {
		if (tPotentialOwnerEClass == null) {
			tPotentialOwnerEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(121);
		}
	...
	public EClass getTProcess() {
		if (tProcessEClass == null) {
			tProcessEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(122);
		}
	...
	public EClass getTProperty() {
		if (tPropertyEClass == null) {
			tPropertyEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(125);
		}
	...
	public EClass getTReceiveTask() {
		if (tReceiveTaskEClass == null) {
			tReceiveTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(126);
		}
	...
	public EClass getTRelationship() {
		if (tRelationshipEClass == null) {
			tRelationshipEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(127);
		}
	...
	public EClass getTRendering() {
		if (tRenderingEClass == null) {
			tRenderingEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(130);
		}
	...
	public EClass getTResource() {
		if (tResourceEClass == null) {
			tResourceEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(131);
		}
	...
	public EClass getTResourceAssignmentExpression() {
		if (tResourceAssignmentExpressionEClass == null) {
			tResourceAssignmentExpressionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(132);
		}
	...
	public EClass getTResourceParameter() {
		if (tResourceParameterEClass == null) {
			tResourceParameterEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(133);
		}
	...
	public EClass getTResourceParameterBinding() {
		if (tResourceParameterBindingEClass == null) {
			tResourceParameterBindingEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(134);
		}
	...
	public EClass getTResourceRole() {
		if (tResourceRoleEClass == null) {
			tResourceRoleEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(135);
		}
	...
	public EClass getTRootElement() {
		if (tRootElementEClass == null) {
			tRootElementEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(136);
		}
	...
	public EClass getTScript() {
		if (tScriptEClass == null) {
			tScriptEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(137);
		}
	...
	public EClass getTScriptTask() {
		if (tScriptTaskEClass == null) {
			tScriptTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(138);
		}
	...
	public EClass getTSendTask() {
		if (tSendTaskEClass == null) {
			tSendTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(139);
		}
	...
	public EClass getTSequenceFlow() {
		if (tSequenceFlowEClass == null) {
			tSequenceFlowEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(140);
		}
	...
	public EClass getTServiceTask() {
		if (tServiceTaskEClass == null) {
			tServiceTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(141);
		}
	...
	public EClass getTSignal() {
		if (tSignalEClass == null) {
			tSignalEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(142);
		}
	...
	public EClass getTSignalEventDefinition() {
		if (tSignalEventDefinitionEClass == null) {
			tSignalEventDefinitionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(143);
		}
	...
	public EClass getTStandardLoopCharacteristics() {
		if (tStandardLoopCharacteristicsEClass == null) {
			tStandardLoopCharacteristicsEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(144);
		}
	...
	public EClass getTStartEvent() {
		if (tStartEventEClass == null) {
			tStartEventEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(145);
		}
	...
	public EClass getTSubChoreography() {
		if (tSubChoreographyEClass == null) {
			tSubChoreographyEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(146);
		}
	...
	public EClass getTSubConversation() {
		if (tSubConversationEClass == null) {
			tSubConversationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(147);
		}
	...
	public EClass getTSubProcess() {
		if (tSubProcessEClass == null) {
			tSubProcessEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(148);
		}
	...
	public EClass getTTask() {
		if (tTaskEClass == null) {
			tTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(149);
		}
		return tTaskEClass;
	}
	...
	public EClass getTTerminateEventDefinition() {
		if (tTerminateEventDefinitionEClass == null) {
			tTerminateEventDefinitionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(150);
		}
	...
	public EClass getTText() {
		if (tTextEClass == null) {
			tTextEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(151);
		}
		return tTextEClass;
	}
	...
	public EClass getTTextAnnotation() {
		if (tTextAnnotationEClass == null) {
			tTextAnnotationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(152);
		}
	...
	public EClass getTThrowEvent() {
		if (tThrowEventEClass == null) {
			tThrowEventEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(153);
		}
	...
	public EClass getTTimerEventDefinition() {
		if (tTimerEventDefinitionEClass == null) {
			tTimerEventDefinitionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(154);
		}
	...
	public EClass getTTransaction() {
		if (tTransactionEClass == null) {
			tTransactionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(155);
		}
	...
	public EClass getTUserTask() {
		if (tUserTaskEClass == null) {
			tUserTaskEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(159);
		}
	...
	public EEnum getTAdHocOrdering() {
		if (tAdHocOrderingEEnum == null) {
			tAdHocOrderingEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(2);
		}
	...
	public EEnum getTAssociationDirection() {
		if (tAssociationDirectionEEnum == null) {
			tAssociationDirectionEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(8);
		}
	...
	public EEnum getTChoreographyLoopType() {
		if (tChoreographyLoopTypeEEnum == null) {
			tChoreographyLoopTypeEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(25);
		}
	...
	public EEnum getTEventBasedGatewayType() {
		if (tEventBasedGatewayTypeEEnum == null) {
			tEventBasedGatewayTypeEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(62);
		}
	...
	public EEnum getTGatewayDirection() {
		if (tGatewayDirectionEEnum == null) {
			tGatewayDirectionEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(73);
		}
	...
	public EEnum getTImplementationMember1() {
		if (tImplementationMember1EEnum == null) {
			tImplementationMember1EEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(85);
		}
	...
	public EEnum getTItemKind() {
		if (tItemKindEEnum == null) {
			tItemKindEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(97);
		}
	...
	public EEnum getTMultiInstanceFlowCondition() {
		if (tMultiInstanceFlowConditionEEnum == null) {
			tMultiInstanceFlowConditionEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(109);
		}
	...
	public EEnum getTProcessType() {
		if (tProcessTypeEEnum == null) {
			tProcessTypeEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(123);
		}
	...
	public EEnum getTRelationshipDirection() {
		if (tRelationshipDirectionEEnum == null) {
			tRelationshipDirectionEEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(128);
		}
	...
	public EEnum getTTransactionMethodMember1() {
		if (tTransactionMethodMember1EEnum == null) {
			tTransactionMethodMember1EEnum = (EEnum)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(157);
		}
	...
	public EDataType getTAdHocOrderingObject() {
		if (tAdHocOrderingObjectEDataType == null) {
			tAdHocOrderingObjectEDataType = (EDataType)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(3);
		}
	...
	public EDataType getTAssociationDirectionObject() {
		if (tAssociationDirectionObjectEDataType == null) {
			tAssociationDirectionObjectEDataType = (EDataType)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(9);
		}
	...
	public EDataType getTChoreographyLoopTypeObject() {
		if (tChoreographyLoopTypeObjectEDataType == null) {
			tChoreographyLoopTypeObjectEDataType = (EDataType)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(26);
		}
	...
	public EDataType getTEventBasedGatewayTypeObject() {
		if (tEventBasedGatewayTypeObjectEDataType == null) {
			tEventBasedGatewayTypeObjectEDataType = (EDataType)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(63);
		}
	...
	public EDataType getTGatewayDirectionObject() {
		if (tGatewayDirectionObjectEDataType == null) {
			tGatewayDirectionObjectEDataType = (EDataType)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(74);
		}
	...
	public EDataType getTImplementation() {
		if (tImplementationEDataType == null) {
			tImplementationEDataType = (EDataType)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(84);
		}
	...
	public EDataType getTImplementationMember1Object() {
		if (tImplementationMember1ObjectEDataType == null) {
			tImplementationMember1ObjectEDataType = (EDataType)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(86);
		}
	...
	public EDataType getTItemKindObject() {
		if (tItemKindObjectEDataType == null) {
			tItemKindObjectEDataType = (EDataType)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(98);
		}
	...
	public EDataType getTMultiInstanceFlowConditionObject() {
		if (tMultiInstanceFlowConditionObjectEDataType == null) {
			tMultiInstanceFlowConditionObjectEDataType = (EDataType)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(110);
		}
	...
	public EDataType getTProcessTypeObject() {
		if (tProcessTypeObjectEDataType == null) {
			tProcessTypeObjectEDataType = (EDataType)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(124);
		}
	...
	public EDataType getTRelationshipDirectionObject() {
		if (tRelationshipDirectionObjectEDataType == null) {
			tRelationshipDirectionObjectEDataType = (EDataType)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(129);
		}
	...
	public EDataType getTTransactionMethod() {
		if (tTransactionMethodEDataType == null) {
			tTransactionMethodEDataType = (EDataType)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(156);
		}
	...
	public EDataType getTTransactionMethodMember1Object() {
		if (tTransactionMethodMember1ObjectEDataType == null) {
			tTransactionMethodMember1ObjectEDataType = (EDataType)EPackage.Registry.INSTANCE.getEPackage(BPMNPackage.eNS_URI).getEClassifiers().get(158);
		}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("org.omg.spec.bpmn.bpmn." + eClassifier.getName());
