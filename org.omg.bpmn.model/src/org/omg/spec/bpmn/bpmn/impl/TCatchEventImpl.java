 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCatchEventImpl#getDataOutput <em>Data Output</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCatchEventImpl#getDataOutputAssociation <em>Data Output Association</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCatchEventImpl#getOutputSet <em>Output Set</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCatchEventImpl#getEventDefinitionGroup <em>Event Definition Group</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCatchEventImpl#getEventDefinition <em>Event Definition</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCatchEventImpl#getEventDefinitionRef <em>Event Definition Ref</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCatchEventImpl#isParallelMultiple <em>Parallel Multiple</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TCatchEventImpl extends TEventImpl implements TCatchEvent {
	...
	public EList<TDataOutput> getDataOutput() {
		if (dataOutput == null) {
			dataOutput = new EObjectContainmentEList<TDataOutput>(TDataOutput.class, this, BPMNPackage.TCATCH_EVENT__DATA_OUTPUT);
		}
		return dataOutput;
	}
	...
	public EList<TDataOutputAssociation> getDataOutputAssociation() {
		if (dataOutputAssociation == null) {
			dataOutputAssociation = new EObjectContainmentEList<TDataOutputAssociation>(TDataOutputAssociation.class, this, BPMNPackage.TCATCH_EVENT__DATA_OUTPUT_ASSOCIATION);
		}
	...
	public NotificationChain basicSetOutputSet(TOutputSet newOutputSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMNPackage.TCATCH_EVENT__OUTPUT_SET, oldOutputSet, newOutputSet);
	...
	public void setOutputSet(TOutputSet newOutputSet) {
		if (newOutputSet != outputSet) {
			...
			if (outputSet != null)
				msgs = ((InternalEObject)outputSet).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TCATCH_EVENT__OUTPUT_SET, null, msgs);
			if (newOutputSet != null)
				msgs = ((InternalEObject)newOutputSet).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TCATCH_EVENT__OUTPUT_SET, null, msgs);
			msgs = basicSetOutputSet(newOutputSet, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TCATCH_EVENT__OUTPUT_SET, newOutputSet, newOutputSet));
	}
	...
	public FeatureMap getEventDefinitionGroup() {
		if (eventDefinitionGroup == null) {
			eventDefinitionGroup = new BasicFeatureMap(this, BPMNPackage.TCATCH_EVENT__EVENT_DEFINITION_GROUP);
		}
	...
	public EList<QName> getEventDefinitionRef() {
		if (eventDefinitionRef == null) {
			eventDefinitionRef = new EDataTypeEList<QName>(QName.class, this, BPMNPackage.TCATCH_EVENT__EVENT_DEFINITION_REF);
		}
	...
	public void setParallelMultiple(boolean newParallelMultiple) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TCATCH_EVENT__PARALLEL_MULTIPLE, oldParallelMultiple, parallelMultiple, !oldParallelMultipleESet));
	}
	...
	public void unsetParallelMultiple() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TCATCH_EVENT__PARALLEL_MULTIPLE, oldParallelMultiple, PARALLEL_MULTIPLE_EDEFAULT, oldParallelMultipleESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNPackage.TCATCH_EVENT__DATA_OUTPUT:
				return ((InternalEList<?>)getDataOutput()).basicRemove(otherEnd, msgs);
			case BPMNPackage.TCATCH_EVENT__DATA_OUTPUT_ASSOCIATION:
				return ((InternalEList<?>)getDataOutputAssociation()).basicRemove(otherEnd, msgs);
			case BPMNPackage.TCATCH_EVENT__OUTPUT_SET:
				return basicSetOutputSet(null, msgs);
			case BPMNPackage.TCATCH_EVENT__EVENT_DEFINITION_GROUP:
				return ((InternalEList<?>)getEventDefinitionGroup()).basicRemove(otherEnd, msgs);
			case BPMNPackage.TCATCH_EVENT__EVENT_DEFINITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMNPackage.TCATCH_EVENT__EVENT_DEFINITION_REF:
				return getEventDefinitionRef();
			case BPMNPackage.TCATCH_EVENT__PARALLEL_MULTIPLE:
