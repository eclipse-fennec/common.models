 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TResourceRoleImpl#getResourceRef <em>Resource Ref</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TResourceRoleImpl#getResourceParameterBinding <em>Resource Parameter Binding</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TResourceRoleImpl#getResourceAssignmentExpression <em>Resource Assignment Expression</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TResourceRoleImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TResourceRoleImpl extends TBaseElementImpl implements TResourceRole {
	...
	protected EClass eStaticClass() {
		return BPMNPackage.eINSTANCE.getTResourceRole();
	}
	...
	public void setResourceRef(QName newResourceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TRESOURCE_ROLE__RESOURCE_REF, oldResourceRef, resourceRef));
	}
	...
	public EList<TResourceParameterBinding> getResourceParameterBinding() {
		if (resourceParameterBinding == null) {
			resourceParameterBinding = new EObjectContainmentEList<TResourceParameterBinding>(TResourceParameterBinding.class, this, BPMNPackage.TRESOURCE_ROLE__RESOURCE_PARAMETER_BINDING);
		}
	...
	public NotificationChain basicSetResourceAssignmentExpression(TResourceAssignmentExpression newResourceAssignmentExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMNPackage.TRESOURCE_ROLE__RESOURCE_ASSIGNMENT_EXPRESSION, oldResourceAssignmentExpression, newResourceAssignmentExpression);
	...
	public void setResourceAssignmentExpression(TResourceAssignmentExpression newResourceAssignmentExpression) {
		if (newResourceAssignmentExpression != resourceAssignmentExpression) {
			...
			if (resourceAssignmentExpression != null)
				msgs = ((InternalEObject)resourceAssignmentExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TRESOURCE_ROLE__RESOURCE_ASSIGNMENT_EXPRESSION, null, msgs);
			if (newResourceAssignmentExpression != null)
				msgs = ((InternalEObject)newResourceAssignmentExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TRESOURCE_ROLE__RESOURCE_ASSIGNMENT_EXPRESSION, null, msgs);
			msgs = basicSetResourceAssignmentExpression(newResourceAssignmentExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TRESOURCE_ROLE__RESOURCE_ASSIGNMENT_EXPRESSION, newResourceAssignmentExpression, newResourceAssignmentExpression));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TRESOURCE_ROLE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNPackage.TRESOURCE_ROLE__RESOURCE_PARAMETER_BINDING:
				return ((InternalEList<?>)getResourceParameterBinding()).basicRemove(otherEnd, msgs);
			case BPMNPackage.TRESOURCE_ROLE__RESOURCE_ASSIGNMENT_EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TRESOURCE_ROLE__RESOURCE_REF:
				return getResourceRef();
			case BPMNPackage.TRESOURCE_ROLE__RESOURCE_PARAMETER_BINDING:
				return getResourceParameterBinding();
			case BPMNPackage.TRESOURCE_ROLE__RESOURCE_ASSIGNMENT_EXPRESSION:
				return getResourceAssignmentExpression();
			case BPMNPackage.TRESOURCE_ROLE__NAME:
				return getName();
		}
