 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TImportImpl#getImportType <em>Import Type</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TImportImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TImportImpl#getNamespace <em>Namespace</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TImportImpl extends MinimalEObjectImpl.Container implements TImport {
	...
	protected EClass eStaticClass() {
		return BPMNPackage.eINSTANCE.getTImport();
	}
	...
	public void setImportType(String newImportType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TIMPORT__IMPORT_TYPE, oldImportType, importType));
	}
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TIMPORT__LOCATION, oldLocation, location));
	}
	...
	public void setNamespace(String newNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TIMPORT__NAMESPACE, oldNamespace, namespace));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TIMPORT__IMPORT_TYPE:
				return getImportType();
			case BPMNPackage.TIMPORT__LOCATION:
				return getLocation();
			case BPMNPackage.TIMPORT__NAMESPACE:
				return getNamespace();
		}
