 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TTimerEventDefinitionImpl#getTimeDate <em>Time Date</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TTimerEventDefinitionImpl#getTimeDuration <em>Time Duration</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TTimerEventDefinitionImpl#getTimeCycle <em>Time Cycle</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TTimerEventDefinitionImpl extends TEventDefinitionImpl implements TTimerEventDefinition {
	...
	public NotificationChain basicSetTimeDate(TExpression newTimeDate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_DATE, oldTimeDate, newTimeDate);
	...
	public void setTimeDate(TExpression newTimeDate) {
		if (newTimeDate != timeDate) {
			...
			if (timeDate != null)
				msgs = ((InternalEObject)timeDate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_DATE, null, msgs);
			if (newTimeDate != null)
				msgs = ((InternalEObject)newTimeDate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_DATE, null, msgs);
			msgs = basicSetTimeDate(newTimeDate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_DATE, newTimeDate, newTimeDate));
	}
	...
	public NotificationChain basicSetTimeDuration(TExpression newTimeDuration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_DURATION, oldTimeDuration, newTimeDuration);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTimeDuration(TExpression newTimeDuration) {
		if (newTimeDuration != timeDuration) {
			...
			if (timeDuration != null)
				msgs = ((InternalEObject)timeDuration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_DURATION, null, msgs);
			if (newTimeDuration != null)
				msgs = ((InternalEObject)newTimeDuration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_DURATION, null, msgs);
			msgs = basicSetTimeDuration(newTimeDuration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_DURATION, newTimeDuration, newTimeDuration));
	}
	...
	public NotificationChain basicSetTimeCycle(TExpression newTimeCycle, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_CYCLE, oldTimeCycle, newTimeCycle);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTimeCycle(TExpression newTimeCycle) {
		if (newTimeCycle != timeCycle) {
			NotificationChain msgs = null;
			if (timeCycle != null)
				msgs = ((InternalEObject)timeCycle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_CYCLE, null, msgs);
			if (newTimeCycle != null)
				msgs = ((InternalEObject)newTimeCycle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_CYCLE, null, msgs);
			msgs = basicSetTimeCycle(newTimeCycle, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_CYCLE, newTimeCycle, newTimeCycle));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_DATE:
				return basicSetTimeDate(null, msgs);
			case BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_DURATION:
				return basicSetTimeDuration(null, msgs);
			case BPMNPackage.TTIMER_EVENT_DEFINITION__TIME_CYCLE:
