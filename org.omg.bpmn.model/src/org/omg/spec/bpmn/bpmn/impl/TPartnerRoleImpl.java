 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TPartnerRoleImpl#getParticipantRef <em>Participant Ref</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TPartnerRoleImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TPartnerRoleImpl extends TRootElementImpl implements TPartnerRole {
	...
	protected EClass eStaticClass() {
		return BPMNPackage.eINSTANCE.getTPartnerRole();
	}
	...
	public EList<QName> getParticipantRef() {
		if (participantRef == null) {
			participantRef = new EDataTypeEList<QName>(QName.class, this, BPMNPackage.TPARTNER_ROLE__PARTICIPANT_REF);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TPARTNER_ROLE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TPARTNER_ROLE__PARTICIPANT_REF:
				return getParticipantRef();
			case BPMNPackage.TPARTNER_ROLE__NAME:
				return getName();
		}
