 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TSubProcessImpl#getLaneSet <em>Lane Set</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TSubProcessImpl#getFlowElementGroup <em>Flow Element Group</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TSubProcessImpl#getFlowElement <em>Flow Element</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TSubProcessImpl#getArtifactGroup <em>Artifact Group</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TSubProcessImpl#getArtifact <em>Artifact</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TSubProcessImpl#isTriggeredByEvent <em>Triggered By Event</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TSubProcessImpl extends TActivityImpl implements TSubProcess {
	...
	public EList<TLaneSet> getLaneSet() {
		if (laneSet == null) {
			laneSet = new EObjectContainmentEList<TLaneSet>(TLaneSet.class, this, BPMNPackage.TSUB_PROCESS__LANE_SET);
		}
		return laneSet;
	}
	...
	public FeatureMap getFlowElementGroup() {
		if (flowElementGroup == null) {
			flowElementGroup = new BasicFeatureMap(this, BPMNPackage.TSUB_PROCESS__FLOW_ELEMENT_GROUP);
		}
	...
	public FeatureMap getArtifactGroup() {
		if (artifactGroup == null) {
			artifactGroup = new BasicFeatureMap(this, BPMNPackage.TSUB_PROCESS__ARTIFACT_GROUP);
		}
	...
	public void setTriggeredByEvent(boolean newTriggeredByEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TSUB_PROCESS__TRIGGERED_BY_EVENT, oldTriggeredByEvent, triggeredByEvent, !oldTriggeredByEventESet));
	}
	...
	public void unsetTriggeredByEvent() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TSUB_PROCESS__TRIGGERED_BY_EVENT, oldTriggeredByEvent, TRIGGERED_BY_EVENT_EDEFAULT, oldTriggeredByEventESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMNPackage.TSUB_PROCESS__ARTIFACT:
				return getArtifact();
			case BPMNPackage.TSUB_PROCESS__TRIGGERED_BY_EVENT:
