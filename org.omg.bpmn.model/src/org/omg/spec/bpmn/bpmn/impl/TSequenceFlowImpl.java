 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TSequenceFlowImpl#getConditionExpression <em>Condition Expression</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TSequenceFlowImpl#isIsImmediate <em>Is Immediate</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TSequenceFlowImpl#getSourceRef <em>Source Ref</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TSequenceFlowImpl#getTargetRef <em>Target Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TSequenceFlowImpl extends TFlowElementImpl implements TSequenceFlow {
	...
	public NotificationChain basicSetConditionExpression(TExpression newConditionExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMNPackage.TSEQUENCE_FLOW__CONDITION_EXPRESSION, oldConditionExpression, newConditionExpression);
	...
	public void setConditionExpression(TExpression newConditionExpression) {
		if (newConditionExpression != conditionExpression) {
			...
			if (conditionExpression != null)
				msgs = ((InternalEObject)conditionExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TSEQUENCE_FLOW__CONDITION_EXPRESSION, null, msgs);
			if (newConditionExpression != null)
				msgs = ((InternalEObject)newConditionExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TSEQUENCE_FLOW__CONDITION_EXPRESSION, null, msgs);
			msgs = basicSetConditionExpression(newConditionExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TSEQUENCE_FLOW__CONDITION_EXPRESSION, newConditionExpression, newConditionExpression));
	}
	...
	public void setIsImmediate(boolean newIsImmediate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TSEQUENCE_FLOW__IS_IMMEDIATE, oldIsImmediate, isImmediate, !oldIsImmediateESet));
	}
	...
	public void unsetIsImmediate() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TSEQUENCE_FLOW__IS_IMMEDIATE, oldIsImmediate, IS_IMMEDIATE_EDEFAULT, oldIsImmediateESet));
	}
	...
	public void setSourceRef(String newSourceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TSEQUENCE_FLOW__SOURCE_REF, oldSourceRef, sourceRef));
	}
	...
	public void setTargetRef(String newTargetRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TSEQUENCE_FLOW__TARGET_REF, oldTargetRef, targetRef));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNPackage.TSEQUENCE_FLOW__CONDITION_EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMNPackage.TSEQUENCE_FLOW__IS_IMMEDIATE:
				return isIsImmediate();
			case BPMNPackage.TSEQUENCE_FLOW__SOURCE_REF:
				return getSourceRef();
			case BPMNPackage.TSEQUENCE_FLOW__TARGET_REF:
				return getTargetRef();
		}
