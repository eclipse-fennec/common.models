 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TSignalImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TSignalImpl#getStructureRef <em>Structure Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TSignalImpl extends TRootElementImpl implements TSignal {
	...
	protected EClass eStaticClass() {
		return BPMNPackage.eINSTANCE.getTSignal();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TSIGNAL__NAME, oldName, name));
	}
	...
	public void setStructureRef(QName newStructureRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TSIGNAL__STRUCTURE_REF, oldStructureRef, structureRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TSIGNAL__NAME:
				return getName();
			case BPMNPackage.TSIGNAL__STRUCTURE_REF:
