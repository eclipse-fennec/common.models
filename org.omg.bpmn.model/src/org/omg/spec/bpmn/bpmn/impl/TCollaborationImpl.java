 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCollaborationImpl#getParticipant <em>Participant</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCollaborationImpl#getMessageFlow <em>Message Flow</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCollaborationImpl#getArtifactGroup <em>Artifact Group</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCollaborationImpl#getArtifact <em>Artifact</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCollaborationImpl#getConversationNodeGroup <em>Conversation Node Group</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCollaborationImpl#getConversationNode <em>Conversation Node</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCollaborationImpl#getConversationAssociation <em>Conversation Association</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCollaborationImpl#getParticipantAssociation <em>Participant Association</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCollaborationImpl#getMessageFlowAssociation <em>Message Flow Association</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCollaborationImpl#getCorrelationKey <em>Correlation Key</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCollaborationImpl#getChoreographyRef <em>Choreography Ref</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCollaborationImpl#getConversationLink <em>Conversation Link</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCollaborationImpl#isIsClosed <em>Is Closed</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCollaborationImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCollaborationImpl extends TRootElementImpl implements TCollaboration {
	...
	public EList<TParticipant> getParticipant() {
		if (participant == null) {
			participant = new EObjectContainmentEList<TParticipant>(TParticipant.class, this, BPMNPackage.TCOLLABORATION__PARTICIPANT);
		}
		return participant;
	}
	...
	public EList<TMessageFlow> getMessageFlow() {
		if (messageFlow == null) {
			messageFlow = new EObjectContainmentEList<TMessageFlow>(TMessageFlow.class, this, BPMNPackage.TCOLLABORATION__MESSAGE_FLOW);
		}
		return messageFlow;
	}
	...
	public FeatureMap getArtifactGroup() {
		if (artifactGroup == null) {
			artifactGroup = new BasicFeatureMap(this, BPMNPackage.TCOLLABORATION__ARTIFACT_GROUP);
		}
	...
	public FeatureMap getConversationNodeGroup() {
		if (conversationNodeGroup == null) {
			conversationNodeGroup = new BasicFeatureMap(this, BPMNPackage.TCOLLABORATION__CONVERSATION_NODE_GROUP);
		}
	...
	public EList<TConversationNode> getConversationNode() {
		return getConversationNodeGroup().list(BPMNPackage.eINSTANCE.getTCollaboration_ConversationNode());
	}
	...
	public EList<TConversationAssociation> getConversationAssociation() {
		if (conversationAssociation == null) {
			conversationAssociation = new EObjectContainmentEList<TConversationAssociation>(TConversationAssociation.class, this, BPMNPackage.TCOLLABORATION__CONVERSATION_ASSOCIATION);
		}
	...
	public EList<TParticipantAssociation> getParticipantAssociation() {
		if (participantAssociation == null) {
			participantAssociation = new EObjectContainmentEList<TParticipantAssociation>(TParticipantAssociation.class, this, BPMNPackage.TCOLLABORATION__PARTICIPANT_ASSOCIATION);
		}
	...
	public EList<TMessageFlowAssociation> getMessageFlowAssociation() {
		if (messageFlowAssociation == null) {
			messageFlowAssociation = new EObjectContainmentEList<TMessageFlowAssociation>(TMessageFlowAssociation.class, this, BPMNPackage.TCOLLABORATION__MESSAGE_FLOW_ASSOCIATION);
		}
	...
	public EList<TCorrelationKey> getCorrelationKey() {
		if (correlationKey == null) {
			correlationKey = new EObjectContainmentEList<TCorrelationKey>(TCorrelationKey.class, this, BPMNPackage.TCOLLABORATION__CORRELATION_KEY);
		}
	...
	public EList<QName> getChoreographyRef() {
		if (choreographyRef == null) {
			choreographyRef = new EDataTypeEList<QName>(QName.class, this, BPMNPackage.TCOLLABORATION__CHOREOGRAPHY_REF);
		}
	...
	public EList<TConversationLink> getConversationLink() {
		if (conversationLink == null) {
			conversationLink = new EObjectContainmentEList<TConversationLink>(TConversationLink.class, this, BPMNPackage.TCOLLABORATION__CONVERSATION_LINK);
		}
	...
	public void setIsClosed(boolean newIsClosed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TCOLLABORATION__IS_CLOSED, oldIsClosed, isClosed, !oldIsClosedESet));
	}
	...
	public void unsetIsClosed() {
		...
		isClosedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TCOLLABORATION__IS_CLOSED, oldIsClosed, IS_CLOSED_EDEFAULT, oldIsClosedESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TCOLLABORATION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMNPackage.TCOLLABORATION__CHOREOGRAPHY_REF:
				return getChoreographyRef();
			case BPMNPackage.TCOLLABORATION__CONVERSATION_LINK:
				return getConversationLink();
			case BPMNPackage.TCOLLABORATION__IS_CLOSED:
				return isIsClosed();
			case BPMNPackage.TCOLLABORATION__NAME:
				return getName();
		}
