 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TDataStoreImpl#getDataState <em>Data State</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TDataStoreImpl#getCapacity <em>Capacity</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TDataStoreImpl#isIsUnlimited <em>Is Unlimited</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TDataStoreImpl#getItemSubjectRef <em>Item Subject Ref</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TDataStoreImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TDataStoreImpl extends TRootElementImpl implements TDataStore {
	...
	protected EClass eStaticClass() {
		return BPMNPackage.eINSTANCE.getTDataStore();
	}
	...
	public NotificationChain basicSetDataState(TDataState newDataState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMNPackage.TDATA_STORE__DATA_STATE, oldDataState, newDataState);
	...
	public void setDataState(TDataState newDataState) {
		if (newDataState != dataState) {
			...
			if (dataState != null)
				msgs = ((InternalEObject)dataState).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TDATA_STORE__DATA_STATE, null, msgs);
			if (newDataState != null)
				msgs = ((InternalEObject)newDataState).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TDATA_STORE__DATA_STATE, null, msgs);
			msgs = basicSetDataState(newDataState, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TDATA_STORE__DATA_STATE, newDataState, newDataState));
	}
	...
	public void setCapacity(BigInteger newCapacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TDATA_STORE__CAPACITY, oldCapacity, capacity));
	}
	...
	public void setIsUnlimited(boolean newIsUnlimited) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TDATA_STORE__IS_UNLIMITED, oldIsUnlimited, isUnlimited, !oldIsUnlimitedESet));
	}
	...
	public void unsetIsUnlimited() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TDATA_STORE__IS_UNLIMITED, oldIsUnlimited, IS_UNLIMITED_EDEFAULT, oldIsUnlimitedESet));
	}
	...
	public void setItemSubjectRef(QName newItemSubjectRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TDATA_STORE__ITEM_SUBJECT_REF, oldItemSubjectRef, itemSubjectRef));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TDATA_STORE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNPackage.TDATA_STORE__DATA_STATE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TDATA_STORE__DATA_STATE:
				return getDataState();
			case BPMNPackage.TDATA_STORE__CAPACITY:
				return getCapacity();
			case BPMNPackage.TDATA_STORE__IS_UNLIMITED:
				return isIsUnlimited();
			case BPMNPackage.TDATA_STORE__ITEM_SUBJECT_REF:
				return getItemSubjectRef();
			case BPMNPackage.TDATA_STORE__NAME:
				return getName();
		}
