 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TMessageFlowAssociationImpl#getInnerMessageFlowRef <em>Inner Message Flow Ref</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TMessageFlowAssociationImpl#getOuterMessageFlowRef <em>Outer Message Flow Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TMessageFlowAssociationImpl extends TBaseElementImpl implements TMessageFlowAssociation {
	...
	public void setInnerMessageFlowRef(QName newInnerMessageFlowRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TMESSAGE_FLOW_ASSOCIATION__INNER_MESSAGE_FLOW_REF, oldInnerMessageFlowRef, innerMessageFlowRef));
	}
	...
	public void setOuterMessageFlowRef(QName newOuterMessageFlowRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TMESSAGE_FLOW_ASSOCIATION__OUTER_MESSAGE_FLOW_REF, oldOuterMessageFlowRef, outerMessageFlowRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TMESSAGE_FLOW_ASSOCIATION__INNER_MESSAGE_FLOW_REF:
				return getInnerMessageFlowRef();
			case BPMNPackage.TMESSAGE_FLOW_ASSOCIATION__OUTER_MESSAGE_FLOW_REF:
