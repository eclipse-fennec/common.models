 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TMessageEventDefinitionImpl#getOperationRef <em>Operation Ref</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TMessageEventDefinitionImpl#getMessageRef <em>Message Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TMessageEventDefinitionImpl extends TEventDefinitionImpl implements TMessageEventDefinition {
	...
	protected EClass eStaticClass() {
		return BPMNPackage.eINSTANCE.getTMessageEventDefinition();
	}
	...
	public void setOperationRef(QName newOperationRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TMESSAGE_EVENT_DEFINITION__OPERATION_REF, oldOperationRef, operationRef));
	}
	...
	public void setMessageRef(QName newMessageRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TMESSAGE_EVENT_DEFINITION__MESSAGE_REF, oldMessageRef, messageRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TMESSAGE_EVENT_DEFINITION__OPERATION_REF:
				return getOperationRef();
			case BPMNPackage.TMESSAGE_EVENT_DEFINITION__MESSAGE_REF:
