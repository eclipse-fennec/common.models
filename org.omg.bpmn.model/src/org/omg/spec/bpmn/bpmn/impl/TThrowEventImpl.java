 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TThrowEventImpl#getDataInput <em>Data Input</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TThrowEventImpl#getDataInputAssociation <em>Data Input Association</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TThrowEventImpl#getInputSet <em>Input Set</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TThrowEventImpl#getEventDefinitionGroup <em>Event Definition Group</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TThrowEventImpl#getEventDefinition <em>Event Definition</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TThrowEventImpl#getEventDefinitionRef <em>Event Definition Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TThrowEventImpl extends TEventImpl implements TThrowEvent {
	...
	protected EClass eStaticClass() {
		return BPMNPackage.eINSTANCE.getTThrowEvent();
	}
	...
	public EList<TDataInput> getDataInput() {
		if (dataInput == null) {
			dataInput = new EObjectContainmentEList<TDataInput>(TDataInput.class, this, BPMNPackage.TTHROW_EVENT__DATA_INPUT);
		}
		return dataInput;
	}
	...
	public EList<TDataInputAssociation> getDataInputAssociation() {
		if (dataInputAssociation == null) {
			dataInputAssociation = new EObjectContainmentEList<TDataInputAssociation>(TDataInputAssociation.class, this, BPMNPackage.TTHROW_EVENT__DATA_INPUT_ASSOCIATION);
		}
	...
	public NotificationChain basicSetInputSet(TInputSet newInputSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMNPackage.TTHROW_EVENT__INPUT_SET, oldInputSet, newInputSet);
	...
	public void setInputSet(TInputSet newInputSet) {
		if (newInputSet != inputSet) {
			...
			if (inputSet != null)
				msgs = ((InternalEObject)inputSet).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TTHROW_EVENT__INPUT_SET, null, msgs);
			if (newInputSet != null)
				msgs = ((InternalEObject)newInputSet).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TTHROW_EVENT__INPUT_SET, null, msgs);
			msgs = basicSetInputSet(newInputSet, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TTHROW_EVENT__INPUT_SET, newInputSet, newInputSet));
	}
	...
	public FeatureMap getEventDefinitionGroup() {
		if (eventDefinitionGroup == null) {
			eventDefinitionGroup = new BasicFeatureMap(this, BPMNPackage.TTHROW_EVENT__EVENT_DEFINITION_GROUP);
		}
	...
	public EList<TEventDefinition> getEventDefinition() {
		return getEventDefinitionGroup().list(BPMNPackage.eINSTANCE.getTThrowEvent_EventDefinition());
	}
	...
	public EList<QName> getEventDefinitionRef() {
		if (eventDefinitionRef == null) {
			eventDefinitionRef = new EDataTypeEList<QName>(QName.class, this, BPMNPackage.TTHROW_EVENT__EVENT_DEFINITION_REF);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNPackage.TTHROW_EVENT__DATA_INPUT:
				return ((InternalEList<?>)getDataInput()).basicRemove(otherEnd, msgs);
			case BPMNPackage.TTHROW_EVENT__DATA_INPUT_ASSOCIATION:
				return ((InternalEList<?>)getDataInputAssociation()).basicRemove(otherEnd, msgs);
			case BPMNPackage.TTHROW_EVENT__INPUT_SET:
				return basicSetInputSet(null, msgs);
			case BPMNPackage.TTHROW_EVENT__EVENT_DEFINITION_GROUP:
				return ((InternalEList<?>)getEventDefinitionGroup()).basicRemove(otherEnd, msgs);
			case BPMNPackage.TTHROW_EVENT__EVENT_DEFINITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMNPackage.TTHROW_EVENT__EVENT_DEFINITION_REF:
