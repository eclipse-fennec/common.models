 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TServiceTaskImpl#getImplementation <em>Implementation</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TServiceTaskImpl#getOperationRef <em>Operation Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TServiceTaskImpl extends TTaskImpl implements TServiceTask {
	...
	public void setImplementation(Object newImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TSERVICE_TASK__IMPLEMENTATION, oldImplementation, implementation, !oldImplementationESet));
	}
	...
	public void unsetImplementation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TSERVICE_TASK__IMPLEMENTATION, oldImplementation, IMPLEMENTATION_EDEFAULT, oldImplementationESet));
	}
	...
	public void setOperationRef(QName newOperationRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TSERVICE_TASK__OPERATION_REF, oldOperationRef, operationRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TSERVICE_TASK__IMPLEMENTATION:
				return getImplementation();
			case BPMNPackage.TSERVICE_TASK__OPERATION_REF:
