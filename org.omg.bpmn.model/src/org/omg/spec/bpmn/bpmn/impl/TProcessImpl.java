...
import org.omg.spec.bpmn.bpmn.TProcessType;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#getAuditing <em>Auditing</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#getMonitoring <em>Monitoring</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#getLaneSet <em>Lane Set</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#getFlowElementGroup <em>Flow Element Group</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#getFlowElement <em>Flow Element</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#getArtifactGroup <em>Artifact Group</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#getArtifact <em>Artifact</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#getResourceRoleGroup <em>Resource Role Group</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#getResourceRole <em>Resource Role</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#getCorrelationSubscription <em>Correlation Subscription</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#getSupports <em>Supports</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#getDefinitionalCollaborationRef <em>Definitional Collaboration Ref</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#isIsClosed <em>Is Closed</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#isIsExecutable <em>Is Executable</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TProcessImpl#getProcessType <em>Process Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TProcessImpl extends TCallableElementImpl implements TProcess {
	...
	public NotificationChain basicSetAuditing(TAuditing newAuditing, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMNPackage.TPROCESS__AUDITING, oldAuditing, newAuditing);
	...
	public void setAuditing(TAuditing newAuditing) {
		if (newAuditing != auditing) {
			...
			if (auditing != null)
				msgs = ((InternalEObject)auditing).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TPROCESS__AUDITING, null, msgs);
			if (newAuditing != null)
				msgs = ((InternalEObject)newAuditing).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TPROCESS__AUDITING, null, msgs);
			msgs = basicSetAuditing(newAuditing, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TPROCESS__AUDITING, newAuditing, newAuditing));
	}
	...
	public NotificationChain basicSetMonitoring(TMonitoring newMonitoring, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMNPackage.TPROCESS__MONITORING, oldMonitoring, newMonitoring);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMonitoring(TMonitoring newMonitoring) {
		if (newMonitoring != monitoring) {
			NotificationChain msgs = null;
			if (monitoring != null)
				msgs = ((InternalEObject)monitoring).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TPROCESS__MONITORING, null, msgs);
			if (newMonitoring != null)
				msgs = ((InternalEObject)newMonitoring).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TPROCESS__MONITORING, null, msgs);
			msgs = basicSetMonitoring(newMonitoring, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TPROCESS__MONITORING, newMonitoring, newMonitoring));
	}
	...
	public EList<TProperty> getProperty() {
		if (property == null) {
			property = new EObjectContainmentEList<TProperty>(TProperty.class, this, BPMNPackage.TPROCESS__PROPERTY);
		}
		return property;
	}
	...
	public EList<TLaneSet> getLaneSet() {
		if (laneSet == null) {
			laneSet = new EObjectContainmentEList<TLaneSet>(TLaneSet.class, this, BPMNPackage.TPROCESS__LANE_SET);
		}
		return laneSet;
	}
	...
	public FeatureMap getFlowElementGroup() {
		if (flowElementGroup == null) {
			flowElementGroup = new BasicFeatureMap(this, BPMNPackage.TPROCESS__FLOW_ELEMENT_GROUP);
		}
	...
	public FeatureMap getArtifactGroup() {
		if (artifactGroup == null) {
			artifactGroup = new BasicFeatureMap(this, BPMNPackage.TPROCESS__ARTIFACT_GROUP);
		}
	...
	public FeatureMap getResourceRoleGroup() {
		if (resourceRoleGroup == null) {
			resourceRoleGroup = new BasicFeatureMap(this, BPMNPackage.TPROCESS__RESOURCE_ROLE_GROUP);
		}
	...
	public EList<TCorrelationSubscription> getCorrelationSubscription() {
		if (correlationSubscription == null) {
			correlationSubscription = new EObjectContainmentEList<TCorrelationSubscription>(TCorrelationSubscription.class, this, BPMNPackage.TPROCESS__CORRELATION_SUBSCRIPTION);
		}
	...
	public EList<QName> getSupports() {
		if (supports == null) {
			supports = new EDataTypeEList<QName>(QName.class, this, BPMNPackage.TPROCESS__SUPPORTS);
		}
		return supports;
	}
	...
	public void setDefinitionalCollaborationRef(QName newDefinitionalCollaborationRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TPROCESS__DEFINITIONAL_COLLABORATION_REF, oldDefinitionalCollaborationRef, definitionalCollaborationRef));
	}
	...
	public void setIsClosed(boolean newIsClosed) {
		...
		isClosedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TPROCESS__IS_CLOSED, oldIsClosed, isClosed, !oldIsClosedESet));
	}
	...
	public void unsetIsClosed() {
		...
		isClosedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TPROCESS__IS_CLOSED, oldIsClosed, IS_CLOSED_EDEFAULT, oldIsClosedESet));
	}
	...
	public void setIsExecutable(boolean newIsExecutable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TPROCESS__IS_EXECUTABLE, oldIsExecutable, isExecutable, !oldIsExecutableESet));
	}
	...
	public void unsetIsExecutable() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TPROCESS__IS_EXECUTABLE, oldIsExecutable, IS_EXECUTABLE_EDEFAULT, oldIsExecutableESet));
	}
	...
	public void setProcessType(TProcessType newProcessType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TPROCESS__PROCESS_TYPE, oldProcessType, processType, !oldProcessTypeESet));
	}
	...
	public void unsetProcessType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TPROCESS__PROCESS_TYPE, oldProcessType, PROCESS_TYPE_EDEFAULT, oldProcessTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMNPackage.TPROCESS__SUPPORTS:
				return getSupports();
			case BPMNPackage.TPROCESS__DEFINITIONAL_COLLABORATION_REF:
				return getDefinitionalCollaborationRef();
			case BPMNPackage.TPROCESS__IS_CLOSED:
				return isIsClosed();
			case BPMNPackage.TPROCESS__IS_EXECUTABLE:
				return isIsExecutable();
			case BPMNPackage.TPROCESS__PROCESS_TYPE:
