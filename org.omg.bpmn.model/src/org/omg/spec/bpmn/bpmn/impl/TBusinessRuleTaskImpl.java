 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TBusinessRuleTaskImpl#getImplementation <em>Implementation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TBusinessRuleTaskImpl extends TTaskImpl implements TBusinessRuleTask {
	...
	protected EClass eStaticClass() {
		return BPMNPackage.eINSTANCE.getTBusinessRuleTask();
	}
	...
	public void setImplementation(Object newImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TBUSINESS_RULE_TASK__IMPLEMENTATION, oldImplementation, implementation, !oldImplementationESet));
	}
	...
	public void unsetImplementation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TBUSINESS_RULE_TASK__IMPLEMENTATION, oldImplementation, IMPLEMENTATION_EDEFAULT, oldImplementationESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TBUSINESS_RULE_TASK__IMPLEMENTATION:
