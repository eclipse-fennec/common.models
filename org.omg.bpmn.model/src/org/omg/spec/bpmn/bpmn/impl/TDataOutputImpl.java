 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TDataOutputImpl#getDataState <em>Data State</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TDataOutputImpl#isIsCollection <em>Is Collection</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TDataOutputImpl#getItemSubjectRef <em>Item Subject Ref</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TDataOutputImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TDataOutputImpl extends TBaseElementImpl implements TDataOutput {
	...
	protected EClass eStaticClass() {
		return BPMNPackage.eINSTANCE.getTDataOutput();
	}
	...
	public NotificationChain basicSetDataState(TDataState newDataState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMNPackage.TDATA_OUTPUT__DATA_STATE, oldDataState, newDataState);
	...
	public void setDataState(TDataState newDataState) {
		if (newDataState != dataState) {
			...
			if (dataState != null)
				msgs = ((InternalEObject)dataState).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TDATA_OUTPUT__DATA_STATE, null, msgs);
			if (newDataState != null)
				msgs = ((InternalEObject)newDataState).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TDATA_OUTPUT__DATA_STATE, null, msgs);
			msgs = basicSetDataState(newDataState, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TDATA_OUTPUT__DATA_STATE, newDataState, newDataState));
	}
	...
	public void setIsCollection(boolean newIsCollection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TDATA_OUTPUT__IS_COLLECTION, oldIsCollection, isCollection, !oldIsCollectionESet));
	}
	...
	public void unsetIsCollection() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TDATA_OUTPUT__IS_COLLECTION, oldIsCollection, IS_COLLECTION_EDEFAULT, oldIsCollectionESet));
	}
	...
	public void setItemSubjectRef(QName newItemSubjectRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TDATA_OUTPUT__ITEM_SUBJECT_REF, oldItemSubjectRef, itemSubjectRef));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TDATA_OUTPUT__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNPackage.TDATA_OUTPUT__DATA_STATE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TDATA_OUTPUT__DATA_STATE:
				return getDataState();
			case BPMNPackage.TDATA_OUTPUT__IS_COLLECTION:
				return isIsCollection();
			case BPMNPackage.TDATA_OUTPUT__ITEM_SUBJECT_REF:
				return getItemSubjectRef();
			case BPMNPackage.TDATA_OUTPUT__NAME:
				return getName();
		}
