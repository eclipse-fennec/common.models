 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCorrelationPropertyBindingImpl#getDataPath <em>Data Path</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCorrelationPropertyBindingImpl#getCorrelationPropertyRef <em>Correlation Property Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCorrelationPropertyBindingImpl extends TBaseElementImpl implements TCorrelationPropertyBinding {
	...
	public NotificationChain basicSetDataPath(TFormalExpression newDataPath, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMNPackage.TCORRELATION_PROPERTY_BINDING__DATA_PATH, oldDataPath, newDataPath);
	...
	public void setDataPath(TFormalExpression newDataPath) {
		if (newDataPath != dataPath) {
			...
			if (dataPath != null)
				msgs = ((InternalEObject)dataPath).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TCORRELATION_PROPERTY_BINDING__DATA_PATH, null, msgs);
			if (newDataPath != null)
				msgs = ((InternalEObject)newDataPath).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TCORRELATION_PROPERTY_BINDING__DATA_PATH, null, msgs);
			msgs = basicSetDataPath(newDataPath, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TCORRELATION_PROPERTY_BINDING__DATA_PATH, newDataPath, newDataPath));
	}
	...
	public void setCorrelationPropertyRef(QName newCorrelationPropertyRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TCORRELATION_PROPERTY_BINDING__CORRELATION_PROPERTY_REF, oldCorrelationPropertyRef, correlationPropertyRef));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNPackage.TCORRELATION_PROPERTY_BINDING__DATA_PATH:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TCORRELATION_PROPERTY_BINDING__DATA_PATH:
				return getDataPath();
			case BPMNPackage.TCORRELATION_PROPERTY_BINDING__CORRELATION_PROPERTY_REF:
