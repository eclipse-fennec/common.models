 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCategoryImpl#getCategoryValue <em>Category Value</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCategoryImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCategoryImpl extends TRootElementImpl implements TCategory {
	...
	protected EClass eStaticClass() {
		return BPMNPackage.eINSTANCE.getTCategory();
	}
	...
	public EList<TCategoryValue> getCategoryValue() {
		if (categoryValue == null) {
			categoryValue = new EObjectContainmentEList<TCategoryValue>(TCategoryValue.class, this, BPMNPackage.TCATEGORY__CATEGORY_VALUE);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TCATEGORY__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNPackage.TCATEGORY__CATEGORY_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMNPackage.TCATEGORY__NAME:
				return getName();
		}
