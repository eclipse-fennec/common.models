 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TActivityImpl#getIoSpecification <em>Io Specification</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TActivityImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TActivityImpl#getDataInputAssociation <em>Data Input Association</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TActivityImpl#getDataOutputAssociation <em>Data Output Association</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TActivityImpl#getResourceRoleGroup <em>Resource Role Group</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TActivityImpl#getResourceRole <em>Resource Role</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TActivityImpl#getLoopCharacteristicsGroup <em>Loop Characteristics Group</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TActivityImpl#getLoopCharacteristics <em>Loop Characteristics</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TActivityImpl#getCompletionQuantity <em>Completion Quantity</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TActivityImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TActivityImpl#isIsForCompensation <em>Is For Compensation</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TActivityImpl#getStartQuantity <em>Start Quantity</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TActivityImpl extends TFlowNodeImpl implements TActivity {
	...
	public NotificationChain basicSetIoSpecification(TInputOutputSpecification newIoSpecification, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMNPackage.TACTIVITY__IO_SPECIFICATION, oldIoSpecification, newIoSpecification);
	...
	public void setIoSpecification(TInputOutputSpecification newIoSpecification) {
		if (newIoSpecification != ioSpecification) {
			...
			if (ioSpecification != null)
				msgs = ((InternalEObject)ioSpecification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TACTIVITY__IO_SPECIFICATION, null, msgs);
			if (newIoSpecification != null)
				msgs = ((InternalEObject)newIoSpecification).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TACTIVITY__IO_SPECIFICATION, null, msgs);
			msgs = basicSetIoSpecification(newIoSpecification, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TACTIVITY__IO_SPECIFICATION, newIoSpecification, newIoSpecification));
	}
	...
	public EList<TProperty> getProperty() {
		if (property == null) {
			property = new EObjectContainmentEList<TProperty>(TProperty.class, this, BPMNPackage.TACTIVITY__PROPERTY);
		}
		return property;
	}
	...
	public EList<TDataInputAssociation> getDataInputAssociation() {
		if (dataInputAssociation == null) {
			dataInputAssociation = new EObjectContainmentEList<TDataInputAssociation>(TDataInputAssociation.class, this, BPMNPackage.TACTIVITY__DATA_INPUT_ASSOCIATION);
		}
	...
	public EList<TDataOutputAssociation> getDataOutputAssociation() {
		if (dataOutputAssociation == null) {
			dataOutputAssociation = new EObjectContainmentEList<TDataOutputAssociation>(TDataOutputAssociation.class, this, BPMNPackage.TACTIVITY__DATA_OUTPUT_ASSOCIATION);
		}
	...
	public FeatureMap getResourceRoleGroup() {
		if (resourceRoleGroup == null) {
			resourceRoleGroup = new BasicFeatureMap(this, BPMNPackage.TACTIVITY__RESOURCE_ROLE_GROUP);
		}
	...
	public FeatureMap getLoopCharacteristicsGroup() {
		if (loopCharacteristicsGroup == null) {
			loopCharacteristicsGroup = new BasicFeatureMap(this, BPMNPackage.TACTIVITY__LOOP_CHARACTERISTICS_GROUP);
		}
	...
	public void setCompletionQuantity(BigInteger newCompletionQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TACTIVITY__COMPLETION_QUANTITY, oldCompletionQuantity, completionQuantity, !oldCompletionQuantityESet));
	}
	...
	public void unsetCompletionQuantity() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TACTIVITY__COMPLETION_QUANTITY, oldCompletionQuantity, COMPLETION_QUANTITY_EDEFAULT, oldCompletionQuantityESet));
	}
	...
	public void setDefault(String newDefault) {
		...
		default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TACTIVITY__DEFAULT, oldDefault, default_));
	}
	...
	public void setIsForCompensation(boolean newIsForCompensation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TACTIVITY__IS_FOR_COMPENSATION, oldIsForCompensation, isForCompensation, !oldIsForCompensationESet));
	}
	...
	public void unsetIsForCompensation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TACTIVITY__IS_FOR_COMPENSATION, oldIsForCompensation, IS_FOR_COMPENSATION_EDEFAULT, oldIsForCompensationESet));
	}
	...
	public void setStartQuantity(BigInteger newStartQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TACTIVITY__START_QUANTITY, oldStartQuantity, startQuantity, !oldStartQuantityESet));
	}
	...
	public void unsetStartQuantity() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TACTIVITY__START_QUANTITY, oldStartQuantity, START_QUANTITY_EDEFAULT, oldStartQuantityESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMNPackage.TACTIVITY__COMPLETION_QUANTITY:
				return getCompletionQuantity();
			case BPMNPackage.TACTIVITY__DEFAULT:
				return getDefault();
			case BPMNPackage.TACTIVITY__IS_FOR_COMPENSATION:
				return isIsForCompensation();
			case BPMNPackage.TACTIVITY__START_QUANTITY:
