 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TGlobalUserTaskImpl#getRendering <em>Rendering</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TGlobalUserTaskImpl#getImplementation <em>Implementation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TGlobalUserTaskImpl extends TGlobalTaskImpl implements TGlobalUserTask {
	...
	protected EClass eStaticClass() {
		return BPMNPackage.eINSTANCE.getTGlobalUserTask();
	}
	...
	public EList<TRendering> getRendering() {
		if (rendering == null) {
			rendering = new EObjectContainmentEList<TRendering>(TRendering.class, this, BPMNPackage.TGLOBAL_USER_TASK__RENDERING);
		}
		return rendering;
	}
	...
	public void setImplementation(Object newImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TGLOBAL_USER_TASK__IMPLEMENTATION, oldImplementation, implementation, !oldImplementationESet));
	}
	...
	public void unsetImplementation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BPMNPackage.TGLOBAL_USER_TASK__IMPLEMENTATION, oldImplementation, IMPLEMENTATION_EDEFAULT, oldImplementationESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNPackage.TGLOBAL_USER_TASK__RENDERING:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TGLOBAL_USER_TASK__RENDERING:
				return getRendering();
			case BPMNPackage.TGLOBAL_USER_TASK__IMPLEMENTATION:
