 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TPropertyImpl#getDataState <em>Data State</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TPropertyImpl#getItemSubjectRef <em>Item Subject Ref</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TPropertyImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TPropertyImpl extends TBaseElementImpl implements TProperty {
	...
	protected EClass eStaticClass() {
		return BPMNPackage.eINSTANCE.getTProperty();
	}
	...
	public NotificationChain basicSetDataState(TDataState newDataState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMNPackage.TPROPERTY__DATA_STATE, oldDataState, newDataState);
	...
	public void setDataState(TDataState newDataState) {
		if (newDataState != dataState) {
			...
			if (dataState != null)
				msgs = ((InternalEObject)dataState).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TPROPERTY__DATA_STATE, null, msgs);
			if (newDataState != null)
				msgs = ((InternalEObject)newDataState).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMNPackage.TPROPERTY__DATA_STATE, null, msgs);
			msgs = basicSetDataState(newDataState, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TPROPERTY__DATA_STATE, newDataState, newDataState));
	}
	...
	public void setItemSubjectRef(QName newItemSubjectRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TPROPERTY__ITEM_SUBJECT_REF, oldItemSubjectRef, itemSubjectRef));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TPROPERTY__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNPackage.TPROPERTY__DATA_STATE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNPackage.TPROPERTY__DATA_STATE:
				return getDataState();
			case BPMNPackage.TPROPERTY__ITEM_SUBJECT_REF:
				return getItemSubjectRef();
			case BPMNPackage.TPROPERTY__NAME:
				return getName();
		}
