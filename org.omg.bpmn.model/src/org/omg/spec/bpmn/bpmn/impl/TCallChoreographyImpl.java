 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCallChoreographyImpl#getParticipantAssociation <em>Participant Association</em>}</li>
 *   <li>{@link org.omg.spec.bpmn.bpmn.impl.TCallChoreographyImpl#getCalledChoreographyRef <em>Called Choreography Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCallChoreographyImpl extends TChoreographyActivityImpl implements TCallChoreography {
	...
	protected EClass eStaticClass() {
		return BPMNPackage.eINSTANCE.getTCallChoreography();
	}
	...
	public EList<TParticipantAssociation> getParticipantAssociation() {
		if (participantAssociation == null) {
			participantAssociation = new EObjectContainmentEList<TParticipantAssociation>(TParticipantAssociation.class, this, BPMNPackage.TCALL_CHOREOGRAPHY__PARTICIPANT_ASSOCIATION);
		}
	...
	public void setCalledChoreographyRef(QName newCalledChoreographyRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNPackage.TCALL_CHOREOGRAPHY__CALLED_CHOREOGRAPHY_REF, oldCalledChoreographyRef, calledChoreographyRef));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNPackage.TCALL_CHOREOGRAPHY__PARTICIPANT_ASSOCIATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMNPackage.TCALL_CHOREOGRAPHY__CALLED_CHOREOGRAPHY_REF:
