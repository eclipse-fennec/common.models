...
public class BPMNValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "org.omg.spec.bpmn.bpmn";
	 ...
	 * @generated
	 */
	public boolean validateBPMNRoot(BPMNRoot bpmnRoot, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(bpmnRoot, diagnostics, context);
	}
	...
	public boolean validateTImplementation_MemberTypes(Object tImplementation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			...
			if (BPMNPackage.eINSTANCE.getTImplementationMember1().isInstance(tImplementation)) {
	...
	public boolean validateTTransactionMethod_MemberTypes(Object tTransactionMethod, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			...
			if (BPMNPackage.eINSTANCE.getTTransactionMethodMember1().isInstance(tTransactionMethod)) {
