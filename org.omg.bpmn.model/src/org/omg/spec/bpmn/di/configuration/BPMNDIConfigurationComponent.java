...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.omg.spec.bpmn.di\"" })
...
public class BPMNDIConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(BPMNDIPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(BPMNDIPackage.eNS_URI, ePackage);
		}
