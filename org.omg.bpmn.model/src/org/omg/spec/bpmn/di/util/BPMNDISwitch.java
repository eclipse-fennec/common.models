 ...
 * <!-- end-user-doc -->
 * @see org.omg.spec.bpmn.di.BPMNDIPackage
 * @generated
 */
public class BPMNDISwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case BPMNDIPackage.BPMNDI_ROOT: {
				BPMNDIRoot bpmndiRoot = (BPMNDIRoot)theEObject;
				T result = caseBPMNDIRoot(bpmndiRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseBPMNDIRoot(BPMNDIRoot object) {
		return null;
	}
