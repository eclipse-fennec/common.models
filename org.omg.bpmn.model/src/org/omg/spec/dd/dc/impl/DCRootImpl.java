...
import org.omg.spec.dd.dc.DCRoot;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.dd.dc.impl.DCRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.omg.spec.dd.dc.impl.DCRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link org.omg.spec.dd.dc.impl.DCRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link org.omg.spec.dd.dc.impl.DCRootImpl#getBounds <em>Bounds</em>}</li>
 *   <li>{@link org.omg.spec.dd.dc.impl.DCRootImpl#getFont <em>Font</em>}</li>
 *   <li>{@link org.omg.spec.dd.dc.impl.DCRootImpl#getPoint <em>Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DCRootImpl extends MinimalEObjectImpl.Container implements DCRoot {
	...
	@Override
	public Font getFont() {
		return (Font)getMixed().get(DCPackage.Literals.DC_ROOT__FONT, true);
	}
	...
	public NotificationChain basicSetFont(Font newFont, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(DCPackage.Literals.DC_ROOT__FONT, newFont, msgs);
	}
	...
	public void setFont(Font newFont) {
		((FeatureMap.Internal)getMixed()).set(DCPackage.Literals.DC_ROOT__FONT, newFont);
	}
