...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.isotc211._2005.gts\"" })
...
public class GTSConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(GTSPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(GTSPackage.eNS_URI, ePackage);
		}
