...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.isotc211._2005.gco\"" })
...
public class GCOConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(GCOPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(GCOPackage.eNS_URI, ePackage);
		}
