 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.TopoCurvePropertyType#getTopoCurve <em>Topo Curve</em>}</li>
 *   <li>{@link net.opengis.gml.gml.TopoCurvePropertyType#isOwns <em>Owns</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getTopoCurvePropertyType()
...
public interface TopoCurvePropertyType extends EObject {
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getTopoCurvePropertyType_TopoCurve()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.TopoCurvePropertyType#getTopoCurve <em>Topo Curve</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #unsetOwns()
	 * @see #setOwns(boolean)
	 * @see net.opengis.gml.gml.GMLPackage#getTopoCurvePropertyType_Owns()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.TopoCurvePropertyType#isOwns <em>Owns</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml.gml.TopoCurvePropertyType#isOwns <em>Owns</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetOwns()
	 * @see #isOwns()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml.gml.TopoCurvePropertyType#isOwns <em>Owns</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
