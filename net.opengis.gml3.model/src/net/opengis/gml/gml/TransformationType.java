 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.TransformationType#getMethodGroup <em>Method Group</em>}</li>
 *   <li>{@link net.opengis.gml.gml.TransformationType#getMethod <em>Method</em>}</li>
 *   <li>{@link net.opengis.gml.gml.TransformationType#getParameterValueGroup <em>Parameter Value Group</em>}</li>
 *   <li>{@link net.opengis.gml.gml.TransformationType#getParameterValue <em>Parameter Value</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getTransformationType()
...
public interface TransformationType extends AbstractGeneralTransformationType {
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getTransformationType_MethodGroup()
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getTransformationType_Method()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.TransformationType#getMethod <em>Method</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getTransformationType_ParameterValueGroup()
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getTransformationType_ParameterValue()
