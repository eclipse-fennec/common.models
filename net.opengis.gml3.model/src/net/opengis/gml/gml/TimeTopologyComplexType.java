 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.TimeTopologyComplexType#getPrimitive <em>Primitive</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getTimeTopologyComplexType()
 * @model abstract="true"
...
public interface TimeTopologyComplexType extends AbstractTimeComplexType {
	 ...
	 * The list contents are of type {@link net.opengis.gml.gml.TimeTopologyPrimitivePropertyType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Primitive</em>' containment reference list.
	 * @see net.opengis.gml.gml.GMLPackage#getTimeTopologyComplexType_Primitive()
