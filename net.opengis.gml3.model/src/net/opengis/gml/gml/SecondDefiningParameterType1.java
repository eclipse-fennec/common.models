 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.SecondDefiningParameterType1#getInverseFlattening <em>Inverse Flattening</em>}</li>
 *   <li>{@link net.opengis.gml.gml.SecondDefiningParameterType1#getSemiMinorAxis <em>Semi Minor Axis</em>}</li>
 *   <li>{@link net.opengis.gml.gml.SecondDefiningParameterType1#isIsSphere <em>Is Sphere</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getSecondDefiningParameterType1()
...
public interface SecondDefiningParameterType1 extends EObject {
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getSecondDefiningParameterType1_InverseFlattening()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.SecondDefiningParameterType1#getInverseFlattening <em>Inverse Flattening</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getSecondDefiningParameterType1_SemiMinorAxis()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.SecondDefiningParameterType1#getSemiMinorAxis <em>Semi Minor Axis</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getSecondDefiningParameterType1_IsSphere()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.SecondDefiningParameterType1#isIsSphere <em>Is Sphere</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml.gml.SecondDefiningParameterType1#isIsSphere <em>Is Sphere</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetIsSphere()
	 * @see #isIsSphere()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml.gml.SecondDefiningParameterType1#isIsSphere <em>Is Sphere</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
