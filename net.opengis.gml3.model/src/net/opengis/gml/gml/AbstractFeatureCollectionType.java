 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.AbstractFeatureCollectionType#getFeatureMember <em>Feature Member</em>}</li>
 *   <li>{@link net.opengis.gml.gml.AbstractFeatureCollectionType#getFeatureMembers <em>Feature Members</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getAbstractFeatureCollectionType()
 * @model abstract="true"
...
public interface AbstractFeatureCollectionType extends AbstractFeatureType {
	 ...
	 * The list contents are of type {@link net.opengis.gml.gml.FeaturePropertyType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Feature Member</em>' containment reference list.
	 * @see net.opengis.gml.gml.GMLPackage#getAbstractFeatureCollectionType_FeatureMember()
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getAbstractFeatureCollectionType_FeatureMembers()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.AbstractFeatureCollectionType#getFeatureMembers <em>Feature Members</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
