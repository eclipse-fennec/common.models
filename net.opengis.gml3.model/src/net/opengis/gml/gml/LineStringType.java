 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.LineStringType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.gml.gml.LineStringType#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml.gml.LineStringType#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link net.opengis.gml.gml.LineStringType#getPointRep <em>Point Rep</em>}</li>
 *   <li>{@link net.opengis.gml.gml.LineStringType#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml.gml.LineStringType#getCoordinates <em>Coordinates</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getLineStringType()
...
public interface LineStringType extends AbstractCurveType {
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getLineStringType_Group()
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getLineStringType_Pos()
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getLineStringType_PointProperty()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getLineStringType_PointRep()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getLineStringType_PosList()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.LineStringType#getPosList <em>Pos List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getLineStringType_Coordinates()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.LineStringType#getCoordinates <em>Coordinates</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
