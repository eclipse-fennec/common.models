 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.TimeNodeType#getPreviousEdge <em>Previous Edge</em>}</li>
 *   <li>{@link net.opengis.gml.gml.TimeNodeType#getNextEdge <em>Next Edge</em>}</li>
 *   <li>{@link net.opengis.gml.gml.TimeNodeType#getPosition <em>Position</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getTimeNodeType()
...
public interface TimeNodeType extends AbstractTimeTopologyPrimitiveType {
	 ...
	 * The list contents are of type {@link net.opengis.gml.gml.TimeEdgePropertyType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Previous Edge</em>' containment reference list.
	 * @see net.opengis.gml.gml.GMLPackage#getTimeNodeType_PreviousEdge()
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getTimeNodeType_NextEdge()
	 * @model containment="true"
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getTimeNodeType_Position()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.TimeNodeType#getPosition <em>Position</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
