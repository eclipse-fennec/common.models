 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.TimeEdgeType#getStart <em>Start</em>}</li>
 *   <li>{@link net.opengis.gml.gml.TimeEdgeType#getEnd <em>End</em>}</li>
 *   <li>{@link net.opengis.gml.gml.TimeEdgeType#getExtent <em>Extent</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getTimeEdgeType()
...
public interface TimeEdgeType extends AbstractTimeTopologyPrimitiveType {
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getTimeEdgeType_Start()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.TimeEdgeType#getStart <em>Start</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getTimeEdgeType_End()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.TimeEdgeType#getEnd <em>End</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getTimeEdgeType_Extent()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.TimeEdgeType#getExtent <em>Extent</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
