 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.CompositeCurveType#getCurveMember <em>Curve Member</em>}</li>
 *   <li>{@link net.opengis.gml.gml.CompositeCurveType#getAggregationType <em>Aggregation Type</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getCompositeCurveType()
...
public interface CompositeCurveType extends AbstractCurveType {
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getCompositeCurveType_CurveMember()
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getCompositeCurveType_AggregationType()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.CompositeCurveType#getAggregationType <em>Aggregation Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml.gml.CompositeCurveType#getAggregationType <em>Aggregation Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetAggregationType()
	 * @see #getAggregationType()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml.gml.CompositeCurveType#getAggregationType <em>Aggregation Type</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
