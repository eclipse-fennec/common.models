 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.DiscreteCoverageType#getCoverageFunction <em>Coverage Function</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getDiscreteCoverageType()
...
public interface DiscreteCoverageType extends AbstractCoverageType {
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getDiscreteCoverageType_CoverageFunction()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.DiscreteCoverageType#getCoverageFunction <em>Coverage Function</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
