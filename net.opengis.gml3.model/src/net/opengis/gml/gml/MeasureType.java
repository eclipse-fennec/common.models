 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.MeasureType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.gml.gml.MeasureType#getUom <em>Uom</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getMeasureType()
...
public interface MeasureType extends EObject {
	 ...
	 * @see #unsetValue()
	 * @see #setValue(double)
	 * @see net.opengis.gml.gml.GMLPackage#getMeasureType_Value()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.MeasureType#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml.gml.MeasureType#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetValue()
	 * @see #getValue()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml.gml.MeasureType#getValue <em>Value</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setUom(String)
	 * @see net.opengis.gml.gml.GMLPackage#getMeasureType_Uom()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.MeasureType#getUom <em>Uom</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
