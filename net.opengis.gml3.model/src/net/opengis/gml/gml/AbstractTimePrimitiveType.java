 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.AbstractTimePrimitiveType#getRelatedTime <em>Related Time</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getAbstractTimePrimitiveType()
 * @model abstract="true"
...
public interface AbstractTimePrimitiveType extends AbstractTimeObjectType {
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getAbstractTimePrimitiveType_RelatedTime()
