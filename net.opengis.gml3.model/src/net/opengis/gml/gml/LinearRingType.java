 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.LinearRingType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.gml.gml.LinearRingType#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml.gml.LinearRingType#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link net.opengis.gml.gml.LinearRingType#getPointRep <em>Point Rep</em>}</li>
 *   <li>{@link net.opengis.gml.gml.LinearRingType#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml.gml.LinearRingType#getCoordinates <em>Coordinates</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getLinearRingType()
...
public interface LinearRingType extends AbstractRingType {
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getLinearRingType_Group()
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getLinearRingType_Pos()
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getLinearRingType_PointProperty()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getLinearRingType_PointRep()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getLinearRingType_PosList()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.LinearRingType#getPosList <em>Pos List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getLinearRingType_Coordinates()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.LinearRingType#getCoordinates <em>Coordinates</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
