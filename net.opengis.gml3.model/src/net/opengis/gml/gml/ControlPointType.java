 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.ControlPointType#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml.gml.ControlPointType#getGeometricPositionGroup <em>Geometric Position Group</em>}</li>
 *   <li>{@link net.opengis.gml.gml.ControlPointType#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml.gml.ControlPointType#getPointProperty <em>Point Property</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getControlPointType()
...
public interface ControlPointType extends EObject {
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getControlPointType_PosList()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.ControlPointType#getPosList <em>Pos List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getControlPointType_GeometricPositionGroup()
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getControlPointType_Pos()
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getControlPointType_PointProperty()
	 * @model containment="true" transient="true" volatile="true" derived="true"
