 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.DirectPositionListType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.gml.gml.DirectPositionListType#getAxisLabels <em>Axis Labels</em>}</li>
 *   <li>{@link net.opengis.gml.gml.DirectPositionListType#getCount <em>Count</em>}</li>
 *   <li>{@link net.opengis.gml.gml.DirectPositionListType#getSrsDimension <em>Srs Dimension</em>}</li>
 *   <li>{@link net.opengis.gml.gml.DirectPositionListType#getSrsName <em>Srs Name</em>}</li>
 *   <li>{@link net.opengis.gml.gml.DirectPositionListType#getUomLabels <em>Uom Labels</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getDirectPositionListType()
...
public interface DirectPositionListType extends EObject {
	 ...
	 * @see #setValue(List)
	 * @see net.opengis.gml.gml.GMLPackage#getDirectPositionListType_Value()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.DirectPositionListType#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getDirectPositionListType_AxisLabels()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.DirectPositionListType#getAxisLabels <em>Axis Labels</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getDirectPositionListType_Count()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.DirectPositionListType#getCount <em>Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getDirectPositionListType_SrsDimension()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.PositiveInteger"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.DirectPositionListType#getSrsDimension <em>Srs Dimension</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getDirectPositionListType_SrsName()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.DirectPositionListType#getSrsName <em>Srs Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getDirectPositionListType_UomLabels()
	 * @model dataType="net.opengis.gml.gml.NCNameList" many="false"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.DirectPositionListType#getUomLabels <em>Uom Labels</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
