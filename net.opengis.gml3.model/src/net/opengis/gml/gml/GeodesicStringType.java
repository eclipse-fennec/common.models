 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.GeodesicStringType#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml.gml.GeodesicStringType#getGeometricPositionGroup <em>Geometric Position Group</em>}</li>
 *   <li>{@link net.opengis.gml.gml.GeodesicStringType#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml.gml.GeodesicStringType#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link net.opengis.gml.gml.GeodesicStringType#getInterpolation <em>Interpolation</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getGeodesicStringType()
...
public interface GeodesicStringType extends AbstractCurveSegmentType {
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getGeodesicStringType_PosList()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.GeodesicStringType#getPosList <em>Pos List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getGeodesicStringType_GeometricPositionGroup()
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getGeodesicStringType_Pos()
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getGeodesicStringType_PointProperty()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getGeodesicStringType_Interpolation()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.GeodesicStringType#getInterpolation <em>Interpolation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml.gml.GeodesicStringType#getInterpolation <em>Interpolation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetInterpolation()
	 * @see #getInterpolation()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml.gml.GeodesicStringType#getInterpolation <em>Interpolation</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
