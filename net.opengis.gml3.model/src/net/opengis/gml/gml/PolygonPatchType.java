 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.PolygonPatchType#getExterior <em>Exterior</em>}</li>
 *   <li>{@link net.opengis.gml.gml.PolygonPatchType#getInterior <em>Interior</em>}</li>
 *   <li>{@link net.opengis.gml.gml.PolygonPatchType#getInterpolation <em>Interpolation</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getPolygonPatchType()
...
public interface PolygonPatchType extends AbstractSurfacePatchType {
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getPolygonPatchType_Exterior()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.PolygonPatchType#getExterior <em>Exterior</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getPolygonPatchType_Interior()
	 * @model containment="true"
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getPolygonPatchType_Interpolation()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.PolygonPatchType#getInterpolation <em>Interpolation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml.gml.PolygonPatchType#getInterpolation <em>Interpolation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetInterpolation()
	 * @see #getInterpolation()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml.gml.PolygonPatchType#getInterpolation <em>Interpolation</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
