 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.BoundingShapeType#getEnvelopeGroup <em>Envelope Group</em>}</li>
 *   <li>{@link net.opengis.gml.gml.BoundingShapeType#getEnvelope <em>Envelope</em>}</li>
 *   <li>{@link net.opengis.gml.gml.BoundingShapeType#getNull <em>Null</em>}</li>
 *   <li>{@link net.opengis.gml.gml.BoundingShapeType#getNilReason <em>Nil Reason</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml.gml.GMLPackage#getBoundingShapeType()
...
public interface BoundingShapeType extends EObject {
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getBoundingShapeType_EnvelopeGroup()
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getBoundingShapeType_Envelope()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.BoundingShapeType#getEnvelope <em>Envelope</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setNull(Object)
	 * @see net.opengis.gml.gml.GMLPackage#getBoundingShapeType_Null()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.BoundingShapeType#getNull <em>Null</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml.gml.GMLPackage#getBoundingShapeType_NilReason()
	 * @model dataType="net.opengis.gml.gml.NilReasonType"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml.gml.BoundingShapeType#getNilReason <em>Nil Reason</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
