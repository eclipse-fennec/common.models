 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.impl.CubicSplineTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.CubicSplineTypeImpl#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.CubicSplineTypeImpl#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.CubicSplineTypeImpl#getPointRep <em>Point Rep</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.CubicSplineTypeImpl#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.CubicSplineTypeImpl#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.CubicSplineTypeImpl#getVectorAtStart <em>Vector At Start</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.CubicSplineTypeImpl#getVectorAtEnd <em>Vector At End</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.CubicSplineTypeImpl#getDegree <em>Degree</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.CubicSplineTypeImpl#getInterpolation <em>Interpolation</em>}</li>
 * </ul>
 *
 * @generated
 */
