 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.impl.NodeOrEdgePropertyTypeImpl#getNode <em>Node</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.NodeOrEdgePropertyTypeImpl#getEdge <em>Edge</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.NodeOrEdgePropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.NodeOrEdgePropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.NodeOrEdgePropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.NodeOrEdgePropertyTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.NodeOrEdgePropertyTypeImpl#isOwns <em>Owns</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.NodeOrEdgePropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.NodeOrEdgePropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.NodeOrEdgePropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.NodeOrEdgePropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.NodeOrEdgePropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
