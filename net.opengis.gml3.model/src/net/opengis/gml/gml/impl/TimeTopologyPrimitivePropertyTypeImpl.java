 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.impl.TimeTopologyPrimitivePropertyTypeImpl#getAbstractTimeTopologyPrimitiveGroup <em>Abstract Time Topology Primitive Group</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TimeTopologyPrimitivePropertyTypeImpl#getAbstractTimeTopologyPrimitive <em>Abstract Time Topology Primitive</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TimeTopologyPrimitivePropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TimeTopologyPrimitivePropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TimeTopologyPrimitivePropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TimeTopologyPrimitivePropertyTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TimeTopologyPrimitivePropertyTypeImpl#isOwns <em>Owns</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TimeTopologyPrimitivePropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TimeTopologyPrimitivePropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TimeTopologyPrimitivePropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TimeTopologyPrimitivePropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TimeTopologyPrimitivePropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
