 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.impl.BSplineTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.BSplineTypeImpl#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.BSplineTypeImpl#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.BSplineTypeImpl#getPointRep <em>Point Rep</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.BSplineTypeImpl#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.BSplineTypeImpl#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.BSplineTypeImpl#getDegree <em>Degree</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.BSplineTypeImpl#getKnot <em>Knot</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.BSplineTypeImpl#getInterpolation <em>Interpolation</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.BSplineTypeImpl#isIsPolynomial <em>Is Polynomial</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.BSplineTypeImpl#getKnotType <em>Knot Type</em>}</li>
 * </ul>
 *
 * @generated
 */
