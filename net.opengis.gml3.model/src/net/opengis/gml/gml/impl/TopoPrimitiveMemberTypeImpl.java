 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.impl.TopoPrimitiveMemberTypeImpl#getAbstractTopoPrimitiveGroup <em>Abstract Topo Primitive Group</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TopoPrimitiveMemberTypeImpl#getAbstractTopoPrimitive <em>Abstract Topo Primitive</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TopoPrimitiveMemberTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TopoPrimitiveMemberTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TopoPrimitiveMemberTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TopoPrimitiveMemberTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TopoPrimitiveMemberTypeImpl#isOwns <em>Owns</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TopoPrimitiveMemberTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TopoPrimitiveMemberTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TopoPrimitiveMemberTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TopoPrimitiveMemberTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.TopoPrimitiveMemberTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
