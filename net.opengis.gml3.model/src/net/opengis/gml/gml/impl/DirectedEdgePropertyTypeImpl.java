 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.impl.DirectedEdgePropertyTypeImpl#getEdge <em>Edge</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.DirectedEdgePropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.DirectedEdgePropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.DirectedEdgePropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.DirectedEdgePropertyTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.DirectedEdgePropertyTypeImpl#getOrientation <em>Orientation</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.DirectedEdgePropertyTypeImpl#isOwns <em>Owns</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.DirectedEdgePropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.DirectedEdgePropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.DirectedEdgePropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.DirectedEdgePropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.DirectedEdgePropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
