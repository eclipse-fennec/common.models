 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.impl.MetaDataPropertyTypeImpl#getAbstractMetaDataGroup <em>Abstract Meta Data Group</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.MetaDataPropertyTypeImpl#getAbstractMetaData <em>Abstract Meta Data</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.MetaDataPropertyTypeImpl#getAbout <em>About</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.MetaDataPropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.MetaDataPropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.MetaDataPropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.MetaDataPropertyTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.MetaDataPropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.MetaDataPropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.MetaDataPropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.MetaDataPropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.MetaDataPropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
