 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml.gml.impl.ArcByCenterPointTypeImpl#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.ArcByCenterPointTypeImpl#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.ArcByCenterPointTypeImpl#getPointRep <em>Point Rep</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.ArcByCenterPointTypeImpl#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.ArcByCenterPointTypeImpl#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.ArcByCenterPointTypeImpl#getRadius <em>Radius</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.ArcByCenterPointTypeImpl#getStartAngle <em>Start Angle</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.ArcByCenterPointTypeImpl#getEndAngle <em>End Angle</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.ArcByCenterPointTypeImpl#getInterpolation <em>Interpolation</em>}</li>
 *   <li>{@link net.opengis.gml.gml.impl.ArcByCenterPointTypeImpl#getNumArc <em>Num Arc</em>}</li>
 * </ul>
 *
 * @generated
 */
