...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Style URL Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wms.StyleURLType#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wms.StyleURLType#getOnlineResource <em>Online Resource</em>}</li>
 * </ul>
 *
 * @see net.opengis.wms.WMSPackage#getStyleURLType()
 * @model extendedMetaData="name='StyleURL_._type' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface StyleURLType extends EObject {
	/**
	 ...
	 * @see net.opengis.wms.WMSPackage#getStyleURLType_Format()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wms.StyleURLType#getFormat <em>Format</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wms.WMSPackage#getStyleURLType_OnlineResource()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wms.StyleURLType#getOnlineResource <em>Online Resource</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
