 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wms.MetadataURLType#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wms.MetadataURLType#getOnlineResource <em>Online Resource</em>}</li>
 *   <li>{@link net.opengis.wms.MetadataURLType#getType <em>Type</em>}</li>
 * </ul>
 *
 * @see net.opengis.wms.WMSPackage#getMetadataURLType()
 * @model extendedMetaData="name='MetadataURL_._type' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface MetadataURLType extends EObject {
	 ...
	 * @see net.opengis.wms.WMSPackage#getMetadataURLType_Format()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wms.MetadataURLType#getFormat <em>Format</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wms.WMSPackage#getMetadataURLType_OnlineResource()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wms.MetadataURLType#getOnlineResource <em>Online Resource</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setType(String)
	 * @see net.opengis.wms.WMSPackage#getMetadataURLType_Type()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wms.MetadataURLType#getType <em>Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
