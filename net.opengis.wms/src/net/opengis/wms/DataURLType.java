...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Data URL Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wms.DataURLType#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wms.DataURLType#getOnlineResource <em>Online Resource</em>}</li>
 * </ul>
 *
 * @see net.opengis.wms.WMSPackage#getDataURLType()
 * @model extendedMetaData="name='DataURL_._type' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface DataURLType extends EObject {
	/**
	 ...
	 * @see net.opengis.wms.WMSPackage#getDataURLType_Format()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wms.DataURLType#getFormat <em>Format</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wms.WMSPackage#getDataURLType_OnlineResource()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wms.DataURLType#getOnlineResource <em>Online Resource</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
