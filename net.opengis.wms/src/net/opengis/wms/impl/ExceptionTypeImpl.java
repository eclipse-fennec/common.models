 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wms.impl.ExceptionTypeImpl#getFormat <em>Format</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExceptionTypeImpl extends MinimalEObjectImpl.Container implements ExceptionType {
	...
	protected EClass eStaticClass() {
		return WMSPackage.Literals.EXCEPTION_TYPE;
	}
	...
	public EList<String> getFormat() {
		if (format == null) {
			format = new EDataTypeEList<String>(String.class, this, WMSPackage.EXCEPTION_TYPE__FORMAT);
		}
		return format;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WMSPackage.EXCEPTION_TYPE__FORMAT:
				return getFormat();
		}
