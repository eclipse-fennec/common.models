 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wms.impl.GetTypeImpl#getOnlineResource <em>Online Resource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetTypeImpl extends MinimalEObjectImpl.Container implements GetType {
	/**
	...
	protected EClass eStaticClass() {
		return WMSPackage.Literals.GET_TYPE;
	}
	...
	public NotificationChain basicSetOnlineResource(OnlineResourceType newOnlineResource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WMSPackage.GET_TYPE__ONLINE_RESOURCE, oldOnlineResource, newOnlineResource);
	...
	public void setOnlineResource(OnlineResourceType newOnlineResource) {
		if (newOnlineResource != onlineResource) {
			...
			if (onlineResource != null)
				msgs = ((InternalEObject)onlineResource).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WMSPackage.GET_TYPE__ONLINE_RESOURCE, null, msgs);
			if (newOnlineResource != null)
				msgs = ((InternalEObject)newOnlineResource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WMSPackage.GET_TYPE__ONLINE_RESOURCE, null, msgs);
			msgs = basicSetOnlineResource(newOnlineResource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WMSPackage.GET_TYPE__ONLINE_RESOURCE, newOnlineResource, newOnlineResource));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WMSPackage.GET_TYPE__ONLINE_RESOURCE:
