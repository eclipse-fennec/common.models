 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wms.PostType#getOnlineResource <em>Online Resource</em>}</li>
 * </ul>
 *
 * @see net.opengis.wms.WMSPackage#getPostType()
...
public interface PostType extends EObject {
	 ...
	 * @see net.opengis.wms.WMSPackage#getPostType_OnlineResource()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wms.PostType#getOnlineResource <em>Online Resource</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
