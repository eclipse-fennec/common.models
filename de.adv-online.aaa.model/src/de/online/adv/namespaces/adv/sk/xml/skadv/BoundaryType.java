 ...
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.BoundaryType#getStrokeGroup <em>Stroke Group</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.BoundaryType#getStroke <em>Stroke</em>}</li>
 * </ul>
 *
 * @see de.online.adv.namespaces.adv.sk.xml.skadv.AAAPackage#getBoundaryType()
 * @model extendedMetaData="name='boundary_._type' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface BoundaryType extends EObject {
	 ...
	 * @see de.online.adv.namespaces.adv.sk.xml.skadv.AAAPackage#getBoundaryType_StrokeGroup()
	 ...
	 * @see de.online.adv.namespaces.adv.sk.xml.skadv.AAAPackage#getBoundaryType_Stroke()
