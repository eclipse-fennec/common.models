...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Hatch Lines Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchLinesTypeImpl#getOriginX <em>Origin X</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchLinesTypeImpl#getOriginY <em>Origin Y</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchLinesTypeImpl#getHatchRayDirectionX <em>Hatch Ray Direction X</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchLinesTypeImpl#getHatchRayDirectionY <em>Hatch Ray Direction Y</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchLinesTypeImpl#getHatchDisplacementDirectionX <em>Hatch Displacement Direction X</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchLinesTypeImpl#getHatchDisplacementDirectionY <em>Hatch Displacement Direction Y</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchLinesTypeImpl#getHatchDisplacementOffset <em>Hatch Displacement Offset</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HatchLinesTypeImpl extends PlacementRuleTypeImpl implements HatchLinesType {
	/**
	...
	protected EClass eStaticClass() {
		return AAAPackage.eINSTANCE.getHatchLinesType();
	}
	...
	public void setOriginX(double newOriginX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_LINES_TYPE__ORIGIN_X, oldOriginX, originX, !oldOriginXESet));
	}
	...
	public void unsetOriginX() {
		...
		originXESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_LINES_TYPE__ORIGIN_X, oldOriginX, ORIGIN_X_EDEFAULT, oldOriginXESet));
	}
	...
	public void setOriginY(double newOriginY) {
		...
		originYESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_LINES_TYPE__ORIGIN_Y, oldOriginY, originY, !oldOriginYESet));
	}
	...
	public void unsetOriginY() {
		...
		originYESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_LINES_TYPE__ORIGIN_Y, oldOriginY, ORIGIN_Y_EDEFAULT, oldOriginYESet));
	}
	...
	public void setHatchRayDirectionX(double newHatchRayDirectionX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_LINES_TYPE__HATCH_RAY_DIRECTION_X, oldHatchRayDirectionX, hatchRayDirectionX, !oldHatchRayDirectionXESet));
	}
	...
	public void unsetHatchRayDirectionX() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_LINES_TYPE__HATCH_RAY_DIRECTION_X, oldHatchRayDirectionX, HATCH_RAY_DIRECTION_X_EDEFAULT, oldHatchRayDirectionXESet));
	}
	...
	public void setHatchRayDirectionY(double newHatchRayDirectionY) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_LINES_TYPE__HATCH_RAY_DIRECTION_Y, oldHatchRayDirectionY, hatchRayDirectionY, !oldHatchRayDirectionYESet));
	}
	...
	public void unsetHatchRayDirectionY() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_LINES_TYPE__HATCH_RAY_DIRECTION_Y, oldHatchRayDirectionY, HATCH_RAY_DIRECTION_Y_EDEFAULT, oldHatchRayDirectionYESet));
	}
	...
	public void setHatchDisplacementDirectionX(double newHatchDisplacementDirectionX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_LINES_TYPE__HATCH_DISPLACEMENT_DIRECTION_X, oldHatchDisplacementDirectionX, hatchDisplacementDirectionX, !oldHatchDisplacementDirectionXESet));
	}
	...
	public void unsetHatchDisplacementDirectionX() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_LINES_TYPE__HATCH_DISPLACEMENT_DIRECTION_X, oldHatchDisplacementDirectionX, HATCH_DISPLACEMENT_DIRECTION_X_EDEFAULT, oldHatchDisplacementDirectionXESet));
	}
	...
	public void setHatchDisplacementDirectionY(double newHatchDisplacementDirectionY) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_LINES_TYPE__HATCH_DISPLACEMENT_DIRECTION_Y, oldHatchDisplacementDirectionY, hatchDisplacementDirectionY, !oldHatchDisplacementDirectionYESet));
	}
	...
	public void unsetHatchDisplacementDirectionY() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_LINES_TYPE__HATCH_DISPLACEMENT_DIRECTION_Y, oldHatchDisplacementDirectionY, HATCH_DISPLACEMENT_DIRECTION_Y_EDEFAULT, oldHatchDisplacementDirectionYESet));
	}
	...
	public void setHatchDisplacementOffset(double newHatchDisplacementOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_LINES_TYPE__HATCH_DISPLACEMENT_OFFSET, oldHatchDisplacementOffset, hatchDisplacementOffset, !oldHatchDisplacementOffsetESet));
	}
	...
	public void unsetHatchDisplacementOffset() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_LINES_TYPE__HATCH_DISPLACEMENT_OFFSET, oldHatchDisplacementOffset, HATCH_DISPLACEMENT_OFFSET_EDEFAULT, oldHatchDisplacementOffsetESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AAAPackage.HATCH_LINES_TYPE__ORIGIN_X:
				return getOriginX();
			case AAAPackage.HATCH_LINES_TYPE__ORIGIN_Y:
				return getOriginY();
			case AAAPackage.HATCH_LINES_TYPE__HATCH_RAY_DIRECTION_X:
				return getHatchRayDirectionX();
			case AAAPackage.HATCH_LINES_TYPE__HATCH_RAY_DIRECTION_Y:
				return getHatchRayDirectionY();
			case AAAPackage.HATCH_LINES_TYPE__HATCH_DISPLACEMENT_DIRECTION_X:
				return getHatchDisplacementDirectionX();
			case AAAPackage.HATCH_LINES_TYPE__HATCH_DISPLACEMENT_DIRECTION_Y:
				return getHatchDisplacementDirectionY();
			case AAAPackage.HATCH_LINES_TYPE__HATCH_DISPLACEMENT_OFFSET:
