...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Operand Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.OperandType#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.OperandType#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @see de.online.adv.namespaces.adv.sk.xml.skadv.AAAPackage#getOperandType()
 * @model extendedMetaData="name='operand_._type' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface OperandType extends EObject {
	/**
	 ...
	 * @see de.online.adv.namespaces.adv.sk.xml.skadv.AAAPackage#getOperandType_ExpressionGroup()
	 ...
	 * @see de.online.adv.namespaces.adv.sk.xml.skadv.AAAPackage#getOperandType_Expression()
