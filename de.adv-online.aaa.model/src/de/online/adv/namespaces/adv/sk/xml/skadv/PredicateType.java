 ...
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.PredicateType#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.PredicateType#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @see de.online.adv.namespaces.adv.sk.xml.skadv.AAAPackage#getPredicateType()
 * @model extendedMetaData="name='predicate_._type' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface PredicateType extends EObject {
	 ...
	 * @see de.online.adv.namespaces.adv.sk.xml.skadv.AAAPackage#getPredicateType_ExpressionGroup()
	 ...
	 * @see de.online.adv.namespaces.adv.sk.xml.skadv.AAAPackage#getPredicateType_Expression()
