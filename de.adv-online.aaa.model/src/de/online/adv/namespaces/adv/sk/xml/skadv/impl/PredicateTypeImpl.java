 ...
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.PredicateTypeImpl#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.PredicateTypeImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PredicateTypeImpl extends MinimalEObjectImpl.Container implements PredicateType {
	...
	protected EClass eStaticClass() {
		return AAAPackage.eINSTANCE.getPredicateType();
	}
	...
	public FeatureMap getExpressionGroup() {
		if (expressionGroup == null) {
			expressionGroup = new BasicFeatureMap(this, AAAPackage.PREDICATE_TYPE__EXPRESSION_GROUP);
		}
	...
	public ExpressionType1 getExpression() {
		return (ExpressionType1)getExpressionGroup().get(AAAPackage.eINSTANCE.getPredicateType_Expression(), true);
	}
	...
	public NotificationChain basicSetExpression(ExpressionType1 newExpression, NotificationChain msgs) {
		return ((FeatureMap.Internal)getExpressionGroup()).basicAdd(AAAPackage.eINSTANCE.getPredicateType_Expression(), newExpression, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AAAPackage.PREDICATE_TYPE__EXPRESSION_GROUP:
				return ((InternalEList<?>)getExpressionGroup()).basicRemove(otherEnd, msgs);
			case AAAPackage.PREDICATE_TYPE__EXPRESSION:
