...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Relate Filter Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.RelateFilterType#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.RelateFilterType#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @see de.online.adv.namespaces.adv.sk.xml.skadv.AAAPackage#getRelateFilterType()
 * @model extendedMetaData="name='relateFilter_._type' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface RelateFilterType extends EObject {
	/**
	 ...
	 * @see de.online.adv.namespaces.adv.sk.xml.skadv.AAAPackage#getRelateFilterType_ExpressionGroup()
	 ...
	 * @see de.online.adv.namespaces.adv.sk.xml.skadv.AAAPackage#getRelateFilterType_Expression()
