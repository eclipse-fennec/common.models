 ...
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.InTypeImpl#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.InTypeImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InTypeImpl extends MinimalEObjectImpl.Container implements InType {
	/**
	...
	protected EClass eStaticClass() {
		return AAAPackage.eINSTANCE.getInType();
	}
	...
	public FeatureMap getExpressionGroup() {
		if (expressionGroup == null) {
			expressionGroup = new BasicFeatureMap(this, AAAPackage.IN_TYPE__EXPRESSION_GROUP);
		}
	...
	public ExpressionType1 getExpression() {
		return (ExpressionType1)getExpressionGroup().get(AAAPackage.eINSTANCE.getInType_Expression(), true);
	}
	...
	public NotificationChain basicSetExpression(ExpressionType1 newExpression, NotificationChain msgs) {
		return ((FeatureMap.Internal)getExpressionGroup()).basicAdd(AAAPackage.eINSTANCE.getInType_Expression(), newExpression, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AAAPackage.IN_TYPE__EXPRESSION_GROUP:
				return ((InternalEList<?>)getExpressionGroup()).basicRemove(otherEnd, msgs);
			case AAAPackage.IN_TYPE__EXPRESSION:
