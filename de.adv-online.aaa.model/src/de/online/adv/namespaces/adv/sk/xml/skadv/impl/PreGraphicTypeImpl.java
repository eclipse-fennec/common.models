...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pre Graphic Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.PreGraphicTypeImpl#getLinePlacedGraphic <em>Line Placed Graphic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PreGraphicTypeImpl extends MinimalEObjectImpl.Container implements PreGraphicType {
	/**
	...
	protected EClass eStaticClass() {
		return AAAPackage.eINSTANCE.getPreGraphicType();
	}
	...
	public NotificationChain basicSetLinePlacedGraphic(LinePlacedGraphicType newLinePlacedGraphic, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AAAPackage.PRE_GRAPHIC_TYPE__LINE_PLACED_GRAPHIC, oldLinePlacedGraphic, newLinePlacedGraphic);
	...
	public void setLinePlacedGraphic(LinePlacedGraphicType newLinePlacedGraphic) {
		if (newLinePlacedGraphic != linePlacedGraphic) {
			...
			if (linePlacedGraphic != null)
				msgs = ((InternalEObject)linePlacedGraphic).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AAAPackage.PRE_GRAPHIC_TYPE__LINE_PLACED_GRAPHIC, null, msgs);
			if (newLinePlacedGraphic != null)
				msgs = ((InternalEObject)newLinePlacedGraphic).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AAAPackage.PRE_GRAPHIC_TYPE__LINE_PLACED_GRAPHIC, null, msgs);
			msgs = basicSetLinePlacedGraphic(newLinePlacedGraphic, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.PRE_GRAPHIC_TYPE__LINE_PLACED_GRAPHIC, newLinePlacedGraphic, newLinePlacedGraphic));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AAAPackage.PRE_GRAPHIC_TYPE__LINE_PLACED_GRAPHIC:
