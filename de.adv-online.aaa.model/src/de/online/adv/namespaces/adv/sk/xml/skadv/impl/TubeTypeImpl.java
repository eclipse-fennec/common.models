...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tube Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.TubeTypeImpl#getLinecaps <em>Linecaps</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.TubeTypeImpl#getLinejoin <em>Linejoin</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.TubeTypeImpl#getMiterlimit <em>Miterlimit</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.TubeTypeImpl#getWidth <em>Width</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TubeTypeImpl extends PlacementRuleTypeImpl implements TubeType {
	/**
	...
	protected EClass eStaticClass() {
		return AAAPackage.eINSTANCE.getTubeType();
	}
	...
	public void setLinecaps(LineCapsType newLinecaps) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.TUBE_TYPE__LINECAPS, oldLinecaps, linecaps, !oldLinecapsESet));
	}
	...
	public void unsetLinecaps() {
		...
		linecapsESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.TUBE_TYPE__LINECAPS, oldLinecaps, LINECAPS_EDEFAULT, oldLinecapsESet));
	}
	...
	public void setLinejoin(LineJoinType newLinejoin) {
		...
		linejoinESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.TUBE_TYPE__LINEJOIN, oldLinejoin, linejoin, !oldLinejoinESet));
	}
	...
	public void unsetLinejoin() {
		...
		linejoinESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.TUBE_TYPE__LINEJOIN, oldLinejoin, LINEJOIN_EDEFAULT, oldLinejoinESet));
	}
	...
	public void setMiterlimit(double newMiterlimit) {
		...
		miterlimitESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.TUBE_TYPE__MITERLIMIT, oldMiterlimit, miterlimit, !oldMiterlimitESet));
	}
	...
	public void unsetMiterlimit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.TUBE_TYPE__MITERLIMIT, oldMiterlimit, MITERLIMIT_EDEFAULT, oldMiterlimitESet));
	}
	...
	public void setWidth(double newWidth) {
		...
		widthESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.TUBE_TYPE__WIDTH, oldWidth, width, !oldWidthESet));
	}
	...
	public void unsetWidth() {
		...
		widthESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.TUBE_TYPE__WIDTH, oldWidth, WIDTH_EDEFAULT, oldWidthESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AAAPackage.TUBE_TYPE__LINECAPS:
				return getLinecaps();
			case AAAPackage.TUBE_TYPE__LINEJOIN:
				return getLinejoin();
			case AAAPackage.TUBE_TYPE__MITERLIMIT:
				return getMiterlimit();
			case AAAPackage.TUBE_TYPE__WIDTH:
				return getWidth();
		}
