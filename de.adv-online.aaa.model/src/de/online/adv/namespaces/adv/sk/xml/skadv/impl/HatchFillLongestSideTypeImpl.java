...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Hatch Fill Longest Side Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchFillLongestSideTypeImpl#getOffsetToAreaOutline <em>Offset To Area Outline</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchFillLongestSideTypeImpl#getOriginX <em>Origin X</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchFillLongestSideTypeImpl#getOriginY <em>Origin Y</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchFillLongestSideTypeImpl#getHatchRayDirectionX <em>Hatch Ray Direction X</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchFillLongestSideTypeImpl#getHatchRayDirectionY <em>Hatch Ray Direction Y</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchFillLongestSideTypeImpl#getHatchDisplacementDirectionX <em>Hatch Displacement Direction X</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchFillLongestSideTypeImpl#getHatchDisplacementDirectionY <em>Hatch Displacement Direction Y</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchFillLongestSideTypeImpl#getHatchDisplacementOffset <em>Hatch Displacement Offset</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.HatchFillLongestSideTypeImpl#getStroke <em>Stroke</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HatchFillLongestSideTypeImpl extends FillTypeImpl implements HatchFillLongestSideType {
	/**
	 ...
	 * @generated
	 */
	protected HatchFillLongestSideTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AAAPackage.eINSTANCE.getHatchFillLongestSideType();
	}
	...
	public void setOffsetToAreaOutline(double newOffsetToAreaOutline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__OFFSET_TO_AREA_OUTLINE, oldOffsetToAreaOutline, offsetToAreaOutline, !oldOffsetToAreaOutlineESet));
	}
	...
	public void unsetOffsetToAreaOutline() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__OFFSET_TO_AREA_OUTLINE, oldOffsetToAreaOutline, OFFSET_TO_AREA_OUTLINE_EDEFAULT, oldOffsetToAreaOutlineESet));
	}
	...
	public void setOriginX(double newOriginX) {
		...
		originXESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__ORIGIN_X, oldOriginX, originX, !oldOriginXESet));
	}
	...
	public void unsetOriginX() {
		...
		originXESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__ORIGIN_X, oldOriginX, ORIGIN_X_EDEFAULT, oldOriginXESet));
	}
	...
	public void setOriginY(double newOriginY) {
		...
		originYESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__ORIGIN_Y, oldOriginY, originY, !oldOriginYESet));
	}
	...
	public void unsetOriginY() {
		...
		originYESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__ORIGIN_Y, oldOriginY, ORIGIN_Y_EDEFAULT, oldOriginYESet));
	}
	...
	public void setHatchRayDirectionX(double newHatchRayDirectionX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_RAY_DIRECTION_X, oldHatchRayDirectionX, hatchRayDirectionX, !oldHatchRayDirectionXESet));
	}
	...
	public void unsetHatchRayDirectionX() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_RAY_DIRECTION_X, oldHatchRayDirectionX, HATCH_RAY_DIRECTION_X_EDEFAULT, oldHatchRayDirectionXESet));
	}
	...
	public void setHatchRayDirectionY(double newHatchRayDirectionY) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_RAY_DIRECTION_Y, oldHatchRayDirectionY, hatchRayDirectionY, !oldHatchRayDirectionYESet));
	}
	...
	public void unsetHatchRayDirectionY() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_RAY_DIRECTION_Y, oldHatchRayDirectionY, HATCH_RAY_DIRECTION_Y_EDEFAULT, oldHatchRayDirectionYESet));
	}
	...
	public void setHatchDisplacementDirectionX(double newHatchDisplacementDirectionX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_DISPLACEMENT_DIRECTION_X, oldHatchDisplacementDirectionX, hatchDisplacementDirectionX, !oldHatchDisplacementDirectionXESet));
	}
	...
	public void unsetHatchDisplacementDirectionX() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_DISPLACEMENT_DIRECTION_X, oldHatchDisplacementDirectionX, HATCH_DISPLACEMENT_DIRECTION_X_EDEFAULT, oldHatchDisplacementDirectionXESet));
	}
	...
	public void setHatchDisplacementDirectionY(double newHatchDisplacementDirectionY) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_DISPLACEMENT_DIRECTION_Y, oldHatchDisplacementDirectionY, hatchDisplacementDirectionY, !oldHatchDisplacementDirectionYESet));
	}
	...
	public void unsetHatchDisplacementDirectionY() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_DISPLACEMENT_DIRECTION_Y, oldHatchDisplacementDirectionY, HATCH_DISPLACEMENT_DIRECTION_Y_EDEFAULT, oldHatchDisplacementDirectionYESet));
	}
	...
	public void setHatchDisplacementOffset(double newHatchDisplacementOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_DISPLACEMENT_OFFSET, oldHatchDisplacementOffset, hatchDisplacementOffset, !oldHatchDisplacementOffsetESet));
	}
	...
	public void unsetHatchDisplacementOffset() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_DISPLACEMENT_OFFSET, oldHatchDisplacementOffset, HATCH_DISPLACEMENT_OFFSET_EDEFAULT, oldHatchDisplacementOffsetESet));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetStroke(StrokeType2 newStroke, NotificationChain msgs) {
		StrokeType2 oldStroke = stroke;
		stroke = newStroke;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__STROKE, oldStroke, newStroke);
	 ...
	 */
	@Override
	public void setStroke(StrokeType2 newStroke) {
		if (newStroke != stroke) {
			NotificationChain msgs = null;
			if (stroke != null)
				msgs = ((InternalEObject)stroke).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__STROKE, null, msgs);
			if (newStroke != null)
				msgs = ((InternalEObject)newStroke).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__STROKE, null, msgs);
			msgs = basicSetStroke(newStroke, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__STROKE, newStroke, newStroke));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__STROKE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__OFFSET_TO_AREA_OUTLINE:
				return getOffsetToAreaOutline();
			case AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__ORIGIN_X:
				return getOriginX();
			case AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__ORIGIN_Y:
				return getOriginY();
			case AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_RAY_DIRECTION_X:
				return getHatchRayDirectionX();
			case AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_RAY_DIRECTION_Y:
				return getHatchRayDirectionY();
			case AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_DISPLACEMENT_DIRECTION_X:
				return getHatchDisplacementDirectionX();
			case AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_DISPLACEMENT_DIRECTION_Y:
				return getHatchDisplacementDirectionY();
			case AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_DISPLACEMENT_OFFSET:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__HATCH_DISPLACEMENT_OFFSET:
				...
				return;
			case AAAPackage.HATCH_FILL_LONGEST_SIDE_TYPE__STROKE:
				setStroke((StrokeType2)newValue);
				return;
		}
