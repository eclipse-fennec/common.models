 ...
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.ExpressionTypeImpl#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.ExpressionTypeImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpressionTypeImpl extends MinimalEObjectImpl.Container implements ExpressionType {
	...
	protected EClass eStaticClass() {
		return AAAPackage.eINSTANCE.getExpressionType();
	}
	...
	public FeatureMap getExpressionGroup() {
		if (expressionGroup == null) {
			expressionGroup = new BasicFeatureMap(this, AAAPackage.EXPRESSION_TYPE__EXPRESSION_GROUP);
		}
	...
	public ExpressionType1 getExpression() {
		return (ExpressionType1)getExpressionGroup().get(AAAPackage.eINSTANCE.getExpressionType_Expression(), true);
	}
	...
	public NotificationChain basicSetExpression(ExpressionType1 newExpression, NotificationChain msgs) {
		return ((FeatureMap.Internal)getExpressionGroup()).basicAdd(AAAPackage.eINSTANCE.getExpressionType_Expression(), newExpression, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AAAPackage.EXPRESSION_TYPE__EXPRESSION_GROUP:
				return ((InternalEList<?>)getExpressionGroup()).basicRemove(otherEnd, msgs);
			case AAAPackage.EXPRESSION_TYPE__EXPRESSION:
