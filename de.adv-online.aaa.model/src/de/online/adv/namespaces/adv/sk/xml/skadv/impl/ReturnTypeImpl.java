 ...
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.ReturnTypeImpl#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.ReturnTypeImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReturnTypeImpl extends MinimalEObjectImpl.Container implements ReturnType {
	...
	protected EClass eStaticClass() {
		return AAAPackage.eINSTANCE.getReturnType();
	}
	...
	public FeatureMap getExpressionGroup() {
		if (expressionGroup == null) {
			expressionGroup = new BasicFeatureMap(this, AAAPackage.RETURN_TYPE__EXPRESSION_GROUP);
		}
	...
	public ExpressionType1 getExpression() {
		return (ExpressionType1)getExpressionGroup().get(AAAPackage.eINSTANCE.getReturnType_Expression(), true);
	}
	...
	public NotificationChain basicSetExpression(ExpressionType1 newExpression, NotificationChain msgs) {
		return ((FeatureMap.Internal)getExpressionGroup()).basicAdd(AAAPackage.eINSTANCE.getReturnType_Expression(), newExpression, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AAAPackage.RETURN_TYPE__EXPRESSION_GROUP:
				return ((InternalEList<?>)getExpressionGroup()).basicRemove(otherEnd, msgs);
			case AAAPackage.RETURN_TYPE__EXPRESSION:
