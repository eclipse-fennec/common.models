 ...
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.BoundaryTypeImpl#getStrokeGroup <em>Stroke Group</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.BoundaryTypeImpl#getStroke <em>Stroke</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoundaryTypeImpl extends MinimalEObjectImpl.Container implements BoundaryType {
	...
	protected EClass eStaticClass() {
		return AAAPackage.eINSTANCE.getBoundaryType();
	}
	...
	public FeatureMap getStrokeGroup() {
		if (strokeGroup == null) {
			strokeGroup = new BasicFeatureMap(this, AAAPackage.BOUNDARY_TYPE__STROKE_GROUP);
		}
		return strokeGroup;
	}
	...
	public StrokeType5 getStroke() {
		return (StrokeType5)getStrokeGroup().get(AAAPackage.eINSTANCE.getBoundaryType_Stroke(), true);
	}
	...
	public NotificationChain basicSetStroke(StrokeType5 newStroke, NotificationChain msgs) {
		return ((FeatureMap.Internal)getStrokeGroup()).basicAdd(AAAPackage.eINSTANCE.getBoundaryType_Stroke(), newStroke, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AAAPackage.BOUNDARY_TYPE__STROKE_GROUP:
				return ((InternalEList<?>)getStrokeGroup()).basicRemove(otherEnd, msgs);
			case AAAPackage.BOUNDARY_TYPE__STROKE:
