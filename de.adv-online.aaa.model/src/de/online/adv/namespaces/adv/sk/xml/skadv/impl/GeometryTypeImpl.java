 ...
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.GeometryTypeImpl#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.GeometryTypeImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeometryTypeImpl extends MinimalEObjectImpl.Container implements GeometryType {
	...
	protected EClass eStaticClass() {
		return AAAPackage.eINSTANCE.getGeometryType();
	}
	...
	public FeatureMap getExpressionGroup() {
		if (expressionGroup == null) {
			expressionGroup = new BasicFeatureMap(this, AAAPackage.GEOMETRY_TYPE__EXPRESSION_GROUP);
		}
	...
	public ExpressionType1 getExpression() {
		return (ExpressionType1)getExpressionGroup().get(AAAPackage.eINSTANCE.getGeometryType_Expression(), true);
	}
	...
	public NotificationChain basicSetExpression(ExpressionType1 newExpression, NotificationChain msgs) {
		return ((FeatureMap.Internal)getExpressionGroup()).basicAdd(AAAPackage.eINSTANCE.getGeometryType_Expression(), newExpression, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AAAPackage.GEOMETRY_TYPE__EXPRESSION_GROUP:
				return ((InternalEList<?>)getExpressionGroup()).basicRemove(otherEnd, msgs);
			case AAAPackage.GEOMETRY_TYPE__EXPRESSION:
