...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Feature Type Step Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.online.adv.namespaces.adv.sk.xml.skadv.impl.FeatureTypeStepTypeImpl#getFeatureTypeName <em>Feature Type Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureTypeStepTypeImpl extends FirstStepType1Impl implements FeatureTypeStepType {
	/**
	 ...
	 * @generated
	 */
	protected FeatureTypeStepTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AAAPackage.eINSTANCE.getFeatureTypeStepType();
	}
	...
	public void setFeatureTypeName(QName newFeatureTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AAAPackage.FEATURE_TYPE_STEP_TYPE__FEATURE_TYPE_NAME, oldFeatureTypeName, featureTypeName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AAAPackage.FEATURE_TYPE_STEP_TYPE__FEATURE_TYPE_NAME:
