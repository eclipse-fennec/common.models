 ...
 * <!-- end-user-doc -->
 * @see de.dwd.cdc.util.CDCResourceImpl
 * @generated
 */
public class CDCResourceFactoryImpl extends ResourceFactoryImpl {
	...
	public Resource createResource(URI uri) {
		XMLResource result = new CDCResourceImpl(uri);
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_CONFIGURATOR_NAME, CDCPackage.eNAME);
		properties.put(EMFNamespaces.EMF_MODEL_FILE_EXT, "cdc");
		properties.put(EMFNamespaces.EMF_MODEL_VERSION, "1.0");
		return properties;
	}

} //CDCResourceFactoryImpl
