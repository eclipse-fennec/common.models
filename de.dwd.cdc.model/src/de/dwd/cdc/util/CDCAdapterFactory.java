...
public class CDCAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected CDCSwitch<Adapter> modelSwitch =
		new CDCSwitch<Adapter>() {
			@Override
			public Adapter caseDocumentRoot(DocumentRoot object) {
				return createDocumentRootAdapter();
			}
			@Override
			public Adapter caseOBSDEUPT1HT2MType(OBSDEUPT1HT2MType object) {
				return createOBSDEUPT1HT2MTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dwd.cdc.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dwd.cdc.OBSDEUPT1HT2MType <em>OBSDEUPT1HT2M Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
