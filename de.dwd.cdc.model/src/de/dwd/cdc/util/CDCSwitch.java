...
public class CDCSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CDCPackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CDCPackage.OBSDEUPT1HT2M_TYPE: {
				OBSDEUPT1HT2MType obsdeupt1HT2MType = (OBSDEUPT1HT2MType)theEObject;
				T result = caseOBSDEUPT1HT2MType(obsdeupt1HT2MType);
				if (result == null) result = caseAbstractFeatureType(obsdeupt1HT2MType);
				if (result == null) result = caseAbstractGMLType(obsdeupt1HT2MType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>OBSDEUPT1HT2M Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>OBSDEUPT1HT2M Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOBSDEUPT1HT2MType(OBSDEUPT1HT2MType object) {
		return null;
	}
