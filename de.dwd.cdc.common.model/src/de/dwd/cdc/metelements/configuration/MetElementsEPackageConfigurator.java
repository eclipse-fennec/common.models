...
public class MetElementsEPackageConfigurator implements EPackageConfigurator {
	...
	public void configureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.put(MetElementsPackage.eNS_URI, ePackage);
	}
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_NAME, MetElementsPackage.eNAME);
		properties.put(EMFNamespaces.EMF_MODEL_NSURI, MetElementsPackage.eNS_URI);
