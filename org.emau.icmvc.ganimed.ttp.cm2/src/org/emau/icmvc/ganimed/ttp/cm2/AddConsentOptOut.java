...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Add Consent Opt Out</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.AddConsentOptOut#getConsentTemplateKey <em>Consent Template Key</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.AddConsentOptOut#getSignerIds <em>Signer Ids</em>}</li>
 * </ul>
 *
 * @see org.emau.icmvc.ganimed.ttp.cm2.Cm2Package#getAddConsentOptOut()
 * @model extendedMetaData="name='addConsentOptOut' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface AddConsentOptOut extends EObject {
	/**
	 ...
	 * @see org.emau.icmvc.ganimed.ttp.cm2.Cm2Package#getAddConsentOptOut_ConsentTemplateKey()
	...
	/**
	 * Sets the value of the '{@link org.emau.icmvc.ganimed.ttp.cm2.AddConsentOptOut#getConsentTemplateKey <em>Consent Template Key</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.emau.icmvc.ganimed.ttp.cm2.Cm2Package#getAddConsentOptOut_SignerIds()
	 * @model containment="true" required="true"
