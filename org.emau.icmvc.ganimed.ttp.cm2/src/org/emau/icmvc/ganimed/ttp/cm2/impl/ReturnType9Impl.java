...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Return Type9</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.ReturnType9Impl#getSignedPolicies <em>Signed Policies</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReturnType9Impl extends MinimalEObjectImpl.Container implements ReturnType9 {
	/**
	...
	protected EClass eStaticClass() {
		return Cm2Package.eINSTANCE.getReturnType9();
	}
	...
	public EList<SignedPolicyDTO> getSignedPolicies() {
		if (signedPolicies == null) {
			signedPolicies = new EObjectContainmentEList<SignedPolicyDTO>(SignedPolicyDTO.class, this, Cm2Package.RETURN_TYPE9__SIGNED_POLICIES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Cm2Package.RETURN_TYPE9__SIGNED_POLICIES:
