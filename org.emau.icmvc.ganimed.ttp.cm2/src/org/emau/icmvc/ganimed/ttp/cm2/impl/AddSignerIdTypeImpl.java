...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Add Signer Id Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.AddSignerIdTypeImpl#getDomainName <em>Domain Name</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.AddSignerIdTypeImpl#getSignerIdTypeName <em>Signer Id Type Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddSignerIdTypeImpl extends MinimalEObjectImpl.Container implements AddSignerIdType {
	/**
	...
	protected EClass eStaticClass() {
		return Cm2Package.eINSTANCE.getAddSignerIdType();
	}
	...
	public void setDomainName(String newDomainName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.ADD_SIGNER_ID_TYPE__DOMAIN_NAME, oldDomainName, domainName));
	}
	...
	public void setSignerIdTypeName(String newSignerIdTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.ADD_SIGNER_ID_TYPE__SIGNER_ID_TYPE_NAME, oldSignerIdTypeName, signerIdTypeName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cm2Package.ADD_SIGNER_ID_TYPE__DOMAIN_NAME:
				return getDomainName();
			case Cm2Package.ADD_SIGNER_ID_TYPE__SIGNER_ID_TYPE_NAME:
