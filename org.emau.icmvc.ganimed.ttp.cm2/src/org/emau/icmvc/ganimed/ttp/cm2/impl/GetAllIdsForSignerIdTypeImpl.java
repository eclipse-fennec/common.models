...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Get All Ids For Signer Id Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.GetAllIdsForSignerIdTypeImpl#getDomainName <em>Domain Name</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.GetAllIdsForSignerIdTypeImpl#getSignerIdTypeName <em>Signer Id Type Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetAllIdsForSignerIdTypeImpl extends MinimalEObjectImpl.Container implements GetAllIdsForSignerIdType {
	/**
	 ...
	 * @generated
	 */
	protected GetAllIdsForSignerIdTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Cm2Package.eINSTANCE.getGetAllIdsForSignerIdType();
	}
	...
	public void setDomainName(String newDomainName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.GET_ALL_IDS_FOR_SIGNER_ID_TYPE__DOMAIN_NAME, oldDomainName, domainName));
	}
	...
	public void setSignerIdTypeName(String newSignerIdTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.GET_ALL_IDS_FOR_SIGNER_ID_TYPE__SIGNER_ID_TYPE_NAME, oldSignerIdTypeName, signerIdTypeName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cm2Package.GET_ALL_IDS_FOR_SIGNER_ID_TYPE__DOMAIN_NAME:
				return getDomainName();
			case Cm2Package.GET_ALL_IDS_FOR_SIGNER_ID_TYPE__SIGNER_ID_TYPE_NAME:
