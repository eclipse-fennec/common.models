...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Add Alias</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.AddAliasImpl#getDomainName <em>Domain Name</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.AddAliasImpl#getOriginalSignerId <em>Original Signer Id</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.AddAliasImpl#getAliasSignerId <em>Alias Signer Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddAliasImpl extends MinimalEObjectImpl.Container implements AddAlias {
	/**
	...
	protected EClass eStaticClass() {
		return Cm2Package.eINSTANCE.getAddAlias();
	}
	...
	public void setDomainName(String newDomainName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.ADD_ALIAS__DOMAIN_NAME, oldDomainName, domainName));
	}
	...
	public NotificationChain basicSetOriginalSignerId(SignerIdDTO newOriginalSignerId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Cm2Package.ADD_ALIAS__ORIGINAL_SIGNER_ID, oldOriginalSignerId, newOriginalSignerId);
	...
	public void setOriginalSignerId(SignerIdDTO newOriginalSignerId) {
		if (newOriginalSignerId != originalSignerId) {
			...
			if (originalSignerId != null)
				msgs = ((InternalEObject)originalSignerId).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Cm2Package.ADD_ALIAS__ORIGINAL_SIGNER_ID, null, msgs);
			if (newOriginalSignerId != null)
				msgs = ((InternalEObject)newOriginalSignerId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Cm2Package.ADD_ALIAS__ORIGINAL_SIGNER_ID, null, msgs);
			msgs = basicSetOriginalSignerId(newOriginalSignerId, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.ADD_ALIAS__ORIGINAL_SIGNER_ID, newOriginalSignerId, newOriginalSignerId));
	}
	...
	public NotificationChain basicSetAliasSignerId(SignerIdDTO newAliasSignerId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Cm2Package.ADD_ALIAS__ALIAS_SIGNER_ID, oldAliasSignerId, newAliasSignerId);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAliasSignerId(SignerIdDTO newAliasSignerId) {
		if (newAliasSignerId != aliasSignerId) {
			...
			if (aliasSignerId != null)
				msgs = ((InternalEObject)aliasSignerId).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Cm2Package.ADD_ALIAS__ALIAS_SIGNER_ID, null, msgs);
			if (newAliasSignerId != null)
				msgs = ((InternalEObject)newAliasSignerId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Cm2Package.ADD_ALIAS__ALIAS_SIGNER_ID, null, msgs);
			msgs = basicSetAliasSignerId(newAliasSignerId, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.ADD_ALIAS__ALIAS_SIGNER_ID, newAliasSignerId, newAliasSignerId));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Cm2Package.ADD_ALIAS__ORIGINAL_SIGNER_ID:
				return basicSetOriginalSignerId(null, msgs);
			case Cm2Package.ADD_ALIAS__ALIAS_SIGNER_ID:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cm2Package.ADD_ALIAS__DOMAIN_NAME:
