...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Is Consented From Excluding To Including</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.IsConsentedFromExcludingToIncludingImpl#getSignerIds <em>Signer Ids</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.IsConsentedFromExcludingToIncludingImpl#getDomainName <em>Domain Name</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.IsConsentedFromExcludingToIncludingImpl#getPolicyName <em>Policy Name</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.IsConsentedFromExcludingToIncludingImpl#getVersionFrom <em>Version From</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.IsConsentedFromExcludingToIncludingImpl#getVersionTo <em>Version To</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.IsConsentedFromExcludingToIncludingImpl#getConfig <em>Config</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IsConsentedFromExcludingToIncludingImpl extends MinimalEObjectImpl.Container implements IsConsentedFromExcludingToIncluding {
	/**
	 ...
	 * @generated
	 */
	protected IsConsentedFromExcludingToIncludingImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Cm2Package.eINSTANCE.getIsConsentedFromExcludingToIncluding();
	}
	...
	public EList<SignerIdDTO> getSignerIds() {
		if (signerIds == null) {
			signerIds = new EObjectContainmentEList<SignerIdDTO>(SignerIdDTO.class, this, Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__SIGNER_IDS);
		}
		return signerIds;
	}
	...
	public void setDomainName(String newDomainName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__DOMAIN_NAME, oldDomainName, domainName));
	}
	...
	public void setPolicyName(String newPolicyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__POLICY_NAME, oldPolicyName, policyName));
	}
	...
	public void setVersionFrom(String newVersionFrom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__VERSION_FROM, oldVersionFrom, versionFrom));
	}
	...
	public void setVersionTo(String newVersionTo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__VERSION_TO, oldVersionTo, versionTo));
	}
	...
	public NotificationChain basicSetConfig(CheckConsentConfig newConfig, NotificationChain msgs) {
		...
		config = newConfig;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__CONFIG, oldConfig, newConfig);
	...
	public void setConfig(CheckConsentConfig newConfig) {
		if (newConfig != config) {
			...
			if (config != null)
				msgs = ((InternalEObject)config).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__CONFIG, null, msgs);
			if (newConfig != null)
				msgs = ((InternalEObject)newConfig).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__CONFIG, null, msgs);
			msgs = basicSetConfig(newConfig, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__CONFIG, newConfig, newConfig));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__SIGNER_IDS:
				return ((InternalEList<?>)getSignerIds()).basicRemove(otherEnd, msgs);
			case Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__CONFIG:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__SIGNER_IDS:
				return getSignerIds();
			case Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__DOMAIN_NAME:
				return getDomainName();
			case Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__POLICY_NAME:
				return getPolicyName();
			case Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__VERSION_FROM:
				return getVersionFrom();
			case Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__VERSION_TO:
				return getVersionTo();
			case Cm2Package.IS_CONSENTED_FROM_EXCLUDING_TO_INCLUDING__CONFIG:
				return getConfig();
		}
...
} //IsConsentedFromExcludingToIncludingImpl
