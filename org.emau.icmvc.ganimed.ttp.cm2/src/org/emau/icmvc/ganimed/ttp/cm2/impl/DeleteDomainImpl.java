...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Delete Domain</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.DeleteDomainImpl#getDomainName <em>Domain Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeleteDomainImpl extends MinimalEObjectImpl.Container implements DeleteDomain {
	/**
	...
	protected EClass eStaticClass() {
		return Cm2Package.eINSTANCE.getDeleteDomain();
	}
	...
	public void setDomainName(String newDomainName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.DELETE_DOMAIN__DOMAIN_NAME, oldDomainName, domainName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cm2Package.DELETE_DOMAIN__DOMAIN_NAME:
