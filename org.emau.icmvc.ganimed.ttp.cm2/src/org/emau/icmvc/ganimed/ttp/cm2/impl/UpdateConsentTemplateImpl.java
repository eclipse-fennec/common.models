...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Update Consent Template</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.UpdateConsentTemplateImpl#getConsentTemplate <em>Consent Template</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.UpdateConsentTemplateImpl#isFinaliseRelatedEntities <em>Finalise Related Entities</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UpdateConsentTemplateImpl extends MinimalEObjectImpl.Container implements UpdateConsentTemplate {
	/**
	 ...
	 * @generated
	 */
	protected UpdateConsentTemplateImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Cm2Package.eINSTANCE.getUpdateConsentTemplate();
	}
	...
	public NotificationChain basicSetConsentTemplate(ConsentTemplateDTO newConsentTemplate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Cm2Package.UPDATE_CONSENT_TEMPLATE__CONSENT_TEMPLATE, oldConsentTemplate, newConsentTemplate);
	...
	public void setConsentTemplate(ConsentTemplateDTO newConsentTemplate) {
		if (newConsentTemplate != consentTemplate) {
			...
			if (consentTemplate != null)
				msgs = ((InternalEObject)consentTemplate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Cm2Package.UPDATE_CONSENT_TEMPLATE__CONSENT_TEMPLATE, null, msgs);
			if (newConsentTemplate != null)
				msgs = ((InternalEObject)newConsentTemplate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Cm2Package.UPDATE_CONSENT_TEMPLATE__CONSENT_TEMPLATE, null, msgs);
			msgs = basicSetConsentTemplate(newConsentTemplate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.UPDATE_CONSENT_TEMPLATE__CONSENT_TEMPLATE, newConsentTemplate, newConsentTemplate));
	}
	...
	public void setFinaliseRelatedEntities(boolean newFinaliseRelatedEntities) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.UPDATE_CONSENT_TEMPLATE__FINALISE_RELATED_ENTITIES, oldFinaliseRelatedEntities, finaliseRelatedEntities, !oldFinaliseRelatedEntitiesESet));
	}
	...
	public void unsetFinaliseRelatedEntities() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Cm2Package.UPDATE_CONSENT_TEMPLATE__FINALISE_RELATED_ENTITIES, oldFinaliseRelatedEntities, FINALISE_RELATED_ENTITIES_EDEFAULT, oldFinaliseRelatedEntitiesESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Cm2Package.UPDATE_CONSENT_TEMPLATE__CONSENT_TEMPLATE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Cm2Package.UPDATE_CONSENT_TEMPLATE__FINALISE_RELATED_ENTITIES:
