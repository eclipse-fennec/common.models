 ...
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.config.impl.FilterTypeImpl#getEntry <em>Entry</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FilterTypeImpl extends MinimalEObjectImpl.Container implements FilterType {
	...
	protected EClass eStaticClass() {
		return ConfigPackage.Literals.FILTER_TYPE;
	}
	...
	public EList<EntryType> getEntry() {
		if (entry == null) {
			entry = new EObjectContainmentEList<EntryType>(EntryType.class, this, ConfigPackage.FILTER_TYPE__ENTRY);
		}
		return entry;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConfigPackage.FILTER_TYPE__ENTRY:
