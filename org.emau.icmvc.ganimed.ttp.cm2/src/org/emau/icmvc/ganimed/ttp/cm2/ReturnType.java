 ...
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.ReturnType#getDomains <em>Domains</em>}</li>
 * </ul>
 *
 * @see org.emau.icmvc.ganimed.ttp.cm2.Cm2Package#getReturnType()
...
public interface ReturnType extends EObject {
	 ...
	 * The list contents are of type {@link org.emau.icmvc.ganimed.ttp.cm2.DomainDTO}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Domains</em>' containment reference list.
	 * @see org.emau.icmvc.ganimed.ttp.cm2.Cm2Package#getReturnType_Domains()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='domains'"
	 * @generated
	 */
	EList<DomainDTO> getDomains();
