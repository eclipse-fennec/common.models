...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.emau.icmvc.ganimed.ttp.cm2\"" })
...
public class Cm2ConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(Cm2Package.eNS_URI)){
			EPackage.Registry.INSTANCE.put(Cm2Package.eNS_URI, ePackage);
		}
