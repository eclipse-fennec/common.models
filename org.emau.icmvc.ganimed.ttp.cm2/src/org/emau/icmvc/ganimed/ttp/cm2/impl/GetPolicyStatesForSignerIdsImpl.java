...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Get Policy States For Signer Ids</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.GetPolicyStatesForSignerIdsImpl#getDomainName <em>Domain Name</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.GetPolicyStatesForSignerIdsImpl#getSignerIds <em>Signer Ids</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.GetPolicyStatesForSignerIdsImpl#isUseAliases <em>Use Aliases</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetPolicyStatesForSignerIdsImpl extends MinimalEObjectImpl.Container implements GetPolicyStatesForSignerIds {
	/**
	 ...
	 * @generated
	 */
	protected GetPolicyStatesForSignerIdsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Cm2Package.eINSTANCE.getGetPolicyStatesForSignerIds();
	}
	...
	public void setDomainName(String newDomainName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.GET_POLICY_STATES_FOR_SIGNER_IDS__DOMAIN_NAME, oldDomainName, domainName));
	}
	...
	public EList<SignerIdDTO> getSignerIds() {
		if (signerIds == null) {
			signerIds = new EObjectContainmentEList<SignerIdDTO>(SignerIdDTO.class, this, Cm2Package.GET_POLICY_STATES_FOR_SIGNER_IDS__SIGNER_IDS);
		}
		return signerIds;
	}
	...
	public void setUseAliases(boolean newUseAliases) {
		...
		useAliasesESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.GET_POLICY_STATES_FOR_SIGNER_IDS__USE_ALIASES, oldUseAliases, useAliases, !oldUseAliasesESet));
	}
	...
	public void unsetUseAliases() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Cm2Package.GET_POLICY_STATES_FOR_SIGNER_IDS__USE_ALIASES, oldUseAliases, USE_ALIASES_EDEFAULT, oldUseAliasesESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Cm2Package.GET_POLICY_STATES_FOR_SIGNER_IDS__SIGNER_IDS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cm2Package.GET_POLICY_STATES_FOR_SIGNER_IDS__DOMAIN_NAME:
				return getDomainName();
			case Cm2Package.GET_POLICY_STATES_FOR_SIGNER_IDS__SIGNER_IDS:
				return getSignerIds();
			case Cm2Package.GET_POLICY_STATES_FOR_SIGNER_IDS__USE_ALIASES:
				return isUseAliases();
		}
...
} //GetPolicyStatesForSignerIdsImpl
