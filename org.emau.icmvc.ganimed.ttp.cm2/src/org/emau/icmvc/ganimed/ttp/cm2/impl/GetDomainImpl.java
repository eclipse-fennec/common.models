...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Get Domain</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.GetDomainImpl#getDomainName <em>Domain Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetDomainImpl extends MinimalEObjectImpl.Container implements GetDomain {
	/**
	...
	protected EClass eStaticClass() {
		return Cm2Package.eINSTANCE.getGetDomain();
	}
	...
	public void setDomainName(String newDomainName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.GET_DOMAIN__DOMAIN_NAME, oldDomainName, domainName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cm2Package.GET_DOMAIN__DOMAIN_NAME:
