...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Get Policy States For Policy Name And Signer Ids</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.GetPolicyStatesForPolicyNameAndSignerIdsImpl#getDomainName <em>Domain Name</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.GetPolicyStatesForPolicyNameAndSignerIdsImpl#getPolicyName <em>Policy Name</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.GetPolicyStatesForPolicyNameAndSignerIdsImpl#getSignerIds <em>Signer Ids</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.GetPolicyStatesForPolicyNameAndSignerIdsImpl#isUseAliases <em>Use Aliases</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetPolicyStatesForPolicyNameAndSignerIdsImpl extends MinimalEObjectImpl.Container implements GetPolicyStatesForPolicyNameAndSignerIds {
	/**
	 ...
	 * @generated
	 */
	protected GetPolicyStatesForPolicyNameAndSignerIdsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Cm2Package.eINSTANCE.getGetPolicyStatesForPolicyNameAndSignerIds();
	}
	...
	public void setDomainName(String newDomainName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.GET_POLICY_STATES_FOR_POLICY_NAME_AND_SIGNER_IDS__DOMAIN_NAME, oldDomainName, domainName));
	}
	...
	public void setPolicyName(String newPolicyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.GET_POLICY_STATES_FOR_POLICY_NAME_AND_SIGNER_IDS__POLICY_NAME, oldPolicyName, policyName));
	}
	...
	public EList<SignerIdDTO> getSignerIds() {
		if (signerIds == null) {
			signerIds = new EObjectContainmentEList<SignerIdDTO>(SignerIdDTO.class, this, Cm2Package.GET_POLICY_STATES_FOR_POLICY_NAME_AND_SIGNER_IDS__SIGNER_IDS);
		}
		return signerIds;
	}
	...
	public void setUseAliases(boolean newUseAliases) {
		...
		useAliasesESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.GET_POLICY_STATES_FOR_POLICY_NAME_AND_SIGNER_IDS__USE_ALIASES, oldUseAliases, useAliases, !oldUseAliasesESet));
	}
	...
	public void unsetUseAliases() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Cm2Package.GET_POLICY_STATES_FOR_POLICY_NAME_AND_SIGNER_IDS__USE_ALIASES, oldUseAliases, USE_ALIASES_EDEFAULT, oldUseAliasesESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Cm2Package.GET_POLICY_STATES_FOR_POLICY_NAME_AND_SIGNER_IDS__SIGNER_IDS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cm2Package.GET_POLICY_STATES_FOR_POLICY_NAME_AND_SIGNER_IDS__DOMAIN_NAME:
				return getDomainName();
			case Cm2Package.GET_POLICY_STATES_FOR_POLICY_NAME_AND_SIGNER_IDS__POLICY_NAME:
				return getPolicyName();
			case Cm2Package.GET_POLICY_STATES_FOR_POLICY_NAME_AND_SIGNER_IDS__SIGNER_IDS:
				return getSignerIds();
			case Cm2Package.GET_POLICY_STATES_FOR_POLICY_NAME_AND_SIGNER_IDS__USE_ALIASES:
				return isUseAliases();
		}
...
} //GetPolicyStatesForPolicyNameAndSignerIdsImpl
