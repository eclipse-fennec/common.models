...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Refuse Consent</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.RefuseConsent#getConsentTemplateKey <em>Consent Template Key</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.RefuseConsent#getSignerIds <em>Signer Ids</em>}</li>
 * </ul>
 *
 * @see org.emau.icmvc.ganimed.ttp.cm2.Cm2Package#getRefuseConsent()
 * @model extendedMetaData="name='refuseConsent' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface RefuseConsent extends EObject {
	/**
	 ...
	 * @see org.emau.icmvc.ganimed.ttp.cm2.Cm2Package#getRefuseConsent_ConsentTemplateKey()
	...
	/**
	 * Sets the value of the '{@link org.emau.icmvc.ganimed.ttp.cm2.RefuseConsent#getConsentTemplateKey <em>Consent Template Key</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.emau.icmvc.ganimed.ttp.cm2.Cm2Package#getRefuseConsent_SignerIds()
	 * @model containment="true" required="true"
