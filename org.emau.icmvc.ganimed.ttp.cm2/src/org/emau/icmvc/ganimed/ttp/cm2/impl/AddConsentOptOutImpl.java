...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Add Consent Opt Out</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.AddConsentOptOutImpl#getConsentTemplateKey <em>Consent Template Key</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.AddConsentOptOutImpl#getSignerIds <em>Signer Ids</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddConsentOptOutImpl extends MinimalEObjectImpl.Container implements AddConsentOptOut {
	/**
	 ...
	 * @generated
	 */
	protected AddConsentOptOutImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Cm2Package.eINSTANCE.getAddConsentOptOut();
	}
	...
	public NotificationChain basicSetConsentTemplateKey(ConsentTemplateKeyDTO newConsentTemplateKey, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Cm2Package.ADD_CONSENT_OPT_OUT__CONSENT_TEMPLATE_KEY, oldConsentTemplateKey, newConsentTemplateKey);
	...
	public void setConsentTemplateKey(ConsentTemplateKeyDTO newConsentTemplateKey) {
		if (newConsentTemplateKey != consentTemplateKey) {
			...
			if (consentTemplateKey != null)
				msgs = ((InternalEObject)consentTemplateKey).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Cm2Package.ADD_CONSENT_OPT_OUT__CONSENT_TEMPLATE_KEY, null, msgs);
			if (newConsentTemplateKey != null)
				msgs = ((InternalEObject)newConsentTemplateKey).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Cm2Package.ADD_CONSENT_OPT_OUT__CONSENT_TEMPLATE_KEY, null, msgs);
			msgs = basicSetConsentTemplateKey(newConsentTemplateKey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.ADD_CONSENT_OPT_OUT__CONSENT_TEMPLATE_KEY, newConsentTemplateKey, newConsentTemplateKey));
	}
	...
	public EList<SignerIdDTO> getSignerIds() {
		if (signerIds == null) {
			signerIds = new EObjectContainmentEList<SignerIdDTO>(SignerIdDTO.class, this, Cm2Package.ADD_CONSENT_OPT_OUT__SIGNER_IDS);
		}
		return signerIds;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Cm2Package.ADD_CONSENT_OPT_OUT__CONSENT_TEMPLATE_KEY:
				return basicSetConsentTemplateKey(null, msgs);
			case Cm2Package.ADD_CONSENT_OPT_OUT__SIGNER_IDS:
