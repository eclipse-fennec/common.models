...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Add Module</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.AddModuleImpl#getModule <em>Module</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.AddModuleImpl#isFinaliseRelatedEntities <em>Finalise Related Entities</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddModuleImpl extends MinimalEObjectImpl.Container implements AddModule {
	/**
	...
	protected EClass eStaticClass() {
		return Cm2Package.eINSTANCE.getAddModule();
	}
	...
	public NotificationChain basicSetModule(ModuleDTO newModule, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Cm2Package.ADD_MODULE__MODULE, oldModule, newModule);
	...
	public void setModule(ModuleDTO newModule) {
		if (newModule != module) {
			...
			if (module != null)
				msgs = ((InternalEObject)module).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Cm2Package.ADD_MODULE__MODULE, null, msgs);
			if (newModule != null)
				msgs = ((InternalEObject)newModule).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Cm2Package.ADD_MODULE__MODULE, null, msgs);
			msgs = basicSetModule(newModule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.ADD_MODULE__MODULE, newModule, newModule));
	}
	...
	public void setFinaliseRelatedEntities(boolean newFinaliseRelatedEntities) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.ADD_MODULE__FINALISE_RELATED_ENTITIES, oldFinaliseRelatedEntities, finaliseRelatedEntities, !oldFinaliseRelatedEntitiesESet));
	}
	...
	public void unsetFinaliseRelatedEntities() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Cm2Package.ADD_MODULE__FINALISE_RELATED_ENTITIES, oldFinaliseRelatedEntities, FINALISE_RELATED_ENTITIES_EDEFAULT, oldFinaliseRelatedEntitiesESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Cm2Package.ADD_MODULE__MODULE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cm2Package.ADD_MODULE__MODULE:
				return getModule();
			case Cm2Package.ADD_MODULE__FINALISE_RELATED_ENTITIES:
