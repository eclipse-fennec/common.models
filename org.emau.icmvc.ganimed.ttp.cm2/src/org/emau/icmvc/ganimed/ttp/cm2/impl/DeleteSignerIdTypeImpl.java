...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Delete Signer Id Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.DeleteSignerIdTypeImpl#getDomainName <em>Domain Name</em>}</li>
 *   <li>{@link org.emau.icmvc.ganimed.ttp.cm2.impl.DeleteSignerIdTypeImpl#getSignerIdTypeName <em>Signer Id Type Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeleteSignerIdTypeImpl extends MinimalEObjectImpl.Container implements DeleteSignerIdType {
	/**
	 ...
	 * @generated
	 */
	protected DeleteSignerIdTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Cm2Package.eINSTANCE.getDeleteSignerIdType();
	}
	...
	public void setDomainName(String newDomainName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.DELETE_SIGNER_ID_TYPE__DOMAIN_NAME, oldDomainName, domainName));
	}
	...
	public void setSignerIdTypeName(String newSignerIdTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cm2Package.DELETE_SIGNER_ID_TYPE__SIGNER_ID_TYPE_NAME, oldSignerIdTypeName, signerIdTypeName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cm2Package.DELETE_SIGNER_ID_TYPE__DOMAIN_NAME:
				return getDomainName();
			case Cm2Package.DELETE_SIGNER_ID_TYPE__SIGNER_ID_TYPE_NAME:
