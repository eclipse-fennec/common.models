 ...
 * </p>
 * <ul>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getBr <em>Br</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getSpan <em>Span</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getBdo <em>Bdo</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getMap <em>Map</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getImg <em>Img</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getTt <em>Tt</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getI <em>I</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getB <em>B</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getBig <em>Big</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getSmall <em>Small</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getEm <em>Em</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getStrong <em>Strong</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getDfn <em>Dfn</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getQ <em>Q</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getSamp <em>Samp</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getKbd <em>Kbd</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getVar <em>Var</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getCite <em>Cite</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getAbbr <em>Abbr</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getAcronym <em>Acronym</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getSub <em>Sub</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.AContentImpl#getSup <em>Sup</em>}</li>
 * </ul>
 *
 * @generated
 */
