 ...
 * </p>
 * <ul>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getP <em>P</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getH1 <em>H1</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getH2 <em>H2</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getH3 <em>H3</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getH4 <em>H4</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getH5 <em>H5</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getH6 <em>H6</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getDiv <em>Div</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getUl <em>Ul</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getOl <em>Ol</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getDl <em>Dl</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getPre <em>Pre</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getHr <em>Hr</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getBlockquote <em>Blockquote</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getTable <em>Table</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getA <em>A</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getBr <em>Br</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getSpan <em>Span</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getBdo <em>Bdo</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getMap <em>Map</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getImg <em>Img</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getTt <em>Tt</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getI <em>I</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getB <em>B</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getBig <em>Big</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getSmall <em>Small</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getEm <em>Em</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getStrong <em>Strong</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getDfn <em>Dfn</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getQ <em>Q</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getSamp <em>Samp</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getKbd <em>Kbd</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getVar <em>Var</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getCite <em>Cite</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getAbbr <em>Abbr</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getAcronym <em>Acronym</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getSub <em>Sub</em>}</li>
 *   <li>{@link org.w3.xhtml.impl.FlowImpl#getSup <em>Sup</em>}</li>
 * </ul>
 *
 * @generated
 */
