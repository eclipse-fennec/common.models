...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.xoev.kosit.datentyp._201903.din91379\"" })
...
public class DIN913791903ConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(DIN913791903Package.eNS_URI)){
			EPackage.Registry.INSTANCE.put(DIN913791903Package.eNS_URI, ePackage);
		}
