 ...
 * <!-- end-user-doc -->
 * @see de.xoev.kosit.datentyp._201903.din91379.DIN913791903Package
 * @generated
 */
public class DIN913791903Validator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final DIN913791903Validator INSTANCE = new DIN913791903Validator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "de.xoev.kosit.datentyp._201903.din91379";
	...
	public boolean validateDatatypeA_Pattern(String datatypeA, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(DIN913791903Package.Literals.DATATYPE_A, datatypeA, DATATYPE_A__PATTERN__VALUES, diagnostics, context);
	}
	...
	public static final  PatternMatcher [][] DATATYPE_B__PATTERN__VALUES =
		new PatternMatcher [][] {
			new PatternMatcher [] {
				XMLTypeUtil.createPatternMatcher("([ -~]|[\u00a1-\u00a3]|\u00a5|[\u00a7-\u00ac]|[\u00ae-\u00b7]|[\u00b9-\u00bb]|[\u00bf-\u017e]|[\u0187-\u0188]|\u018f|\u0197|[\u01a0-\u01a1]|[\u01af-\u01b0]|\u01b7|[\u01cd-\u01dc]|[\u01de-\u01df]|[\u01e2-\u01f0]|[\u01f4-\u01f5]|[\u01f8-\u01ff]|[\u0212-\u0213]|[\u0218-\u021b]|[\u021e-\u021f]|[\u0227-\u0233]|\u0259|\u0268|\u0292|[\u02b9-\u02ba]|[\u02be-\u02bf]|\u02c8|\u02cc|[\u1e02-\u1e03]|[\u1e06-\u1e07]|[\u1e0a-\u1e11]|[\u1e1c-\u1e2b]|[\u1e2f-\u1e37]|[\u1e3a-\u1e3b]|[\u1e40-\u1e49]|[\u1e52-\u1e5b]|[\u1e5e-\u1e63]|[\u1e6a-\u1e6f]|[\u1e80-\u1e87]|[\u1e8c-\u1e97]|\u1e9e|[\u1ea0-\u1ef9]|\u2019|\u2021|\u20ac|A\u030b|C(\u0300|\u0304|\u0306|\u0308|\u0315|\u0323|\u0326|\u0328\u0306)|D\u0302|F(\u0300|\u0304)|G\u0300|H(\u0304|\u0326|\u0331)|J(\u0301|\u030c)|K(\u0300|\u0302|\u0304|\u0307|\u0315|\u031b|\u0326|\u035fH|\u035fh)|L(\u0302|\u0325|\u0325\u0304|\u0326)|M(\u0300|\u0302|\u0306|\u0310)|N(\u0302|\u0304|\u0306|\u0326)|P(\u0300|\u0304|\u0315|\u0323)|R(\u0306|\u0325|\u0325\u0304)|S(\u0300|\u0304|\u031b\u0304|\u0331)|T(\u0300|\u0304|\u0308|\u0315|\u031b)|U\u0307|Z(\u0300|\u0304|\u0306|\u0308|\u0327)|a\u030b|c(\u0300|\u0304|\u0306|\u0308|\u0315|\u0323|\u0326|\u0328\u0306)|d\u0302|f(\u0300|\u0304)|g\u0300|h(\u0304|\u0326)|j\u0301|k(\u0300|\u0302|\u0304|\u0307|\u0315|\u031b|\u0326|\u035fh)|l(\u0302|\u0325|\u0325\u0304|\u0326)|m(\u0300|\u0302|\u0306|\u0310)|n(\u0302|\u0304|\u0306|\u0326)|p(\u0300|\u0304|\u0315|\u0323)|r(\u0306|\u0325|\u0325\u0304)|s(\u0300|\u0304|\u031b\u0304|\u0331)|t(\u0300|\u0304|\u0315|\u031b)|u\u0307|z(\u0300|\u0304|\u0306|\u0308|\u0327)|\u00c7\u0306|\u00db\u0304|\u00e7\u0306|\u00fb\u0304|\u00ff\u0301|\u010c(\u0315|\u0323)|\u010d(\u0315|\u0323)|\u012a\u0301|\u012b\u0301|\u017d(\u0326|\u0327)|\u017e(\u0326|\u0327)|\u1e32\u0304|\u1e33\u0304|\u1e62\u0304|\u1e63\u0304|\u1e6c\u0304|\u1e6d\u0304|\u1ea0\u0308|\u1ea1\u0308|\u1ecc\u0308|\u1ecd\u0308|\u1ee4(\u0304|\u0308)|\u1ee5(\u0304|\u0308))*")
			}
		};
	...
	public boolean validateDatatypeB_Pattern(String datatypeB, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(DIN913791903Package.Literals.DATATYPE_B, datatypeB, DATATYPE_B__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validateDatatypeC_Pattern(String datatypeC, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(DIN913791903Package.Literals.DATATYPE_C, datatypeC, DATATYPE_C__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validateDatatypeD_Pattern(String datatypeD, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(DIN913791903Package.Literals.DATATYPE_D, datatypeD, DATATYPE_D__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validateDatatypeE_Pattern(String datatypeE, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(DIN913791903Package.Literals.DATATYPE_E, datatypeE, DATATYPE_E__PATTERN__VALUES, diagnostics, context);
	}
