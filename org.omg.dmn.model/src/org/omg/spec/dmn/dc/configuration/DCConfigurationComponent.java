 ...
 */
package org.omg.spec.dmn.dc.configuration;
...
import org.omg.spec.dmn.dc.DCFactory;
import org.omg.spec.dmn.dc.DCPackage;

import org.omg.spec.dmn.dc.impl.DCPackageImpl;

import org.omg.spec.dmn.dc.util.DCResourceFactoryImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.omg.spec.dmn.dc.util.DCResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource$Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,org.omg.spec.dmn.dc.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.omg.spec.dmn.dc.DCFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,org.omg.spec.dmn.dc\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.omg.spec.dmn.dc.DCPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,org.omg.spec.dmn.dc\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.omg.spec.dmn.dc\"" })
...
public class DCConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(DCPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(DCPackage.eNS_URI, ePackage);
		}
