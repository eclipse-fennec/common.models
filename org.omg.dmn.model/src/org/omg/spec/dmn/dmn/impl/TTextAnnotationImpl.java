 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.dmn.dmn.impl.TTextAnnotationImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.omg.spec.dmn.dmn.impl.TTextAnnotationImpl#getTextFormat <em>Text Format</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TTextAnnotationImpl extends TArtifactImpl implements TTextAnnotation {
	...
	protected EClass eStaticClass() {
		return DMNPackage.Literals.TTEXT_ANNOTATION;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DMNPackage.TTEXT_ANNOTATION__TEXT, oldText, text));
	}
	...
	public void setTextFormat(String newTextFormat) {
		...
		textFormatESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DMNPackage.TTEXT_ANNOTATION__TEXT_FORMAT, oldTextFormat, textFormat, !oldTextFormatESet));
	}
	...
	public void unsetTextFormat() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DMNPackage.TTEXT_ANNOTATION__TEXT_FORMAT, oldTextFormat, TEXT_FORMAT_EDEFAULT, oldTextFormatESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DMNPackage.TTEXT_ANNOTATION__TEXT:
				return getText();
			case DMNPackage.TTEXT_ANNOTATION__TEXT_FORMAT:
