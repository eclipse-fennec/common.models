 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.dmn.dmn.impl.TImportImpl#getImportType <em>Import Type</em>}</li>
 *   <li>{@link org.omg.spec.dmn.dmn.impl.TImportImpl#getLocationURI <em>Location URI</em>}</li>
 *   <li>{@link org.omg.spec.dmn.dmn.impl.TImportImpl#getNamespace <em>Namespace</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TImportImpl extends TNamedElementImpl implements TImport {
	/**
	...
	protected EClass eStaticClass() {
		return DMNPackage.Literals.TIMPORT;
	}
	...
	public void setImportType(String newImportType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DMNPackage.TIMPORT__IMPORT_TYPE, oldImportType, importType));
	}
	...
	public void setLocationURI(String newLocationURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DMNPackage.TIMPORT__LOCATION_URI, oldLocationURI, locationURI));
	}
	...
	public void setNamespace(String newNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DMNPackage.TIMPORT__NAMESPACE, oldNamespace, namespace));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DMNPackage.TIMPORT__IMPORT_TYPE:
				return getImportType();
			case DMNPackage.TIMPORT__LOCATION_URI:
				return getLocationURI();
			case DMNPackage.TIMPORT__NAMESPACE:
				return getNamespace();
		}
