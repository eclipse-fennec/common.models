...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TTyped Child Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.dmn.dmn.impl.TTypedChildExpressionImpl#getTypeRef <em>Type Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TTypedChildExpressionImpl extends TChildExpressionImpl implements TTypedChildExpression {
	/**
	 ...
	 * @generated
	 */
	protected TTypedChildExpressionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DMNPackage.Literals.TTYPED_CHILD_EXPRESSION;
	}
	...
	public void setTypeRef(String newTypeRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DMNPackage.TTYPED_CHILD_EXPRESSION__TYPE_REF, oldTypeRef, typeRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DMNPackage.TTYPED_CHILD_EXPRESSION__TYPE_REF:
				return getTypeRef();
		}
