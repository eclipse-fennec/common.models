 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.dmn.di.ExtensionType#getAny <em>Any</em>}</li>
 * </ul>
 *
 * @see org.omg.spec.dmn.di.DIPackage#getExtensionType()
...
public interface ExtensionType extends EObject {
	 ...
	 * @see org.omg.spec.dmn.di.DIPackage#getExtensionType_Any()
