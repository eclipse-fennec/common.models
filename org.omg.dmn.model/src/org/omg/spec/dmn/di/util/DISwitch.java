...
public class DISwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DIPackage.EXTENSION_TYPE1: {
				ExtensionType1 extensionType1 = (ExtensionType1)theEObject;
				T result = caseExtensionType1(extensionType1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DIPackage.DI_ROOT: {
				DIRoot diRoot = (DIRoot)theEObject;
				T result = caseDIRoot(diRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Extension Type1</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Extension Type1</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExtensionType1(ExtensionType1 object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseDIRoot(DIRoot object) {
		return null;
	}
