...
public class XlinkFactoryImpl extends EFactoryImpl implements XlinkFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case XlinkPackage.XLINK_DOCUMENT_ROOT: return createXlinkDocumentRoot();
			default:
	 ...
	 */
	@Override
	public XlinkDocumentRoot createXlinkDocumentRoot() {
		XlinkDocumentRootImpl xlinkDocumentRoot = new XlinkDocumentRootImpl();
		return xlinkDocumentRoot;
	}
