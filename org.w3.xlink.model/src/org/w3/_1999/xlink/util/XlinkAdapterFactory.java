...
public class XlinkAdapterFactory extends AdapterFactoryImpl {
	...
	protected XlinkSwitch<Adapter> modelSwitch =
		new XlinkSwitch<Adapter>() {
			...
			@Override
			public Adapter caseXlinkDocumentRoot(XlinkDocumentRoot object) {
				return createXlinkDocumentRootAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.w3._1999.xlink.XlinkDocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
