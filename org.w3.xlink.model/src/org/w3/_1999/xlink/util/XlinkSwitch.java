...
public class XlinkSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case XlinkPackage.XLINK_DOCUMENT_ROOT: {
				XlinkDocumentRoot xlinkDocumentRoot = (XlinkDocumentRoot)theEObject;
				T result = caseXlinkDocumentRoot(xlinkDocumentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseXlinkDocumentRoot(XlinkDocumentRoot object) {
		return null;
	}
