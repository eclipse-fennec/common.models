...
public class XlinkValidator extends EObjectValidator {
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case XlinkPackage.XLINK_DOCUMENT_ROOT:
				return validateXlinkDocumentRoot((XlinkDocumentRoot)value, diagnostics, context);
	 ...
	 * @generated
	 */
	public boolean validateXlinkDocumentRoot(XlinkDocumentRoot xlinkDocumentRoot, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(xlinkDocumentRoot, diagnostics, context);
	}
