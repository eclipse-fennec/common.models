...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.w3._1999.xlink\"" })
...
public class XlinkConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(XlinkPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(XlinkPackage.eNS_URI, ePackage);
		}
