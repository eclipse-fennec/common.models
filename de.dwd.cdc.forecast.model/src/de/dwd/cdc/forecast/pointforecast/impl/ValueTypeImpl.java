 ...
 * </p>
 * <ul>
 *   <li>{@link de.dwd.cdc.forecast.pointforecast.impl.ValueTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueTypeImpl extends MinimalEObjectImpl.Container implements ValueType {
	...
	protected EClass eStaticClass() {
		return PointforecastPackage.Literals.VALUE_TYPE;
	}
	...
	public void setValue(List<Object> newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PointforecastPackage.VALUE_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PointforecastPackage.VALUE_TYPE__VALUE:
				return getValue();
		}
