 ...
 * </p>
 * <ul>
 *   <li>{@link org.apache.maven.pom.pom.MailingListsType#getMailingList <em>Mailing List</em>}</li>
 * </ul>
 *
 * @see org.apache.maven.pom.pom.POMPackage#getMailingListsType()
...
public interface MailingListsType extends EObject {
	 ...
	 * The list contents are of type {@link org.apache.maven.pom.pom.MailingList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Mailing List</em>' containment reference list.
	 * @see org.apache.maven.pom.pom.POMPackage#getMailingListsType_MailingList()
