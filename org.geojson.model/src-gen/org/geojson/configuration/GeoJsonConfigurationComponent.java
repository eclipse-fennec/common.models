...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.geojson\"" })
...
public class GeoJsonConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(GeoJsonPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(GeoJsonPackage.eNS_URI, ePackage);
		}
