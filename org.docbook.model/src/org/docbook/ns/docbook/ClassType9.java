...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Class Type9</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.docbook.ns.docbook.DocbookPackage#getClassType9()
 * @model extendedMetaData="name='class_._9_._type'"
 * @generated
 */
@ProviderType
public enum ClassType9 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Class Type9</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ClassType9[] VALUES_ARRAY =
		new ClassType9[] {
			DOI,
			ISBN,
			ISRN,
	...
	/**
	 * A public read-only list of all the '<em><b>Class Type9</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ClassType9> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Class Type9</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ClassType9 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ClassType9 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Class Type9</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static ClassType9 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ClassType9 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Class Type9</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ClassType9 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ClassType9(int value, String name, String literal) {
		this.value = value;
		this.name = name;
