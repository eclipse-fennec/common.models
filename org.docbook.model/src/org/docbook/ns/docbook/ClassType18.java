...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Class Type18</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.docbook.ns.docbook.DocbookPackage#getClassType18()
 * @model extendedMetaData="name='class_._18_._type'"
 * @generated
 */
@ProviderType
public enum ClassType18 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Class Type18</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ClassType18[] VALUES_ARRAY =
		new ClassType18[] {
			DOI,
			ISBN,
			ISRN,
	...
	/**
	 * A public read-only list of all the '<em><b>Class Type18</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ClassType18> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Class Type18</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ClassType18 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ClassType18 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Class Type18</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static ClassType18 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ClassType18 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Class Type18</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ClassType18 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ClassType18(int value, String name, String literal) {
		this.value = value;
		this.name = name;
