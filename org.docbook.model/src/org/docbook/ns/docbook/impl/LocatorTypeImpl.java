 ...
 * </p>
 * <ul>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getArch <em>Arch</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getAudience <em>Audience</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getConformance <em>Conformance</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getOs <em>Os</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getRemap <em>Remap</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getRevision <em>Revision</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getRevisionflag <em>Revisionflag</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getUserlevel <em>Userlevel</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getVendor <em>Vendor</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getWordsize <em>Wordsize</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.LocatorTypeImpl#getXreflabel <em>Xreflabel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocatorTypeImpl extends MinimalEObjectImpl.Container implements LocatorType {
	...
	protected EClass eStaticClass() {
		return DocbookPackage.eINSTANCE.getLocatorType();
	}
	...
	public void setAnnotations(Object newAnnotations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__ANNOTATIONS, oldAnnotations, annotations));
	}
	...
	public void setArch(Object newArch) {
		...
		arch = newArch;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__ARCH, oldArch, arch));
	}
	...
	public void setAudience(Object newAudience) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__AUDIENCE, oldAudience, audience));
	}
	...
	public void setBase(Object newBase) {
		...
		base = newBase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__BASE, oldBase, base));
	}
	...
	public void setCondition(Object newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__CONDITION, oldCondition, condition));
	}
	...
	public void setConformance(Object newConformance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__CONFORMANCE, oldConformance, conformance));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.LOCATOR_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__ID, oldId, id));
	}
	...
	public void setLabel(String newLabel) {
		...
		label = newLabel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__LABEL, oldLabel, label));
	}
	...
	public void setLang(Object newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__LANG, oldLang, lang));
	}
	...
	public void setOs(Object newOs) {
		...
		os = newOs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__OS, oldOs, os));
	}
	...
	public void setRemap(Object newRemap) {
		...
		remap = newRemap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__REMAP, oldRemap, remap));
	}
	...
	public void setRevision(Object newRevision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__REVISION, oldRevision, revision));
	}
	...
	public void setRevisionflag(RevisionflagType newRevisionflag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__REVISIONFLAG, oldRevisionflag, revisionflag, !oldRevisionflagESet));
	}
	...
	public void unsetRevisionflag() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.LOCATOR_TYPE__REVISIONFLAG, oldRevisionflag, REVISIONFLAG_EDEFAULT, oldRevisionflagESet));
	}
	...
	public void setRole(Object newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__ROLE, oldRole, role));
	}
	...
	public void setSecurity(Object newSecurity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__SECURITY, oldSecurity, security));
	}
	...
	public void setUserlevel(Object newUserlevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__USERLEVEL, oldUserlevel, userlevel));
	}
	...
	public void setVendor(Object newVendor) {
		...
		vendor = newVendor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setVersion(Object newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__VERSION, oldVersion, version));
	}
	...
	public void setWordsize(Object newWordsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__WORDSIZE, oldWordsize, wordsize));
	}
	...
	public void setXreflabel(Object newXreflabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.LOCATOR_TYPE__XREFLABEL, oldXreflabel, xreflabel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DocbookPackage.LOCATOR_TYPE__ANNOTATIONS:
				return getAnnotations();
			case DocbookPackage.LOCATOR_TYPE__ARCH:
				return getArch();
			case DocbookPackage.LOCATOR_TYPE__AUDIENCE:
				return getAudience();
			case DocbookPackage.LOCATOR_TYPE__BASE:
				return getBase();
			case DocbookPackage.LOCATOR_TYPE__CONDITION:
				return getCondition();
			case DocbookPackage.LOCATOR_TYPE__CONFORMANCE:
				return getConformance();
			case DocbookPackage.LOCATOR_TYPE__DIR:
				return getDir();
			case DocbookPackage.LOCATOR_TYPE__ID:
				return getId();
			case DocbookPackage.LOCATOR_TYPE__LABEL:
				return getLabel();
			case DocbookPackage.LOCATOR_TYPE__LANG:
				return getLang();
			case DocbookPackage.LOCATOR_TYPE__OS:
				return getOs();
			case DocbookPackage.LOCATOR_TYPE__REMAP:
				return getRemap();
			case DocbookPackage.LOCATOR_TYPE__REVISION:
				return getRevision();
			case DocbookPackage.LOCATOR_TYPE__REVISIONFLAG:
				return getRevisionflag();
			case DocbookPackage.LOCATOR_TYPE__ROLE:
				return getRole();
			case DocbookPackage.LOCATOR_TYPE__SECURITY:
				return getSecurity();
			case DocbookPackage.LOCATOR_TYPE__USERLEVEL:
				return getUserlevel();
			case DocbookPackage.LOCATOR_TYPE__VENDOR:
				return getVendor();
			case DocbookPackage.LOCATOR_TYPE__VERSION:
				return getVersion();
			case DocbookPackage.LOCATOR_TYPE__WORDSIZE:
				return getWordsize();
			case DocbookPackage.LOCATOR_TYPE__XREFLABEL:
				return getXreflabel();
		}
