...
import org.docbook.ns.docbook.AlignType12;
import org.docbook.ns.docbook.ColsepType6;
...
import org.docbook.ns.docbook.RowsepType7;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getArch <em>Arch</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getAudience <em>Audience</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getChar <em>Char</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getCharoff <em>Charoff</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getColname <em>Colname</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getColnum <em>Colnum</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getColsep <em>Colsep</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getColwidth <em>Colwidth</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getConformance <em>Conformance</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getLinkend <em>Linkend</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getOs <em>Os</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getRemap <em>Remap</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getRevision <em>Revision</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getRevisionflag <em>Revisionflag</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getRole1 <em>Role1</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getRowsep <em>Rowsep</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getUserlevel <em>Userlevel</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getVendor <em>Vendor</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getWordsize <em>Wordsize</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ColspecTypeImpl#getXreflabel <em>Xreflabel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColspecTypeImpl extends MinimalEObjectImpl.Container implements ColspecType {
	/**
	 ...
	 * @ordered
	 */
	protected static final AlignType12 ALIGN_EDEFAULT = AlignType12.CENTER;
	 ...
	 * @ordered
	 */
	protected AlignType12 align = ALIGN_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final ColsepType6 COLSEP_EDEFAULT = ColsepType6._0;
	 ...
	 * @ordered
	 */
	protected ColsepType6 colsep = COLSEP_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final RowsepType7 ROWSEP_EDEFAULT = RowsepType7._0;
	 ...
	 * @ordered
	 */
	protected RowsepType7 rowsep = ROWSEP_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return DocbookPackage.eINSTANCE.getColspecType();
	}
	...
	public void setActuate(ActuateType newActuate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__ACTUATE, oldActuate, actuate, !oldActuateESet));
	}
	...
	public void unsetActuate() {
		...
		actuateESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.COLSPEC_TYPE__ACTUATE, oldActuate, ACTUATE_EDEFAULT, oldActuateESet));
	}
	 ...
	 */
	@Override
	public void setAlign(AlignType12 newAlign) {
		AlignType12 oldAlign = align;
		align = newAlign == null ? ALIGN_EDEFAULT : newAlign;
		boolean oldAlignESet = alignESet;
		alignESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__ALIGN, oldAlign, align, !oldAlignESet));
	}
	...
	public void unsetAlign() {
		...
		alignESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.COLSPEC_TYPE__ALIGN, oldAlign, ALIGN_EDEFAULT, oldAlignESet));
	}
	...
	public void setAnnotations(Object newAnnotations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__ANNOTATIONS, oldAnnotations, annotations));
	}
	...
	public void setArch(Object newArch) {
		...
		arch = newArch;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__ARCH, oldArch, arch));
	}
	...
	public void setArcrole(Object newArcrole) {
		...
		arcrole = newArcrole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__ARCROLE, oldArcrole, arcrole));
	}
	...
	public void setAudience(Object newAudience) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__AUDIENCE, oldAudience, audience));
	}
	...
	public void setBase(Object newBase) {
		...
		base = newBase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__BASE, oldBase, base));
	}
	...
	public void setChar(Object newChar) {
		...
		char_ = newChar;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__CHAR, oldChar, char_));
	}
	...
	public void setCharoff(Object newCharoff) {
		...
		charoff = newCharoff;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__CHAROFF, oldCharoff, charoff));
	}
	...
	public void setColnum(String newColnum) {
		...
		colnum = newColnum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__COLNUM, oldColnum, colnum));
	}
	 ...
	 */
	@Override
	public void setColsep(ColsepType6 newColsep) {
		ColsepType6 oldColsep = colsep;
		colsep = newColsep == null ? COLSEP_EDEFAULT : newColsep;
		boolean oldColsepESet = colsepESet;
		colsepESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__COLSEP, oldColsep, colsep, !oldColsepESet));
	}
	...
	public void unsetColsep() {
		...
		colsepESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.COLSPEC_TYPE__COLSEP, oldColsep, COLSEP_EDEFAULT, oldColsepESet));
	}
	...
	public void setCondition(Object newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__CONDITION, oldCondition, condition));
	}
	...
	public void setConformance(Object newConformance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__CONFORMANCE, oldConformance, conformance));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.COLSPEC_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setHref(Object newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__HREF, oldHref, href));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__ID, oldId, id));
	}
	...
	public void setLang(Object newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLinkend(String newLinkend) {
		...
		linkend = newLinkend;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__LINKEND, oldLinkend, linkend));
	}
	...
	public void setOs(Object newOs) {
		...
		os = newOs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__OS, oldOs, os));
	}
	...
	public void setRemap(Object newRemap) {
		...
		remap = newRemap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__REMAP, oldRemap, remap));
	}
	...
	public void setRevision(Object newRevision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__REVISION, oldRevision, revision));
	}
	...
	public void setRevisionflag(RevisionflagType newRevisionflag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__REVISIONFLAG, oldRevisionflag, revisionflag, !oldRevisionflagESet));
	}
	...
	public void unsetRevisionflag() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.COLSPEC_TYPE__REVISIONFLAG, oldRevisionflag, REVISIONFLAG_EDEFAULT, oldRevisionflagESet));
	}
	...
	public void setRole(Object newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__ROLE, oldRole, role));
	}
	...
	public void setRole1(Object newRole1) {
		...
		role1 = newRole1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__ROLE1, oldRole1, role1));
	}
	 ...
	 */
	@Override
	public void setRowsep(RowsepType7 newRowsep) {
		RowsepType7 oldRowsep = rowsep;
		rowsep = newRowsep == null ? ROWSEP_EDEFAULT : newRowsep;
		boolean oldRowsepESet = rowsepESet;
		rowsepESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__ROWSEP, oldRowsep, rowsep, !oldRowsepESet));
	}
	...
	public void unsetRowsep() {
		...
		rowsepESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.COLSPEC_TYPE__ROWSEP, oldRowsep, ROWSEP_EDEFAULT, oldRowsepESet));
	}
	...
	public void setSecurity(Object newSecurity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__SECURITY, oldSecurity, security));
	}
	...
	public void setShow(ShowType newShow) {
		...
		showESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__SHOW, oldShow, show, !oldShowESet));
	}
	...
	public void unsetShow() {
		...
		showESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.COLSPEC_TYPE__SHOW, oldShow, SHOW_EDEFAULT, oldShowESet));
	}
	...
	public void setTitle(Object newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setType(Object newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__TYPE, oldType, type));
	}
	...
	public void setUserlevel(Object newUserlevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__USERLEVEL, oldUserlevel, userlevel));
	}
	...
	public void setVendor(Object newVendor) {
		...
		vendor = newVendor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setVersion(Object newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__VERSION, oldVersion, version));
	}
	...
	public void setWordsize(Object newWordsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__WORDSIZE, oldWordsize, wordsize));
	}
	...
	public void setXreflabel(Object newXreflabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.COLSPEC_TYPE__XREFLABEL, oldXreflabel, xreflabel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DocbookPackage.COLSPEC_TYPE__ACTUATE:
				return getActuate();
			case DocbookPackage.COLSPEC_TYPE__ALIGN:
				return getAlign();
			case DocbookPackage.COLSPEC_TYPE__ANNOTATIONS:
				return getAnnotations();
			case DocbookPackage.COLSPEC_TYPE__ARCH:
				return getArch();
			case DocbookPackage.COLSPEC_TYPE__ARCROLE:
				return getArcrole();
			case DocbookPackage.COLSPEC_TYPE__AUDIENCE:
				return getAudience();
			case DocbookPackage.COLSPEC_TYPE__BASE:
				return getBase();
			case DocbookPackage.COLSPEC_TYPE__CHAR:
				return getChar();
			case DocbookPackage.COLSPEC_TYPE__CHAROFF:
				return getCharoff();
			case DocbookPackage.COLSPEC_TYPE__COLNAME:
				return getColname();
			case DocbookPackage.COLSPEC_TYPE__COLNUM:
				return getColnum();
			case DocbookPackage.COLSPEC_TYPE__COLSEP:
				return getColsep();
			case DocbookPackage.COLSPEC_TYPE__COLWIDTH:
				return getColwidth();
			case DocbookPackage.COLSPEC_TYPE__CONDITION:
				return getCondition();
			case DocbookPackage.COLSPEC_TYPE__CONFORMANCE:
				return getConformance();
			case DocbookPackage.COLSPEC_TYPE__DIR:
				return getDir();
			case DocbookPackage.COLSPEC_TYPE__HREF:
				return getHref();
			case DocbookPackage.COLSPEC_TYPE__ID:
				return getId();
			case DocbookPackage.COLSPEC_TYPE__LANG:
				return getLang();
			case DocbookPackage.COLSPEC_TYPE__LINKEND:
				return getLinkend();
			case DocbookPackage.COLSPEC_TYPE__OS:
				return getOs();
			case DocbookPackage.COLSPEC_TYPE__REMAP:
				return getRemap();
			case DocbookPackage.COLSPEC_TYPE__REVISION:
				return getRevision();
			case DocbookPackage.COLSPEC_TYPE__REVISIONFLAG:
				return getRevisionflag();
			case DocbookPackage.COLSPEC_TYPE__ROLE:
				return getRole();
			case DocbookPackage.COLSPEC_TYPE__ROLE1:
				return getRole1();
			case DocbookPackage.COLSPEC_TYPE__ROWSEP:
				return getRowsep();
			case DocbookPackage.COLSPEC_TYPE__SECURITY:
				return getSecurity();
			case DocbookPackage.COLSPEC_TYPE__SHOW:
				return getShow();
			case DocbookPackage.COLSPEC_TYPE__TITLE:
				return getTitle();
			case DocbookPackage.COLSPEC_TYPE__TYPE:
				return getType();
			case DocbookPackage.COLSPEC_TYPE__USERLEVEL:
				return getUserlevel();
			case DocbookPackage.COLSPEC_TYPE__VENDOR:
				return getVendor();
			case DocbookPackage.COLSPEC_TYPE__VERSION:
				return getVersion();
			case DocbookPackage.COLSPEC_TYPE__WORDSIZE:
				return getWordsize();
			case DocbookPackage.COLSPEC_TYPE__XREFLABEL:
				return getXreflabel();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DocbookPackage.COLSPEC_TYPE__COLNUM:
				...
				return;
			case DocbookPackage.COLSPEC_TYPE__COLSEP:
				setColsep((ColsepType6)newValue);
				return;
			case DocbookPackage.COLSPEC_TYPE__COLWIDTH:
			...
			case DocbookPackage.COLSPEC_TYPE__ROLE1:
				...
				return;
			case DocbookPackage.COLSPEC_TYPE__ROWSEP:
				setRowsep((RowsepType7)newValue);
				return;
			case DocbookPackage.COLSPEC_TYPE__SECURITY:
