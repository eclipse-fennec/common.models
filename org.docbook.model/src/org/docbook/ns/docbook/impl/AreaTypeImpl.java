...
import org.docbook.ns.docbook.UnitsType2;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getAlt <em>Alt</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getArch <em>Arch</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getAudience <em>Audience</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getConformance <em>Conformance</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getCoords <em>Coords</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getLinkends <em>Linkends</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getOs <em>Os</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getOtherunits <em>Otherunits</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getRemap <em>Remap</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getRevision <em>Revision</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getRevisionflag <em>Revisionflag</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getUnits <em>Units</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getUserlevel <em>Userlevel</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getVendor <em>Vendor</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getWordsize <em>Wordsize</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AreaTypeImpl#getXreflabel <em>Xreflabel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AreaTypeImpl extends MinimalEObjectImpl.Container implements AreaType {
	 ...
	 * @ordered
	 */
	protected static final Object COORDS_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected Object coords = COORDS_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final UnitsType2 UNITS_EDEFAULT = UnitsType2.CALSPAIR;
	 ...
	 * @ordered
	 */
	protected UnitsType2 units = UNITS_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return DocbookPackage.eINSTANCE.getAreaType();
	}
	...
	public NotificationChain basicSetAlt(AltType newAlt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__ALT, oldAlt, newAlt);
	...
	public void setAlt(AltType newAlt) {
		if (newAlt != alt) {
			...
			if (alt != null)
				msgs = ((InternalEObject)alt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.AREA_TYPE__ALT, null, msgs);
			if (newAlt != null)
				msgs = ((InternalEObject)newAlt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.AREA_TYPE__ALT, null, msgs);
			msgs = basicSetAlt(newAlt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__ALT, newAlt, newAlt));
	}
	...
	public void setAnnotations(Object newAnnotations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__ANNOTATIONS, oldAnnotations, annotations));
	}
	...
	public void setArch(Object newArch) {
		...
		arch = newArch;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__ARCH, oldArch, arch));
	}
	...
	public void setAudience(Object newAudience) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__AUDIENCE, oldAudience, audience));
	}
	...
	public void setBase(Object newBase) {
		...
		base = newBase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__BASE, oldBase, base));
	}
	...
	public void setCondition(Object newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__CONDITION, oldCondition, condition));
	}
	...
	public void setConformance(Object newConformance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__CONFORMANCE, oldConformance, conformance));
	}
	...
	public void setCoords(Object newCoords) {
		...
		coords = newCoords;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__COORDS, oldCoords, coords));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.AREA_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__ID, oldId, id));
	}
	...
	public void setLabel(Object newLabel) {
		...
		label = newLabel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__LABEL, oldLabel, label));
	}
	...
	public void setLang(Object newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLinkends(List<String> newLinkends) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__LINKENDS, oldLinkends, linkends));
	}
	...
	public void setOs(Object newOs) {
		...
		os = newOs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__OS, oldOs, os));
	}
	...
	public void setOtherunits(String newOtherunits) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__OTHERUNITS, oldOtherunits, otherunits));
	}
	...
	public void setRemap(Object newRemap) {
		...
		remap = newRemap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__REMAP, oldRemap, remap));
	}
	...
	public void setRevision(Object newRevision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__REVISION, oldRevision, revision));
	}
	...
	public void setRevisionflag(RevisionflagType newRevisionflag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__REVISIONFLAG, oldRevisionflag, revisionflag, !oldRevisionflagESet));
	}
	...
	public void unsetRevisionflag() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.AREA_TYPE__REVISIONFLAG, oldRevisionflag, REVISIONFLAG_EDEFAULT, oldRevisionflagESet));
	}
	...
	public void setRole(Object newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__ROLE, oldRole, role));
	}
	...
	public void setSecurity(Object newSecurity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__SECURITY, oldSecurity, security));
	}
	 ...
	 */
	@Override
	public void setUnits(UnitsType2 newUnits) {
		UnitsType2 oldUnits = units;
		units = newUnits == null ? UNITS_EDEFAULT : newUnits;
		boolean oldUnitsESet = unitsESet;
		unitsESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__UNITS, oldUnits, units, !oldUnitsESet));
	}
	...
	public void unsetUnits() {
		...
		unitsESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.AREA_TYPE__UNITS, oldUnits, UNITS_EDEFAULT, oldUnitsESet));
	}
	...
	public void setUserlevel(Object newUserlevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__USERLEVEL, oldUserlevel, userlevel));
	}
	...
	public void setVendor(Object newVendor) {
		...
		vendor = newVendor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setVersion(Object newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__VERSION, oldVersion, version));
	}
	...
	public void setWordsize(Object newWordsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__WORDSIZE, oldWordsize, wordsize));
	}
	...
	public void setXreflabel(Object newXreflabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AREA_TYPE__XREFLABEL, oldXreflabel, xreflabel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DocbookPackage.AREA_TYPE__ALT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DocbookPackage.AREA_TYPE__ALT:
				return getAlt();
			case DocbookPackage.AREA_TYPE__ANNOTATIONS:
				return getAnnotations();
			case DocbookPackage.AREA_TYPE__ARCH:
				return getArch();
			case DocbookPackage.AREA_TYPE__AUDIENCE:
				return getAudience();
			case DocbookPackage.AREA_TYPE__BASE:
				return getBase();
			case DocbookPackage.AREA_TYPE__CONDITION:
				return getCondition();
			case DocbookPackage.AREA_TYPE__CONFORMANCE:
				return getConformance();
			case DocbookPackage.AREA_TYPE__COORDS:
				return getCoords();
			case DocbookPackage.AREA_TYPE__DIR:
				return getDir();
			case DocbookPackage.AREA_TYPE__ID:
				return getId();
			case DocbookPackage.AREA_TYPE__LABEL:
				return getLabel();
			case DocbookPackage.AREA_TYPE__LANG:
				return getLang();
			case DocbookPackage.AREA_TYPE__LINKENDS:
				return getLinkends();
			case DocbookPackage.AREA_TYPE__OS:
				return getOs();
			case DocbookPackage.AREA_TYPE__OTHERUNITS:
				return getOtherunits();
			case DocbookPackage.AREA_TYPE__REMAP:
				return getRemap();
			case DocbookPackage.AREA_TYPE__REVISION:
				return getRevision();
			case DocbookPackage.AREA_TYPE__REVISIONFLAG:
				return getRevisionflag();
			case DocbookPackage.AREA_TYPE__ROLE:
				return getRole();
			case DocbookPackage.AREA_TYPE__SECURITY:
				return getSecurity();
			case DocbookPackage.AREA_TYPE__UNITS:
				return getUnits();
			case DocbookPackage.AREA_TYPE__USERLEVEL:
				return getUserlevel();
			case DocbookPackage.AREA_TYPE__VENDOR:
				return getVendor();
			case DocbookPackage.AREA_TYPE__VERSION:
				return getVersion();
			case DocbookPackage.AREA_TYPE__WORDSIZE:
				return getWordsize();
			case DocbookPackage.AREA_TYPE__XREFLABEL:
				return getXreflabel();
		}
