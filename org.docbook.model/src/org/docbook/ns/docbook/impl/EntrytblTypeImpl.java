...
import org.docbook.ns.docbook.AlignType7;
import org.docbook.ns.docbook.ColsepType;
...
import org.docbook.ns.docbook.RowsepType3;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Entrytbl Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getColspec <em>Colspec</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getSpanspec <em>Spanspec</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getThead <em>Thead</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getTbody <em>Tbody</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getArch <em>Arch</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getAudience <em>Audience</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getChar <em>Char</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getCharoff <em>Charoff</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getColname <em>Colname</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getCols <em>Cols</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getColsep <em>Colsep</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getConformance <em>Conformance</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getLinkend <em>Linkend</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getNameend <em>Nameend</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getNamest <em>Namest</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getOs <em>Os</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getRemap <em>Remap</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getRevision <em>Revision</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getRevisionflag <em>Revisionflag</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getRole1 <em>Role1</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getRowsep <em>Rowsep</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getSpanname <em>Spanname</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getTgroupstyle <em>Tgroupstyle</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getUserlevel <em>Userlevel</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getVendor <em>Vendor</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getWordsize <em>Wordsize</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.EntrytblTypeImpl#getXreflabel <em>Xreflabel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntrytblTypeImpl extends MinimalEObjectImpl.Container implements EntrytblType {
	/**
	 ...
	 * @ordered
	 */
	protected static final ColsepType COLSEP_EDEFAULT = ColsepType._0;
	 ...
	 * @ordered
	 */
	protected ColsepType colsep = COLSEP_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final RowsepType3 ROWSEP_EDEFAULT = RowsepType3._0;
	 ...
	 * @ordered
	 */
	protected RowsepType3 rowsep = ROWSEP_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return DocbookPackage.eINSTANCE.getEntrytblType();
	}
	...
	public EList<ColspecType> getColspec() {
		if (colspec == null) {
			colspec = new EObjectContainmentEList<ColspecType>(ColspecType.class, this, DocbookPackage.ENTRYTBL_TYPE__COLSPEC);
		}
		return colspec;
	}
	...
	public EList<SpanspecType> getSpanspec() {
		if (spanspec == null) {
			spanspec = new EObjectContainmentEList<SpanspecType>(SpanspecType.class, this, DocbookPackage.ENTRYTBL_TYPE__SPANSPEC);
		}
		return spanspec;
	}
	...
	public NotificationChain basicSetThead(TheadType newThead, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__THEAD, oldThead, newThead);
	...
	public void setThead(TheadType newThead) {
		if (newThead != thead) {
			...
			if (thead != null)
				msgs = ((InternalEObject)thead).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.ENTRYTBL_TYPE__THEAD, null, msgs);
			if (newThead != null)
				msgs = ((InternalEObject)newThead).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.ENTRYTBL_TYPE__THEAD, null, msgs);
			msgs = basicSetThead(newThead, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__THEAD, newThead, newThead));
	}
	...
	public NotificationChain basicSetTbody(TbodyType newTbody, NotificationChain msgs) {
		...
		tbody = newTbody;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__TBODY, oldTbody, newTbody);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTbody(TbodyType newTbody) {
		if (newTbody != tbody) {
			NotificationChain msgs = null;
			if (tbody != null)
				msgs = ((InternalEObject)tbody).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.ENTRYTBL_TYPE__TBODY, null, msgs);
			if (newTbody != null)
				msgs = ((InternalEObject)newTbody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.ENTRYTBL_TYPE__TBODY, null, msgs);
			msgs = basicSetTbody(newTbody, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__TBODY, newTbody, newTbody));
	}
	...
	public void setActuate(ActuateType newActuate) {
		...
		actuateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__ACTUATE, oldActuate, actuate, !oldActuateESet));
	}
	...
	public void unsetActuate() {
		...
		actuateESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.ENTRYTBL_TYPE__ACTUATE, oldActuate, ACTUATE_EDEFAULT, oldActuateESet));
	}
	...
	public void setAlign(AlignType7 newAlign) {
		...
		alignESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__ALIGN, oldAlign, align, !oldAlignESet));
	}
	...
	public void unsetAlign() {
		...
		alignESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.ENTRYTBL_TYPE__ALIGN, oldAlign, ALIGN_EDEFAULT, oldAlignESet));
	}
	...
	public void setAnnotations(Object newAnnotations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__ANNOTATIONS, oldAnnotations, annotations));
	}
	...
	public void setArch(Object newArch) {
		...
		arch = newArch;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__ARCH, oldArch, arch));
	}
	...
	public void setArcrole(Object newArcrole) {
		...
		arcrole = newArcrole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__ARCROLE, oldArcrole, arcrole));
	}
	...
	public void setAudience(Object newAudience) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__AUDIENCE, oldAudience, audience));
	}
	...
	public void setBase(Object newBase) {
		...
		base = newBase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__BASE, oldBase, base));
	}
	...
	public void setChar(Object newChar) {
		...
		char_ = newChar;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__CHAR, oldChar, char_));
	}
	...
	public void setCharoff(Object newCharoff) {
		...
		charoff = newCharoff;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__CHAROFF, oldCharoff, charoff));
	}
	...
	public void setColname(Object newColname) {
		...
		colname = newColname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__COLNAME, oldColname, colname));
	}
	...
	public void setCols(String newCols) {
		...
		cols = newCols;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__COLS, oldCols, cols));
	}
	 ...
	 */
	@Override
	public void setColsep(ColsepType newColsep) {
		ColsepType oldColsep = colsep;
		colsep = newColsep == null ? COLSEP_EDEFAULT : newColsep;
		boolean oldColsepESet = colsepESet;
		colsepESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__COLSEP, oldColsep, colsep, !oldColsepESet));
	}
	...
	public void unsetColsep() {
		...
		colsepESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.ENTRYTBL_TYPE__COLSEP, oldColsep, COLSEP_EDEFAULT, oldColsepESet));
	}
	...
	public void setCondition(Object newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__CONDITION, oldCondition, condition));
	}
	...
	public void setConformance(Object newConformance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__CONFORMANCE, oldConformance, conformance));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.ENTRYTBL_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setHref(Object newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__HREF, oldHref, href));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__ID, oldId, id));
	}
	...
	public void setLang(Object newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLinkend(String newLinkend) {
		...
		linkend = newLinkend;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__LINKEND, oldLinkend, linkend));
	}
	...
	public void setNameend(Object newNameend) {
		...
		nameend = newNameend;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__NAMEEND, oldNameend, nameend));
	}
	...
	public void setNamest(Object newNamest) {
		...
		namest = newNamest;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__NAMEST, oldNamest, namest));
	}
	...
	public void setOs(Object newOs) {
		...
		os = newOs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__OS, oldOs, os));
	}
	...
	public void setRemap(Object newRemap) {
		...
		remap = newRemap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__REMAP, oldRemap, remap));
	}
	...
	public void setRevision(Object newRevision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__REVISION, oldRevision, revision));
	}
	...
	public void setRevisionflag(RevisionflagType newRevisionflag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__REVISIONFLAG, oldRevisionflag, revisionflag, !oldRevisionflagESet));
	}
	...
	public void unsetRevisionflag() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.ENTRYTBL_TYPE__REVISIONFLAG, oldRevisionflag, REVISIONFLAG_EDEFAULT, oldRevisionflagESet));
	}
	...
	public void setRole(Object newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__ROLE, oldRole, role));
	}
	...
	public void setRole1(Object newRole1) {
		...
		role1 = newRole1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__ROLE1, oldRole1, role1));
	}
	 ...
	 */
	@Override
	public void setRowsep(RowsepType3 newRowsep) {
		RowsepType3 oldRowsep = rowsep;
		rowsep = newRowsep == null ? ROWSEP_EDEFAULT : newRowsep;
		boolean oldRowsepESet = rowsepESet;
		rowsepESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__ROWSEP, oldRowsep, rowsep, !oldRowsepESet));
	}
	...
	public void unsetRowsep() {
		...
		rowsepESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.ENTRYTBL_TYPE__ROWSEP, oldRowsep, ROWSEP_EDEFAULT, oldRowsepESet));
	}
	...
	public void setSecurity(Object newSecurity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__SECURITY, oldSecurity, security));
	}
	...
	public void setShow(ShowType newShow) {
		...
		showESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__SHOW, oldShow, show, !oldShowESet));
	}
	...
	public void unsetShow() {
		...
		showESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.ENTRYTBL_TYPE__SHOW, oldShow, SHOW_EDEFAULT, oldShowESet));
	}
	...
	public void setSpanname(Object newSpanname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__SPANNAME, oldSpanname, spanname));
	}
	...
	public void setTgroupstyle(Object newTgroupstyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__TGROUPSTYLE, oldTgroupstyle, tgroupstyle));
	}
	...
	public void setTitle(Object newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setType(Object newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__TYPE, oldType, type));
	}
	...
	public void setUserlevel(Object newUserlevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__USERLEVEL, oldUserlevel, userlevel));
	}
	...
	public void setVendor(Object newVendor) {
		...
		vendor = newVendor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setVersion(Object newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__VERSION, oldVersion, version));
	}
	...
	public void setWordsize(Object newWordsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__WORDSIZE, oldWordsize, wordsize));
	}
	...
	public void setXreflabel(Object newXreflabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ENTRYTBL_TYPE__XREFLABEL, oldXreflabel, xreflabel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DocbookPackage.ENTRYTBL_TYPE__COLSPEC:
				return ((InternalEList<?>)getColspec()).basicRemove(otherEnd, msgs);
			case DocbookPackage.ENTRYTBL_TYPE__SPANSPEC:
				return ((InternalEList<?>)getSpanspec()).basicRemove(otherEnd, msgs);
			case DocbookPackage.ENTRYTBL_TYPE__THEAD:
				return basicSetThead(null, msgs);
			case DocbookPackage.ENTRYTBL_TYPE__TBODY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DocbookPackage.ENTRYTBL_TYPE__TBODY:
				return getTbody();
			case DocbookPackage.ENTRYTBL_TYPE__ACTUATE:
				return getActuate();
			case DocbookPackage.ENTRYTBL_TYPE__ALIGN:
				return getAlign();
			case DocbookPackage.ENTRYTBL_TYPE__ANNOTATIONS:
				return getAnnotations();
			case DocbookPackage.ENTRYTBL_TYPE__ARCH:
				return getArch();
			case DocbookPackage.ENTRYTBL_TYPE__ARCROLE:
				return getArcrole();
			case DocbookPackage.ENTRYTBL_TYPE__AUDIENCE:
				return getAudience();
			case DocbookPackage.ENTRYTBL_TYPE__BASE:
				return getBase();
			case DocbookPackage.ENTRYTBL_TYPE__CHAR:
				return getChar();
			case DocbookPackage.ENTRYTBL_TYPE__CHAROFF:
				return getCharoff();
			case DocbookPackage.ENTRYTBL_TYPE__COLNAME:
				return getColname();
			case DocbookPackage.ENTRYTBL_TYPE__COLS:
				return getCols();
			case DocbookPackage.ENTRYTBL_TYPE__COLSEP:
				return getColsep();
			case DocbookPackage.ENTRYTBL_TYPE__CONDITION:
				return getCondition();
			case DocbookPackage.ENTRYTBL_TYPE__CONFORMANCE:
				return getConformance();
			case DocbookPackage.ENTRYTBL_TYPE__DIR:
				return getDir();
			case DocbookPackage.ENTRYTBL_TYPE__HREF:
				return getHref();
			case DocbookPackage.ENTRYTBL_TYPE__ID:
				return getId();
			case DocbookPackage.ENTRYTBL_TYPE__LANG:
				return getLang();
			case DocbookPackage.ENTRYTBL_TYPE__LINKEND:
				return getLinkend();
			case DocbookPackage.ENTRYTBL_TYPE__NAMEEND:
				return getNameend();
			case DocbookPackage.ENTRYTBL_TYPE__NAMEST:
				return getNamest();
			case DocbookPackage.ENTRYTBL_TYPE__OS:
				return getOs();
			case DocbookPackage.ENTRYTBL_TYPE__REMAP:
				return getRemap();
			case DocbookPackage.ENTRYTBL_TYPE__REVISION:
				return getRevision();
			case DocbookPackage.ENTRYTBL_TYPE__REVISIONFLAG:
				return getRevisionflag();
			case DocbookPackage.ENTRYTBL_TYPE__ROLE:
				return getRole();
			case DocbookPackage.ENTRYTBL_TYPE__ROLE1:
				return getRole1();
			case DocbookPackage.ENTRYTBL_TYPE__ROWSEP:
				return getRowsep();
			case DocbookPackage.ENTRYTBL_TYPE__SECURITY:
				return getSecurity();
			case DocbookPackage.ENTRYTBL_TYPE__SHOW:
				return getShow();
			case DocbookPackage.ENTRYTBL_TYPE__SPANNAME:
				return getSpanname();
			case DocbookPackage.ENTRYTBL_TYPE__TGROUPSTYLE:
				return getTgroupstyle();
			case DocbookPackage.ENTRYTBL_TYPE__TITLE:
				return getTitle();
			case DocbookPackage.ENTRYTBL_TYPE__TYPE:
				return getType();
			case DocbookPackage.ENTRYTBL_TYPE__USERLEVEL:
				return getUserlevel();
			case DocbookPackage.ENTRYTBL_TYPE__VENDOR:
				return getVendor();
			case DocbookPackage.ENTRYTBL_TYPE__VERSION:
				return getVersion();
			case DocbookPackage.ENTRYTBL_TYPE__WORDSIZE:
				return getWordsize();
			case DocbookPackage.ENTRYTBL_TYPE__XREFLABEL:
				return getXreflabel();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DocbookPackage.ENTRYTBL_TYPE__ROLE1:
				...
				return;
			case DocbookPackage.ENTRYTBL_TYPE__ROWSEP:
				setRowsep((RowsepType3)newValue);
				return;
			case DocbookPackage.ENTRYTBL_TYPE__SECURITY:
