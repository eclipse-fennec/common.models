 ...
 * </p>
 * <ul>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getRevnumber <em>Revnumber</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getDate <em>Date</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getAuthorinitials <em>Authorinitials</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getRevremark <em>Revremark</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getRevdescription <em>Revdescription</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getArch <em>Arch</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getAudience <em>Audience</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getConformance <em>Conformance</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getLinkend <em>Linkend</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getOs <em>Os</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getRemap <em>Remap</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getRevision <em>Revision</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getRevisionflag <em>Revisionflag</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getRole1 <em>Role1</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getUserlevel <em>Userlevel</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getVendor <em>Vendor</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getWordsize <em>Wordsize</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.RevisionTypeImpl#getXreflabel <em>Xreflabel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RevisionTypeImpl extends MinimalEObjectImpl.Container implements RevisionType {
	/**
	...
	/**
	 * The cached value of the '{@link #getRevremark() <em>Revremark</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRevremark()
	 * @generated
	 * @ordered
	 */
	protected RevremarkType revremark;
	...
	protected EClass eStaticClass() {
		return DocbookPackage.eINSTANCE.getRevisionType();
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, DocbookPackage.REVISION_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<AuthorinitialsType> getAuthorinitials() {
		return getGroup().list(DocbookPackage.eINSTANCE.getRevisionType_Authorinitials());
	}
	...
	public EList<AuthorType> getAuthor() {
		return getGroup().list(DocbookPackage.eINSTANCE.getRevisionType_Author());
	}
	...
	public NotificationChain basicSetRevremark(RevremarkType newRevremark, NotificationChain msgs) {
		RevremarkType oldRevremark = revremark;
		revremark = newRevremark;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__REVREMARK, oldRevremark, newRevremark);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRevremark(RevremarkType newRevremark) {
		if (newRevremark != revremark) {
			NotificationChain msgs = null;
			if (revremark != null)
				msgs = ((InternalEObject)revremark).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.REVISION_TYPE__REVREMARK, null, msgs);
			if (newRevremark != null)
				msgs = ((InternalEObject)newRevremark).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.REVISION_TYPE__REVREMARK, null, msgs);
			msgs = basicSetRevremark(newRevremark, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__REVREMARK, newRevremark, newRevremark));
	}
	...
	public void setActuate(ActuateType newActuate) {
		...
		actuateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__ACTUATE, oldActuate, actuate, !oldActuateESet));
	}
	...
	public void unsetActuate() {
		...
		actuateESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.REVISION_TYPE__ACTUATE, oldActuate, ACTUATE_EDEFAULT, oldActuateESet));
	}
	...
	public void setAnnotations(Object newAnnotations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__ANNOTATIONS, oldAnnotations, annotations));
	}
	...
	public void setArch(Object newArch) {
		...
		arch = newArch;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__ARCH, oldArch, arch));
	}
	...
	public void setArcrole(Object newArcrole) {
		...
		arcrole = newArcrole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__ARCROLE, oldArcrole, arcrole));
	}
	...
	public void setAudience(Object newAudience) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__AUDIENCE, oldAudience, audience));
	}
	...
	public void setBase(Object newBase) {
		...
		base = newBase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__BASE, oldBase, base));
	}
	...
	public void setCondition(Object newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__CONDITION, oldCondition, condition));
	}
	...
	public void setConformance(Object newConformance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__CONFORMANCE, oldConformance, conformance));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.REVISION_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setHref(Object newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__HREF, oldHref, href));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__ID, oldId, id));
	}
	...
	public void setLang(Object newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLinkend(String newLinkend) {
		...
		linkend = newLinkend;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__LINKEND, oldLinkend, linkend));
	}
	...
	public void setOs(Object newOs) {
		...
		os = newOs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__OS, oldOs, os));
	}
	...
	public void setRemap(Object newRemap) {
		...
		remap = newRemap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__REMAP, oldRemap, remap));
	}
	...
	public void setRevision(Object newRevision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__REVISION, oldRevision, revision));
	}
	...
	public void setRevisionflag(RevisionflagType newRevisionflag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__REVISIONFLAG, oldRevisionflag, revisionflag, !oldRevisionflagESet));
	}
	...
	public void unsetRevisionflag() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.REVISION_TYPE__REVISIONFLAG, oldRevisionflag, REVISIONFLAG_EDEFAULT, oldRevisionflagESet));
	}
	...
	public void setRole(Object newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__ROLE, oldRole, role));
	}
	...
	public void setRole1(Object newRole1) {
		...
		role1 = newRole1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__ROLE1, oldRole1, role1));
	}
	...
	public void setSecurity(Object newSecurity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__SECURITY, oldSecurity, security));
	}
	...
	public void setShow(ShowType newShow) {
		...
		showESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__SHOW, oldShow, show, !oldShowESet));
	}
	...
	public void unsetShow() {
		...
		showESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.REVISION_TYPE__SHOW, oldShow, SHOW_EDEFAULT, oldShowESet));
	}
	...
	public void setTitle(Object newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setType(Object newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__TYPE, oldType, type));
	}
	...
	public void setUserlevel(Object newUserlevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__USERLEVEL, oldUserlevel, userlevel));
	}
	...
	public void setVendor(Object newVendor) {
		...
		vendor = newVendor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setVersion(Object newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__VERSION, oldVersion, version));
	}
	...
	public void setWordsize(Object newWordsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__WORDSIZE, oldWordsize, wordsize));
	}
	...
	public void setXreflabel(Object newXreflabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REVISION_TYPE__XREFLABEL, oldXreflabel, xreflabel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case DocbookPackage.REVISION_TYPE__GROUP:
			...
			case DocbookPackage.REVISION_TYPE__AUTHOR:
				return ((InternalEList<?>)getAuthor()).basicRemove(otherEnd, msgs);
			case DocbookPackage.REVISION_TYPE__REVREMARK:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DocbookPackage.REVISION_TYPE__ACTUATE:
				return getActuate();
			case DocbookPackage.REVISION_TYPE__ANNOTATIONS:
				return getAnnotations();
			case DocbookPackage.REVISION_TYPE__ARCH:
				return getArch();
			case DocbookPackage.REVISION_TYPE__ARCROLE:
				return getArcrole();
			case DocbookPackage.REVISION_TYPE__AUDIENCE:
				return getAudience();
			case DocbookPackage.REVISION_TYPE__BASE:
				return getBase();
			case DocbookPackage.REVISION_TYPE__CONDITION:
				return getCondition();
			case DocbookPackage.REVISION_TYPE__CONFORMANCE:
				return getConformance();
			case DocbookPackage.REVISION_TYPE__DIR:
				return getDir();
			case DocbookPackage.REVISION_TYPE__HREF:
				return getHref();
			case DocbookPackage.REVISION_TYPE__ID:
				return getId();
			case DocbookPackage.REVISION_TYPE__LANG:
				return getLang();
			case DocbookPackage.REVISION_TYPE__LINKEND:
				return getLinkend();
			case DocbookPackage.REVISION_TYPE__OS:
				return getOs();
			case DocbookPackage.REVISION_TYPE__REMAP:
				return getRemap();
			case DocbookPackage.REVISION_TYPE__REVISION:
				return getRevision();
			case DocbookPackage.REVISION_TYPE__REVISIONFLAG:
				return getRevisionflag();
			case DocbookPackage.REVISION_TYPE__ROLE:
				return getRole();
			case DocbookPackage.REVISION_TYPE__ROLE1:
				return getRole1();
			case DocbookPackage.REVISION_TYPE__SECURITY:
				return getSecurity();
			case DocbookPackage.REVISION_TYPE__SHOW:
				return getShow();
			case DocbookPackage.REVISION_TYPE__TITLE:
				return getTitle();
			case DocbookPackage.REVISION_TYPE__TYPE:
				return getType();
			case DocbookPackage.REVISION_TYPE__USERLEVEL:
				return getUserlevel();
			case DocbookPackage.REVISION_TYPE__VENDOR:
				return getVendor();
			case DocbookPackage.REVISION_TYPE__VERSION:
				return getVersion();
			case DocbookPackage.REVISION_TYPE__WORDSIZE:
				return getWordsize();
			case DocbookPackage.REVISION_TYPE__XREFLABEL:
				return getXreflabel();
		}
