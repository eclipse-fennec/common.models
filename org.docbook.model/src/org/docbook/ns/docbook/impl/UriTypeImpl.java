 ...
 * </p>
 * <ul>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getInlinemediaobject <em>Inlinemediaobject</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getRemark <em>Remark</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getSuperscript <em>Superscript</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getSubscript <em>Subscript</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getXref <em>Xref</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getLink <em>Link</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getOlink <em>Olink</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getAnchor <em>Anchor</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getBiblioref <em>Biblioref</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getAlt <em>Alt</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getIndexterm <em>Indexterm</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getPhrase <em>Phrase</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getReplaceable <em>Replaceable</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getArch <em>Arch</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getAudience <em>Audience</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getConformance <em>Conformance</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getLinkend <em>Linkend</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getOs <em>Os</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getRemap <em>Remap</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getRevision <em>Revision</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getRevisionflag <em>Revisionflag</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getRole1 <em>Role1</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getType1 <em>Type1</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getUserlevel <em>Userlevel</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getVendor <em>Vendor</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getWordsize <em>Wordsize</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.UriTypeImpl#getXreflabel <em>Xreflabel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UriTypeImpl extends MinimalEObjectImpl.Container implements UriType {
	...
	protected EClass eStaticClass() {
		return DocbookPackage.eINSTANCE.getUriType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, DocbookPackage.URI_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public FeatureMap getGroup() {
		return (FeatureMap)getMixed().<FeatureMap.Entry>list(DocbookPackage.eINSTANCE.getUriType_Group());
	}
	...
	public EList<InlinemediaobjectType> getInlinemediaobject() {
		return getGroup().list(DocbookPackage.eINSTANCE.getUriType_Inlinemediaobject());
	}
	...
	public EList<RemarkType> getRemark() {
		return getGroup().list(DocbookPackage.eINSTANCE.getUriType_Remark());
	}
	...
	public EList<SuperscriptType> getSuperscript() {
		return getGroup().list(DocbookPackage.eINSTANCE.getUriType_Superscript());
	}
	...
	public EList<SubscriptType> getSubscript() {
		return getGroup().list(DocbookPackage.eINSTANCE.getUriType_Subscript());
	}
	...
	public EList<XrefType> getXref() {
		return getGroup().list(DocbookPackage.eINSTANCE.getUriType_Xref());
	}
	...
	public EList<LinkType> getLink() {
		return getGroup().list(DocbookPackage.eINSTANCE.getUriType_Link());
	}
	...
	public EList<OlinkType> getOlink() {
		return getGroup().list(DocbookPackage.eINSTANCE.getUriType_Olink());
	}
	...
	public EList<AnchorType> getAnchor() {
		return getGroup().list(DocbookPackage.eINSTANCE.getUriType_Anchor());
	}
	...
	public EList<BibliorefType> getBiblioref() {
		return getGroup().list(DocbookPackage.eINSTANCE.getUriType_Biblioref());
	}
	...
	public EList<AltType> getAlt() {
		return getGroup().list(DocbookPackage.eINSTANCE.getUriType_Alt());
	}
	...
	public EList<AnnotationType> getAnnotation() {
		return getGroup().list(DocbookPackage.eINSTANCE.getUriType_Annotation());
	}
	...
	public EList<IndextermType> getIndexterm() {
		return getGroup().list(DocbookPackage.eINSTANCE.getUriType_Indexterm());
	}
	...
	public EList<PhraseType> getPhrase() {
		return getGroup().list(DocbookPackage.eINSTANCE.getUriType_Phrase());
	}
	...
	public EList<ReplaceableType> getReplaceable() {
		return getGroup().list(DocbookPackage.eINSTANCE.getUriType_Replaceable());
	}
	...
	public void setActuate(ActuateType newActuate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__ACTUATE, oldActuate, actuate, !oldActuateESet));
	}
	...
	public void unsetActuate() {
		...
		actuateESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.URI_TYPE__ACTUATE, oldActuate, ACTUATE_EDEFAULT, oldActuateESet));
	}
	...
	public void setAnnotations(Object newAnnotations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__ANNOTATIONS, oldAnnotations, annotations));
	}
	...
	public void setArch(Object newArch) {
		...
		arch = newArch;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__ARCH, oldArch, arch));
	}
	...
	public void setArcrole(Object newArcrole) {
		...
		arcrole = newArcrole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__ARCROLE, oldArcrole, arcrole));
	}
	...
	public void setAudience(Object newAudience) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__AUDIENCE, oldAudience, audience));
	}
	...
	public void setBase(Object newBase) {
		...
		base = newBase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__BASE, oldBase, base));
	}
	...
	public void setCondition(Object newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__CONDITION, oldCondition, condition));
	}
	...
	public void setConformance(Object newConformance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__CONFORMANCE, oldConformance, conformance));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.URI_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setHref(Object newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__HREF, oldHref, href));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__ID, oldId, id));
	}
	...
	public void setLang(Object newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLinkend(String newLinkend) {
		...
		linkend = newLinkend;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__LINKEND, oldLinkend, linkend));
	}
	...
	public void setOs(Object newOs) {
		...
		os = newOs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__OS, oldOs, os));
	}
	...
	public void setRemap(Object newRemap) {
		...
		remap = newRemap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__REMAP, oldRemap, remap));
	}
	...
	public void setRevision(Object newRevision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__REVISION, oldRevision, revision));
	}
	...
	public void setRevisionflag(RevisionflagType newRevisionflag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__REVISIONFLAG, oldRevisionflag, revisionflag, !oldRevisionflagESet));
	}
	...
	public void unsetRevisionflag() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.URI_TYPE__REVISIONFLAG, oldRevisionflag, REVISIONFLAG_EDEFAULT, oldRevisionflagESet));
	}
	...
	public void setRole(Object newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__ROLE, oldRole, role));
	}
	...
	public void setRole1(Object newRole1) {
		...
		role1 = newRole1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__ROLE1, oldRole1, role1));
	}
	...
	public void setSecurity(Object newSecurity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__SECURITY, oldSecurity, security));
	}
	...
	public void setShow(ShowType newShow) {
		...
		showESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__SHOW, oldShow, show, !oldShowESet));
	}
	...
	public void unsetShow() {
		...
		showESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.URI_TYPE__SHOW, oldShow, SHOW_EDEFAULT, oldShowESet));
	}
	...
	public void setTitle(Object newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setType(Object newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__TYPE, oldType, type));
	}
	...
	public void setType1(Object newType1) {
		...
		type1 = newType1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__TYPE1, oldType1, type1));
	}
	...
	public void setUserlevel(Object newUserlevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__USERLEVEL, oldUserlevel, userlevel));
	}
	...
	public void setVendor(Object newVendor) {
		...
		vendor = newVendor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setVersion(Object newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__VERSION, oldVersion, version));
	}
	...
	public void setWordsize(Object newWordsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__WORDSIZE, oldWordsize, wordsize));
	}
	...
	public void setXreflabel(Object newXreflabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.URI_TYPE__XREFLABEL, oldXreflabel, xreflabel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DocbookPackage.URI_TYPE__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__INLINEMEDIAOBJECT:
				return ((InternalEList<?>)getInlinemediaobject()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__REMARK:
				return ((InternalEList<?>)getRemark()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__SUPERSCRIPT:
				return ((InternalEList<?>)getSuperscript()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__SUBSCRIPT:
				return ((InternalEList<?>)getSubscript()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__XREF:
				return ((InternalEList<?>)getXref()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__LINK:
				return ((InternalEList<?>)getLink()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__OLINK:
				return ((InternalEList<?>)getOlink()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__ANCHOR:
				return ((InternalEList<?>)getAnchor()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__BIBLIOREF:
				return ((InternalEList<?>)getBiblioref()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__ALT:
				return ((InternalEList<?>)getAlt()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__ANNOTATION:
				return ((InternalEList<?>)getAnnotation()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__INDEXTERM:
				return ((InternalEList<?>)getIndexterm()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__PHRASE:
				return ((InternalEList<?>)getPhrase()).basicRemove(otherEnd, msgs);
			case DocbookPackage.URI_TYPE__REPLACEABLE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DocbookPackage.URI_TYPE__ACTUATE:
				return getActuate();
			case DocbookPackage.URI_TYPE__ANNOTATIONS:
				return getAnnotations();
			case DocbookPackage.URI_TYPE__ARCH:
				return getArch();
			case DocbookPackage.URI_TYPE__ARCROLE:
				return getArcrole();
			case DocbookPackage.URI_TYPE__AUDIENCE:
				return getAudience();
			case DocbookPackage.URI_TYPE__BASE:
				return getBase();
			case DocbookPackage.URI_TYPE__CONDITION:
				return getCondition();
			case DocbookPackage.URI_TYPE__CONFORMANCE:
				return getConformance();
			case DocbookPackage.URI_TYPE__DIR:
				return getDir();
			case DocbookPackage.URI_TYPE__HREF:
				return getHref();
			case DocbookPackage.URI_TYPE__ID:
				return getId();
			case DocbookPackage.URI_TYPE__LANG:
				return getLang();
			case DocbookPackage.URI_TYPE__LINKEND:
				return getLinkend();
			case DocbookPackage.URI_TYPE__OS:
				return getOs();
			case DocbookPackage.URI_TYPE__REMAP:
				return getRemap();
			case DocbookPackage.URI_TYPE__REVISION:
				return getRevision();
			case DocbookPackage.URI_TYPE__REVISIONFLAG:
				return getRevisionflag();
			case DocbookPackage.URI_TYPE__ROLE:
				return getRole();
			case DocbookPackage.URI_TYPE__ROLE1:
				return getRole1();
			case DocbookPackage.URI_TYPE__SECURITY:
				return getSecurity();
			case DocbookPackage.URI_TYPE__SHOW:
				return getShow();
			case DocbookPackage.URI_TYPE__TITLE:
				return getTitle();
			case DocbookPackage.URI_TYPE__TYPE:
				return getType();
			case DocbookPackage.URI_TYPE__TYPE1:
				return getType1();
			case DocbookPackage.URI_TYPE__USERLEVEL:
				return getUserlevel();
			case DocbookPackage.URI_TYPE__VENDOR:
				return getVendor();
			case DocbookPackage.URI_TYPE__VERSION:
				return getVersion();
			case DocbookPackage.URI_TYPE__WORDSIZE:
				return getWordsize();
			case DocbookPackage.URI_TYPE__XREFLABEL:
				return getXreflabel();
		}
