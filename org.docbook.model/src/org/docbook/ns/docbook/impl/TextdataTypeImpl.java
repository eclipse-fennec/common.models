...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Textdata Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getInfo <em>Info</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getArch <em>Arch</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getAudience <em>Audience</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getConformance <em>Conformance</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getEncoding <em>Encoding</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getEntityref <em>Entityref</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getFileref <em>Fileref</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getOs <em>Os</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getRemap <em>Remap</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getRevision <em>Revision</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getRevisionflag <em>Revisionflag</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getUserlevel <em>Userlevel</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getVendor <em>Vendor</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getWordsize <em>Wordsize</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.TextdataTypeImpl#getXreflabel <em>Xreflabel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextdataTypeImpl extends MinimalEObjectImpl.Container implements TextdataType {
	/**
	...
	protected EClass eStaticClass() {
		return DocbookPackage.eINSTANCE.getTextdataType();
	}
	...
	public NotificationChain basicSetInfo(InfoType newInfo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__INFO, oldInfo, newInfo);
	...
	public void setInfo(InfoType newInfo) {
		if (newInfo != info) {
			...
			if (info != null)
				msgs = ((InternalEObject)info).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.TEXTDATA_TYPE__INFO, null, msgs);
			if (newInfo != null)
				msgs = ((InternalEObject)newInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.TEXTDATA_TYPE__INFO, null, msgs);
			msgs = basicSetInfo(newInfo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__INFO, newInfo, newInfo));
	}
	...
	public void setAnnotations(Object newAnnotations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__ANNOTATIONS, oldAnnotations, annotations));
	}
	...
	public void setArch(Object newArch) {
		...
		arch = newArch;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__ARCH, oldArch, arch));
	}
	...
	public void setAudience(Object newAudience) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__AUDIENCE, oldAudience, audience));
	}
	...
	public void setBase(Object newBase) {
		...
		base = newBase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__BASE, oldBase, base));
	}
	...
	public void setCondition(Object newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__CONDITION, oldCondition, condition));
	}
	...
	public void setConformance(Object newConformance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__CONFORMANCE, oldConformance, conformance));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.TEXTDATA_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setEncoding(Object newEncoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__ENCODING, oldEncoding, encoding));
	}
	...
	public void setEntityref(String newEntityref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__ENTITYREF, oldEntityref, entityref));
	}
	...
	public void setFileref(Object newFileref) {
		...
		fileref = newFileref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__FILEREF, oldFileref, fileref));
	}
	...
	public void setFormat(Object newFormat) {
		...
		format = newFormat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__FORMAT, oldFormat, format));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__ID, oldId, id));
	}
	...
	public void setLang(Object newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__LANG, oldLang, lang));
	}
	...
	public void setOs(Object newOs) {
		...
		os = newOs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__OS, oldOs, os));
	}
	...
	public void setRemap(Object newRemap) {
		...
		remap = newRemap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__REMAP, oldRemap, remap));
	}
	...
	public void setRevision(Object newRevision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__REVISION, oldRevision, revision));
	}
	...
	public void setRevisionflag(RevisionflagType newRevisionflag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__REVISIONFLAG, oldRevisionflag, revisionflag, !oldRevisionflagESet));
	}
	...
	public void unsetRevisionflag() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.TEXTDATA_TYPE__REVISIONFLAG, oldRevisionflag, REVISIONFLAG_EDEFAULT, oldRevisionflagESet));
	}
	...
	public void setRole(Object newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__ROLE, oldRole, role));
	}
	...
	public void setSecurity(Object newSecurity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__SECURITY, oldSecurity, security));
	}
	...
	public void setUserlevel(Object newUserlevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__USERLEVEL, oldUserlevel, userlevel));
	}
	...
	public void setVendor(Object newVendor) {
		...
		vendor = newVendor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setVersion(Object newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__VERSION, oldVersion, version));
	}
	...
	public void setWordsize(Object newWordsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__WORDSIZE, oldWordsize, wordsize));
	}
	...
	public void setXreflabel(Object newXreflabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.TEXTDATA_TYPE__XREFLABEL, oldXreflabel, xreflabel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DocbookPackage.TEXTDATA_TYPE__INFO:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DocbookPackage.TEXTDATA_TYPE__INFO:
				return getInfo();
			case DocbookPackage.TEXTDATA_TYPE__ANNOTATIONS:
				return getAnnotations();
			case DocbookPackage.TEXTDATA_TYPE__ARCH:
				return getArch();
			case DocbookPackage.TEXTDATA_TYPE__AUDIENCE:
				return getAudience();
			case DocbookPackage.TEXTDATA_TYPE__BASE:
				return getBase();
			case DocbookPackage.TEXTDATA_TYPE__CONDITION:
				return getCondition();
			case DocbookPackage.TEXTDATA_TYPE__CONFORMANCE:
				return getConformance();
			case DocbookPackage.TEXTDATA_TYPE__DIR:
				return getDir();
			case DocbookPackage.TEXTDATA_TYPE__ENCODING:
				return getEncoding();
			case DocbookPackage.TEXTDATA_TYPE__ENTITYREF:
				return getEntityref();
			case DocbookPackage.TEXTDATA_TYPE__FILEREF:
				return getFileref();
			case DocbookPackage.TEXTDATA_TYPE__FORMAT:
				return getFormat();
			case DocbookPackage.TEXTDATA_TYPE__ID:
				return getId();
			case DocbookPackage.TEXTDATA_TYPE__LANG:
				return getLang();
			case DocbookPackage.TEXTDATA_TYPE__OS:
				return getOs();
			case DocbookPackage.TEXTDATA_TYPE__REMAP:
				return getRemap();
			case DocbookPackage.TEXTDATA_TYPE__REVISION:
				return getRevision();
			case DocbookPackage.TEXTDATA_TYPE__REVISIONFLAG:
				return getRevisionflag();
			case DocbookPackage.TEXTDATA_TYPE__ROLE:
				return getRole();
			case DocbookPackage.TEXTDATA_TYPE__SECURITY:
				return getSecurity();
			case DocbookPackage.TEXTDATA_TYPE__USERLEVEL:
				return getUserlevel();
			case DocbookPackage.TEXTDATA_TYPE__VENDOR:
				return getVendor();
			case DocbookPackage.TEXTDATA_TYPE__VERSION:
				return getVersion();
			case DocbookPackage.TEXTDATA_TYPE__WORDSIZE:
				return getWordsize();
			case DocbookPackage.TEXTDATA_TYPE__XREFLABEL:
				return getXreflabel();
		}
