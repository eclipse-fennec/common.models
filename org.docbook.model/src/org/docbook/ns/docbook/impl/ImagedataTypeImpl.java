...
import org.docbook.ns.docbook.AlignType13;
...
import org.docbook.ns.docbook.ScalefitType;
import org.docbook.ns.docbook.ValignType6;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getInfo <em>Info</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getArch <em>Arch</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getAudience <em>Audience</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getConformance <em>Conformance</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getContentdepth <em>Contentdepth</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getContentwidth <em>Contentwidth</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getDepth <em>Depth</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getEntityref <em>Entityref</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getFileref <em>Fileref</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getOs <em>Os</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getRemap <em>Remap</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getRevision <em>Revision</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getRevisionflag <em>Revisionflag</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getScale <em>Scale</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getScalefit <em>Scalefit</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getUserlevel <em>Userlevel</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getValign <em>Valign</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getVendor <em>Vendor</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getWordsize <em>Wordsize</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ImagedataTypeImpl#getXreflabel <em>Xreflabel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImagedataTypeImpl extends MinimalEObjectImpl.Container implements ImagedataType {
	/**
	 ...
	 * @ordered
	 */
	protected static final AlignType13 ALIGN_EDEFAULT = AlignType13.CENTER;
	 ...
	 * @ordered
	 */
	protected AlignType13 align = ALIGN_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final ScalefitType SCALEFIT_EDEFAULT = ScalefitType._0;
	 ...
	 * @ordered
	 */
	protected ScalefitType scalefit = SCALEFIT_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final ValignType6 VALIGN_EDEFAULT = ValignType6.BOTTOM;
	...
	protected EClass eStaticClass() {
		return DocbookPackage.eINSTANCE.getImagedataType();
	}
	...
	public NotificationChain basicSetInfo(InfoType newInfo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__INFO, oldInfo, newInfo);
	...
	public void setInfo(InfoType newInfo) {
		if (newInfo != info) {
			...
			if (info != null)
				msgs = ((InternalEObject)info).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.IMAGEDATA_TYPE__INFO, null, msgs);
			if (newInfo != null)
				msgs = ((InternalEObject)newInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.IMAGEDATA_TYPE__INFO, null, msgs);
			msgs = basicSetInfo(newInfo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__INFO, newInfo, newInfo));
	}
	 ...
	 */
	@Override
	public void setAlign(AlignType13 newAlign) {
		AlignType13 oldAlign = align;
		align = newAlign == null ? ALIGN_EDEFAULT : newAlign;
		boolean oldAlignESet = alignESet;
		alignESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__ALIGN, oldAlign, align, !oldAlignESet));
	}
	...
	public void unsetAlign() {
		...
		alignESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.IMAGEDATA_TYPE__ALIGN, oldAlign, ALIGN_EDEFAULT, oldAlignESet));
	}
	...
	public void setAnnotations(Object newAnnotations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__ANNOTATIONS, oldAnnotations, annotations));
	}
	...
	public void setArch(Object newArch) {
		...
		arch = newArch;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__ARCH, oldArch, arch));
	}
	...
	public void setAudience(Object newAudience) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__AUDIENCE, oldAudience, audience));
	}
	...
	public void setBase(Object newBase) {
		...
		base = newBase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__BASE, oldBase, base));
	}
	...
	public void setCondition(Object newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__CONDITION, oldCondition, condition));
	}
	...
	public void setConformance(Object newConformance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__CONFORMANCE, oldConformance, conformance));
	}
	...
	public void setContentdepth(Object newContentdepth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__CONTENTDEPTH, oldContentdepth, contentdepth));
	}
	...
	public void setContentwidth(Object newContentwidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__CONTENTWIDTH, oldContentwidth, contentwidth));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.IMAGEDATA_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setEntityref(String newEntityref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__ENTITYREF, oldEntityref, entityref));
	}
	...
	public void setFormat(Object newFormat) {
		...
		format = newFormat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__FORMAT, oldFormat, format));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__ID, oldId, id));
	}
	...
	public void setLang(Object newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__LANG, oldLang, lang));
	}
	...
	public void setOs(Object newOs) {
		...
		os = newOs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__OS, oldOs, os));
	}
	...
	public void setRemap(Object newRemap) {
		...
		remap = newRemap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__REMAP, oldRemap, remap));
	}
	...
	public void setRevision(Object newRevision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__REVISION, oldRevision, revision));
	}
	...
	public void setRevisionflag(RevisionflagType newRevisionflag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__REVISIONFLAG, oldRevisionflag, revisionflag, !oldRevisionflagESet));
	}
	...
	public void unsetRevisionflag() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.IMAGEDATA_TYPE__REVISIONFLAG, oldRevisionflag, REVISIONFLAG_EDEFAULT, oldRevisionflagESet));
	}
	...
	public void setRole(Object newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__ROLE, oldRole, role));
	}
	 ...
	 */
	@Override
	public ScalefitType getScalefit() {
		return scalefit;
	}
	 ...
	 */
	@Override
	public void setScalefit(ScalefitType newScalefit) {
		ScalefitType oldScalefit = scalefit;
		scalefit = newScalefit == null ? SCALEFIT_EDEFAULT : newScalefit;
		boolean oldScalefitESet = scalefitESet;
		scalefitESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__SCALEFIT, oldScalefit, scalefit, !oldScalefitESet));
	}
	...
	public void unsetScalefit() {
		...
		scalefitESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.IMAGEDATA_TYPE__SCALEFIT, oldScalefit, SCALEFIT_EDEFAULT, oldScalefitESet));
	}
	...
	public void setSecurity(Object newSecurity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__SECURITY, oldSecurity, security));
	}
	...
	public void setUserlevel(Object newUserlevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__USERLEVEL, oldUserlevel, userlevel));
	}
	...
	public void setValign(ValignType6 newValign) {
		...
		valignESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__VALIGN, oldValign, valign, !oldValignESet));
	}
	...
	public void unsetValign() {
		...
		valignESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.IMAGEDATA_TYPE__VALIGN, oldValign, VALIGN_EDEFAULT, oldValignESet));
	}
	...
	public void setVendor(Object newVendor) {
		...
		vendor = newVendor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setVersion(Object newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__VERSION, oldVersion, version));
	}
	...
	public void setWordsize(Object newWordsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__WORDSIZE, oldWordsize, wordsize));
	}
	...
	public void setXreflabel(Object newXreflabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.IMAGEDATA_TYPE__XREFLABEL, oldXreflabel, xreflabel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DocbookPackage.IMAGEDATA_TYPE__INFO:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DocbookPackage.IMAGEDATA_TYPE__ALIGN:
				return getAlign();
			case DocbookPackage.IMAGEDATA_TYPE__ANNOTATIONS:
				return getAnnotations();
			case DocbookPackage.IMAGEDATA_TYPE__ARCH:
				return getArch();
			case DocbookPackage.IMAGEDATA_TYPE__AUDIENCE:
				return getAudience();
			case DocbookPackage.IMAGEDATA_TYPE__BASE:
				return getBase();
			case DocbookPackage.IMAGEDATA_TYPE__CONDITION:
				return getCondition();
			case DocbookPackage.IMAGEDATA_TYPE__CONFORMANCE:
				return getConformance();
			case DocbookPackage.IMAGEDATA_TYPE__CONTENTDEPTH:
				return getContentdepth();
			case DocbookPackage.IMAGEDATA_TYPE__CONTENTWIDTH:
				return getContentwidth();
			case DocbookPackage.IMAGEDATA_TYPE__DEPTH:
				return getDepth();
			case DocbookPackage.IMAGEDATA_TYPE__DIR:
				return getDir();
			case DocbookPackage.IMAGEDATA_TYPE__ENTITYREF:
				return getEntityref();
			case DocbookPackage.IMAGEDATA_TYPE__FILEREF:
				return getFileref();
			case DocbookPackage.IMAGEDATA_TYPE__FORMAT:
				return getFormat();
			case DocbookPackage.IMAGEDATA_TYPE__ID:
				return getId();
			case DocbookPackage.IMAGEDATA_TYPE__LANG:
				return getLang();
			case DocbookPackage.IMAGEDATA_TYPE__OS:
				return getOs();
			case DocbookPackage.IMAGEDATA_TYPE__REMAP:
				return getRemap();
			case DocbookPackage.IMAGEDATA_TYPE__REVISION:
				return getRevision();
			case DocbookPackage.IMAGEDATA_TYPE__REVISIONFLAG:
				return getRevisionflag();
			case DocbookPackage.IMAGEDATA_TYPE__ROLE:
				return getRole();
			case DocbookPackage.IMAGEDATA_TYPE__SCALE:
				return getScale();
			case DocbookPackage.IMAGEDATA_TYPE__SCALEFIT:
				return getScalefit();
			case DocbookPackage.IMAGEDATA_TYPE__SECURITY:
				return getSecurity();
			case DocbookPackage.IMAGEDATA_TYPE__USERLEVEL:
				return getUserlevel();
			case DocbookPackage.IMAGEDATA_TYPE__VALIGN:
				return getValign();
			case DocbookPackage.IMAGEDATA_TYPE__VENDOR:
				return getVendor();
			case DocbookPackage.IMAGEDATA_TYPE__VERSION:
				return getVersion();
			case DocbookPackage.IMAGEDATA_TYPE__WIDTH:
				return getWidth();
			case DocbookPackage.IMAGEDATA_TYPE__WORDSIZE:
				return getWordsize();
			case DocbookPackage.IMAGEDATA_TYPE__XREFLABEL:
				return getXreflabel();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DocbookPackage.IMAGEDATA_TYPE__SCALE:
				...
				return;
			case DocbookPackage.IMAGEDATA_TYPE__SCALEFIT:
				setScalefit((ScalefitType)newValue);
				return;
			case DocbookPackage.IMAGEDATA_TYPE__SECURITY:
