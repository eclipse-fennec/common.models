 ...
 * </p>
 * <ul>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getPersonname <em>Personname</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getPersonblurb <em>Personblurb</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getAffiliation <em>Affiliation</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getUri <em>Uri</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getContrib <em>Contrib</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getOrgname <em>Orgname</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getOrgdiv <em>Orgdiv</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getAffiliation1 <em>Affiliation1</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getEmail1 <em>Email1</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getUri1 <em>Uri1</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getAddress1 <em>Address1</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getContrib1 <em>Contrib1</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getArch <em>Arch</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getAudience <em>Audience</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getConformance <em>Conformance</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getLinkend <em>Linkend</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getOs <em>Os</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getRemap <em>Remap</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getRevision <em>Revision</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getRevisionflag <em>Revisionflag</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getRole1 <em>Role1</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getUserlevel <em>Userlevel</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getVendor <em>Vendor</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getWordsize <em>Wordsize</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.AuthorTypeImpl#getXreflabel <em>Xreflabel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AuthorTypeImpl extends MinimalEObjectImpl.Container implements AuthorType {
	...
	protected EClass eStaticClass() {
		return DocbookPackage.eINSTANCE.getAuthorType();
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, DocbookPackage.AUTHOR_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<PersonblurbType> getPersonblurb() {
		return getGroup().list(DocbookPackage.eINSTANCE.getAuthorType_Personblurb());
	}
	...
	public EList<AffiliationType> getAffiliation() {
		return getGroup().list(DocbookPackage.eINSTANCE.getAuthorType_Affiliation());
	}
	...
	public EList<EmailType> getEmail() {
		return getGroup().list(DocbookPackage.eINSTANCE.getAuthorType_Email());
	}
	...
	public EList<UriType> getUri() {
		return getGroup().list(DocbookPackage.eINSTANCE.getAuthorType_Uri());
	}
	...
	public EList<AddressType> getAddress() {
		return getGroup().list(DocbookPackage.eINSTANCE.getAuthorType_Address());
	}
	...
	public EList<ContribType> getContrib() {
		return getGroup().list(DocbookPackage.eINSTANCE.getAuthorType_Contrib());
	}
	...
	public NotificationChain basicSetOrgname(OrgnameType newOrgname, NotificationChain msgs) {
		...
		orgname = newOrgname;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__ORGNAME, oldOrgname, newOrgname);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOrgname(OrgnameType newOrgname) {
		if (newOrgname != orgname) {
			NotificationChain msgs = null;
			if (orgname != null)
				msgs = ((InternalEObject)orgname).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.AUTHOR_TYPE__ORGNAME, null, msgs);
			if (newOrgname != null)
				msgs = ((InternalEObject)newOrgname).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.AUTHOR_TYPE__ORGNAME, null, msgs);
			msgs = basicSetOrgname(newOrgname, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__ORGNAME, newOrgname, newOrgname));
	}
	...
	public FeatureMap getGroup1() {
		if (group1 == null) {
			group1 = new BasicFeatureMap(this, DocbookPackage.AUTHOR_TYPE__GROUP1);
		}
		return group1;
	}
	...
	public EList<OrgdivType> getOrgdiv() {
		return getGroup1().list(DocbookPackage.eINSTANCE.getAuthorType_Orgdiv());
	}
	...
	public EList<AffiliationType> getAffiliation1() {
		return getGroup1().list(DocbookPackage.eINSTANCE.getAuthorType_Affiliation1());
	}
	...
	public EList<EmailType> getEmail1() {
		return getGroup1().list(DocbookPackage.eINSTANCE.getAuthorType_Email1());
	}
	...
	public EList<UriType> getUri1() {
		return getGroup1().list(DocbookPackage.eINSTANCE.getAuthorType_Uri1());
	}
	...
	public EList<AddressType> getAddress1() {
		return getGroup1().list(DocbookPackage.eINSTANCE.getAuthorType_Address1());
	}
	...
	public EList<ContribType> getContrib1() {
		return getGroup1().list(DocbookPackage.eINSTANCE.getAuthorType_Contrib1());
	}
	...
	public void setActuate(ActuateType newActuate) {
		...
		actuateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__ACTUATE, oldActuate, actuate, !oldActuateESet));
	}
	...
	public void unsetActuate() {
		...
		actuateESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.AUTHOR_TYPE__ACTUATE, oldActuate, ACTUATE_EDEFAULT, oldActuateESet));
	}
	...
	public void setAnnotations(Object newAnnotations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__ANNOTATIONS, oldAnnotations, annotations));
	}
	...
	public void setArch(Object newArch) {
		...
		arch = newArch;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__ARCH, oldArch, arch));
	}
	...
	public void setArcrole(Object newArcrole) {
		...
		arcrole = newArcrole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__ARCROLE, oldArcrole, arcrole));
	}
	...
	public void setAudience(Object newAudience) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__AUDIENCE, oldAudience, audience));
	}
	...
	public void setBase(Object newBase) {
		...
		base = newBase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__BASE, oldBase, base));
	}
	...
	public void setCondition(Object newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__CONDITION, oldCondition, condition));
	}
	...
	public void setConformance(Object newConformance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__CONFORMANCE, oldConformance, conformance));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.AUTHOR_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setHref(Object newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__HREF, oldHref, href));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__ID, oldId, id));
	}
	...
	public void setLang(Object newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLinkend(String newLinkend) {
		...
		linkend = newLinkend;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__LINKEND, oldLinkend, linkend));
	}
	...
	public void setOs(Object newOs) {
		...
		os = newOs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__OS, oldOs, os));
	}
	...
	public void setRemap(Object newRemap) {
		...
		remap = newRemap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__REMAP, oldRemap, remap));
	}
	...
	public void setRevision(Object newRevision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__REVISION, oldRevision, revision));
	}
	...
	public void setRevisionflag(RevisionflagType newRevisionflag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__REVISIONFLAG, oldRevisionflag, revisionflag, !oldRevisionflagESet));
	}
	...
	public void unsetRevisionflag() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.AUTHOR_TYPE__REVISIONFLAG, oldRevisionflag, REVISIONFLAG_EDEFAULT, oldRevisionflagESet));
	}
	...
	public void setRole(Object newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__ROLE, oldRole, role));
	}
	...
	public void setRole1(Object newRole1) {
		...
		role1 = newRole1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__ROLE1, oldRole1, role1));
	}
	...
	public void setSecurity(Object newSecurity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__SECURITY, oldSecurity, security));
	}
	...
	public void setShow(ShowType newShow) {
		...
		showESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__SHOW, oldShow, show, !oldShowESet));
	}
	...
	public void unsetShow() {
		...
		showESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.AUTHOR_TYPE__SHOW, oldShow, SHOW_EDEFAULT, oldShowESet));
	}
	...
	public void setTitle(Object newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setType(Object newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__TYPE, oldType, type));
	}
	...
	public void setUserlevel(Object newUserlevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__USERLEVEL, oldUserlevel, userlevel));
	}
	...
	public void setVendor(Object newVendor) {
		...
		vendor = newVendor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setVersion(Object newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__VERSION, oldVersion, version));
	}
	...
	public void setWordsize(Object newWordsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__WORDSIZE, oldWordsize, wordsize));
	}
	...
	public void setXreflabel(Object newXreflabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.AUTHOR_TYPE__XREFLABEL, oldXreflabel, xreflabel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case DocbookPackage.AUTHOR_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case DocbookPackage.AUTHOR_TYPE__PERSONBLURB:
				return ((InternalEList<?>)getPersonblurb()).basicRemove(otherEnd, msgs);
			case DocbookPackage.AUTHOR_TYPE__AFFILIATION:
				return ((InternalEList<?>)getAffiliation()).basicRemove(otherEnd, msgs);
			case DocbookPackage.AUTHOR_TYPE__EMAIL:
				return ((InternalEList<?>)getEmail()).basicRemove(otherEnd, msgs);
			case DocbookPackage.AUTHOR_TYPE__URI:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DocbookPackage.AUTHOR_TYPE__CONTRIB1:
				return getContrib1();
			case DocbookPackage.AUTHOR_TYPE__ACTUATE:
				return getActuate();
			case DocbookPackage.AUTHOR_TYPE__ANNOTATIONS:
				return getAnnotations();
			case DocbookPackage.AUTHOR_TYPE__ARCH:
				return getArch();
			case DocbookPackage.AUTHOR_TYPE__ARCROLE:
				return getArcrole();
			case DocbookPackage.AUTHOR_TYPE__AUDIENCE:
				return getAudience();
			case DocbookPackage.AUTHOR_TYPE__BASE:
				return getBase();
			case DocbookPackage.AUTHOR_TYPE__CONDITION:
				return getCondition();
			case DocbookPackage.AUTHOR_TYPE__CONFORMANCE:
				return getConformance();
			case DocbookPackage.AUTHOR_TYPE__DIR:
				return getDir();
			case DocbookPackage.AUTHOR_TYPE__HREF:
				return getHref();
			case DocbookPackage.AUTHOR_TYPE__ID:
				return getId();
			case DocbookPackage.AUTHOR_TYPE__LANG:
				return getLang();
			case DocbookPackage.AUTHOR_TYPE__LINKEND:
				return getLinkend();
			case DocbookPackage.AUTHOR_TYPE__OS:
				return getOs();
			case DocbookPackage.AUTHOR_TYPE__REMAP:
				return getRemap();
			case DocbookPackage.AUTHOR_TYPE__REVISION:
				return getRevision();
			case DocbookPackage.AUTHOR_TYPE__REVISIONFLAG:
				return getRevisionflag();
			case DocbookPackage.AUTHOR_TYPE__ROLE:
				return getRole();
			case DocbookPackage.AUTHOR_TYPE__ROLE1:
				return getRole1();
			case DocbookPackage.AUTHOR_TYPE__SECURITY:
				return getSecurity();
			case DocbookPackage.AUTHOR_TYPE__SHOW:
				return getShow();
			case DocbookPackage.AUTHOR_TYPE__TITLE:
				return getTitle();
			case DocbookPackage.AUTHOR_TYPE__TYPE:
				return getType();
			case DocbookPackage.AUTHOR_TYPE__USERLEVEL:
				return getUserlevel();
			case DocbookPackage.AUTHOR_TYPE__VENDOR:
				return getVendor();
			case DocbookPackage.AUTHOR_TYPE__VERSION:
				return getVersion();
			case DocbookPackage.AUTHOR_TYPE__WORDSIZE:
				return getWordsize();
			case DocbookPackage.AUTHOR_TYPE__XREFLABEL:
				return getXreflabel();
		}
