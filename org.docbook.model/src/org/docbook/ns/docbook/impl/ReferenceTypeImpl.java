 ...
 * </p>
 * <ul>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getTitleabbrev <em>Titleabbrev</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getSubtitle <em>Subtitle</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getInfo <em>Info</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getPartintro <em>Partintro</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getRefentry <em>Refentry</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getArch <em>Arch</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getAudience <em>Audience</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getConformance <em>Conformance</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getLinkend <em>Linkend</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getOs <em>Os</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getRemap <em>Remap</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getRevision <em>Revision</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getRevisionflag <em>Revisionflag</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getRole1 <em>Role1</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getTitle1 <em>Title1</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getUserlevel <em>Userlevel</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getVendor <em>Vendor</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getWordsize <em>Wordsize</em>}</li>
 *   <li>{@link org.docbook.ns.docbook.impl.ReferenceTypeImpl#getXreflabel <em>Xreflabel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceTypeImpl extends MinimalEObjectImpl.Container implements ReferenceType {
	...
	protected EClass eStaticClass() {
		return DocbookPackage.eINSTANCE.getReferenceType();
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, DocbookPackage.REFERENCE_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<TitleType> getTitle() {
		return getGroup().list(DocbookPackage.eINSTANCE.getReferenceType_Title());
	}
	...
	public EList<TitleabbrevType> getTitleabbrev() {
		return getGroup().list(DocbookPackage.eINSTANCE.getReferenceType_Titleabbrev());
	}
	...
	public EList<SubtitleType> getSubtitle() {
		return getGroup().list(DocbookPackage.eINSTANCE.getReferenceType_Subtitle());
	}
	...
	public NotificationChain basicSetPartintro(PartintroType newPartintro, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__PARTINTRO, oldPartintro, newPartintro);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPartintro(PartintroType newPartintro) {
		if (newPartintro != partintro) {
			NotificationChain msgs = null;
			if (partintro != null)
				msgs = ((InternalEObject)partintro).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.REFERENCE_TYPE__PARTINTRO, null, msgs);
			if (newPartintro != null)
				msgs = ((InternalEObject)newPartintro).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.REFERENCE_TYPE__PARTINTRO, null, msgs);
			msgs = basicSetPartintro(newPartintro, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__PARTINTRO, newPartintro, newPartintro));
	}
	...
	public void setActuate(ActuateType newActuate) {
		...
		actuateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__ACTUATE, oldActuate, actuate, !oldActuateESet));
	}
	...
	public void unsetActuate() {
		...
		actuateESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.REFERENCE_TYPE__ACTUATE, oldActuate, ACTUATE_EDEFAULT, oldActuateESet));
	}
	...
	public void setAnnotations(Object newAnnotations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__ANNOTATIONS, oldAnnotations, annotations));
	}
	...
	public void setArch(Object newArch) {
		...
		arch = newArch;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__ARCH, oldArch, arch));
	}
	...
	public void setArcrole(Object newArcrole) {
		...
		arcrole = newArcrole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__ARCROLE, oldArcrole, arcrole));
	}
	...
	public void setAudience(Object newAudience) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__AUDIENCE, oldAudience, audience));
	}
	...
	public void setBase(Object newBase) {
		...
		base = newBase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__BASE, oldBase, base));
	}
	...
	public void setCondition(Object newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__CONDITION, oldCondition, condition));
	}
	...
	public void setConformance(Object newConformance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__CONFORMANCE, oldConformance, conformance));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.REFERENCE_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setHref(Object newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__HREF, oldHref, href));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__ID, oldId, id));
	}
	...
	public void setLabel(Object newLabel) {
		...
		label = newLabel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__LABEL, oldLabel, label));
	}
	...
	public void setLang(Object newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLinkend(String newLinkend) {
		...
		linkend = newLinkend;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__LINKEND, oldLinkend, linkend));
	}
	...
	public void setOs(Object newOs) {
		...
		os = newOs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__OS, oldOs, os));
	}
	...
	public void setRemap(Object newRemap) {
		...
		remap = newRemap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__REMAP, oldRemap, remap));
	}
	...
	public void setRevision(Object newRevision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__REVISION, oldRevision, revision));
	}
	...
	public void setRevisionflag(RevisionflagType newRevisionflag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__REVISIONFLAG, oldRevisionflag, revisionflag, !oldRevisionflagESet));
	}
	...
	public void unsetRevisionflag() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.REFERENCE_TYPE__REVISIONFLAG, oldRevisionflag, REVISIONFLAG_EDEFAULT, oldRevisionflagESet));
	}
	...
	public void setRole(Object newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__ROLE, oldRole, role));
	}
	...
	public void setRole1(Object newRole1) {
		...
		role1 = newRole1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__ROLE1, oldRole1, role1));
	}
	...
	public void setSecurity(Object newSecurity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__SECURITY, oldSecurity, security));
	}
	...
	public void setShow(ShowType newShow) {
		...
		showESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__SHOW, oldShow, show, !oldShowESet));
	}
	...
	public void unsetShow() {
		...
		showESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DocbookPackage.REFERENCE_TYPE__SHOW, oldShow, SHOW_EDEFAULT, oldShowESet));
	}
	...
	public void setStatus(Object newStatus) {
		...
		status = newStatus;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__STATUS, oldStatus, status));
	}
	...
	public void setTitle1(Object newTitle1) {
		...
		title1 = newTitle1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__TITLE1, oldTitle1, title1));
	}
	...
	public void setType(Object newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__TYPE, oldType, type));
	}
	...
	public void setUserlevel(Object newUserlevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__USERLEVEL, oldUserlevel, userlevel));
	}
	...
	public void setVendor(Object newVendor) {
		...
		vendor = newVendor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__VENDOR, oldVendor, vendor));
	}
	...
	public void setWordsize(Object newWordsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__WORDSIZE, oldWordsize, wordsize));
	}
	...
	public void setXreflabel(Object newXreflabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.REFERENCE_TYPE__XREFLABEL, oldXreflabel, xreflabel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DocbookPackage.REFERENCE_TYPE__REFENTRY:
				return getRefentry();
			case DocbookPackage.REFERENCE_TYPE__ACTUATE:
				return getActuate();
			case DocbookPackage.REFERENCE_TYPE__ANNOTATIONS:
				return getAnnotations();
			case DocbookPackage.REFERENCE_TYPE__ARCH:
				return getArch();
			case DocbookPackage.REFERENCE_TYPE__ARCROLE:
				return getArcrole();
			case DocbookPackage.REFERENCE_TYPE__AUDIENCE:
				return getAudience();
			case DocbookPackage.REFERENCE_TYPE__BASE:
				return getBase();
			case DocbookPackage.REFERENCE_TYPE__CONDITION:
				return getCondition();
			case DocbookPackage.REFERENCE_TYPE__CONFORMANCE:
				return getConformance();
			case DocbookPackage.REFERENCE_TYPE__DIR:
				return getDir();
			case DocbookPackage.REFERENCE_TYPE__HREF:
				return getHref();
			case DocbookPackage.REFERENCE_TYPE__ID:
				return getId();
			case DocbookPackage.REFERENCE_TYPE__LABEL:
				return getLabel();
			case DocbookPackage.REFERENCE_TYPE__LANG:
				return getLang();
			case DocbookPackage.REFERENCE_TYPE__LINKEND:
				return getLinkend();
			case DocbookPackage.REFERENCE_TYPE__OS:
				return getOs();
			case DocbookPackage.REFERENCE_TYPE__REMAP:
				return getRemap();
			case DocbookPackage.REFERENCE_TYPE__REVISION:
				return getRevision();
			case DocbookPackage.REFERENCE_TYPE__REVISIONFLAG:
				return getRevisionflag();
			case DocbookPackage.REFERENCE_TYPE__ROLE:
				return getRole();
			case DocbookPackage.REFERENCE_TYPE__ROLE1:
				return getRole1();
			case DocbookPackage.REFERENCE_TYPE__SECURITY:
				return getSecurity();
			case DocbookPackage.REFERENCE_TYPE__SHOW:
				return getShow();
			case DocbookPackage.REFERENCE_TYPE__STATUS:
				return getStatus();
			case DocbookPackage.REFERENCE_TYPE__TITLE1:
				return getTitle1();
			case DocbookPackage.REFERENCE_TYPE__TYPE:
				return getType();
			case DocbookPackage.REFERENCE_TYPE__USERLEVEL:
				return getUserlevel();
			case DocbookPackage.REFERENCE_TYPE__VENDOR:
				return getVendor();
			case DocbookPackage.REFERENCE_TYPE__VERSION:
				return getVersion();
			case DocbookPackage.REFERENCE_TYPE__WORDSIZE:
				return getWordsize();
			case DocbookPackage.REFERENCE_TYPE__XREFLABEL:
				return getXreflabel();
		}
