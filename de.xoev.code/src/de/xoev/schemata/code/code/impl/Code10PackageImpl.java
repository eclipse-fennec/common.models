 ...
 */
package de.xoev.schemata.code.code.impl;
 ...
 * @generated
 */
public class Code10PackageImpl extends EPackageImpl implements Code10Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see de.xoev.schemata.code.code.Code10Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Code10PackageImpl() {
		super(eNS_URI, Code10Factory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link Code10Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Code10Package init() {
		if (isInited) return (Code10Package)EPackage.Registry.INSTANCE.getEPackage(Code10Package.eNS_URI);

		// Obtain or create and register package
		Object registeredCode10Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		Code10PackageImpl theCode10Package = registeredCode10Package instanceof Code10PackageImpl ? (Code10PackageImpl)registeredCode10Package : new Code10PackageImpl();
		...
		theCode10Package.createPackageContents();

		// Initialize created meta-data
		theCode10Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theCode10Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Code10Package.eNS_URI, theCode10Package);
		return theCode10Package;
	}
	 ...
	 */
	@Override
	public Code10Factory getCode10Factory() {
		return (Code10Factory)getEFactoryInstance();
	}
