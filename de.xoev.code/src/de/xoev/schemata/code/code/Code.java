 ...
 * </p>
 * <ul>
 *   <li>{@link de.xoev.schemata.code.code.Code#getCode <em>Code</em>}</li>
 *   <li>{@link de.xoev.schemata.code.code.Code#getName <em>Name</em>}</li>
 *   <li>{@link de.xoev.schemata.code.code.Code#getListURI <em>List URI</em>}</li>
 *   <li>{@link de.xoev.schemata.code.code.Code#getListVersionID <em>List Version ID</em>}</li>
 * </ul>
 *
 * @see de.xoev.schemata.code.code.Code10Package#getCode()
...
public interface Code extends EObject {
	 ...
	 * @see #setCode(String)
	 * @see de.xoev.schemata.code.code.Code10Package#getCode_Code()
	...
	/**
	 * Sets the value of the '{@link de.xoev.schemata.code.code.Code#getCode <em>Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see de.xoev.schemata.code.code.Code10Package#getCode_Name()
	...
	/**
	 * Sets the value of the '{@link de.xoev.schemata.code.code.Code#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.xoev.schemata.code.code.Code10Package#getCode_ListURI()
	...
	/**
	 * Sets the value of the '{@link de.xoev.schemata.code.code.Code#getListURI <em>List URI</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.xoev.schemata.code.code.Code10Package#getCode_ListVersionID()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.NormalizedString"
	...
	/**
	 * Sets the value of the '{@link de.xoev.schemata.code.code.Code#getListVersionID <em>List Version ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
