 ...
 * </p>
 * <ul>
 *   <li>{@link org.camunda.bpmn.camunda.ListType#getGroup <em>Group</em>}</li>
 *   <li>{@link org.camunda.bpmn.camunda.ListType#getScripts <em>Scripts</em>}</li>
 *   <li>{@link org.camunda.bpmn.camunda.ListType#getMaps <em>Maps</em>}</li>
 *   <li>{@link org.camunda.bpmn.camunda.ListType#getLists <em>Lists</em>}</li>
 *   <li>{@link org.camunda.bpmn.camunda.ListType#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @see org.camunda.bpmn.camunda.CamundaPackage#getListType()
...
public interface ListType extends EObject {
	 ...
	 * @see org.camunda.bpmn.camunda.CamundaPackage#getListType_Group()
	 ...
	 * The list contents are of type {@link org.camunda.bpmn.camunda.ScriptType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Scripts</em>' containment reference list.
	 * @see org.camunda.bpmn.camunda.CamundaPackage#getListType_Scripts()
	 ...
	 * The list contents are of type {@link org.camunda.bpmn.camunda.MapType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Maps</em>' containment reference list.
	 * @see org.camunda.bpmn.camunda.CamundaPackage#getListType_Maps()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link org.camunda.bpmn.camunda.ListType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Lists</em>' containment reference list.
	 * @see org.camunda.bpmn.camunda.CamundaPackage#getListType_Lists()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.camunda.bpmn.camunda.CamundaPackage#getListType_Values()
