 ...
 * </p>
 * <ul>
 *   <li>{@link org.camunda.bpmn.camunda.impl.OutTypeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.camunda.bpmn.camunda.impl.OutTypeImpl#getSourceExpression <em>Source Expression</em>}</li>
 *   <li>{@link org.camunda.bpmn.camunda.impl.OutTypeImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link org.camunda.bpmn.camunda.impl.OutTypeImpl#getVariables <em>Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutTypeImpl extends EObjectImpl implements OutType {
	...
	protected EClass eStaticClass() {
		return CamundaPackage.Literals.OUT_TYPE;
	}
	...
	public void setSource(String newSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamundaPackage.OUT_TYPE__SOURCE, oldSource, source));
	}
	...
	public void setSourceExpression(String newSourceExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamundaPackage.OUT_TYPE__SOURCE_EXPRESSION, oldSourceExpression, sourceExpression));
	}
	...
	public void setTarget(String newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamundaPackage.OUT_TYPE__TARGET, oldTarget, target));
	}
	...
	public void setVariables(String newVariables) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamundaPackage.OUT_TYPE__VARIABLES, oldVariables, variables));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CamundaPackage.OUT_TYPE__SOURCE:
				return getSource();
			case CamundaPackage.OUT_TYPE__SOURCE_EXPRESSION:
				return getSourceExpression();
			case CamundaPackage.OUT_TYPE__TARGET:
				return getTarget();
			case CamundaPackage.OUT_TYPE__VARIABLES:
				return getVariables();
		}
