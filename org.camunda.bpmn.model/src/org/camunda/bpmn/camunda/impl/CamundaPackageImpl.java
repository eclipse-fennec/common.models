...
import org.camunda.bpmn.camunda.CallActivity;
import org.camunda.bpmn.camunda.CamundaFactory;
import org.camunda.bpmn.camunda.CamundaPackage;
import org.camunda.bpmn.camunda.CamundaRoot;
import org.camunda.bpmn.camunda.ConnectorType;
import org.camunda.bpmn.camunda.ConstraintType;
import org.camunda.bpmn.camunda.EntryType;
import org.camunda.bpmn.camunda.EventType;
import org.camunda.bpmn.camunda.EventType1;
import org.camunda.bpmn.camunda.ExecutionListenerType;
import org.camunda.bpmn.camunda.Expression;
import org.camunda.bpmn.camunda.FailedJobRetryTimeCycleType;
import org.camunda.bpmn.camunda.FieldType;
import org.camunda.bpmn.camunda.FormDataContainer;
import org.camunda.bpmn.camunda.FormDataType;
import org.camunda.bpmn.camunda.FormFieldType;
import org.camunda.bpmn.camunda.FormPropertyType;
import org.camunda.bpmn.camunda.HistoryType;
import org.camunda.bpmn.camunda.InType;
import org.camunda.bpmn.camunda.InputOutputType;
import org.camunda.bpmn.camunda.ListType;
import org.camunda.bpmn.camunda.MapType;
import org.camunda.bpmn.camunda.OutType;
import org.camunda.bpmn.camunda.ParameterType;
import org.camunda.bpmn.camunda.PropertiesType;
import org.camunda.bpmn.camunda.PropertyType;
import org.camunda.bpmn.camunda.ScriptType;
import org.camunda.bpmn.camunda.StartEvent;
import org.camunda.bpmn.camunda.TaskListenerType;
import org.camunda.bpmn.camunda.TypeType;
import org.camunda.bpmn.camunda.UserTask;
import org.camunda.bpmn.camunda.ValidationType;
import org.camunda.bpmn.camunda.ValueType;

import org.camunda.bpmn.camunda.util.CamundaValidator;
...
public class CamundaPackageImpl extends EPackageImpl implements CamundaPackage {
	 ...
	 * @generated
	 */
	private EClass camundaRootEClass = null;
	 ...
	 * @see org.camunda.bpmn.camunda.CamundaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 *
	 * <p>This method is used to initialize {@link CamundaPackage#eINSTANCE} when that field is accessed.
	 ...
	 */
	@Override
	public EClass getCamundaRoot() {
		return camundaRootEClass;
	}
	 ...
	 */
	@Override
	public EReference getCamundaRoot_ExecutionListener() {
		return (EReference)camundaRootEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getCamundaRoot_Field() {
		return (EReference)camundaRootEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getCamundaRoot_FormProperty() {
		return (EReference)camundaRootEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getCamundaRoot_In() {
		return (EReference)camundaRootEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getCamundaRoot_Out() {
		return (EReference)camundaRootEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EReference getCamundaRoot_TaskListener() {
		return (EReference)camundaRootEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_Assignee() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_CandidateGroups() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_CandidateUsers() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_Class() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_Collection() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_DelegateExpression() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(11);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_DueDate() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(12);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_ElementVariable() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(13);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_FormHandlerClass() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(14);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_FormKey() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(15);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_History() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(16);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_Initiator() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(17);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_ResultVariable() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(18);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_Type() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(19);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_Async() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(20);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_ActExpression() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(21);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_Priority() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(22);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_ResultVariableName() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(23);
	}
	 ...
	 */
	@Override
	public EReference getCamundaRoot_FailedJobRetryTimeCycle() {
		return (EReference)camundaRootEClass.getEStructuralFeatures().get(24);
	}
	 ...
	 */
	@Override
	public EReference getCamundaRoot_FormData() {
		return (EReference)camundaRootEClass.getEStructuralFeatures().get(25);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_FollowUpDate() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(26);
	}
	 ...
	 */
	@Override
	public EReference getCamundaRoot_Properties() {
		return (EReference)camundaRootEClass.getEStructuralFeatures().get(27);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_Exclusive() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(28);
	}
	 ...
	 */
	@Override
	public EReference getCamundaRoot_Connector() {
		return (EReference)camundaRootEClass.getEStructuralFeatures().get(29);
	}
	 ...
	 */
	@Override
	public EReference getCamundaRoot_InputOutput() {
		return (EReference)camundaRootEClass.getEStructuralFeatures().get(30);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_AsyncAfter() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(31);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_AsyncBefore() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(32);
	}
	 ...
	 */
	@Override
	public EAttribute getCamundaRoot_Resource1() {
		return (EAttribute)camundaRootEClass.getEStructuralFeatures().get(33);
	}
	...
	public void createPackageContents() {
		...
		camundaRootEClass = createEClass(CAMUNDA_ROOT);
		createEReference(camundaRootEClass, CAMUNDA_ROOT__EXECUTION_LISTENER);
		createEReference(camundaRootEClass, CAMUNDA_ROOT__FIELD);
		createEReference(camundaRootEClass, CAMUNDA_ROOT__FORM_PROPERTY);
		createEReference(camundaRootEClass, CAMUNDA_ROOT__IN);
		createEReference(camundaRootEClass, CAMUNDA_ROOT__OUT);
		createEReference(camundaRootEClass, CAMUNDA_ROOT__TASK_LISTENER);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__ASSIGNEE);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__CANDIDATE_GROUPS);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__CANDIDATE_USERS);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__CLASS);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__COLLECTION);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__DELEGATE_EXPRESSION);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__DUE_DATE);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__ELEMENT_VARIABLE);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__FORM_HANDLER_CLASS);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__FORM_KEY);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__HISTORY);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__INITIATOR);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__RESULT_VARIABLE);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__TYPE);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__ASYNC);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__ACT_EXPRESSION);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__PRIORITY);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__RESULT_VARIABLE_NAME);
		createEReference(camundaRootEClass, CAMUNDA_ROOT__FAILED_JOB_RETRY_TIME_CYCLE);
		createEReference(camundaRootEClass, CAMUNDA_ROOT__FORM_DATA);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__FOLLOW_UP_DATE);
		createEReference(camundaRootEClass, CAMUNDA_ROOT__PROPERTIES);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__EXCLUSIVE);
		createEReference(camundaRootEClass, CAMUNDA_ROOT__CONNECTOR);
		createEReference(camundaRootEClass, CAMUNDA_ROOT__INPUT_OUTPUT);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__ASYNC_AFTER);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__ASYNC_BEFORE);
		createEAttribute(camundaRootEClass, CAMUNDA_ROOT__RESOURCE1);
	...
	public void initializePackageContents() {
		...
		camundaRootEClass.getESuperTypes().add(theBPMNPackage.getBPMNRoot());
		startEventEClass.getESuperTypes().add(this.getFormDataContainer());
		startEventEClass.getESuperTypes().add(theBPMNPackage.getTStartEvent());
		callActivityEClass.getESuperTypes().add(theBPMNPackage.getTCallActivity());
		boundaryEventEClass.getESuperTypes().add(theBPMNPackage.getTBoundaryEvent());
		userTaskEClass.getESuperTypes().add(this.getFormDataContainer());
		userTaskEClass.getESuperTypes().add(theBPMNPackage.getTUserTask());
		expressionEClass.getESuperTypes().add(theBPMNPackage.getTExpression());

		// Initialize classes and features; add operations and parameters
		initEClass(camundaRootEClass, CamundaRoot.class, "CamundaRoot", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCamundaRoot_ExecutionListener(), this.getExecutionListenerType(), null, "executionListener", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getCamundaRoot_Field(), this.getFieldType(), null, "field", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getCamundaRoot_FormProperty(), this.getFormPropertyType(), null, "formProperty", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getCamundaRoot_In(), this.getInType(), null, "in", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getCamundaRoot_Out(), this.getOutType(), null, "out", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getCamundaRoot_TaskListener(), this.getTaskListenerType(), null, "taskListener", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_Assignee(), ecorePackage.getEString(), "assignee", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_CandidateGroups(), ecorePackage.getEString(), "candidateGroups", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_CandidateUsers(), ecorePackage.getEString(), "candidateUsers", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_Class(), this.getClassType(), "class", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_Collection(), theXMLTypePackage.getString(), "collection", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_DelegateExpression(), theXMLTypePackage.getAnySimpleType(), "delegateExpression", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_DueDate(), this.getTExpression(), "dueDate", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_ElementVariable(), theXMLTypePackage.getString(), "elementVariable", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_FormHandlerClass(), this.getFormHandlerClassType(), "formHandlerClass", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_FormKey(), theXMLTypePackage.getString(), "formKey", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_History(), this.getHistoryType(), "history", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_Initiator(), theXMLTypePackage.getString(), "initiator", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_ResultVariable(), theXMLTypePackage.getString(), "resultVariable", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_Type(), this.getTypeType(), "type", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_Async(), theXMLTypePackage.getBoolean(), "async", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_ActExpression(), ecorePackage.getEString(), "actExpression", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_Priority(), ecorePackage.getEString(), "priority", "", 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_ResultVariableName(), ecorePackage.getEString(), "resultVariableName", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCamundaRoot_FailedJobRetryTimeCycle(), this.getFailedJobRetryTimeCycleType(), null, "failedJobRetryTimeCycle", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getCamundaRoot_FormData(), this.getFormDataType(), null, "formData", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_FollowUpDate(), this.getTExpression(), "followUpDate", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCamundaRoot_Properties(), this.getPropertiesType(), null, "properties", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_Exclusive(), theXMLTypePackage.getBoolean(), "exclusive", "true", 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCamundaRoot_Connector(), this.getConnectorType(), null, "connector", null, 0, 1, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getCamundaRoot_InputOutput(), this.getInputOutputType(), null, "inputOutput", null, 0, 1, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_AsyncAfter(), theXMLTypePackage.getBoolean(), "asyncAfter", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_AsyncBefore(), theXMLTypePackage.getBoolean(), "asyncBefore", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCamundaRoot_Resource1(), ecorePackage.getEString(), "resource1", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getCamundaRoot_ExecutionListener(),
		   source,
		   new String[] {
			   "kind", "element",
		...
		addAnnotation
		  (getCamundaRoot_CandidateGroups(),
		   source,
		   new String[] {
			   "kind", "attribute",
		...
		addAnnotation
		  (getCamundaRoot_DelegateExpression(),
		   source,
		   new String[] {
			   "kind", "attribute",
		...
		addAnnotation
		  (getCamundaRoot_ElementVariable(),
		   source,
		   new String[] {
			   "kind", "attribute",
		...
		addAnnotation
		  (getCamundaRoot_FormHandlerClass(),
		   source,
		   new String[] {
			   "kind", "attribute",
		...
		addAnnotation
		  (getCamundaRoot_ResultVariableName(),
		   source,
		   new String[] {
			   "kind", "attribute",
		...
		addAnnotation
		  (getCamundaRoot_FailedJobRetryTimeCycle(),
		   source,
		   new String[] {
			   "kind", "element",
