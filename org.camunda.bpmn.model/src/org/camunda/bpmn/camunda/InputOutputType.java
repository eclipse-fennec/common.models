 ...
 * </p>
 * <ul>
 *   <li>{@link org.camunda.bpmn.camunda.InputOutputType#getInputParameters <em>Input Parameters</em>}</li>
 *   <li>{@link org.camunda.bpmn.camunda.InputOutputType#getOutputParameters <em>Output Parameters</em>}</li>
 * </ul>
 *
 * @see org.camunda.bpmn.camunda.CamundaPackage#getInputOutputType()
...
public interface InputOutputType extends EObject {
	 ...
	 * The list contents are of type {@link org.camunda.bpmn.camunda.ParameterType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Input Parameters</em>' containment reference list.
	 * @see org.camunda.bpmn.camunda.CamundaPackage#getInputOutputType_InputParameters()
	 ...
	 * @see org.camunda.bpmn.camunda.CamundaPackage#getInputOutputType_OutputParameters()
	 * @model containment="true"
