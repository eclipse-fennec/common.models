 ...
 * <!-- end-user-doc -->
 * @see org.camunda.bpmn.camunda.util.CamundaResourceImpl
 * @generated
 */
public class CamundaResourceFactoryImpl extends ResourceFactoryImpl {
	 ...
	 * @generated
	 */
	public CamundaResourceFactoryImpl() {
		super();
	}
	...
	public Resource createResource(URI uri) {
		XMLResource result = new CamundaResourceImpl(uri);
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_CONFIGURATOR_NAME, CamundaPackage.eNAME);
		properties.put(EMFNamespaces.EMF_MODEL_FILE_EXT, "camunda");
		properties.put(EMFNamespaces.EMF_MODEL_VERSION, "1.0");
		return properties;
	}

} //CamundaResourceFactoryImpl
