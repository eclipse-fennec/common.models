 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TCaseFileItemDefinitionImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TCaseFileItemDefinitionImpl#getDefinitionType <em>Definition Type</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TCaseFileItemDefinitionImpl#getImportRef <em>Import Ref</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TCaseFileItemDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TCaseFileItemDefinitionImpl#getStructureRef <em>Structure Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCaseFileItemDefinitionImpl extends TCmmnElementImpl implements TCaseFileItemDefinition {
	 ...
	 * @ordered
	 */
	protected static final Object DEFINITION_TYPE_EDEFAULT = CaseModelFactory.eINSTANCE.createFromString(CaseModelPackage.eINSTANCE.getDefinitionTypeEnum(), "http://www.omg.org/spec/CMMN/DefinitionType/Unspecified");
	...
	protected EClass eStaticClass() {
		return CaseModelPackage.Literals.TCASE_FILE_ITEM_DEFINITION;
	}
	...
	public EList<TProperty> getProperty() {
		if (property == null) {
			property = new EObjectContainmentEList<TProperty>(TProperty.class, this, CaseModelPackage.TCASE_FILE_ITEM_DEFINITION__PROPERTY);
		}
		return property;
	}
	...
	public void setDefinitionType(Object newDefinitionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TCASE_FILE_ITEM_DEFINITION__DEFINITION_TYPE, oldDefinitionType, definitionType, !oldDefinitionTypeESet));
	}
	...
	public void unsetDefinitionType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CaseModelPackage.TCASE_FILE_ITEM_DEFINITION__DEFINITION_TYPE, oldDefinitionType, DEFINITION_TYPE_EDEFAULT, oldDefinitionTypeESet));
	}
	...
	public void setImportRef(QName newImportRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TCASE_FILE_ITEM_DEFINITION__IMPORT_REF, oldImportRef, importRef));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TCASE_FILE_ITEM_DEFINITION__NAME, oldName, name));
	}
	...
	public void setStructureRef(QName newStructureRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TCASE_FILE_ITEM_DEFINITION__STRUCTURE_REF, oldStructureRef, structureRef));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CaseModelPackage.TCASE_FILE_ITEM_DEFINITION__PROPERTY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CaseModelPackage.TCASE_FILE_ITEM_DEFINITION__PROPERTY:
				return getProperty();
			case CaseModelPackage.TCASE_FILE_ITEM_DEFINITION__DEFINITION_TYPE:
				return getDefinitionType();
			case CaseModelPackage.TCASE_FILE_ITEM_DEFINITION__IMPORT_REF:
				return getImportRef();
			case CaseModelPackage.TCASE_FILE_ITEM_DEFINITION__NAME:
				return getName();
			case CaseModelPackage.TCASE_FILE_ITEM_DEFINITION__STRUCTURE_REF:
