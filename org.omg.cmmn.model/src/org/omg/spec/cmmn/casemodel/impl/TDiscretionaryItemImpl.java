 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TDiscretionaryItemImpl#getItemControl <em>Item Control</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TDiscretionaryItemImpl#getEntryCriterion <em>Entry Criterion</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TDiscretionaryItemImpl#getExitCriterion <em>Exit Criterion</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TDiscretionaryItemImpl#getDefinitionRef <em>Definition Ref</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TDiscretionaryItemImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TDiscretionaryItemImpl extends TTableItemImpl implements TDiscretionaryItem {
	...
	protected EClass eStaticClass() {
		return CaseModelPackage.Literals.TDISCRETIONARY_ITEM;
	}
	...
	public NotificationChain basicSetItemControl(TPlanItemControl newItemControl, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CaseModelPackage.TDISCRETIONARY_ITEM__ITEM_CONTROL, oldItemControl, newItemControl);
	...
	public void setItemControl(TPlanItemControl newItemControl) {
		if (newItemControl != itemControl) {
			...
			if (itemControl != null)
				msgs = ((InternalEObject)itemControl).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CaseModelPackage.TDISCRETIONARY_ITEM__ITEM_CONTROL, null, msgs);
			if (newItemControl != null)
				msgs = ((InternalEObject)newItemControl).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CaseModelPackage.TDISCRETIONARY_ITEM__ITEM_CONTROL, null, msgs);
			msgs = basicSetItemControl(newItemControl, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TDISCRETIONARY_ITEM__ITEM_CONTROL, newItemControl, newItemControl));
	}
	...
	public EList<TEntryCriterion> getEntryCriterion() {
		if (entryCriterion == null) {
			entryCriterion = new EObjectContainmentEList<TEntryCriterion>(TEntryCriterion.class, this, CaseModelPackage.TDISCRETIONARY_ITEM__ENTRY_CRITERION);
		}
	...
	public EList<TExitCriterion> getExitCriterion() {
		if (exitCriterion == null) {
			exitCriterion = new EObjectContainmentEList<TExitCriterion>(TExitCriterion.class, this, CaseModelPackage.TDISCRETIONARY_ITEM__EXIT_CRITERION);
		}
	...
	public void setDefinitionRef(String newDefinitionRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TDISCRETIONARY_ITEM__DEFINITION_REF, oldDefinitionRef, definitionRef));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TDISCRETIONARY_ITEM__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CaseModelPackage.TDISCRETIONARY_ITEM__ITEM_CONTROL:
				return basicSetItemControl(null, msgs);
			case CaseModelPackage.TDISCRETIONARY_ITEM__ENTRY_CRITERION:
				return ((InternalEList<?>)getEntryCriterion()).basicRemove(otherEnd, msgs);
			case CaseModelPackage.TDISCRETIONARY_ITEM__EXIT_CRITERION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CaseModelPackage.TDISCRETIONARY_ITEM__DEFINITION_REF:
				return getDefinitionRef();
			case CaseModelPackage.TDISCRETIONARY_ITEM__NAME:
				return getName();
		}
