...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TUser Event Listener</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TUserEventListenerImpl#getAuthorizedRoleRefs <em>Authorized Role Refs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TUserEventListenerImpl extends TEventListenerImpl implements TUserEventListener {
	/**
	 ...
	 * @generated
	 */
	protected TUserEventListenerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CaseModelPackage.Literals.TUSER_EVENT_LISTENER;
	}
	...
	public void setAuthorizedRoleRefs(List<String> newAuthorizedRoleRefs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TUSER_EVENT_LISTENER__AUTHORIZED_ROLE_REFS, oldAuthorizedRoleRefs, authorizedRoleRefs));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CaseModelPackage.TUSER_EVENT_LISTENER__AUTHORIZED_ROLE_REFS:
