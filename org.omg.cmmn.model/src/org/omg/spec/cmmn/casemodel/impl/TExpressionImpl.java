 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TExpressionImpl#getLanguage <em>Language</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TExpressionImpl extends TCmmnElementWithMixedContentImpl implements TExpression {
	...
	protected EClass eStaticClass() {
		return CaseModelPackage.Literals.TEXPRESSION;
	}
	...
	public void setLanguage(String newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TEXPRESSION__LANGUAGE, oldLanguage, language));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CaseModelPackage.TEXPRESSION__LANGUAGE:
				return getLanguage();
		}
