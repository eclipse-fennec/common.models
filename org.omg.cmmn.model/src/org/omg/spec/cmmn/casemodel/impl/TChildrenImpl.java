 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TChildrenImpl#getCaseFileItem <em>Case File Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TChildrenImpl extends TCmmnElementImpl implements TChildren {
	...
	protected EClass eStaticClass() {
		return CaseModelPackage.Literals.TCHILDREN;
	}
	...
	public EList<TCaseFileItem> getCaseFileItem() {
		if (caseFileItem == null) {
			caseFileItem = new EObjectContainmentEList<TCaseFileItem>(TCaseFileItem.class, this, CaseModelPackage.TCHILDREN__CASE_FILE_ITEM);
		}
		return caseFileItem;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CaseModelPackage.TCHILDREN__CASE_FILE_ITEM:
