 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TPlanItemControlImpl#getRepetitionRule <em>Repetition Rule</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TPlanItemControlImpl#getRequiredRule <em>Required Rule</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TPlanItemControlImpl#getManualActivationRule <em>Manual Activation Rule</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TPlanItemControlImpl extends TCmmnElementImpl implements TPlanItemControl {
	...
	protected EClass eStaticClass() {
		return CaseModelPackage.Literals.TPLAN_ITEM_CONTROL;
	}
	...
	public NotificationChain basicSetRepetitionRule(TRepetitionRule newRepetitionRule, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CaseModelPackage.TPLAN_ITEM_CONTROL__REPETITION_RULE, oldRepetitionRule, newRepetitionRule);
	...
	public void setRepetitionRule(TRepetitionRule newRepetitionRule) {
		if (newRepetitionRule != repetitionRule) {
			...
			if (repetitionRule != null)
				msgs = ((InternalEObject)repetitionRule).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CaseModelPackage.TPLAN_ITEM_CONTROL__REPETITION_RULE, null, msgs);
			if (newRepetitionRule != null)
				msgs = ((InternalEObject)newRepetitionRule).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CaseModelPackage.TPLAN_ITEM_CONTROL__REPETITION_RULE, null, msgs);
			msgs = basicSetRepetitionRule(newRepetitionRule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TPLAN_ITEM_CONTROL__REPETITION_RULE, newRepetitionRule, newRepetitionRule));
	}
	...
	public NotificationChain basicSetRequiredRule(TRequiredRule newRequiredRule, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CaseModelPackage.TPLAN_ITEM_CONTROL__REQUIRED_RULE, oldRequiredRule, newRequiredRule);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRequiredRule(TRequiredRule newRequiredRule) {
		if (newRequiredRule != requiredRule) {
			...
			if (requiredRule != null)
				msgs = ((InternalEObject)requiredRule).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CaseModelPackage.TPLAN_ITEM_CONTROL__REQUIRED_RULE, null, msgs);
			if (newRequiredRule != null)
				msgs = ((InternalEObject)newRequiredRule).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CaseModelPackage.TPLAN_ITEM_CONTROL__REQUIRED_RULE, null, msgs);
			msgs = basicSetRequiredRule(newRequiredRule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TPLAN_ITEM_CONTROL__REQUIRED_RULE, newRequiredRule, newRequiredRule));
	}
	...
	public NotificationChain basicSetManualActivationRule(TManualActivationRule newManualActivationRule, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CaseModelPackage.TPLAN_ITEM_CONTROL__MANUAL_ACTIVATION_RULE, oldManualActivationRule, newManualActivationRule);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setManualActivationRule(TManualActivationRule newManualActivationRule) {
		if (newManualActivationRule != manualActivationRule) {
			...
			if (manualActivationRule != null)
				msgs = ((InternalEObject)manualActivationRule).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CaseModelPackage.TPLAN_ITEM_CONTROL__MANUAL_ACTIVATION_RULE, null, msgs);
			if (newManualActivationRule != null)
				msgs = ((InternalEObject)newManualActivationRule).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CaseModelPackage.TPLAN_ITEM_CONTROL__MANUAL_ACTIVATION_RULE, null, msgs);
			msgs = basicSetManualActivationRule(newManualActivationRule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TPLAN_ITEM_CONTROL__MANUAL_ACTIVATION_RULE, newManualActivationRule, newManualActivationRule));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CaseModelPackage.TPLAN_ITEM_CONTROL__REPETITION_RULE:
				return basicSetRepetitionRule(null, msgs);
			case CaseModelPackage.TPLAN_ITEM_CONTROL__REQUIRED_RULE:
				return basicSetRequiredRule(null, msgs);
			case CaseModelPackage.TPLAN_ITEM_CONTROL__MANUAL_ACTIVATION_RULE:
