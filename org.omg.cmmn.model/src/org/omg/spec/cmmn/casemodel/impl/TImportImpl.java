 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TImportImpl#getImportType <em>Import Type</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TImportImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TImportImpl#getNamespace <em>Namespace</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TImportImpl extends MinimalEObjectImpl.Container implements TImport {
	...
	protected EClass eStaticClass() {
		return CaseModelPackage.Literals.TIMPORT;
	}
	...
	public void setImportType(String newImportType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TIMPORT__IMPORT_TYPE, oldImportType, importType));
	}
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TIMPORT__LOCATION, oldLocation, location));
	}
	...
	public void setNamespace(String newNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TIMPORT__NAMESPACE, oldNamespace, namespace));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CaseModelPackage.TIMPORT__IMPORT_TYPE:
				return getImportType();
			case CaseModelPackage.TIMPORT__LOCATION:
				return getLocation();
			case CaseModelPackage.TIMPORT__NAMESPACE:
				return getNamespace();
		}
