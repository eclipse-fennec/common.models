 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TCaseFileItemOnPartImpl#getStandardEvent <em>Standard Event</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TCaseFileItemOnPartImpl#getSourceRef <em>Source Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCaseFileItemOnPartImpl extends TOnPartImpl implements TCaseFileItemOnPart {
	...
	protected EClass eStaticClass() {
		return CaseModelPackage.Literals.TCASE_FILE_ITEM_ON_PART;
	}
	...
	public void setStandardEvent(CaseFileItemTransition newStandardEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TCASE_FILE_ITEM_ON_PART__STANDARD_EVENT, oldStandardEvent, standardEvent, !oldStandardEventESet));
	}
	...
	public void unsetStandardEvent() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CaseModelPackage.TCASE_FILE_ITEM_ON_PART__STANDARD_EVENT, oldStandardEvent, STANDARD_EVENT_EDEFAULT, oldStandardEventESet));
	}
	...
	public void setSourceRef(String newSourceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TCASE_FILE_ITEM_ON_PART__SOURCE_REF, oldSourceRef, sourceRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CaseModelPackage.TCASE_FILE_ITEM_ON_PART__STANDARD_EVENT:
				return getStandardEvent();
			case CaseModelPackage.TCASE_FILE_ITEM_ON_PART__SOURCE_REF:
				return getSourceRef();
		}
