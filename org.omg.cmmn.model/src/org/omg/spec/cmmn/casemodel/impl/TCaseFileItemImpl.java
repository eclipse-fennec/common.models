 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TCaseFileItemImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TCaseFileItemImpl#getDefinitionRef <em>Definition Ref</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TCaseFileItemImpl#getMultiplicity <em>Multiplicity</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TCaseFileItemImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TCaseFileItemImpl#getSourceRef <em>Source Ref</em>}</li>
 *   <li>{@link org.omg.spec.cmmn.casemodel.impl.TCaseFileItemImpl#getTargetRefs <em>Target Refs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCaseFileItemImpl extends TCmmnElementImpl implements TCaseFileItem {
	...
	protected EClass eStaticClass() {
		return CaseModelPackage.Literals.TCASE_FILE_ITEM;
	}
	...
	public NotificationChain basicSetChildren(TChildren newChildren, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CaseModelPackage.TCASE_FILE_ITEM__CHILDREN, oldChildren, newChildren);
	...
	public void setChildren(TChildren newChildren) {
		if (newChildren != children) {
			...
			if (children != null)
				msgs = ((InternalEObject)children).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CaseModelPackage.TCASE_FILE_ITEM__CHILDREN, null, msgs);
			if (newChildren != null)
				msgs = ((InternalEObject)newChildren).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CaseModelPackage.TCASE_FILE_ITEM__CHILDREN, null, msgs);
			msgs = basicSetChildren(newChildren, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TCASE_FILE_ITEM__CHILDREN, newChildren, newChildren));
	}
	...
	public void setDefinitionRef(QName newDefinitionRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TCASE_FILE_ITEM__DEFINITION_REF, oldDefinitionRef, definitionRef));
	}
	...
	public void setMultiplicity(MultiplicityEnum newMultiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TCASE_FILE_ITEM__MULTIPLICITY, oldMultiplicity, multiplicity, !oldMultiplicityESet));
	}
	...
	public void unsetMultiplicity() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CaseModelPackage.TCASE_FILE_ITEM__MULTIPLICITY, oldMultiplicity, MULTIPLICITY_EDEFAULT, oldMultiplicityESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TCASE_FILE_ITEM__NAME, oldName, name));
	}
	...
	public void setSourceRef(String newSourceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TCASE_FILE_ITEM__SOURCE_REF, oldSourceRef, sourceRef));
	}
	...
	public void setTargetRefs(List<String> newTargetRefs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaseModelPackage.TCASE_FILE_ITEM__TARGET_REFS, oldTargetRefs, targetRefs));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CaseModelPackage.TCASE_FILE_ITEM__CHILDREN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CaseModelPackage.TCASE_FILE_ITEM__CHILDREN:
				return getChildren();
			case CaseModelPackage.TCASE_FILE_ITEM__DEFINITION_REF:
				return getDefinitionRef();
			case CaseModelPackage.TCASE_FILE_ITEM__MULTIPLICITY:
				return getMultiplicity();
			case CaseModelPackage.TCASE_FILE_ITEM__NAME:
				return getName();
			case CaseModelPackage.TCASE_FILE_ITEM__SOURCE_REF:
				return getSourceRef();
			case CaseModelPackage.TCASE_FILE_ITEM__TARGET_REFS:
