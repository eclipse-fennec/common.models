 ...
 */
package org.omg.spec.cmmn.di.configuration;
...
import org.omg.spec.cmmn.di.DIFactory;
import org.omg.spec.cmmn.di.DIPackage;

import org.omg.spec.cmmn.di.impl.DIPackageImpl;

import org.omg.spec.cmmn.di.util.DIResourceFactoryImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.omg.spec.cmmn.di.util.DIResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource$Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,org.omg.spec.cmmn.di.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.omg.spec.cmmn.di.DIFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,org.omg.spec.cmmn.di\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.omg.spec.cmmn.di.DIPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,org.omg.spec.cmmn.di\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.omg.spec.cmmn.di\"" })
...
public class DIConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(DIPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(DIPackage.eNS_URI, ePackage);
		}
