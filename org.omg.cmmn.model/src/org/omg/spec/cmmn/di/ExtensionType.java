 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.spec.cmmn.di.ExtensionType#getAny <em>Any</em>}</li>
 * </ul>
 *
 * @see org.omg.spec.cmmn.di.DIPackage#getExtensionType()
...
public interface ExtensionType extends EObject {
	 ...
	 * @see org.omg.spec.cmmn.di.DIPackage#getExtensionType_Any()
