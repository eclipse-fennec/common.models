...
public class CMMNDISwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CMMNDIPackage.CMMNDI: {
				CMMNDI cmmndi = (CMMNDI)theEObject;
				T result = caseCMMNDI(cmmndi);
			...
			case CMMNDIPackage.CMMN_LABEL: {
				...
				if (result == null) result = caseShape(cmmnLabel);
			...
			case CMMNDIPackage.CMMNDI_ROOT: {
				CMMNDIRoot cmmndiRoot = (CMMNDIRoot)theEObject;
				T result = caseCMMNDIRoot(cmmndiRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>CMMNDI</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>CMMNDI</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCMMNDI(CMMNDI object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseCMMNDIRoot(CMMNDIRoot object) {
		return null;
	}
