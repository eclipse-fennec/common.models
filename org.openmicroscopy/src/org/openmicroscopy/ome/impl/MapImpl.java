 ...
 * </p>
 * <ul>
 *   <li>{@link org.openmicroscopy.ome.impl.MapImpl#getM <em>M</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapImpl extends MinimalEObjectImpl.Container implements Map {
	...
	protected EClass eStaticClass() {
		return OMEPackage.eINSTANCE.getMap();
	}
	 ...
	 */
	@Override
	public EList<MType> getM() {
		if (m == null) {
			m = new EObjectContainmentEList<MType>(MType.class, this, OMEPackage.MAP__M);
		}
		return m;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case OMEPackage.MAP__M:
				getM().clear();
				getM().addAll((Collection<? extends MType>)newValue);
				return;
		}
