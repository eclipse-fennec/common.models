...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Font Family Type</b></em>',
 ...
 *           
 * <!-- end-model-doc -->
 * @see org.openmicroscopy.ome.OMEPackage#getFontFamilyType()
 * @model extendedMetaData="name='FontFamily_._type'"
 * @generated
 */
@ProviderType
public enum FontFamilyType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Font Family Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final FontFamilyType[] VALUES_ARRAY =
		new FontFamilyType[] {
			SERIF,
			SANS_SERIF,
			CURSIVE,
	...
	/**
	 * A public read-only list of all the '<em><b>Font Family Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<FontFamilyType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Font Family Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static FontFamilyType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FontFamilyType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Font Family Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static FontFamilyType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FontFamilyType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Font Family Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static FontFamilyType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private FontFamilyType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
