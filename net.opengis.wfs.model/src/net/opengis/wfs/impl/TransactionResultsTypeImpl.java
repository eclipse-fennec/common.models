 ...
 * @generated
 */
public class TransactionResultsTypeImpl extends MinimalEObjectImpl.Container implements TransactionResultsType {
	/**
	...
	public EList<ActionType> getAction() {
		if (action == null) {
			action = new EObjectContainmentEList<ActionType>(ActionType.class, this, WFSPackage.TRANSACTION_RESULTS_TYPE__ACTION);
		}
		return action;
	}
