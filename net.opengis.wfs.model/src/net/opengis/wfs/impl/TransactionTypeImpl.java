...
public class TransactionTypeImpl extends BaseRequestTypeImpl implements TransactionType {
	 ...
	 */
	@Override
	public EList<InsertElementType> getInsert() {
	 ...
	 */
	@Override
	public EList<UpdateElementType> getUpdate() {
	 ...
	 */
	@Override
	public EList<DeleteElementType> getDelete() {
	 ...
	 */
	@Override
	public EList<NativeType> getNative() {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case WFSPackage.TRANSACTION_TYPE__INSERT:
				getInsert().clear();
				getInsert().addAll((Collection<? extends InsertElementType>)newValue);
				return;
			case WFSPackage.TRANSACTION_TYPE__UPDATE:
				getUpdate().clear();
				getUpdate().addAll((Collection<? extends UpdateElementType>)newValue);
				return;
			case WFSPackage.TRANSACTION_TYPE__DELETE:
				getDelete().clear();
				getDelete().addAll((Collection<? extends DeleteElementType>)newValue);
				return;
			case WFSPackage.TRANSACTION_TYPE__NATIVE:
				getNative().clear();
				getNative().addAll((Collection<? extends NativeType>)newValue);
				return;
			case WFSPackage.TRANSACTION_TYPE__RELEASE_ACTION:
