 ...
 * @generated
 */
public class LockTypeImpl extends MinimalEObjectImpl.Container implements LockType {
	/**
	...
	public NotificationChain basicSetFilter(FilterType newFilter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WFSPackage.LOCK_TYPE__FILTER, oldFilter, newFilter);
	...
	public void setFilter(FilterType newFilter) {
		if (newFilter != filter) {
			...
			if (filter != null)
				msgs = ((InternalEObject)filter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WFSPackage.LOCK_TYPE__FILTER, null, msgs);
			if (newFilter != null)
				msgs = ((InternalEObject)newFilter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WFSPackage.LOCK_TYPE__FILTER, null, msgs);
			msgs = basicSetFilter(newFilter, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.LOCK_TYPE__FILTER, newFilter, newFilter));
	}
