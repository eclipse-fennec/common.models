...
public class MetadataURLTypeImpl extends MinimalEObjectImpl.Container implements MetadataURLType {
	...
	public void setFormat(FormatType newFormat) {
		...
		formatESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.METADATA_URL_TYPE__FORMAT, oldFormat, format, !oldFormatESet));
	}
	...
	public void unsetFormat() {
		...
		formatESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WFSPackage.METADATA_URL_TYPE__FORMAT, oldFormat, FORMAT_EDEFAULT, oldFormatESet));
	}
