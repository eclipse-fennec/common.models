 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ogc.SortByType#getSortProperty <em>Sort Property</em>}</li>
 * </ul>
 *
 * @see net.opengis.ogc.OGCPackage#getSortByType()
...
public interface SortByType extends EObject {
	 ...
	 * The list contents are of type {@link net.opengis.ogc.SortPropertyType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Sort Property</em>' containment reference list.
	 * @see net.opengis.ogc.OGCPackage#getSortByType_SortProperty()
