 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ogc.SpatialOperatorsType#getSpatialOperator <em>Spatial Operator</em>}</li>
 * </ul>
 *
 * @see net.opengis.ogc.OGCPackage#getSpatialOperatorsType()
...
public interface SpatialOperatorsType extends EObject {
	 ...
	 * The list contents are of type {@link net.opengis.ogc.SpatialOperatorType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Spatial Operator</em>' containment reference list.
	 * @see net.opengis.ogc.OGCPackage#getSpatialOperatorsType_SpatialOperator()
