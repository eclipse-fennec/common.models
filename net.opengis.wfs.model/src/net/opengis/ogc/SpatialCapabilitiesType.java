 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ogc.SpatialCapabilitiesType#getGeometryOperands <em>Geometry Operands</em>}</li>
 *   <li>{@link net.opengis.ogc.SpatialCapabilitiesType#getSpatialOperators <em>Spatial Operators</em>}</li>
 * </ul>
 *
 * @see net.opengis.ogc.OGCPackage#getSpatialCapabilitiesType()
...
public interface SpatialCapabilitiesType extends EObject {
	 ...
	 * @see net.opengis.ogc.OGCPackage#getSpatialCapabilitiesType_GeometryOperands()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ogc.SpatialCapabilitiesType#getGeometryOperands <em>Geometry Operands</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ogc.OGCPackage#getSpatialCapabilitiesType_SpatialOperators()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.ogc.SpatialCapabilitiesType#getSpatialOperators <em>Spatial Operators</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
