 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ogc.BinaryComparisonOpType#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link net.opengis.ogc.BinaryComparisonOpType#getExpression <em>Expression</em>}</li>
 *   <li>{@link net.opengis.ogc.BinaryComparisonOpType#isMatchCase <em>Match Case</em>}</li>
 * </ul>
 *
 * @see net.opengis.ogc.OGCPackage#getBinaryComparisonOpType()
...
public interface BinaryComparisonOpType extends ComparisonOpsType {
	 ...
	 * @see net.opengis.ogc.OGCPackage#getBinaryComparisonOpType_ExpressionGroup()
	 ...
	 * @see net.opengis.ogc.OGCPackage#getBinaryComparisonOpType_Expression()
	 ...
	 * @see net.opengis.ogc.OGCPackage#getBinaryComparisonOpType_MatchCase()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ogc.BinaryComparisonOpType#isMatchCase <em>Match Case</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.ogc.BinaryComparisonOpType#isMatchCase <em>Match Case</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetMatchCase()
	 * @see #isMatchCase()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.ogc.BinaryComparisonOpType#isMatchCase <em>Match Case</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
