 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ogc.impl.SpatialCapabilitiesTypeImpl#getGeometryOperands <em>Geometry Operands</em>}</li>
 *   <li>{@link net.opengis.ogc.impl.SpatialCapabilitiesTypeImpl#getSpatialOperators <em>Spatial Operators</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpatialCapabilitiesTypeImpl extends MinimalEObjectImpl.Container implements SpatialCapabilitiesType {
	...
	protected EClass eStaticClass() {
		return OGCPackage.Literals.SPATIAL_CAPABILITIES_TYPE;
	}
	...
	public NotificationChain basicSetGeometryOperands(GeometryOperandsType newGeometryOperands, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OGCPackage.SPATIAL_CAPABILITIES_TYPE__GEOMETRY_OPERANDS, oldGeometryOperands, newGeometryOperands);
	...
	public void setGeometryOperands(GeometryOperandsType newGeometryOperands) {
		if (newGeometryOperands != geometryOperands) {
			...
			if (geometryOperands != null)
				msgs = ((InternalEObject)geometryOperands).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OGCPackage.SPATIAL_CAPABILITIES_TYPE__GEOMETRY_OPERANDS, null, msgs);
			if (newGeometryOperands != null)
				msgs = ((InternalEObject)newGeometryOperands).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OGCPackage.SPATIAL_CAPABILITIES_TYPE__GEOMETRY_OPERANDS, null, msgs);
			msgs = basicSetGeometryOperands(newGeometryOperands, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OGCPackage.SPATIAL_CAPABILITIES_TYPE__GEOMETRY_OPERANDS, newGeometryOperands, newGeometryOperands));
	}
	...
	public NotificationChain basicSetSpatialOperators(SpatialOperatorsType newSpatialOperators, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OGCPackage.SPATIAL_CAPABILITIES_TYPE__SPATIAL_OPERATORS, oldSpatialOperators, newSpatialOperators);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSpatialOperators(SpatialOperatorsType newSpatialOperators) {
		if (newSpatialOperators != spatialOperators) {
			...
			if (spatialOperators != null)
				msgs = ((InternalEObject)spatialOperators).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OGCPackage.SPATIAL_CAPABILITIES_TYPE__SPATIAL_OPERATORS, null, msgs);
			if (newSpatialOperators != null)
				msgs = ((InternalEObject)newSpatialOperators).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OGCPackage.SPATIAL_CAPABILITIES_TYPE__SPATIAL_OPERATORS, null, msgs);
			msgs = basicSetSpatialOperators(newSpatialOperators, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OGCPackage.SPATIAL_CAPABILITIES_TYPE__SPATIAL_OPERATORS, newSpatialOperators, newSpatialOperators));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OGCPackage.SPATIAL_CAPABILITIES_TYPE__GEOMETRY_OPERANDS:
				return basicSetGeometryOperands(null, msgs);
			case OGCPackage.SPATIAL_CAPABILITIES_TYPE__SPATIAL_OPERATORS:
