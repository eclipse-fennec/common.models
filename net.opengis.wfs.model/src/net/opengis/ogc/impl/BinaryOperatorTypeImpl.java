...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Binary Operator Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ogc.impl.BinaryOperatorTypeImpl#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link net.opengis.ogc.impl.BinaryOperatorTypeImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BinaryOperatorTypeImpl extends ExpressionTypeImpl implements BinaryOperatorType {
	 ...
	 * @generated
	 */
	protected BinaryOperatorTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OGCPackage.Literals.BINARY_OPERATOR_TYPE;
	}
	...
	public FeatureMap getExpressionGroup() {
		if (expressionGroup == null) {
			expressionGroup = new BasicFeatureMap(this, OGCPackage.BINARY_OPERATOR_TYPE__EXPRESSION_GROUP);
		}
	...
	public EList<ExpressionType> getExpression() {
		return getExpressionGroup().list(OGCPackage.Literals.BINARY_OPERATOR_TYPE__EXPRESSION);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OGCPackage.BINARY_OPERATOR_TYPE__EXPRESSION_GROUP:
				return ((InternalEList<?>)getExpressionGroup()).basicRemove(otherEnd, msgs);
			case OGCPackage.BINARY_OPERATOR_TYPE__EXPRESSION:
