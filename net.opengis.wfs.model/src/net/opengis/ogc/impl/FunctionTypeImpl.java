 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ogc.impl.FunctionTypeImpl#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link net.opengis.ogc.impl.FunctionTypeImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link net.opengis.ogc.impl.FunctionTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionTypeImpl extends ExpressionTypeImpl implements FunctionType {
	...
	protected EClass eStaticClass() {
		return OGCPackage.Literals.FUNCTION_TYPE;
	}
	...
	public FeatureMap getExpressionGroup() {
		if (expressionGroup == null) {
			expressionGroup = new BasicFeatureMap(this, OGCPackage.FUNCTION_TYPE__EXPRESSION_GROUP);
		}
	...
	public EList<ExpressionType> getExpression() {
		return getExpressionGroup().list(OGCPackage.Literals.FUNCTION_TYPE__EXPRESSION);
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OGCPackage.FUNCTION_TYPE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OGCPackage.FUNCTION_TYPE__EXPRESSION_GROUP:
				return ((InternalEList<?>)getExpressionGroup()).basicRemove(otherEnd, msgs);
			case OGCPackage.FUNCTION_TYPE__EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OGCPackage.FUNCTION_TYPE__NAME:
				return getName();
		}
