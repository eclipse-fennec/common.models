 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ogc.impl.PropertyNameTypeImpl#getMixed <em>Mixed</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyNameTypeImpl extends ExpressionTypeImpl implements PropertyNameType {
	...
	protected EClass eStaticClass() {
		return OGCPackage.Literals.PROPERTY_NAME_TYPE;
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, OGCPackage.PROPERTY_NAME_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OGCPackage.PROPERTY_NAME_TYPE__MIXED:
