 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ows.DomainType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.ows.DomainType#getMetadata <em>Metadata</em>}</li>
...
public interface DomainType extends EObject {
	 ...
	 * @see net.opengis.ows.OWSPackage#getDomainType_Value()
	 ...
	 * @see net.opengis.ows.OWSPackage#getDomainType_Metadata()
