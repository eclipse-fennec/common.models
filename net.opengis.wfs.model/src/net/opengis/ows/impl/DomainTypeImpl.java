...
public class DomainTypeImpl extends MinimalEObjectImpl.Container implements DomainType {
	...
	public EList<String> getValue() {
		if (value == null) {
			value = new EDataTypeEList<String>(String.class, this, OWSPackage.DOMAIN_TYPE__VALUE);
		}
		return value;
	}
	...
	public EList<MetadataType> getMetadata() {
		if (metadata == null) {
			metadata = new EObjectContainmentEList<MetadataType>(MetadataType.class, this, OWSPackage.DOMAIN_TYPE__METADATA);
		}
		return metadata;
	}
