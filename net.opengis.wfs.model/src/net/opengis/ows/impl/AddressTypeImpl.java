 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ows.impl.AddressTypeImpl#getDeliveryPoint <em>Delivery Point</em>}</li>
 *   <li>{@link net.opengis.ows.impl.AddressTypeImpl#getCity <em>City</em>}</li>
 *   <li>{@link net.opengis.ows.impl.AddressTypeImpl#getAdministrativeArea <em>Administrative Area</em>}</li>
 *   <li>{@link net.opengis.ows.impl.AddressTypeImpl#getPostalCode <em>Postal Code</em>}</li>
 *   <li>{@link net.opengis.ows.impl.AddressTypeImpl#getCountry <em>Country</em>}</li>
 *   <li>{@link net.opengis.ows.impl.AddressTypeImpl#getElectronicMailAddress <em>Electronic Mail Address</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddressTypeImpl extends MinimalEObjectImpl.Container implements AddressType {
	...
	public EList<String> getDeliveryPoint() {
		if (deliveryPoint == null) {
			deliveryPoint = new EDataTypeEList<String>(String.class, this, OWSPackage.ADDRESS_TYPE__DELIVERY_POINT);
		}
	...
	public EList<String> getElectronicMailAddress() {
		if (electronicMailAddress == null) {
			electronicMailAddress = new EDataTypeEList<String>(String.class, this, OWSPackage.ADDRESS_TYPE__ELECTRONIC_MAIL_ADDRESS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OWSPackage.ADDRESS_TYPE__DELIVERY_POINT:
				return getDeliveryPoint();
			case OWSPackage.ADDRESS_TYPE__CITY:
				return getCity();
			case OWSPackage.ADDRESS_TYPE__ADMINISTRATIVE_AREA:
				return getAdministrativeArea();
			case OWSPackage.ADDRESS_TYPE__POSTAL_CODE:
				return getPostalCode();
			case OWSPackage.ADDRESS_TYPE__COUNTRY:
				return getCountry();
			case OWSPackage.ADDRESS_TYPE__ELECTRONIC_MAIL_ADDRESS:
