 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ows.IdentificationType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.ows.IdentificationType#getBoundingBoxGroup <em>Bounding Box Group</em>}</li>
 *   <li>{@link net.opengis.ows.IdentificationType#getBoundingBox <em>Bounding Box</em>}</li>
 *   <li>{@link net.opengis.ows.IdentificationType#getOutputFormat <em>Output Format</em>}</li>
 *   <li>{@link net.opengis.ows.IdentificationType#getAvailableCRSGroup <em>Available CRS Group</em>}</li>
 *   <li>{@link net.opengis.ows.IdentificationType#getAvailableCRS <em>Available CRS</em>}</li>
 *   <li>{@link net.opengis.ows.IdentificationType#getMetadata <em>Metadata</em>}</li>
 * </ul>
 *
 * @see net.opengis.ows.OWSPackage#getIdentificationType()
