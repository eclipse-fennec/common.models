...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,basisnachricht\"" })
...
public class BasisnachrichtConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(BasisnachrichtPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(BasisnachrichtPackage.eNS_URI, ePackage);
		}
