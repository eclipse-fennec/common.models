 ...
 * </p>
 * <ul>
 *   <li>{@link basisnachricht.impl.KommunikationTypeImpl#getKanal <em>Kanal</em>}</li>
 *   <li>{@link basisnachricht.impl.KommunikationTypeImpl#getKennung <em>Kennung</em>}</li>
 *   <li>{@link basisnachricht.impl.KommunikationTypeImpl#getZusatz <em>Zusatz</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KommunikationTypeImpl extends MinimalEObjectImpl.Container implements KommunikationType {
	...
	protected EClass eStaticClass() {
		return BasisnachrichtPackage.Literals.KOMMUNIKATION_TYPE;
	}
	...
	public NotificationChain basicSetKanal(CodeKommunikationKanalType newKanal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BasisnachrichtPackage.KOMMUNIKATION_TYPE__KANAL, oldKanal, newKanal);
	...
	public void setKanal(CodeKommunikationKanalType newKanal) {
		if (newKanal != kanal) {
			...
			if (kanal != null)
				msgs = ((InternalEObject)kanal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BasisnachrichtPackage.KOMMUNIKATION_TYPE__KANAL, null, msgs);
			if (newKanal != null)
				msgs = ((InternalEObject)newKanal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BasisnachrichtPackage.KOMMUNIKATION_TYPE__KANAL, null, msgs);
			msgs = basicSetKanal(newKanal, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisnachrichtPackage.KOMMUNIKATION_TYPE__KANAL, newKanal, newKanal));
	}
	...
	public void setKennung(String newKennung) {
		...
		kennung = newKennung;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisnachrichtPackage.KOMMUNIKATION_TYPE__KENNUNG, oldKennung, kennung));
	}
	...
	public void setZusatz(String newZusatz) {
		...
		zusatz = newZusatz;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisnachrichtPackage.KOMMUNIKATION_TYPE__ZUSATZ, oldZusatz, zusatz));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasisnachrichtPackage.KOMMUNIKATION_TYPE__KANAL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasisnachrichtPackage.KOMMUNIKATION_TYPE__KANAL:
				return getKanal();
			case BasisnachrichtPackage.KOMMUNIKATION_TYPE__KENNUNG:
				return getKennung();
			case BasisnachrichtPackage.KOMMUNIKATION_TYPE__ZUSATZ:
				return getZusatz();
		}
