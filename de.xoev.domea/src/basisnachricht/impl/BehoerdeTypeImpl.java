 ...
 * </p>
 * <ul>
 *   <li>{@link basisnachricht.impl.BehoerdeTypeImpl#getVerzeichnisdienst <em>Verzeichnisdienst</em>}</li>
 *   <li>{@link basisnachricht.impl.BehoerdeTypeImpl#getKennung <em>Kennung</em>}</li>
 *   <li>{@link basisnachricht.impl.BehoerdeTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link basisnachricht.impl.BehoerdeTypeImpl#getErreichbarkeit <em>Erreichbarkeit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BehoerdeTypeImpl extends MinimalEObjectImpl.Container implements BehoerdeType {
	...
	protected EClass eStaticClass() {
		return BasisnachrichtPackage.Literals.BEHOERDE_TYPE;
	}
	...
	public NotificationChain basicSetVerzeichnisdienst(CodeVerzeichnisdienstType newVerzeichnisdienst, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BasisnachrichtPackage.BEHOERDE_TYPE__VERZEICHNISDIENST, oldVerzeichnisdienst, newVerzeichnisdienst);
	...
	public void setVerzeichnisdienst(CodeVerzeichnisdienstType newVerzeichnisdienst) {
		if (newVerzeichnisdienst != verzeichnisdienst) {
			...
			if (verzeichnisdienst != null)
				msgs = ((InternalEObject)verzeichnisdienst).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BasisnachrichtPackage.BEHOERDE_TYPE__VERZEICHNISDIENST, null, msgs);
			if (newVerzeichnisdienst != null)
				msgs = ((InternalEObject)newVerzeichnisdienst).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BasisnachrichtPackage.BEHOERDE_TYPE__VERZEICHNISDIENST, null, msgs);
			msgs = basicSetVerzeichnisdienst(newVerzeichnisdienst, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisnachrichtPackage.BEHOERDE_TYPE__VERZEICHNISDIENST, newVerzeichnisdienst, newVerzeichnisdienst));
	}
	...
	public void setKennung(String newKennung) {
		...
		kennung = newKennung;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisnachrichtPackage.BEHOERDE_TYPE__KENNUNG, oldKennung, kennung));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisnachrichtPackage.BEHOERDE_TYPE__NAME, oldName, name));
	}
	...
	public EList<KommunikationType> getErreichbarkeit() {
		if (erreichbarkeit == null) {
			erreichbarkeit = new EObjectContainmentEList<KommunikationType>(KommunikationType.class, this, BasisnachrichtPackage.BEHOERDE_TYPE__ERREICHBARKEIT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasisnachrichtPackage.BEHOERDE_TYPE__VERZEICHNISDIENST:
				return basicSetVerzeichnisdienst(null, msgs);
			case BasisnachrichtPackage.BEHOERDE_TYPE__ERREICHBARKEIT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BasisnachrichtPackage.BEHOERDE_TYPE__KENNUNG:
				return getKennung();
			case BasisnachrichtPackage.BEHOERDE_TYPE__NAME:
				return getName();
			case BasisnachrichtPackage.BEHOERDE_TYPE__ERREICHBARKEIT:
