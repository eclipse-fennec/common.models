 ...
 * </p>
 * <ul>
 *   <li>{@link de.xoev.domea.domea.impl.AllgemeinerNameTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AllgemeinerNameTypeImpl extends MinimalEObjectImpl.Container implements AllgemeinerNameType {
	...
	protected EClass eStaticClass() {
		return DomeaPackage.Literals.ALLGEMEINER_NAME_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomeaPackage.ALLGEMEINER_NAME_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomeaPackage.ALLGEMEINER_NAME_TYPE__NAME:
				return getName();
		}
