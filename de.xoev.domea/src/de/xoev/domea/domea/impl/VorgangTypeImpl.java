...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Vorgang Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getIdentifikation <em>Identifikation</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getAllgemeineMetadaten <em>Allgemeine Metadaten</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getAussonderungsmetadaten <em>Aussonderungsmetadaten</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getAktenbetreff <em>Aktenbetreff</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getTyp <em>Typ</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#isZdA <em>Zd A</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getZdADatum <em>Zd ADatum</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getLaufzeit <em>Laufzeit</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getHistorienProtokollInformation <em>Historien Protokoll Information</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getInternerGeschaeftsgang <em>Interner Geschaeftsgang</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getDokumentOderDokumentMitSchriftstueck <em>Dokument Oder Dokument Mit Schriftstueck</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getVerweis <em>Verweis</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getKontakt <em>Kontakt</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getTeilvorgang <em>Teilvorgang</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getAnwendungsspezifischeErweiterung <em>Anwendungsspezifische Erweiterung</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.VorgangTypeImpl#getAnwendungsspezifischeErweiterungXML <em>Anwendungsspezifische Erweiterung XML</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VorgangTypeImpl extends MinimalEObjectImpl.Container implements VorgangType {
	/**
	...
	/**
	 * The default value of the '{@link #getAktenbetreff() <em>Aktenbetreff</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAktenbetreff()
	 * @generated
	 * @ordered
	 */
	protected static final String AKTENBETREFF_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getAktenbetreff() <em>Aktenbetreff</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAktenbetreff()
	 * @generated
	 * @ordered
	 */
	protected String aktenbetreff = AKTENBETREFF_EDEFAULT;
	...
	/**
	 * The cached value of the '{@link #getTeilvorgang() <em>Teilvorgang</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTeilvorgang()
	 * @generated
	 * @ordered
	 */
	protected EList<VorgangType> teilvorgang;
	...
	protected EClass eStaticClass() {
		return DomeaPackage.Literals.VORGANG_TYPE;
	}
	...
	public NotificationChain basicSetIdentifikation(IdentifikationObjektType newIdentifikation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DomeaPackage.VORGANG_TYPE__IDENTIFIKATION, oldIdentifikation, newIdentifikation);
	...
	public void setIdentifikation(IdentifikationObjektType newIdentifikation) {
		if (newIdentifikation != identifikation) {
			...
			if (identifikation != null)
				msgs = ((InternalEObject)identifikation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DomeaPackage.VORGANG_TYPE__IDENTIFIKATION, null, msgs);
			if (newIdentifikation != null)
				msgs = ((InternalEObject)newIdentifikation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DomeaPackage.VORGANG_TYPE__IDENTIFIKATION, null, msgs);
			msgs = basicSetIdentifikation(newIdentifikation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomeaPackage.VORGANG_TYPE__IDENTIFIKATION, newIdentifikation, newIdentifikation));
	}
	...
	public NotificationChain basicSetAllgemeineMetadaten(AllgemeineMetadatenType newAllgemeineMetadaten, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DomeaPackage.VORGANG_TYPE__ALLGEMEINE_METADATEN, oldAllgemeineMetadaten, newAllgemeineMetadaten);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAllgemeineMetadaten(AllgemeineMetadatenType newAllgemeineMetadaten) {
		if (newAllgemeineMetadaten != allgemeineMetadaten) {
			...
			if (allgemeineMetadaten != null)
				msgs = ((InternalEObject)allgemeineMetadaten).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DomeaPackage.VORGANG_TYPE__ALLGEMEINE_METADATEN, null, msgs);
			if (newAllgemeineMetadaten != null)
				msgs = ((InternalEObject)newAllgemeineMetadaten).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DomeaPackage.VORGANG_TYPE__ALLGEMEINE_METADATEN, null, msgs);
			msgs = basicSetAllgemeineMetadaten(newAllgemeineMetadaten, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomeaPackage.VORGANG_TYPE__ALLGEMEINE_METADATEN, newAllgemeineMetadaten, newAllgemeineMetadaten));
	}
	...
	public NotificationChain basicSetAussonderungsmetadaten(AussonderungsmetadatenType newAussonderungsmetadaten, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DomeaPackage.VORGANG_TYPE__AUSSONDERUNGSMETADATEN, oldAussonderungsmetadaten, newAussonderungsmetadaten);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAussonderungsmetadaten(AussonderungsmetadatenType newAussonderungsmetadaten) {
		if (newAussonderungsmetadaten != aussonderungsmetadaten) {
			...
			if (aussonderungsmetadaten != null)
				msgs = ((InternalEObject)aussonderungsmetadaten).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DomeaPackage.VORGANG_TYPE__AUSSONDERUNGSMETADATEN, null, msgs);
			if (newAussonderungsmetadaten != null)
				msgs = ((InternalEObject)newAussonderungsmetadaten).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DomeaPackage.VORGANG_TYPE__AUSSONDERUNGSMETADATEN, null, msgs);
			msgs = basicSetAussonderungsmetadaten(newAussonderungsmetadaten, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomeaPackage.VORGANG_TYPE__AUSSONDERUNGSMETADATEN, newAussonderungsmetadaten, newAussonderungsmetadaten));
	}
	 ...
	 */
	@Override
	public void setAktenbetreff(String newAktenbetreff) {
		String oldAktenbetreff = aktenbetreff;
		aktenbetreff = newAktenbetreff;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomeaPackage.VORGANG_TYPE__AKTENBETREFF, oldAktenbetreff, aktenbetreff));
	}
	...
	public void setTyp(String newTyp) {
		...
		typ = newTyp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomeaPackage.VORGANG_TYPE__TYP, oldTyp, typ));
	}
	...
	public void setZdA(boolean newZdA) {
		...
		zdAESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomeaPackage.VORGANG_TYPE__ZD_A, oldZdA, zdA, !oldZdAESet));
	}
	...
	public void unsetZdA() {
		...
		zdAESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DomeaPackage.VORGANG_TYPE__ZD_A, oldZdA, ZD_A_EDEFAULT, oldZdAESet));
	}
	...
	public void setZdADatum(XMLGregorianCalendar newZdADatum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomeaPackage.VORGANG_TYPE__ZD_ADATUM, oldZdADatum, zdADatum));
	}
	...
	public NotificationChain basicSetLaufzeit(ZeitraumType newLaufzeit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DomeaPackage.VORGANG_TYPE__LAUFZEIT, oldLaufzeit, newLaufzeit);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLaufzeit(ZeitraumType newLaufzeit) {
		if (newLaufzeit != laufzeit) {
			NotificationChain msgs = null;
			if (laufzeit != null)
				msgs = ((InternalEObject)laufzeit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DomeaPackage.VORGANG_TYPE__LAUFZEIT, null, msgs);
			if (newLaufzeit != null)
				msgs = ((InternalEObject)newLaufzeit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DomeaPackage.VORGANG_TYPE__LAUFZEIT, null, msgs);
			msgs = basicSetLaufzeit(newLaufzeit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomeaPackage.VORGANG_TYPE__LAUFZEIT, newLaufzeit, newLaufzeit));
	}
	...
	public EList<HistorienProtokollInformationType> getHistorienProtokollInformation() {
		if (historienProtokollInformation == null) {
			historienProtokollInformation = new EObjectContainmentEList<HistorienProtokollInformationType>(HistorienProtokollInformationType.class, this, DomeaPackage.VORGANG_TYPE__HISTORIEN_PROTOKOLL_INFORMATION);
		}
	...
	public EList<GeschaeftsgangType> getInternerGeschaeftsgang() {
		if (internerGeschaeftsgang == null) {
			internerGeschaeftsgang = new EObjectContainmentEList<GeschaeftsgangType>(GeschaeftsgangType.class, this, DomeaPackage.VORGANG_TYPE__INTERNER_GESCHAEFTSGANG);
		}
	...
	public EList<DokumentOderDokumentMitSchriftstueckType> getDokumentOderDokumentMitSchriftstueck() {
		if (dokumentOderDokumentMitSchriftstueck == null) {
			dokumentOderDokumentMitSchriftstueck = new EObjectContainmentEList<DokumentOderDokumentMitSchriftstueckType>(DokumentOderDokumentMitSchriftstueckType.class, this, DomeaPackage.VORGANG_TYPE__DOKUMENT_ODER_DOKUMENT_MIT_SCHRIFTSTUECK);
		}
	...
	public EList<VerweisType> getVerweis() {
		if (verweis == null) {
			verweis = new EObjectContainmentEList<VerweisType>(VerweisType.class, this, DomeaPackage.VORGANG_TYPE__VERWEIS);
		}
		return verweis;
	}
	...
	public EList<KontaktType> getKontakt() {
		if (kontakt == null) {
			kontakt = new EObjectContainmentEList<KontaktType>(KontaktType.class, this, DomeaPackage.VORGANG_TYPE__KONTAKT);
		}
		return kontakt;
	}
	 ...
	 */
	@Override
	public EList<VorgangType> getTeilvorgang() {
		if (teilvorgang == null) {
			teilvorgang = new EObjectContainmentEList<VorgangType>(VorgangType.class, this, DomeaPackage.VORGANG_TYPE__TEILVORGANG);
		}
		return teilvorgang;
	}
	...
	public EList<AnwendungsspezifischeErweiterungType> getAnwendungsspezifischeErweiterung() {
		if (anwendungsspezifischeErweiterung == null) {
			anwendungsspezifischeErweiterung = new EObjectContainmentEList<AnwendungsspezifischeErweiterungType>(AnwendungsspezifischeErweiterungType.class, this, DomeaPackage.VORGANG_TYPE__ANWENDUNGSSPEZIFISCHE_ERWEITERUNG);
		}
	...
	public NotificationChain basicSetAnwendungsspezifischeErweiterungXML(AnwendungsspezifischeErweiterungXMLType newAnwendungsspezifischeErweiterungXML, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DomeaPackage.VORGANG_TYPE__ANWENDUNGSSPEZIFISCHE_ERWEITERUNG_XML, oldAnwendungsspezifischeErweiterungXML, newAnwendungsspezifischeErweiterungXML);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAnwendungsspezifischeErweiterungXML(AnwendungsspezifischeErweiterungXMLType newAnwendungsspezifischeErweiterungXML) {
		if (newAnwendungsspezifischeErweiterungXML != anwendungsspezifischeErweiterungXML) {
			...
			if (anwendungsspezifischeErweiterungXML != null)
				msgs = ((InternalEObject)anwendungsspezifischeErweiterungXML).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DomeaPackage.VORGANG_TYPE__ANWENDUNGSSPEZIFISCHE_ERWEITERUNG_XML, null, msgs);
			if (newAnwendungsspezifischeErweiterungXML != null)
				msgs = ((InternalEObject)newAnwendungsspezifischeErweiterungXML).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DomeaPackage.VORGANG_TYPE__ANWENDUNGSSPEZIFISCHE_ERWEITERUNG_XML, null, msgs);
			msgs = basicSetAnwendungsspezifischeErweiterungXML(newAnwendungsspezifischeErweiterungXML, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomeaPackage.VORGANG_TYPE__ANWENDUNGSSPEZIFISCHE_ERWEITERUNG_XML, newAnwendungsspezifischeErweiterungXML, newAnwendungsspezifischeErweiterungXML));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DomeaPackage.VORGANG_TYPE__IDENTIFIKATION:
				return basicSetIdentifikation(null, msgs);
			case DomeaPackage.VORGANG_TYPE__ALLGEMEINE_METADATEN:
				return basicSetAllgemeineMetadaten(null, msgs);
			case DomeaPackage.VORGANG_TYPE__AUSSONDERUNGSMETADATEN:
				return basicSetAussonderungsmetadaten(null, msgs);
			case DomeaPackage.VORGANG_TYPE__LAUFZEIT:
				return basicSetLaufzeit(null, msgs);
			case DomeaPackage.VORGANG_TYPE__HISTORIEN_PROTOKOLL_INFORMATION:
				return ((InternalEList<?>)getHistorienProtokollInformation()).basicRemove(otherEnd, msgs);
			case DomeaPackage.VORGANG_TYPE__INTERNER_GESCHAEFTSGANG:
				return ((InternalEList<?>)getInternerGeschaeftsgang()).basicRemove(otherEnd, msgs);
			case DomeaPackage.VORGANG_TYPE__DOKUMENT_ODER_DOKUMENT_MIT_SCHRIFTSTUECK:
				return ((InternalEList<?>)getDokumentOderDokumentMitSchriftstueck()).basicRemove(otherEnd, msgs);
			case DomeaPackage.VORGANG_TYPE__VERWEIS:
				return ((InternalEList<?>)getVerweis()).basicRemove(otherEnd, msgs);
			case DomeaPackage.VORGANG_TYPE__KONTAKT:
				return ((InternalEList<?>)getKontakt()).basicRemove(otherEnd, msgs);
			case DomeaPackage.VORGANG_TYPE__TEILVORGANG:
				return ((InternalEList<?>)getTeilvorgang()).basicRemove(otherEnd, msgs);
			case DomeaPackage.VORGANG_TYPE__ANWENDUNGSSPEZIFISCHE_ERWEITERUNG:
				return ((InternalEList<?>)getAnwendungsspezifischeErweiterung()).basicRemove(otherEnd, msgs);
			case DomeaPackage.VORGANG_TYPE__ANWENDUNGSSPEZIFISCHE_ERWEITERUNG_XML:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DomeaPackage.VORGANG_TYPE__AKTENBETREFF:
				return getAktenbetreff();
			case DomeaPackage.VORGANG_TYPE__TYP:
				return getTyp();
			case DomeaPackage.VORGANG_TYPE__ZD_A:
				return isZdA();
			case DomeaPackage.VORGANG_TYPE__ZD_ADATUM:
				return getZdADatum();
			case DomeaPackage.VORGANG_TYPE__LAUFZEIT:
				return getLaufzeit();
			case DomeaPackage.VORGANG_TYPE__HISTORIEN_PROTOKOLL_INFORMATION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DomeaPackage.VORGANG_TYPE__AUSSONDERUNGSMETADATEN:
				...
				return;
			case DomeaPackage.VORGANG_TYPE__AKTENBETREFF:
				setAktenbetreff((String)newValue);
				return;
			case DomeaPackage.VORGANG_TYPE__TYP:
			...
			case DomeaPackage.VORGANG_TYPE__KONTAKT:
				...
				return;
			case DomeaPackage.VORGANG_TYPE__TEILVORGANG:
				getTeilvorgang().clear();
				getTeilvorgang().addAll((Collection<? extends VorgangType>)newValue);
				return;
			case DomeaPackage.VORGANG_TYPE__ANWENDUNGSSPEZIFISCHE_ERWEITERUNG:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case DomeaPackage.VORGANG_TYPE__AUSSONDERUNGSMETADATEN:
				...
				return;
			case DomeaPackage.VORGANG_TYPE__AKTENBETREFF:
				setAktenbetreff(AKTENBETREFF_EDEFAULT);
				return;
			case DomeaPackage.VORGANG_TYPE__TYP:
				setTyp(TYP_EDEFAULT);
				return;
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case DomeaPackage.VORGANG_TYPE__AKTENBETREFF:
				return AKTENBETREFF_EDEFAULT == null ? aktenbetreff != null : !AKTENBETREFF_EDEFAULT.equals(aktenbetreff);
			case DomeaPackage.VORGANG_TYPE__TYP:
			...
			case DomeaPackage.VORGANG_TYPE__TEILVORGANG:
				return teilvorgang != null && !teilvorgang.isEmpty();
			case DomeaPackage.VORGANG_TYPE__ANWENDUNGSSPEZIFISCHE_ERWEITERUNG:
