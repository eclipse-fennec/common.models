 ...
 * </p>
 * <ul>
 *   <li>{@link de.xoev.domea.domea.impl.ZeitraumTypeImpl#getBeginn <em>Beginn</em>}</li>
 *   <li>{@link de.xoev.domea.domea.impl.ZeitraumTypeImpl#getEnde <em>Ende</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ZeitraumTypeImpl extends MinimalEObjectImpl.Container implements ZeitraumType {
	...
	protected EClass eStaticClass() {
		return DomeaPackage.Literals.ZEITRAUM_TYPE;
	}
	...
	public void setBeginn(XMLGregorianCalendar newBeginn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomeaPackage.ZEITRAUM_TYPE__BEGINN, oldBeginn, beginn));
	}
	...
	public void setEnde(XMLGregorianCalendar newEnde) {
		...
		ende = newEnde;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomeaPackage.ZEITRAUM_TYPE__ENDE, oldEnde, ende));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomeaPackage.ZEITRAUM_TYPE__BEGINN:
				return getBeginn();
			case DomeaPackage.ZEITRAUM_TYPE__ENDE:
				return getEnde();
		}
