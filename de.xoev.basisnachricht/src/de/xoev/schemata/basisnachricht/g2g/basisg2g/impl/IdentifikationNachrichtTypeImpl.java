 ...
 * </p>
 * <ul>
 *   <li>{@link de.xoev.schemata.basisnachricht.g2g.basisg2g.impl.IdentifikationNachrichtTypeImpl#getNachrichtenUUID <em>Nachrichten UUID</em>}</li>
 *   <li>{@link de.xoev.schemata.basisnachricht.g2g.basisg2g.impl.IdentifikationNachrichtTypeImpl#getNachrichtentyp <em>Nachrichtentyp</em>}</li>
 *   <li>{@link de.xoev.schemata.basisnachricht.g2g.basisg2g.impl.IdentifikationNachrichtTypeImpl#getErstellungszeitpunkt <em>Erstellungszeitpunkt</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdentifikationNachrichtTypeImpl extends MinimalEObjectImpl.Container implements IdentifikationNachrichtType {
	...
	protected EClass eStaticClass() {
		return BasisG2GPackage.Literals.IDENTIFIKATION_NACHRICHT_TYPE;
	}
	...
	public void setNachrichtenUUID(String newNachrichtenUUID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisG2GPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTEN_UUID, oldNachrichtenUUID, nachrichtenUUID));
	}
	...
	public NotificationChain basicSetNachrichtentyp(Code newNachrichtentyp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BasisG2GPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTENTYP, oldNachrichtentyp, newNachrichtentyp);
	...
	public void setNachrichtentyp(Code newNachrichtentyp) {
		if (newNachrichtentyp != nachrichtentyp) {
			...
			if (nachrichtentyp != null)
				msgs = ((InternalEObject)nachrichtentyp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BasisG2GPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTENTYP, null, msgs);
			if (newNachrichtentyp != null)
				msgs = ((InternalEObject)newNachrichtentyp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BasisG2GPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTENTYP, null, msgs);
			msgs = basicSetNachrichtentyp(newNachrichtentyp, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisG2GPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTENTYP, newNachrichtentyp, newNachrichtentyp));
	}
	...
	public void setErstellungszeitpunkt(XMLGregorianCalendar newErstellungszeitpunkt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisG2GPackage.IDENTIFIKATION_NACHRICHT_TYPE__ERSTELLUNGSZEITPUNKT, oldErstellungszeitpunkt, erstellungszeitpunkt));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasisG2GPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTENTYP:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasisG2GPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTEN_UUID:
				return getNachrichtenUUID();
			case BasisG2GPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTENTYP:
				return getNachrichtentyp();
			case BasisG2GPackage.IDENTIFIKATION_NACHRICHT_TYPE__ERSTELLUNGSZEITPUNKT:
