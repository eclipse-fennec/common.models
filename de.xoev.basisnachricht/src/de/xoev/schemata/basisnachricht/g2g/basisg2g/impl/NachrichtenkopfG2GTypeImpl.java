 ...
 * </p>
 * <ul>
 *   <li>{@link de.xoev.schemata.basisnachricht.g2g.basisg2g.impl.NachrichtenkopfG2GTypeImpl#getIdentifikationNachricht <em>Identifikation Nachricht</em>}</li>
 *   <li>{@link de.xoev.schemata.basisnachricht.g2g.basisg2g.impl.NachrichtenkopfG2GTypeImpl#getLeser <em>Leser</em>}</li>
 *   <li>{@link de.xoev.schemata.basisnachricht.g2g.basisg2g.impl.NachrichtenkopfG2GTypeImpl#getAutor <em>Autor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NachrichtenkopfG2GTypeImpl extends MinimalEObjectImpl.Container implements NachrichtenkopfG2GType {
	...
	protected EClass eStaticClass() {
		return BasisG2GPackage.Literals.NACHRICHTENKOPF_G2G_TYPE;
	}
	...
	public NotificationChain basicSetIdentifikationNachricht(IdentifikationNachrichtType newIdentifikationNachricht, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__IDENTIFIKATION_NACHRICHT, oldIdentifikationNachricht, newIdentifikationNachricht);
	...
	public void setIdentifikationNachricht(IdentifikationNachrichtType newIdentifikationNachricht) {
		if (newIdentifikationNachricht != identifikationNachricht) {
			...
			if (identifikationNachricht != null)
				msgs = ((InternalEObject)identifikationNachricht).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__IDENTIFIKATION_NACHRICHT, null, msgs);
			if (newIdentifikationNachricht != null)
				msgs = ((InternalEObject)newIdentifikationNachricht).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__IDENTIFIKATION_NACHRICHT, null, msgs);
			msgs = basicSetIdentifikationNachricht(newIdentifikationNachricht, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__IDENTIFIKATION_NACHRICHT, newIdentifikationNachricht, newIdentifikationNachricht));
	}
	...
	public NotificationChain basicSetLeser(BehoerdeType newLeser, NotificationChain msgs) {
		...
		leser = newLeser;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__LESER, oldLeser, newLeser);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLeser(BehoerdeType newLeser) {
		if (newLeser != leser) {
			NotificationChain msgs = null;
			if (leser != null)
				msgs = ((InternalEObject)leser).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__LESER, null, msgs);
			if (newLeser != null)
				msgs = ((InternalEObject)newLeser).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__LESER, null, msgs);
			msgs = basicSetLeser(newLeser, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__LESER, newLeser, newLeser));
	}
	...
	public NotificationChain basicSetAutor(BehoerdeType newAutor, NotificationChain msgs) {
		...
		autor = newAutor;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__AUTOR, oldAutor, newAutor);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAutor(BehoerdeType newAutor) {
		if (newAutor != autor) {
			NotificationChain msgs = null;
			if (autor != null)
				msgs = ((InternalEObject)autor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__AUTOR, null, msgs);
			if (newAutor != null)
				msgs = ((InternalEObject)newAutor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__AUTOR, null, msgs);
			msgs = basicSetAutor(newAutor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__AUTOR, newAutor, newAutor));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__IDENTIFIKATION_NACHRICHT:
				return basicSetIdentifikationNachricht(null, msgs);
			case BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__LESER:
				return basicSetLeser(null, msgs);
			case BasisG2GPackage.NACHRICHTENKOPF_G2G_TYPE__AUTOR:
