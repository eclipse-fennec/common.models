 ...
 * @generated
 */
public class BasisKommunikationSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public BasisKommunikationSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BasisKommunikationPackage.CODE_KOMMUNIKATION_KANAL_TYPE: {
