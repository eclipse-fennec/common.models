 ...
 * @generated
 */
public class BasisBehoerdeAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static BasisBehoerdePackage modelPackage;
	 ...
	 * @generated
	 */
	public BasisBehoerdeAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = BasisBehoerdePackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected BasisBehoerdeSwitch<Adapter> modelSwitch =
		new BasisBehoerdeSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.xoev.schemata.basisnachricht.behoerde.basisbehoerde.BehoerdeType <em>Behoerde Type</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.xoev.schemata.basisnachricht.behoerde.basisbehoerde.CodeVerzeichnisdienstType <em>Code Verzeichnisdienst Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
