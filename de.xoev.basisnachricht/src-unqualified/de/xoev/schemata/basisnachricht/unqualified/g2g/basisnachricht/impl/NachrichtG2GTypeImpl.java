 ...
 * </p>
 * <ul>
 *   <li>{@link de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.impl.NachrichtG2GTypeImpl#getNachrichtenkopfG2g <em>Nachrichtenkopf G2g</em>}</li>
 *   <li>{@link de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.impl.NachrichtG2GTypeImpl#getProdukt <em>Produkt</em>}</li>
 *   <li>{@link de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.impl.NachrichtG2GTypeImpl#getProdukthersteller <em>Produkthersteller</em>}</li>
 *   <li>{@link de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.impl.NachrichtG2GTypeImpl#getProduktversion <em>Produktversion</em>}</li>
 *   <li>{@link de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.impl.NachrichtG2GTypeImpl#getStandard <em>Standard</em>}</li>
 *   <li>{@link de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.impl.NachrichtG2GTypeImpl#getTest <em>Test</em>}</li>
 *   <li>{@link de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.impl.NachrichtG2GTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NachrichtG2GTypeImpl extends MinimalEObjectImpl.Container implements NachrichtG2GType {
	...
	protected EClass eStaticClass() {
		return BasisnachrichtUnqualifiedPackage.Literals.NACHRICHT_G2G_TYPE;
	}
	...
	public NotificationChain basicSetNachrichtenkopfG2g(NachrichtenkopfG2GType newNachrichtenkopfG2g, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__NACHRICHTENKOPF_G2G, oldNachrichtenkopfG2g, newNachrichtenkopfG2g);
	...
	public void setNachrichtenkopfG2g(NachrichtenkopfG2GType newNachrichtenkopfG2g) {
		if (newNachrichtenkopfG2g != nachrichtenkopfG2g) {
			...
			if (nachrichtenkopfG2g != null)
				msgs = ((InternalEObject)nachrichtenkopfG2g).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__NACHRICHTENKOPF_G2G, null, msgs);
			if (newNachrichtenkopfG2g != null)
				msgs = ((InternalEObject)newNachrichtenkopfG2g).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__NACHRICHTENKOPF_G2G, null, msgs);
			msgs = basicSetNachrichtenkopfG2g(newNachrichtenkopfG2g, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__NACHRICHTENKOPF_G2G, newNachrichtenkopfG2g, newNachrichtenkopfG2g));
	}
	...
	public void setProdukt(String newProdukt) {
		...
		produkt = newProdukt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__PRODUKT, oldProdukt, produkt));
	}
	...
	public void setProdukthersteller(String newProdukthersteller) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__PRODUKTHERSTELLER, oldProdukthersteller, produkthersteller));
	}
	...
	public void setProduktversion(String newProduktversion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__PRODUKTVERSION, oldProduktversion, produktversion));
	}
	...
	public void setStandard(String newStandard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__STANDARD, oldStandard, standard));
	}
	...
	public void setTest(String newTest) {
		...
		test = newTest;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__TEST, oldTest, test));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__VERSION, oldVersion, version));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__NACHRICHTENKOPF_G2G:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__PRODUKT:
				return getProdukt();
			case BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__PRODUKTHERSTELLER:
				return getProdukthersteller();
			case BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__PRODUKTVERSION:
				return getProduktversion();
			case BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__STANDARD:
				return getStandard();
			case BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__TEST:
				return getTest();
			case BasisnachrichtUnqualifiedPackage.NACHRICHT_G2G_TYPE__VERSION:
				return getVersion();
		}
