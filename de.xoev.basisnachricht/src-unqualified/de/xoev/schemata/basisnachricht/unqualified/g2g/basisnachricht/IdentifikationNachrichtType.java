 ...
 * </p>
 * <ul>
 *   <li>{@link de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.IdentifikationNachrichtType#getNachrichtenUUID <em>Nachrichten UUID</em>}</li>
 *   <li>{@link de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.IdentifikationNachrichtType#getNachrichtentyp <em>Nachrichtentyp</em>}</li>
 *   <li>{@link de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.IdentifikationNachrichtType#getErstellungszeitpunkt <em>Erstellungszeitpunkt</em>}</li>
 * </ul>
 *
 * @see de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.BasisnachrichtUnqualifiedPackage#getIdentifikationNachrichtType()
...
public interface IdentifikationNachrichtType extends EObject {
	 ...
	 * @see de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.BasisnachrichtUnqualifiedPackage#getIdentifikationNachrichtType_NachrichtenUUID()
	 * @model dataType="de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.UUID" required="true"
	 *        extendedMetaData="kind='element' name='nachrichtenUUID'"
	 * @generated
	 */
	String getNachrichtenUUID();

	/**
	 * Sets the value of the '{@link de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.IdentifikationNachrichtType#getNachrichtenUUID <em>Nachrichten UUID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.BasisnachrichtUnqualifiedPackage#getIdentifikationNachrichtType_Nachrichtentyp()
	 * @model containment="true" required="true"
	 *        extendedMetaData="kind='element' name='nachrichtentyp'"
	 * @generated
	 */
	Code getNachrichtentyp();

	/**
	 * Sets the value of the '{@link de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.IdentifikationNachrichtType#getNachrichtentyp <em>Nachrichtentyp</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.BasisnachrichtUnqualifiedPackage#getIdentifikationNachrichtType_Erstellungszeitpunkt()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.DateTime" required="true"
	 *        extendedMetaData="kind='element' name='erstellungszeitpunkt'"
	 * @generated
	 */
	XMLGregorianCalendar getErstellungszeitpunkt();

	/**
	 * Sets the value of the '{@link de.xoev.schemata.basisnachricht.unqualified.g2g.basisnachricht.IdentifikationNachrichtType#getErstellungszeitpunkt <em>Erstellungszeitpunkt</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
