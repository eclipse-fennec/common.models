 ...
 * </p>
 * <ul>
 *   <li>{@link org.cyclonedx.schema.bom.RequirementsType1#getRequirement <em>Requirement</em>}</li>
 * </ul>
 *
 * @see org.cyclonedx.schema.bom.BOMPackage#getRequirementsType1()
...
public interface RequirementsType1 extends EObject {
	 ...
	 * The list contents are of type {@link org.cyclonedx.schema.bom.RequirementType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Requirement</em>' containment reference list.
	 * @see org.cyclonedx.schema.bom.BOMPackage#getRequirementsType1_Requirement()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='requirement' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<RequirementType> getRequirement();
