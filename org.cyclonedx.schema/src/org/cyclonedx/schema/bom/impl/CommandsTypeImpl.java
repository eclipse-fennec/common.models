 ...
 * </p>
 * <ul>
 *   <li>{@link org.cyclonedx.schema.bom.impl.CommandsTypeImpl#getCommand <em>Command</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommandsTypeImpl extends MinimalEObjectImpl.Container implements CommandsType {
	 ...
	 * @ordered
	 */
	protected EList<CommandType> command;
	...
	protected EClass eStaticClass() {
		return BOMPackage.eINSTANCE.getCommandsType();
	}
	...
	public EList<CommandType> getCommand() {
		if (command == null) {
			command = new EObjectContainmentEList<CommandType>(CommandType.class, this, BOMPackage.COMMANDS_TYPE__COMMAND);
		}
		return command;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BOMPackage.COMMANDS_TYPE__COMMAND:
