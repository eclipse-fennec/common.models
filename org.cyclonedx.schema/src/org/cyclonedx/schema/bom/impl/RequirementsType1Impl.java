 ...
 * </p>
 * <ul>
 *   <li>{@link org.cyclonedx.schema.bom.impl.RequirementsType1Impl#getRequirement <em>Requirement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequirementsType1Impl extends MinimalEObjectImpl.Container implements RequirementsType1 {
	 ...
	 * @ordered
	 */
	protected EList<RequirementType> requirement;
	...
	protected EClass eStaticClass() {
		return BOMPackage.eINSTANCE.getRequirementsType1();
	}
	 ...
	 */
	@Override
	public EList<RequirementType> getRequirement() {
		if (requirement == null) {
			requirement = new EObjectContainmentEList<RequirementType>(RequirementType.class, this, BOMPackage.REQUIREMENTS_TYPE1__REQUIREMENT);
		}
		return requirement;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BOMPackage.REQUIREMENTS_TYPE1__REQUIREMENT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case BOMPackage.REQUIREMENTS_TYPE1__REQUIREMENT:
				...
				getRequirement().addAll((Collection<? extends RequirementType>)newValue);
				return;
		}
