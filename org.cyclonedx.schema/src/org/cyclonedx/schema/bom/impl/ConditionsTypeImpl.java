 ...
 * </p>
 * <ul>
 *   <li>{@link org.cyclonedx.schema.bom.impl.ConditionsTypeImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionsTypeImpl extends MinimalEObjectImpl.Container implements ConditionsType {
	...
	protected EClass eStaticClass() {
		return BOMPackage.eINSTANCE.getConditionsType();
	}
	...
	public EList<ConditionType> getCondition() {
		if (condition == null) {
			condition = new EObjectContainmentEList<ConditionType>(ConditionType.class, this, BOMPackage.CONDITIONS_TYPE__CONDITION);
		}
		return condition;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BOMPackage.CONDITIONS_TYPE__CONDITION:
