 ...
 * </p>
 * <ul>
 *   <li>{@link org.cyclonedx.schema.bom.impl.InputsTypeImpl#getInput <em>Input</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputsTypeImpl extends MinimalEObjectImpl.Container implements InputsType {
	...
	protected EClass eStaticClass() {
		return BOMPackage.eINSTANCE.getInputsType();
	}
	...
	public EList<InputType> getInput() {
		if (input == null) {
			input = new EObjectContainmentEList<InputType>(InputType.class, this, BOMPackage.INPUTS_TYPE__INPUT);
		}
		return input;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BOMPackage.INPUTS_TYPE__INPUT:
