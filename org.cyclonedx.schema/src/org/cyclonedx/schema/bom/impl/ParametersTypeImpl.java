 ...
 * </p>
 * <ul>
 *   <li>{@link org.cyclonedx.schema.bom.impl.ParametersTypeImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParametersTypeImpl extends MinimalEObjectImpl.Container implements ParametersType {
	...
	protected EClass eStaticClass() {
		return BOMPackage.eINSTANCE.getParametersType();
	}
	...
	public EList<ParameterType> getParameter() {
		if (parameter == null) {
			parameter = new EObjectContainmentEList<ParameterType>(ParameterType.class, this, BOMPackage.PARAMETERS_TYPE__PARAMETER);
		}
		return parameter;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BOMPackage.PARAMETERS_TYPE__PARAMETER:
