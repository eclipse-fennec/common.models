 ...
 * </p>
 * <ul>
 *   <li>{@link org.cyclonedx.schema.bom.impl.IdentifiersTypeImpl#getIdentifier <em>Identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdentifiersTypeImpl extends MinimalEObjectImpl.Container implements IdentifiersType {
	...
	protected EClass eStaticClass() {
		return BOMPackage.eINSTANCE.getIdentifiersType();
	}
	...
	public EList<String> getIdentifier() {
		if (identifier == null) {
			identifier = new EDataTypeEList<String>(String.class, this, BOMPackage.IDENTIFIERS_TYPE__IDENTIFIER);
		}
		return identifier;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BOMPackage.IDENTIFIERS_TYPE__IDENTIFIER:
