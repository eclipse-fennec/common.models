 ...
 * @generated
 */
public class BOMEPackageConfigurator implements EPackageConfigurator {
	
	private BOMPackage ePackage;

	protected BOMEPackageConfigurator(BOMPackage ePackage){
	...
	public void configureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.put(BOMPackage.eNS_URI, ePackage);
	}
	...
	public void unconfigureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.remove(BOMPackage.eNS_URI);
	}
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_NAME, BOMPackage.eNAME);
		properties.put(EMFNamespaces.EMF_MODEL_NSURI, BOMPackage.eNS_URI);
		properties.put(EMFNamespaces.EMF_MODEL_REGISTRATION, EMFNamespaces.MODEL_REGISTRATION_PROVIDED);
		properties.put(EMFNamespaces.EMF_MODEL_FILE_EXT, "bom");
