...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.w3._2001.xinclude\"" })
...
public class IncludeConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(IncludePackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(IncludePackage.eNS_URI, ePackage);
		}
