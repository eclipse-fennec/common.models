 ...
 */
package org.eclipse.fennec.model.utilities.impl;
...
import org.eclipse.fennec.model.utilities.Converter;
import org.eclipse.fennec.model.utilities.FeaturePath;
import org.eclipse.fennec.model.utilities.Filter;
import org.eclipse.fennec.model.utilities.LatLng;
import org.eclipse.fennec.model.utilities.Request;
import org.eclipse.fennec.model.utilities.Response;
import org.eclipse.fennec.model.utilities.Sort;
import org.eclipse.fennec.model.utilities.SortType;
...
public class UtilitiesPackageImpl extends EPackageImpl implements UtilitiesPackage {
	 ...
	 * @see org.eclipse.fennec.model.utilities.UtilitiesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void createGenModelAnnotations() {
		...
		addAnnotation
		  (getFeaturePath__GetValue__EObject(),
		   source,
		   new String[] {
			   "body", "<%java.util.List%><Object> result = <%org.eclipse.fennec.model.utils.UtilModelHelper%>.getFeaturePathValue(this, object);\nif (result != null) {\n\treturn <%org.eclipse.emf.common.util.ECollections%>.asEList(result);\n}\nreturn <%org.eclipse.emf.common.util.ECollections%>.emptyEList();"
		   });
		addAnnotation
		  (getFeaturePath__IsValid__EObject(),
		   source,
		   new String[] {
			   "body", "if (object == null) {\n\treturn false;\n}\nreturn <%org.eclipse.fennec.model.utils.UtilModelHelper%>.validateFeaturePath(this, object.eClass());"
		   });
		addAnnotation
		  (requestEClass,
		   source,
