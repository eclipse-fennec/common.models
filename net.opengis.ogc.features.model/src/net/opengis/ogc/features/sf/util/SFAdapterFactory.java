 ...
 */
package net.opengis.ogc.features.sf.util;
 ...
 * @generated
 */
public class SFAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static SFPackage modelPackage;
	 ...
	 * @generated
	 */
	public SFAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = SFPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected SFSwitch<Adapter> modelSwitch =
		new SFSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseFeatureMember(FeatureMember object) {
				return createFeatureMemberAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.opengis.ogc.features.sf.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.opengis.ogc.features.sf.FeatureCollection <em>Feature Collection</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.opengis.ogc.features.sf.FeatureMember <em>Feature Member</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFeatureMemberAdapter() {
		return null;
	}
