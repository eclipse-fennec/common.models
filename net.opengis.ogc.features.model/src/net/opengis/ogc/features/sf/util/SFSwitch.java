 ...
 * @generated
 */
public class SFSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SFPackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SFPackage.FEATURE_COLLECTION: {
				FeatureCollection featureCollection = (FeatureCollection)theEObject;
				T result = caseFeatureCollection(featureCollection);
				if (result == null) result = caseAbstractFeatureType(featureCollection);
				if (result == null) result = caseAbstractGMLType(featureCollection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SFPackage.FEATURE_MEMBER: {
				FeatureMember featureMember = (FeatureMember)theEObject;
				T result = caseFeatureMember(featureMember);
				if (result == null) result = caseAbstractFeatureMemberType(featureMember);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Feature Member</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Feature Member</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFeatureMember(FeatureMember object) {
		return null;
	}
