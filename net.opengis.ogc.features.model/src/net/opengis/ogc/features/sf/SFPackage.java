 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * This XML Schema Document specifies a
 ...
 *       
 * <!-- end-model-doc -->
 * @see net.opengis.ogc.features.sf.SFFactory
 * @model kind="package"
 *        annotation="http://schemas.opengis.net/gmlsfProfile/2.0/gmlsfLevels.xsd appinfo='\n                                                                                             \n      \n      \n      \n      \n      \n      \n      \n      \n      \n      \n      \n      \n      \n      \n  &lt;gmlsf:ComplianceLevel xmlns:gmlsf=\"http://www.opengis.net/gmlsf/2.0\"&gt;0&lt;/gmlsf:ComplianceLevel&gt;\n                                                                                          \n    \n    \n    \n    \n    \n    \n    \n    \n    \n    \n    \n    \n    \n    \n'"
 ...
 */
@ProviderType
@EPackage(uri = SFPackage.eNS_URI, fingerprint = "fp1:6619623ded6feeb5d898b4210e7097e14b9af22ee31add9278f23d3640233a95", genModel = "/model/ogc-features.genmodel", genModelSourceLocations = {"model/ogc-features.genmodel","net.opengis.ogc.features.model/model/ogc-features.genmodel"}, ecore = "/model/ogc-features.ecore", ecoreSourceLocations = "/model/ogc-features.ecore")
public interface SFPackage extends org.eclipse.emf.ecore.EPackage {
	/**
	 * The package name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	String eNS_URI = "http://www.opengis.net/ogcapi-features-1/1.0/sf";
	 ...
	 * @generated
	 */
	SFPackage eINSTANCE = net.opengis.ogc.features.sf.impl.SFPackageImpl.init();

	/**
	 * The meta object id for the '{@link net.opengis.ogc.features.sf.impl.DocumentRootImpl <em>Document Root</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see net.opengis.ogc.features.sf.impl.DocumentRootImpl
	 * @see net.opengis.ogc.features.sf.impl.SFPackageImpl#getDocumentRoot()
	 * @generated
	 */
	int DOCUMENT_ROOT = 0;
	 ...
	 * @ordered
	 */
	int DOCUMENT_ROOT__FEATURE_COLLECTION = 3;
	...
	/**
	 * The meta object id for the '{@link net.opengis.ogc.features.sf.impl.FeatureCollectionImpl <em>Feature Collection</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see net.opengis.ogc.features.sf.impl.FeatureCollectionImpl
	 * @see net.opengis.ogc.features.sf.impl.SFPackageImpl#getFeatureCollection()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int FEATURE_COLLECTION__META_DATA_PROPERTY = GMLPackage.ABSTRACT_FEATURE_TYPE__META_DATA_PROPERTY;
	 ...
	 * @ordered
	 */
	int FEATURE_COLLECTION__DESCRIPTION = GMLPackage.ABSTRACT_FEATURE_TYPE__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int FEATURE_COLLECTION__DESCRIPTION_REFERENCE = GMLPackage.ABSTRACT_FEATURE_TYPE__DESCRIPTION_REFERENCE;
	 ...
	 * @ordered
	 */
	int FEATURE_COLLECTION__IDENTIFIER = GMLPackage.ABSTRACT_FEATURE_TYPE__IDENTIFIER;
	 ...
	 * @ordered
	 */
	int FEATURE_COLLECTION__NAME = GMLPackage.ABSTRACT_FEATURE_TYPE__NAME;
	 ...
	 * @ordered
	 */
	int FEATURE_COLLECTION__ID = GMLPackage.ABSTRACT_FEATURE_TYPE__ID;
	 ...
	 * @ordered
	 */
	int FEATURE_COLLECTION__BOUNDED_BY = GMLPackage.ABSTRACT_FEATURE_TYPE__BOUNDED_BY;
	 ...
	 * @ordered
	 */
	int FEATURE_COLLECTION__LOCATION_GROUP = GMLPackage.ABSTRACT_FEATURE_TYPE__LOCATION_GROUP;
	 ...
	 * @ordered
	 */
	int FEATURE_COLLECTION__LOCATION = GMLPackage.ABSTRACT_FEATURE_TYPE__LOCATION;
	 ...
	 * @ordered
	 */
	int FEATURE_COLLECTION__GROUP = GMLPackage.ABSTRACT_FEATURE_TYPE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FEATURE_COLLECTION__FEATURE_MEMBER = GMLPackage.ABSTRACT_FEATURE_TYPE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int FEATURE_COLLECTION_FEATURE_COUNT = GMLPackage.ABSTRACT_FEATURE_TYPE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int FEATURE_COLLECTION_OPERATION_COUNT = GMLPackage.ABSTRACT_FEATURE_TYPE_OPERATION_COUNT + 0;

	/**
	 * The meta object id for the '{@link net.opengis.ogc.features.sf.impl.FeatureMemberImpl <em>Feature Member</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see net.opengis.ogc.features.sf.impl.FeatureMemberImpl
	 * @see net.opengis.ogc.features.sf.impl.SFPackageImpl#getFeatureMember()
	 * @generated
	 */
	int FEATURE_MEMBER = 2;
	 ...
	 * @ordered
	 */
	int FEATURE_MEMBER__OWNS = GMLPackage.ABSTRACT_FEATURE_MEMBER_TYPE__OWNS;
	 ...
	 * @ordered
	 */
	int FEATURE_MEMBER__ABSTRACT_FEATURE_GROUP = GMLPackage.ABSTRACT_FEATURE_MEMBER_TYPE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FEATURE_MEMBER__ABSTRACT_FEATURE = GMLPackage.ABSTRACT_FEATURE_MEMBER_TYPE_FEATURE_COUNT + 1;

	/**
	 * The number of structural features of the '<em>Feature Member</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int FEATURE_MEMBER_FEATURE_COUNT = GMLPackage.ABSTRACT_FEATURE_MEMBER_TYPE_FEATURE_COUNT + 2;

	/**
	 * The number of operations of the '<em>Feature Member</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int FEATURE_MEMBER_OPERATION_COUNT = GMLPackage.ABSTRACT_FEATURE_MEMBER_TYPE_OPERATION_COUNT + 0;


	/**
	 * Returns the meta object for class '{@link net.opengis.ogc.features.sf.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Document Root</em>'.
	 * @see net.opengis.ogc.features.sf.DocumentRoot
	 * @generated
	 */
	EClass getDocumentRoot();

	/**
	 * Returns the meta object for the attribute list '{@link net.opengis.ogc.features.sf.DocumentRoot#getMixed <em>Mixed</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute list '<em>Mixed</em>'.
	 * @see net.opengis.ogc.features.sf.DocumentRoot#getMixed()
	 * @see #getDocumentRoot()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the map '{@link net.opengis.ogc.features.sf.DocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the map '<em>XMLNS Prefix Map</em>'.
	 * @see net.opengis.ogc.features.sf.DocumentRoot#getXMLNSPrefixMap()
	 * @see #getDocumentRoot()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the map '{@link net.opengis.ogc.features.sf.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the map '<em>XSI Schema Location</em>'.
	 * @see net.opengis.ogc.features.sf.DocumentRoot#getXSISchemaLocation()
	 * @see #getDocumentRoot()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference '{@link net.opengis.ogc.features.sf.DocumentRoot#getFeatureCollection <em>Feature Collection</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Feature Collection</em>'.
	 * @see net.opengis.ogc.features.sf.DocumentRoot#getFeatureCollection()
	 * @see #getDocumentRoot()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link net.opengis.ogc.features.sf.FeatureCollection <em>Feature Collection</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Feature Collection</em>'.
	 * @see net.opengis.ogc.features.sf.FeatureCollection
	 * @generated
	 */
	EClass getFeatureCollection();

	/**
	 * Returns the meta object for the attribute list '{@link net.opengis.ogc.features.sf.FeatureCollection#getGroup <em>Group</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute list '<em>Group</em>'.
	 * @see net.opengis.ogc.features.sf.FeatureCollection#getGroup()
	 * @see #getFeatureCollection()
	 * @generated
	 */
	EAttribute getFeatureCollection_Group();

	/**
	 * Returns the meta object for the containment reference list '{@link net.opengis.ogc.features.sf.FeatureCollection#getFeatureMember <em>Feature Member</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Feature Member</em>'.
	 * @see net.opengis.ogc.features.sf.FeatureCollection#getFeatureMember()
	 * @see #getFeatureCollection()
	 * @generated
	 */
	EReference getFeatureCollection_FeatureMember();

	/**
	 * Returns the meta object for class '{@link net.opengis.ogc.features.sf.FeatureMember <em>Feature Member</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Feature Member</em>'.
	 * @see net.opengis.ogc.features.sf.FeatureMember
	 * @generated
	 */
	EClass getFeatureMember();

	/**
	 * Returns the meta object for the attribute list '{@link net.opengis.ogc.features.sf.FeatureMember#getAbstractFeatureGroup <em>Abstract Feature Group</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute list '<em>Abstract Feature Group</em>'.
	 * @see net.opengis.ogc.features.sf.FeatureMember#getAbstractFeatureGroup()
	 * @see #getFeatureMember()
	 * @generated
	 */
	EAttribute getFeatureMember_AbstractFeatureGroup();

	/**
	 * Returns the meta object for the containment reference '{@link net.opengis.ogc.features.sf.FeatureMember#getAbstractFeature <em>Abstract Feature</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Abstract Feature</em>'.
	 * @see net.opengis.ogc.features.sf.FeatureMember#getAbstractFeature()
	 * @see #getFeatureMember()
	 * @generated
	 */
	EReference getFeatureMember_AbstractFeature();
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link net.opengis.ogc.features.sf.impl.DocumentRootImpl <em>Document Root</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see net.opengis.ogc.features.sf.impl.DocumentRootImpl
		 * @see net.opengis.ogc.features.sf.impl.SFPackageImpl#getDocumentRoot()
		...
		/**
		 * The meta object literal for the '{@link net.opengis.ogc.features.sf.impl.FeatureCollectionImpl <em>Feature Collection</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see net.opengis.ogc.features.sf.impl.FeatureCollectionImpl
		 * @see net.opengis.ogc.features.sf.impl.SFPackageImpl#getFeatureCollection()
		 ...
		 * @generated
		 */
		EAttribute FEATURE_COLLECTION__GROUP = eINSTANCE.getFeatureCollection_Group();

		/**
		 * The meta object literal for the '<em><b>Feature Member</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference FEATURE_COLLECTION__FEATURE_MEMBER = eINSTANCE.getFeatureCollection_FeatureMember();

		/**
		 * The meta object literal for the '{@link net.opengis.ogc.features.sf.impl.FeatureMemberImpl <em>Feature Member</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see net.opengis.ogc.features.sf.impl.FeatureMemberImpl
		 * @see net.opengis.ogc.features.sf.impl.SFPackageImpl#getFeatureMember()
		 * @generated
		 */
		EClass FEATURE_MEMBER = eINSTANCE.getFeatureMember();

		/**
		 * The meta object literal for the '<em><b>Abstract Feature Group</b></em>' attribute list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute FEATURE_MEMBER__ABSTRACT_FEATURE_GROUP = eINSTANCE.getFeatureMember_AbstractFeatureGroup();

		/**
		 * The meta object literal for the '<em><b>Abstract Feature</b></em>' containment reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference FEATURE_MEMBER__ABSTRACT_FEATURE = eINSTANCE.getFeatureMember_AbstractFeature();
