 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ogc.features.impl.ExceptionImpl#getExceptionText <em>Exception Text</em>}</li>
 *   <li>{@link net.opengis.ogc.features.impl.ExceptionImpl#getExceptionCode <em>Exception Code</em>}</li>
 *   <li>{@link net.opengis.ogc.features.impl.ExceptionImpl#getLocator <em>Locator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExceptionImpl extends MinimalEObjectImpl.Container implements net.opengis.ogc.features.Exception {
	/**
	...
	protected EClass eStaticClass() {
		return OGCFeaturesPackage.Literals.EXCEPTION;
	}
	...
	public EList<String> getExceptionText() {
		if (exceptionText == null) {
			exceptionText = new EDataTypeEList<String>(String.class, this, OGCFeaturesPackage.EXCEPTION__EXCEPTION_TEXT);
		}
	...
	public void setExceptionCode(String newExceptionCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OGCFeaturesPackage.EXCEPTION__EXCEPTION_CODE, oldExceptionCode, exceptionCode));
	}
	...
	public void setLocator(String newLocator) {
		...
		locator = newLocator;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OGCFeaturesPackage.EXCEPTION__LOCATOR, oldLocator, locator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OGCFeaturesPackage.EXCEPTION__EXCEPTION_TEXT:
				return getExceptionText();
			case OGCFeaturesPackage.EXCEPTION__EXCEPTION_CODE:
				return getExceptionCode();
			case OGCFeaturesPackage.EXCEPTION__LOCATOR:
				return getLocator();
		}
