 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ogc.features.impl.EndImpl#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.ogc.features.impl.EndImpl#isInclusive <em>Inclusive</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EndImpl extends MinimalEObjectImpl.Container implements End {
	...
	protected EClass eStaticClass() {
		return OGCFeaturesPackage.Literals.END;
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OGCFeaturesPackage.END__VALUE, oldValue, value));
	}
	...
	public void setInclusive(boolean newInclusive) {
		...
		inclusiveESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OGCFeaturesPackage.END__INCLUSIVE, oldInclusive, inclusive, !oldInclusiveESet));
	}
	...
	public void unsetInclusive() {
		...
		inclusiveESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OGCFeaturesPackage.END__INCLUSIVE, oldInclusive, INCLUSIVE_EDEFAULT, oldInclusiveESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OGCFeaturesPackage.END__VALUE:
				return getValue();
			case OGCFeaturesPackage.END__INCLUSIVE:
				return isInclusive();
		}
