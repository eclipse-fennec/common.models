 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ogc.features.impl.BoundingBoxImpl#getLowerCorner <em>Lower Corner</em>}</li>
 *   <li>{@link net.opengis.ogc.features.impl.BoundingBoxImpl#getUpperCorner <em>Upper Corner</em>}</li>
 *   <li>{@link net.opengis.ogc.features.impl.BoundingBoxImpl#getCrs <em>Crs</em>}</li>
 *   <li>{@link net.opengis.ogc.features.impl.BoundingBoxImpl#getDimensions <em>Dimensions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoundingBoxImpl extends SpatialExtentImpl implements BoundingBox {
	/**
	...
	protected EClass eStaticClass() {
		return OGCFeaturesPackage.Literals.BOUNDING_BOX;
	}
	...
	public void setLowerCorner(List<Double> newLowerCorner) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OGCFeaturesPackage.BOUNDING_BOX__LOWER_CORNER, oldLowerCorner, lowerCorner));
	}
	...
	public void setUpperCorner(List<Double> newUpperCorner) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OGCFeaturesPackage.BOUNDING_BOX__UPPER_CORNER, oldUpperCorner, upperCorner));
	}
	...
	public void setCrs(String newCrs) {
		...
		crs = newCrs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OGCFeaturesPackage.BOUNDING_BOX__CRS, oldCrs, crs));
	}
	...
	public void setDimensions(BigInteger newDimensions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OGCFeaturesPackage.BOUNDING_BOX__DIMENSIONS, oldDimensions, dimensions));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OGCFeaturesPackage.BOUNDING_BOX__LOWER_CORNER:
				return getLowerCorner();
			case OGCFeaturesPackage.BOUNDING_BOX__UPPER_CORNER:
				return getUpperCorner();
			case OGCFeaturesPackage.BOUNDING_BOX__CRS:
				return getCrs();
			case OGCFeaturesPackage.BOUNDING_BOX__DIMENSIONS:
