...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.w3._2001.smil20.language\"" })
...
public class LanguageConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(LanguagePackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(LanguagePackage.eNS_URI, ePackage);
		}
