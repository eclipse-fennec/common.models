 ...
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getAddressLine <em>Address Line</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getPostOfficeName <em>Post Office Name</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getPostOfficeNumber <em>Post Office Number</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getPostalRoute <em>Postal Route</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getPostBox <em>Post Box</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getPostalCode <em>Postal Code</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getAny <em>Any</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getIndicator <em>Indicator</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getType <em>Type</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPostOfficeType()
...
public interface PostOfficeType extends EObject {
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPostOfficeType_AddressLine()
	 ...
	 * The list contents are of type {@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeNameType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPostOfficeType_PostOfficeName()
	 * @model containment="true"
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPostOfficeType_PostOfficeNumber()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getPostOfficeNumber <em>Post Office Number</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPostOfficeType_PostalRoute()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getPostalRoute <em>Postal Route</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPostOfficeType_PostBox()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getPostBox <em>Post Box</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPostOfficeType_PostalCode()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getPostalCode <em>Postal Code</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPostOfficeType_Any()
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPostOfficeType_Indicator()
	...
	/**
	 * Sets the value of the '{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getIndicator <em>Indicator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setType(Object)
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPostOfficeType_Type()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.AnySimpleType"
	...
	/**
	 * Sets the value of the '{@link oasis.names.tc.ciq.xsdschema.xAL.PostOfficeType#getType <em>Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPostOfficeType_AnyAttribute()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
