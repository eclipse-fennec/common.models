 ...
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.ThoroughfareNumberToType#getMixed <em>Mixed</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.ThoroughfareNumberToType#getAddressLine <em>Address Line</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.ThoroughfareNumberToType#getThoroughfareNumberPrefix <em>Thoroughfare Number Prefix</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.ThoroughfareNumberToType#getThoroughfareNumber <em>Thoroughfare Number</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.ThoroughfareNumberToType#getThoroughfareNumberSuffix <em>Thoroughfare Number Suffix</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.ThoroughfareNumberToType#getCode <em>Code</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.ThoroughfareNumberToType#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getThoroughfareNumberToType()
...
public interface ThoroughfareNumberToType extends EObject {
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getThoroughfareNumberToType_Mixed()
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getThoroughfareNumberToType_AddressLine()
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getThoroughfareNumberToType_ThoroughfareNumberPrefix()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getThoroughfareNumberToType_ThoroughfareNumber()
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getThoroughfareNumberToType_ThoroughfareNumberSuffix()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see #setCode(Object)
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getThoroughfareNumberToType_Code()
	...
	/**
	 * Sets the value of the '{@link oasis.names.tc.ciq.xsdschema.xAL.ThoroughfareNumberToType#getCode <em>Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getThoroughfareNumberToType_AnyAttribute()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
