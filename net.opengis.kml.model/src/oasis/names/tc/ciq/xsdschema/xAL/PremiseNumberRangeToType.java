 ...
 * </p>
 * <ul>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.PremiseNumberRangeToType#getAddressLine <em>Address Line</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.PremiseNumberRangeToType#getPremiseNumberPrefix <em>Premise Number Prefix</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.PremiseNumberRangeToType#getPremiseNumber <em>Premise Number</em>}</li>
 *   <li>{@link oasis.names.tc.ciq.xsdschema.xAL.PremiseNumberRangeToType#getPremiseNumberSuffix <em>Premise Number Suffix</em>}</li>
 * </ul>
 *
 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPremiseNumberRangeToType()
...
public interface PremiseNumberRangeToType extends EObject {
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPremiseNumberRangeToType_AddressLine()
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPremiseNumberRangeToType_PremiseNumberPrefix()
	 * @model containment="true"
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPremiseNumberRangeToType_PremiseNumber()
	 ...
	 * @see oasis.names.tc.ciq.xsdschema.xAL.XALPackage#getPremiseNumberRangeToType_PremiseNumberSuffix()
	 * @model containment="true"
