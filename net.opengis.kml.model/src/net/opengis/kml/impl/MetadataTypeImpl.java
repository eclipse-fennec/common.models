 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.kml.impl.MetadataTypeImpl#getAny <em>Any</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetadataTypeImpl extends MinimalEObjectImpl.Container implements MetadataType {
	...
	protected EClass eStaticClass() {
		return KMLPackage.eINSTANCE.getMetadataType();
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, KMLPackage.METADATA_TYPE__ANY);
		}
		return any;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KMLPackage.METADATA_TYPE__ANY:
