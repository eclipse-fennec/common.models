...
public class UnterhaltsvorschussEPackageConfigurator implements EPackageConfigurator {
	...
	public void configureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.put(UnterhaltsvorschussPackage.eNS_URI, ePackage);
	}
	...
	public void unconfigureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.remove(UnterhaltsvorschussPackage.eNS_URI);
	}
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_NAME, UnterhaltsvorschussPackage.eNAME);
		properties.put(EMFNamespaces.EMF_MODEL_NSURI, UnterhaltsvorschussPackage.eNS_URI);
