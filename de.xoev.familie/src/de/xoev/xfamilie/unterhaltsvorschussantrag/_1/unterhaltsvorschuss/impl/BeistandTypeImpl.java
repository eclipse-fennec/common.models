...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Beistand Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.xoev.xfamilie.unterhaltsvorschussantrag._1.unterhaltsvorschuss.impl.BeistandTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.xoev.xfamilie.unterhaltsvorschussantrag._1.unterhaltsvorschuss.impl.BeistandTypeImpl#getAnschriftJugendamt <em>Anschrift Jugendamt</em>}</li>
 *   <li>{@link de.xoev.xfamilie.unterhaltsvorschussantrag._1.unterhaltsvorschuss.impl.BeistandTypeImpl#getJugendamtEMail <em>Jugendamt EMail</em>}</li>
 *   <li>{@link de.xoev.xfamilie.unterhaltsvorschussantrag._1.unterhaltsvorschuss.impl.BeistandTypeImpl#getAktenzeichen <em>Aktenzeichen</em>}</li>
 *   <li>{@link de.xoev.xfamilie.unterhaltsvorschussantrag._1.unterhaltsvorschuss.impl.BeistandTypeImpl#getTelefonnummer <em>Telefonnummer</em>}</li>
 *   <li>{@link de.xoev.xfamilie.unterhaltsvorschussantrag._1.unterhaltsvorschuss.impl.BeistandTypeImpl#isBeauftragtGeltungsmachungUVanspruch <em>Beauftragt Geltungsmachung UVanspruch</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BeistandTypeImpl extends MinimalEObjectImpl.Container implements BeistandType {
	/**
	...
	protected EClass eStaticClass() {
		return UnterhaltsvorschussPackage.eINSTANCE.getBeistandType();
	}
	...
	public NotificationChain basicSetName(NameNatuerlichePersonType newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.BEISTAND_TYPE__NAME, oldName, newName);
	...
	public void setName(NameNatuerlichePersonType newName) {
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UnterhaltsvorschussPackage.BEISTAND_TYPE__NAME, null, msgs);
			if (newName != null)
				msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UnterhaltsvorschussPackage.BEISTAND_TYPE__NAME, null, msgs);
			msgs = basicSetName(newName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.BEISTAND_TYPE__NAME, newName, newName));
	}
	...
	public NotificationChain basicSetAnschriftJugendamt(PostalischeInlandsanschriftBasisType newAnschriftJugendamt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.BEISTAND_TYPE__ANSCHRIFT_JUGENDAMT, oldAnschriftJugendamt, newAnschriftJugendamt);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAnschriftJugendamt(PostalischeInlandsanschriftBasisType newAnschriftJugendamt) {
		if (newAnschriftJugendamt != anschriftJugendamt) {
			...
			if (anschriftJugendamt != null)
				msgs = ((InternalEObject)anschriftJugendamt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UnterhaltsvorschussPackage.BEISTAND_TYPE__ANSCHRIFT_JUGENDAMT, null, msgs);
			if (newAnschriftJugendamt != null)
				msgs = ((InternalEObject)newAnschriftJugendamt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UnterhaltsvorschussPackage.BEISTAND_TYPE__ANSCHRIFT_JUGENDAMT, null, msgs);
			msgs = basicSetAnschriftJugendamt(newAnschriftJugendamt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.BEISTAND_TYPE__ANSCHRIFT_JUGENDAMT, newAnschriftJugendamt, newAnschriftJugendamt));
	}
	...
	public void setJugendamtEMail(String newJugendamtEMail) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.BEISTAND_TYPE__JUGENDAMT_EMAIL, oldJugendamtEMail, jugendamtEMail));
	}
	...
	public void setAktenzeichen(String newAktenzeichen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.BEISTAND_TYPE__AKTENZEICHEN, oldAktenzeichen, aktenzeichen));
	}
	...
	public void setTelefonnummer(String newTelefonnummer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.BEISTAND_TYPE__TELEFONNUMMER, oldTelefonnummer, telefonnummer));
	}
	...
	public void setBeauftragtGeltungsmachungUVanspruch(boolean newBeauftragtGeltungsmachungUVanspruch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.BEISTAND_TYPE__BEAUFTRAGT_GELTUNGSMACHUNG_UVANSPRUCH, oldBeauftragtGeltungsmachungUVanspruch, beauftragtGeltungsmachungUVanspruch, !oldBeauftragtGeltungsmachungUVanspruchESet));
	}
	...
	public void unsetBeauftragtGeltungsmachungUVanspruch() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, UnterhaltsvorschussPackage.BEISTAND_TYPE__BEAUFTRAGT_GELTUNGSMACHUNG_UVANSPRUCH, oldBeauftragtGeltungsmachungUVanspruch, BEAUFTRAGT_GELTUNGSMACHUNG_UVANSPRUCH_EDEFAULT, oldBeauftragtGeltungsmachungUVanspruchESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UnterhaltsvorschussPackage.BEISTAND_TYPE__NAME:
				return basicSetName(null, msgs);
			case UnterhaltsvorschussPackage.BEISTAND_TYPE__ANSCHRIFT_JUGENDAMT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UnterhaltsvorschussPackage.BEISTAND_TYPE__JUGENDAMT_EMAIL:
				return getJugendamtEMail();
			case UnterhaltsvorschussPackage.BEISTAND_TYPE__AKTENZEICHEN:
				return getAktenzeichen();
			case UnterhaltsvorschussPackage.BEISTAND_TYPE__TELEFONNUMMER:
				return getTelefonnummer();
			case UnterhaltsvorschussPackage.BEISTAND_TYPE__BEAUFTRAGT_GELTUNGSMACHUNG_UVANSPRUCH:
