...
import de.xoev.xfamilie.unterhaltsvorschussantrag._1.unterhaltsvorschuss.GeburtType;
 ...
 * </p>
 * <ul>
 *   <li>{@link de.xoev.xfamilie.unterhaltsvorschussantrag._1.unterhaltsvorschuss.impl.GeburtTypeImpl#getGeburtsort <em>Geburtsort</em>}</li>
 *   <li>{@link de.xoev.xfamilie.unterhaltsvorschussantrag._1.unterhaltsvorschuss.impl.GeburtTypeImpl#getGeburtsortStaat <em>Geburtsort Staat</em>}</li>
 *   <li>{@link de.xoev.xfamilie.unterhaltsvorschussantrag._1.unterhaltsvorschuss.impl.GeburtTypeImpl#getGeburtsdatum <em>Geburtsdatum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeburtTypeImpl extends MinimalEObjectImpl.Container implements GeburtType {
	...
	protected EClass eStaticClass() {
		return UnterhaltsvorschussPackage.eINSTANCE.getGeburtType();
	}
	...
	public void setGeburtsort(String newGeburtsort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.GEBURT_TYPE__GEBURTSORT, oldGeburtsort, geburtsort));
	}
	...
	public NotificationChain basicSetGeburtsortStaat(CodeStaatType newGeburtsortStaat, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.GEBURT_TYPE__GEBURTSORT_STAAT, oldGeburtsortStaat, newGeburtsortStaat);
	...
	public void setGeburtsortStaat(CodeStaatType newGeburtsortStaat) {
		if (newGeburtsortStaat != geburtsortStaat) {
			...
			if (geburtsortStaat != null)
				msgs = ((InternalEObject)geburtsortStaat).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UnterhaltsvorschussPackage.GEBURT_TYPE__GEBURTSORT_STAAT, null, msgs);
			if (newGeburtsortStaat != null)
				msgs = ((InternalEObject)newGeburtsortStaat).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UnterhaltsvorschussPackage.GEBURT_TYPE__GEBURTSORT_STAAT, null, msgs);
			msgs = basicSetGeburtsortStaat(newGeburtsortStaat, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.GEBURT_TYPE__GEBURTSORT_STAAT, newGeburtsortStaat, newGeburtsortStaat));
	}
	...
	public NotificationChain basicSetGeburtsdatum(TeilbekanntesDatumType newGeburtsdatum, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.GEBURT_TYPE__GEBURTSDATUM, oldGeburtsdatum, newGeburtsdatum);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGeburtsdatum(TeilbekanntesDatumType newGeburtsdatum) {
		if (newGeburtsdatum != geburtsdatum) {
			...
			if (geburtsdatum != null)
				msgs = ((InternalEObject)geburtsdatum).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UnterhaltsvorschussPackage.GEBURT_TYPE__GEBURTSDATUM, null, msgs);
			if (newGeburtsdatum != null)
				msgs = ((InternalEObject)newGeburtsdatum).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UnterhaltsvorschussPackage.GEBURT_TYPE__GEBURTSDATUM, null, msgs);
			msgs = basicSetGeburtsdatum(newGeburtsdatum, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.GEBURT_TYPE__GEBURTSDATUM, newGeburtsdatum, newGeburtsdatum));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UnterhaltsvorschussPackage.GEBURT_TYPE__GEBURTSORT_STAAT:
				return basicSetGeburtsortStaat(null, msgs);
			case UnterhaltsvorschussPackage.GEBURT_TYPE__GEBURTSDATUM:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UnterhaltsvorschussPackage.GEBURT_TYPE__GEBURTSORT:
