...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Lebenspartnerschaft Aufgehoben Antragstellende Basis Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.xoev.xfamilie.unterhaltsvorschussantrag._1.unterhaltsvorschuss.impl.LebenspartnerschaftAufgehobenAntragstellendeBasisTypeImpl#getNachweis <em>Nachweis</em>}</li>
 *   <li>{@link de.xoev.xfamilie.unterhaltsvorschussantrag._1.unterhaltsvorschuss.impl.LebenspartnerschaftAufgehobenAntragstellendeBasisTypeImpl#getSeitWann <em>Seit Wann</em>}</li>
 *   <li>{@link de.xoev.xfamilie.unterhaltsvorschussantrag._1.unterhaltsvorschuss.impl.LebenspartnerschaftAufgehobenAntragstellendeBasisTypeImpl#isHochzeitGeplant <em>Hochzeit Geplant</em>}</li>
 *   <li>{@link de.xoev.xfamilie.unterhaltsvorschussantrag._1.unterhaltsvorschuss.impl.LebenspartnerschaftAufgehobenAntragstellendeBasisTypeImpl#getHochzeitsdatumVoraussichtlich <em>Hochzeitsdatum Voraussichtlich</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LebenspartnerschaftAufgehobenAntragstellendeBasisTypeImpl extends MinimalEObjectImpl.Container implements LebenspartnerschaftAufgehobenAntragstellendeBasisType {
	/**
	 ...
	 * @generated
	 */
	protected LebenspartnerschaftAufgehobenAntragstellendeBasisTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return UnterhaltsvorschussPackage.eINSTANCE.getLebenspartnerschaftAufgehobenAntragstellendeBasisType();
	}
	...
	public EList<String> getNachweis() {
		if (nachweis == null) {
			nachweis = new EDataTypeEList<String>(String.class, this, UnterhaltsvorschussPackage.LEBENSPARTNERSCHAFT_AUFGEHOBEN_ANTRAGSTELLENDE_BASIS_TYPE__NACHWEIS);
		}
		return nachweis;
	}
	...
	public NotificationChain basicSetSeitWann(TeilbekanntesDatumType newSeitWann, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.LEBENSPARTNERSCHAFT_AUFGEHOBEN_ANTRAGSTELLENDE_BASIS_TYPE__SEIT_WANN, oldSeitWann, newSeitWann);
	...
	public void setSeitWann(TeilbekanntesDatumType newSeitWann) {
		if (newSeitWann != seitWann) {
			...
			if (seitWann != null)
				msgs = ((InternalEObject)seitWann).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UnterhaltsvorschussPackage.LEBENSPARTNERSCHAFT_AUFGEHOBEN_ANTRAGSTELLENDE_BASIS_TYPE__SEIT_WANN, null, msgs);
			if (newSeitWann != null)
				msgs = ((InternalEObject)newSeitWann).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UnterhaltsvorschussPackage.LEBENSPARTNERSCHAFT_AUFGEHOBEN_ANTRAGSTELLENDE_BASIS_TYPE__SEIT_WANN, null, msgs);
			msgs = basicSetSeitWann(newSeitWann, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.LEBENSPARTNERSCHAFT_AUFGEHOBEN_ANTRAGSTELLENDE_BASIS_TYPE__SEIT_WANN, newSeitWann, newSeitWann));
	}
	...
	public void setHochzeitGeplant(boolean newHochzeitGeplant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.LEBENSPARTNERSCHAFT_AUFGEHOBEN_ANTRAGSTELLENDE_BASIS_TYPE__HOCHZEIT_GEPLANT, oldHochzeitGeplant, hochzeitGeplant, !oldHochzeitGeplantESet));
	}
	...
	public void unsetHochzeitGeplant() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, UnterhaltsvorschussPackage.LEBENSPARTNERSCHAFT_AUFGEHOBEN_ANTRAGSTELLENDE_BASIS_TYPE__HOCHZEIT_GEPLANT, oldHochzeitGeplant, HOCHZEIT_GEPLANT_EDEFAULT, oldHochzeitGeplantESet));
	}
	...
	public void setHochzeitsdatumVoraussichtlich(XMLGregorianCalendar newHochzeitsdatumVoraussichtlich) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnterhaltsvorschussPackage.LEBENSPARTNERSCHAFT_AUFGEHOBEN_ANTRAGSTELLENDE_BASIS_TYPE__HOCHZEITSDATUM_VORAUSSICHTLICH, oldHochzeitsdatumVoraussichtlich, hochzeitsdatumVoraussichtlich));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UnterhaltsvorschussPackage.LEBENSPARTNERSCHAFT_AUFGEHOBEN_ANTRAGSTELLENDE_BASIS_TYPE__SEIT_WANN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UnterhaltsvorschussPackage.LEBENSPARTNERSCHAFT_AUFGEHOBEN_ANTRAGSTELLENDE_BASIS_TYPE__NACHWEIS:
				return getNachweis();
			case UnterhaltsvorschussPackage.LEBENSPARTNERSCHAFT_AUFGEHOBEN_ANTRAGSTELLENDE_BASIS_TYPE__SEIT_WANN:
				return getSeitWann();
			case UnterhaltsvorschussPackage.LEBENSPARTNERSCHAFT_AUFGEHOBEN_ANTRAGSTELLENDE_BASIS_TYPE__HOCHZEIT_GEPLANT:
				return isHochzeitGeplant();
			case UnterhaltsvorschussPackage.LEBENSPARTNERSCHAFT_AUFGEHOBEN_ANTRAGSTELLENDE_BASIS_TYPE__HOCHZEITSDATUM_VORAUSSICHTLICH:
...
} //LebenspartnerschaftAufgehobenAntragstellendeBasisTypeImpl
