...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.xoev.xfamilie.hilfen.zur.erziehung._1.erziehungshilfen\"" })
...
public class ErziehungshilfeConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(ErziehungshilfePackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(ErziehungshilfePackage.eNS_URI, ePackage);
		}
