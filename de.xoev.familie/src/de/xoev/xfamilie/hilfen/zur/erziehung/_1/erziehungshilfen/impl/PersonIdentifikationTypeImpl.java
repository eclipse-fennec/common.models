...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Person Identifikation Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.xoev.xfamilie.hilfen.zur.erziehung._1.erziehungshilfen.impl.PersonIdentifikationTypeImpl#getNamen <em>Namen</em>}</li>
 *   <li>{@link de.xoev.xfamilie.hilfen.zur.erziehung._1.erziehungshilfen.impl.PersonIdentifikationTypeImpl#getGeburtsdatum <em>Geburtsdatum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonIdentifikationTypeImpl extends MinimalEObjectImpl.Container implements PersonIdentifikationType {
	/**
	 ...
	 * @generated
	 */
	protected PersonIdentifikationTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ErziehungshilfePackage.Literals.PERSON_IDENTIFIKATION_TYPE;
	}
	...
	public NotificationChain basicSetNamen(NameNatuerlichePersonType newNamen, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ErziehungshilfePackage.PERSON_IDENTIFIKATION_TYPE__NAMEN, oldNamen, newNamen);
	...
	public void setNamen(NameNatuerlichePersonType newNamen) {
		if (newNamen != namen) {
			...
			if (namen != null)
				msgs = ((InternalEObject)namen).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ErziehungshilfePackage.PERSON_IDENTIFIKATION_TYPE__NAMEN, null, msgs);
			if (newNamen != null)
				msgs = ((InternalEObject)newNamen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ErziehungshilfePackage.PERSON_IDENTIFIKATION_TYPE__NAMEN, null, msgs);
			msgs = basicSetNamen(newNamen, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErziehungshilfePackage.PERSON_IDENTIFIKATION_TYPE__NAMEN, newNamen, newNamen));
	}
	...
	public void setGeburtsdatum(XMLGregorianCalendar newGeburtsdatum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ErziehungshilfePackage.PERSON_IDENTIFIKATION_TYPE__GEBURTSDATUM, oldGeburtsdatum, geburtsdatum));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ErziehungshilfePackage.PERSON_IDENTIFIKATION_TYPE__NAMEN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ErziehungshilfePackage.PERSON_IDENTIFIKATION_TYPE__NAMEN:
				return getNamen();
			case ErziehungshilfePackage.PERSON_IDENTIFIKATION_TYPE__GEBURTSDATUM:
