...
public class ErziehungshilfeEPackageConfigurator implements EPackageConfigurator {
	...
	public void configureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.put(ErziehungshilfePackage.eNS_URI, ePackage);
	}
	...
	public void unconfigureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.remove(ErziehungshilfePackage.eNS_URI);
	}
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_NAME, ErziehungshilfePackage.eNAME);
		properties.put(EMFNamespaces.EMF_MODEL_NSURI, ErziehungshilfePackage.eNS_URI);
