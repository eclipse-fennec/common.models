...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.xoev.xfamilie.mutterschaftsgeldmeldung._1.mutterschaftsgeld\"" })
...
public class MutterschaftsgeldConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(MutterschaftsgeldPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(MutterschaftsgeldPackage.eNS_URI, ePackage);
		}
