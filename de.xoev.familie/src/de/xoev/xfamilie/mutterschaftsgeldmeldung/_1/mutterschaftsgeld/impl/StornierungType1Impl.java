...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Stornierung Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.xoev.xfamilie.mutterschaftsgeldmeldung._1.mutterschaftsgeld.impl.StornierungType1Impl#isStornokennzeichen <em>Stornokennzeichen</em>}</li>
 *   <li>{@link de.xoev.xfamilie.mutterschaftsgeldmeldung._1.mutterschaftsgeld.impl.StornierungType1Impl#getDatensatzIDUrsprungsmeldung <em>Datensatz ID Ursprungsmeldung</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StornierungType1Impl extends MinimalEObjectImpl.Container implements StornierungType1 {
	/**
	 ...
	 * @generated
	 */
	protected StornierungType1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MutterschaftsgeldPackage.Literals.STORNIERUNG_TYPE1;
	}
	...
	public void setStornokennzeichen(boolean newStornokennzeichen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutterschaftsgeldPackage.STORNIERUNG_TYPE1__STORNOKENNZEICHEN, oldStornokennzeichen, stornokennzeichen, !oldStornokennzeichenESet));
	}
	...
	public void unsetStornokennzeichen() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MutterschaftsgeldPackage.STORNIERUNG_TYPE1__STORNOKENNZEICHEN, oldStornokennzeichen, STORNOKENNZEICHEN_EDEFAULT, oldStornokennzeichenESet));
	}
	...
	public void setDatensatzIDUrsprungsmeldung(String newDatensatzIDUrsprungsmeldung) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutterschaftsgeldPackage.STORNIERUNG_TYPE1__DATENSATZ_ID_URSPRUNGSMELDUNG, oldDatensatzIDUrsprungsmeldung, datensatzIDUrsprungsmeldung));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MutterschaftsgeldPackage.STORNIERUNG_TYPE1__STORNOKENNZEICHEN:
				return isStornokennzeichen();
			case MutterschaftsgeldPackage.STORNIERUNG_TYPE1__DATENSATZ_ID_URSPRUNGSMELDUNG:
