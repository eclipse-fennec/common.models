...
public class KinderwunschEPackageConfigurator implements EPackageConfigurator {
	...
	public void configureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.put(KinderwunschPackage.eNS_URI, ePackage);
	}
	...
	public void unconfigureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.remove(KinderwunschPackage.eNS_URI);
	}
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_NAME, KinderwunschPackage.eNAME);
		properties.put(EMFNamespaces.EMF_MODEL_NSURI, KinderwunschPackage.eNS_URI);
