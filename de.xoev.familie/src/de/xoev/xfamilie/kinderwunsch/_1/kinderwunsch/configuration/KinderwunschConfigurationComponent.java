...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.xoev.xfamilie.kinderwunsch._1.kinderwunsch\"" })
...
public class KinderwunschConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(KinderwunschPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(KinderwunschPackage.eNS_URI, ePackage);
		}
