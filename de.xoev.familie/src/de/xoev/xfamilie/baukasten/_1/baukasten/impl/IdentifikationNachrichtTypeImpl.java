 ...
 * </p>
 * <ul>
 *   <li>{@link de.xoev.xfamilie.baukasten._1.baukasten.impl.IdentifikationNachrichtTypeImpl#getNachrichtenUUID <em>Nachrichten UUID</em>}</li>
 *   <li>{@link de.xoev.xfamilie.baukasten._1.baukasten.impl.IdentifikationNachrichtTypeImpl#getNachrichtentyp <em>Nachrichtentyp</em>}</li>
 *   <li>{@link de.xoev.xfamilie.baukasten._1.baukasten.impl.IdentifikationNachrichtTypeImpl#getErstellungszeitpunkt <em>Erstellungszeitpunkt</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdentifikationNachrichtTypeImpl extends MinimalEObjectImpl.Container implements IdentifikationNachrichtType {
	 ...
	 * @ordered
	 */
	protected CodeNachrichtentypType nachrichtentyp;
	...
	protected EClass eStaticClass() {
		return BaukastenPackage.Literals.IDENTIFIKATION_NACHRICHT_TYPE;
	}
	...
	public void setNachrichtenUUID(String newNachrichtenUUID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTEN_UUID, oldNachrichtenUUID, nachrichtenUUID));
	}
	 ...
	 */
	@Override
	public CodeNachrichtentypType getNachrichtentyp() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNachrichtentyp(CodeNachrichtentypType newNachrichtentyp, NotificationChain msgs) {
		CodeNachrichtentypType oldNachrichtentyp = nachrichtentyp;
		nachrichtentyp = newNachrichtentyp;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTENTYP, oldNachrichtentyp, newNachrichtentyp);
	 ...
	 */
	@Override
	public void setNachrichtentyp(CodeNachrichtentypType newNachrichtentyp) {
		if (newNachrichtentyp != nachrichtentyp) {
			NotificationChain msgs = null;
			if (nachrichtentyp != null)
				msgs = ((InternalEObject)nachrichtentyp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTENTYP, null, msgs);
			if (newNachrichtentyp != null)
				msgs = ((InternalEObject)newNachrichtentyp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTENTYP, null, msgs);
			msgs = basicSetNachrichtentyp(newNachrichtentyp, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTENTYP, newNachrichtentyp, newNachrichtentyp));
	}
	...
	public void setErstellungszeitpunkt(XMLGregorianCalendar newErstellungszeitpunkt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__ERSTELLUNGSZEITPUNKT, oldErstellungszeitpunkt, erstellungszeitpunkt));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTENTYP:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTEN_UUID:
				return getNachrichtenUUID();
			case BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTENTYP:
				return getNachrichtentyp();
			case BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__ERSTELLUNGSZEITPUNKT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTEN_UUID:
				...
				return;
			case BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTENTYP:
				setNachrichtentyp((CodeNachrichtentypType)newValue);
				return;
			case BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__ERSTELLUNGSZEITPUNKT:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTEN_UUID:
				...
				return;
			case BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__NACHRICHTENTYP:
				setNachrichtentyp((CodeNachrichtentypType)null);
				return;
			case BaukastenPackage.IDENTIFIKATION_NACHRICHT_TYPE__ERSTELLUNGSZEITPUNKT:
