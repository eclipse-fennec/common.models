...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Artnachweis</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see de.xoev.xfamilie.baukasten._1.baukasten.BaukastenPackage#getArtnachweis()
 * @model extendedMetaData="name='artnachweis'"
 * @generated
 */
@ProviderType
public enum Artnachweis implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Artnachweis</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final Artnachweis[] VALUES_ARRAY =
		new Artnachweis[] {
			_01,
			_02,
			_03,
	...
	/**
	 * A public read-only list of all the '<em><b>Artnachweis</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<Artnachweis> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Artnachweis</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static Artnachweis get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Artnachweis result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Artnachweis</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static Artnachweis getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Artnachweis result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Artnachweis</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static Artnachweis get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private Artnachweis(int value, String name, String literal) {
		this.value = value;
		this.name = name;
