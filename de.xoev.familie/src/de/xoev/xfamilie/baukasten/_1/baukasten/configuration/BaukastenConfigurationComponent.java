...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.xoev.xfamilie.baukasten._1.baukasten\"" })
...
public class BaukastenConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(BaukastenPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(BaukastenPackage.eNS_URI, ePackage);
		}
