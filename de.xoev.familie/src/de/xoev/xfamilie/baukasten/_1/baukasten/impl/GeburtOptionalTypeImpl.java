...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Geburt Optional Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.xoev.xfamilie.baukasten._1.baukasten.impl.GeburtOptionalTypeImpl#getGeburtsort <em>Geburtsort</em>}</li>
 *   <li>{@link de.xoev.xfamilie.baukasten._1.baukasten.impl.GeburtOptionalTypeImpl#getGeburtsortStaat <em>Geburtsort Staat</em>}</li>
 *   <li>{@link de.xoev.xfamilie.baukasten._1.baukasten.impl.GeburtOptionalTypeImpl#getGeburtsdatum <em>Geburtsdatum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeburtOptionalTypeImpl extends MinimalEObjectImpl.Container implements GeburtOptionalType {
	/**
	 ...
	 * @generated
	 */
	protected GeburtOptionalTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BaukastenPackage.Literals.GEBURT_OPTIONAL_TYPE;
	}
	...
	public void setGeburtsort(String newGeburtsort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaukastenPackage.GEBURT_OPTIONAL_TYPE__GEBURTSORT, oldGeburtsort, geburtsort));
	}
	...
	public NotificationChain basicSetGeburtsortStaat(CodeStaatType newGeburtsortStaat, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BaukastenPackage.GEBURT_OPTIONAL_TYPE__GEBURTSORT_STAAT, oldGeburtsortStaat, newGeburtsortStaat);
	...
	public void setGeburtsortStaat(CodeStaatType newGeburtsortStaat) {
		if (newGeburtsortStaat != geburtsortStaat) {
			...
			if (geburtsortStaat != null)
				msgs = ((InternalEObject)geburtsortStaat).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BaukastenPackage.GEBURT_OPTIONAL_TYPE__GEBURTSORT_STAAT, null, msgs);
			if (newGeburtsortStaat != null)
				msgs = ((InternalEObject)newGeburtsortStaat).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BaukastenPackage.GEBURT_OPTIONAL_TYPE__GEBURTSORT_STAAT, null, msgs);
			msgs = basicSetGeburtsortStaat(newGeburtsortStaat, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaukastenPackage.GEBURT_OPTIONAL_TYPE__GEBURTSORT_STAAT, newGeburtsortStaat, newGeburtsortStaat));
	}
	...
	public NotificationChain basicSetGeburtsdatum(TeilbekanntesDatumType newGeburtsdatum, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BaukastenPackage.GEBURT_OPTIONAL_TYPE__GEBURTSDATUM, oldGeburtsdatum, newGeburtsdatum);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGeburtsdatum(TeilbekanntesDatumType newGeburtsdatum) {
		if (newGeburtsdatum != geburtsdatum) {
			...
			if (geburtsdatum != null)
				msgs = ((InternalEObject)geburtsdatum).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BaukastenPackage.GEBURT_OPTIONAL_TYPE__GEBURTSDATUM, null, msgs);
			if (newGeburtsdatum != null)
				msgs = ((InternalEObject)newGeburtsdatum).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BaukastenPackage.GEBURT_OPTIONAL_TYPE__GEBURTSDATUM, null, msgs);
			msgs = basicSetGeburtsdatum(newGeburtsdatum, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaukastenPackage.GEBURT_OPTIONAL_TYPE__GEBURTSDATUM, newGeburtsdatum, newGeburtsdatum));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BaukastenPackage.GEBURT_OPTIONAL_TYPE__GEBURTSORT_STAAT:
				return basicSetGeburtsortStaat(null, msgs);
			case BaukastenPackage.GEBURT_OPTIONAL_TYPE__GEBURTSDATUM:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BaukastenPackage.GEBURT_OPTIONAL_TYPE__GEBURTSORT:
