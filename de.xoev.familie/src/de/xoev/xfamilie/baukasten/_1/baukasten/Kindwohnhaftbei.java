...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Kindwohnhaftbei</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see de.xoev.xfamilie.baukasten._1.baukasten.BaukastenPackage#getKindwohnhaftbei()
 * @model extendedMetaData="name='kindwohnhaftbei'"
 * @generated
 */
@ProviderType
public enum Kindwohnhaftbei implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Kindwohnhaftbei</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final Kindwohnhaftbei[] VALUES_ARRAY =
		new Kindwohnhaftbei[] {
			_01,
			_02,
			_03,
	...
	/**
	 * A public read-only list of all the '<em><b>Kindwohnhaftbei</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<Kindwohnhaftbei> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Kindwohnhaftbei</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static Kindwohnhaftbei get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Kindwohnhaftbei result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Kindwohnhaftbei</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static Kindwohnhaftbei getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Kindwohnhaftbei result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Kindwohnhaftbei</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static Kindwohnhaftbei get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private Kindwohnhaftbei(int value, String name, String literal) {
		this.value = value;
		this.name = name;
