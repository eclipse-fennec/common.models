 ...
 * </p>
 * <ul>
 *   <li>{@link de.xoev.xfamilie.baukasten._1.baukasten.impl.NameNatuerlichePersonTypeImpl#getFamiliennameUnstrukturiert <em>Familienname Unstrukturiert</em>}</li>
 *   <li>{@link de.xoev.xfamilie.baukasten._1.baukasten.impl.NameNatuerlichePersonTypeImpl#getGeburtsnameUnstrukturiert <em>Geburtsname Unstrukturiert</em>}</li>
 *   <li>{@link de.xoev.xfamilie.baukasten._1.baukasten.impl.NameNatuerlichePersonTypeImpl#getVornamen <em>Vornamen</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NameNatuerlichePersonTypeImpl extends MinimalEObjectImpl.Container implements NameNatuerlichePersonType {
	...
	protected EClass eStaticClass() {
		return BaukastenPackage.Literals.NAME_NATUERLICHE_PERSON_TYPE;
	}
	...
	public NotificationChain basicSetFamiliennameUnstrukturiert(AllgemeinerNameType newFamiliennameUnstrukturiert, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__FAMILIENNAME_UNSTRUKTURIERT, oldFamiliennameUnstrukturiert, newFamiliennameUnstrukturiert);
	...
	public void setFamiliennameUnstrukturiert(AllgemeinerNameType newFamiliennameUnstrukturiert) {
		if (newFamiliennameUnstrukturiert != familiennameUnstrukturiert) {
			...
			if (familiennameUnstrukturiert != null)
				msgs = ((InternalEObject)familiennameUnstrukturiert).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__FAMILIENNAME_UNSTRUKTURIERT, null, msgs);
			if (newFamiliennameUnstrukturiert != null)
				msgs = ((InternalEObject)newFamiliennameUnstrukturiert).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__FAMILIENNAME_UNSTRUKTURIERT, null, msgs);
			msgs = basicSetFamiliennameUnstrukturiert(newFamiliennameUnstrukturiert, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__FAMILIENNAME_UNSTRUKTURIERT, newFamiliennameUnstrukturiert, newFamiliennameUnstrukturiert));
	}
	...
	public NotificationChain basicSetGeburtsnameUnstrukturiert(AllgemeinerNameType newGeburtsnameUnstrukturiert, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__GEBURTSNAME_UNSTRUKTURIERT, oldGeburtsnameUnstrukturiert, newGeburtsnameUnstrukturiert);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGeburtsnameUnstrukturiert(AllgemeinerNameType newGeburtsnameUnstrukturiert) {
		if (newGeburtsnameUnstrukturiert != geburtsnameUnstrukturiert) {
			...
			if (geburtsnameUnstrukturiert != null)
				msgs = ((InternalEObject)geburtsnameUnstrukturiert).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__GEBURTSNAME_UNSTRUKTURIERT, null, msgs);
			if (newGeburtsnameUnstrukturiert != null)
				msgs = ((InternalEObject)newGeburtsnameUnstrukturiert).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__GEBURTSNAME_UNSTRUKTURIERT, null, msgs);
			msgs = basicSetGeburtsnameUnstrukturiert(newGeburtsnameUnstrukturiert, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__GEBURTSNAME_UNSTRUKTURIERT, newGeburtsnameUnstrukturiert, newGeburtsnameUnstrukturiert));
	}
	...
	public NotificationChain basicSetVornamen(AllgemeinerNameType newVornamen, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__VORNAMEN, oldVornamen, newVornamen);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVornamen(AllgemeinerNameType newVornamen) {
		if (newVornamen != vornamen) {
			NotificationChain msgs = null;
			if (vornamen != null)
				msgs = ((InternalEObject)vornamen).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__VORNAMEN, null, msgs);
			if (newVornamen != null)
				msgs = ((InternalEObject)newVornamen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__VORNAMEN, null, msgs);
			msgs = basicSetVornamen(newVornamen, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__VORNAMEN, newVornamen, newVornamen));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__FAMILIENNAME_UNSTRUKTURIERT:
				return basicSetFamiliennameUnstrukturiert(null, msgs);
			case BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__GEBURTSNAME_UNSTRUKTURIERT:
				return basicSetGeburtsnameUnstrukturiert(null, msgs);
			case BaukastenPackage.NAME_NATUERLICHE_PERSON_TYPE__VORNAMEN:
