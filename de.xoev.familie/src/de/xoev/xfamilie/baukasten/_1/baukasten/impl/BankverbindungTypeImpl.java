...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bankverbindung Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.xoev.xfamilie.baukasten._1.baukasten.impl.BankverbindungTypeImpl#getInhaber <em>Inhaber</em>}</li>
 *   <li>{@link de.xoev.xfamilie.baukasten._1.baukasten.impl.BankverbindungTypeImpl#getIban <em>Iban</em>}</li>
 *   <li>{@link de.xoev.xfamilie.baukasten._1.baukasten.impl.BankverbindungTypeImpl#getBic <em>Bic</em>}</li>
 *   <li>{@link de.xoev.xfamilie.baukasten._1.baukasten.impl.BankverbindungTypeImpl#getInstitut <em>Institut</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BankverbindungTypeImpl extends MinimalEObjectImpl.Container implements BankverbindungType {
	/**
	 ...
	 * @generated
	 */
	protected BankverbindungTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BaukastenPackage.Literals.BANKVERBINDUNG_TYPE;
	}
	...
	public NotificationChain basicSetInhaber(NameNatuerlichePersonType newInhaber, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BaukastenPackage.BANKVERBINDUNG_TYPE__INHABER, oldInhaber, newInhaber);
	...
	public void setInhaber(NameNatuerlichePersonType newInhaber) {
		if (newInhaber != inhaber) {
			...
			if (inhaber != null)
				msgs = ((InternalEObject)inhaber).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BaukastenPackage.BANKVERBINDUNG_TYPE__INHABER, null, msgs);
			if (newInhaber != null)
				msgs = ((InternalEObject)newInhaber).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BaukastenPackage.BANKVERBINDUNG_TYPE__INHABER, null, msgs);
			msgs = basicSetInhaber(newInhaber, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaukastenPackage.BANKVERBINDUNG_TYPE__INHABER, newInhaber, newInhaber));
	}
	...
	public void setIban(String newIban) {
		...
		iban = newIban;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaukastenPackage.BANKVERBINDUNG_TYPE__IBAN, oldIban, iban));
	}
	...
	public void setBic(String newBic) {
		...
		bic = newBic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaukastenPackage.BANKVERBINDUNG_TYPE__BIC, oldBic, bic));
	}
	...
	public void setInstitut(String newInstitut) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaukastenPackage.BANKVERBINDUNG_TYPE__INSTITUT, oldInstitut, institut));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BaukastenPackage.BANKVERBINDUNG_TYPE__INHABER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BaukastenPackage.BANKVERBINDUNG_TYPE__INHABER:
				return getInhaber();
			case BaukastenPackage.BANKVERBINDUNG_TYPE__IBAN:
				return getIban();
			case BaukastenPackage.BANKVERBINDUNG_TYPE__BIC:
				return getBic();
			case BaukastenPackage.BANKVERBINDUNG_TYPE__INSTITUT:
				return getInstitut();
		}
