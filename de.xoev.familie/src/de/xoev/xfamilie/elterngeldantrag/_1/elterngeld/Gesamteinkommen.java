...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Gesamteinkommen</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see de.xoev.xfamilie.elterngeldantrag._1.elterngeld.ElterngeldPackage#getGesamteinkommen()
 * @model extendedMetaData="name='gesamteinkommen'"
 * @generated
 */
@ProviderType
public enum Gesamteinkommen implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Gesamteinkommen</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final Gesamteinkommen[] VALUES_ARRAY =
		new Gesamteinkommen[] {
			_01,
			_02,
			_03,
	...
	/**
	 * A public read-only list of all the '<em><b>Gesamteinkommen</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<Gesamteinkommen> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Gesamteinkommen</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static Gesamteinkommen get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Gesamteinkommen result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Gesamteinkommen</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static Gesamteinkommen getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Gesamteinkommen result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Gesamteinkommen</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static Gesamteinkommen get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private Gesamteinkommen(int value, String name, String literal) {
		this.value = value;
		this.name = name;
