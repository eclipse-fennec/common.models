...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Elternteil Zwei Elterngeldantrag Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getPersoenlicheAngaben <em>Persoenliche Angaben</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getAnschrift <em>Anschrift</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getGewoehnlicherAufenthalt <em>Gewoehnlicher Aufenthalt</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getKindschaftsverhaeltnis <em>Kindschaftsverhaeltnis</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getHaushaltszugehoerigkeitDesKindes <em>Haushaltszugehoerigkeit Des Kindes</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getBeantragungElterngeld <em>Beantragung Elterngeld</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getKrankenversicherung <em>Krankenversicherung</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getEinkommenVorGeburt <em>Einkommen Vor Geburt</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getEinkommenWaehrendBezugszeitraum <em>Einkommen Waehrend Bezugszeitraum</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getBankverbindung <em>Bankverbindung</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getZustimmungDatenabrufe <em>Zustimmung Datenabrufe</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#isZustimmungAuskunftseinholungJobcenterArbeitsamt <em>Zustimmung Auskunftseinholung Jobcenter Arbeitsamt</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getKontaktmoeglichkeit <em>Kontaktmoeglichkeit</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getSteuerlicheIdentifikationsnummer <em>Steuerliche Identifikationsnummer</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getNutzerkonto <em>Nutzerkonto</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getErwerbstaetigkeitBezugszeitraum <em>Erwerbstaetigkeit Bezugszeitraum</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getBescheidzustellungVersandweg <em>Bescheidzustellung Versandweg</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getGesetzlicheVertretung <em>Gesetzliche Vertretung</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getElternzeit <em>Elternzeit</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#isZusammenveranlagungLiegtVor <em>Zusammenveranlagung Liegt Vor</em>}</li>
 *   <li>{@link de.xoev.xfamilie.elterngeldantrag._1.elterngeld.impl.ElternteilZweiElterngeldantragTypeImpl#getMitteilungAnBehoerde <em>Mitteilung An Behoerde</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElternteilZweiElterngeldantragTypeImpl extends MinimalEObjectImpl.Container implements ElternteilZweiElterngeldantragType {
	/**
	 ...
	 * @generated
	 */
	protected ElternteilZweiElterngeldantragTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ElterngeldPackage.eINSTANCE.getElternteilZweiElterngeldantragType();
	}
	...
	public NotificationChain basicSetPersoenlicheAngaben(PersoenlicheAngabenETType newPersoenlicheAngaben, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__PERSOENLICHE_ANGABEN, oldPersoenlicheAngaben, newPersoenlicheAngaben);
	...
	public void setPersoenlicheAngaben(PersoenlicheAngabenETType newPersoenlicheAngaben) {
		if (newPersoenlicheAngaben != persoenlicheAngaben) {
			...
			if (persoenlicheAngaben != null)
				msgs = ((InternalEObject)persoenlicheAngaben).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__PERSOENLICHE_ANGABEN, null, msgs);
			if (newPersoenlicheAngaben != null)
				msgs = ((InternalEObject)newPersoenlicheAngaben).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__PERSOENLICHE_ANGABEN, null, msgs);
			msgs = basicSetPersoenlicheAngaben(newPersoenlicheAngaben, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__PERSOENLICHE_ANGABEN, newPersoenlicheAngaben, newPersoenlicheAngaben));
	}
	...
	public NotificationChain basicSetAnschrift(AnschriftType newAnschrift, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ANSCHRIFT, oldAnschrift, newAnschrift);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAnschrift(AnschriftType newAnschrift) {
		if (newAnschrift != anschrift) {
			NotificationChain msgs = null;
			if (anschrift != null)
				msgs = ((InternalEObject)anschrift).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ANSCHRIFT, null, msgs);
			if (newAnschrift != null)
				msgs = ((InternalEObject)newAnschrift).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ANSCHRIFT, null, msgs);
			msgs = basicSetAnschrift(newAnschrift, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ANSCHRIFT, newAnschrift, newAnschrift));
	}
	...
	public NotificationChain basicSetGewoehnlicherAufenthalt(GewoehnlicherAufenthaltType newGewoehnlicherAufenthalt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__GEWOEHNLICHER_AUFENTHALT, oldGewoehnlicherAufenthalt, newGewoehnlicherAufenthalt);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGewoehnlicherAufenthalt(GewoehnlicherAufenthaltType newGewoehnlicherAufenthalt) {
		if (newGewoehnlicherAufenthalt != gewoehnlicherAufenthalt) {
			...
			if (gewoehnlicherAufenthalt != null)
				msgs = ((InternalEObject)gewoehnlicherAufenthalt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__GEWOEHNLICHER_AUFENTHALT, null, msgs);
			if (newGewoehnlicherAufenthalt != null)
				msgs = ((InternalEObject)newGewoehnlicherAufenthalt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__GEWOEHNLICHER_AUFENTHALT, null, msgs);
			msgs = basicSetGewoehnlicherAufenthalt(newGewoehnlicherAufenthalt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__GEWOEHNLICHER_AUFENTHALT, newGewoehnlicherAufenthalt, newGewoehnlicherAufenthalt));
	}
	...
	public NotificationChain basicSetKindschaftsverhaeltnis(KindschaftsverhaeltnisType newKindschaftsverhaeltnis, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__KINDSCHAFTSVERHAELTNIS, oldKindschaftsverhaeltnis, newKindschaftsverhaeltnis);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setKindschaftsverhaeltnis(KindschaftsverhaeltnisType newKindschaftsverhaeltnis) {
		if (newKindschaftsverhaeltnis != kindschaftsverhaeltnis) {
			...
			if (kindschaftsverhaeltnis != null)
				msgs = ((InternalEObject)kindschaftsverhaeltnis).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__KINDSCHAFTSVERHAELTNIS, null, msgs);
			if (newKindschaftsverhaeltnis != null)
				msgs = ((InternalEObject)newKindschaftsverhaeltnis).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__KINDSCHAFTSVERHAELTNIS, null, msgs);
			msgs = basicSetKindschaftsverhaeltnis(newKindschaftsverhaeltnis, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__KINDSCHAFTSVERHAELTNIS, newKindschaftsverhaeltnis, newKindschaftsverhaeltnis));
	}
	...
	public NotificationChain basicSetHaushaltszugehoerigkeitDesKindes(HaushaltszugehoerigkeitDesKindesType newHaushaltszugehoerigkeitDesKindes, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__HAUSHALTSZUGEHOERIGKEIT_DES_KINDES, oldHaushaltszugehoerigkeitDesKindes, newHaushaltszugehoerigkeitDesKindes);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHaushaltszugehoerigkeitDesKindes(HaushaltszugehoerigkeitDesKindesType newHaushaltszugehoerigkeitDesKindes) {
		if (newHaushaltszugehoerigkeitDesKindes != haushaltszugehoerigkeitDesKindes) {
			...
			if (haushaltszugehoerigkeitDesKindes != null)
				msgs = ((InternalEObject)haushaltszugehoerigkeitDesKindes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__HAUSHALTSZUGEHOERIGKEIT_DES_KINDES, null, msgs);
			if (newHaushaltszugehoerigkeitDesKindes != null)
				msgs = ((InternalEObject)newHaushaltszugehoerigkeitDesKindes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__HAUSHALTSZUGEHOERIGKEIT_DES_KINDES, null, msgs);
			msgs = basicSetHaushaltszugehoerigkeitDesKindes(newHaushaltszugehoerigkeitDesKindes, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__HAUSHALTSZUGEHOERIGKEIT_DES_KINDES, newHaushaltszugehoerigkeitDesKindes, newHaushaltszugehoerigkeitDesKindes));
	}
	...
	public NotificationChain basicSetBeantragungElterngeld(BeantragungElterngeldType newBeantragungElterngeld, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BEANTRAGUNG_ELTERNGELD, oldBeantragungElterngeld, newBeantragungElterngeld);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBeantragungElterngeld(BeantragungElterngeldType newBeantragungElterngeld) {
		if (newBeantragungElterngeld != beantragungElterngeld) {
			...
			if (beantragungElterngeld != null)
				msgs = ((InternalEObject)beantragungElterngeld).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BEANTRAGUNG_ELTERNGELD, null, msgs);
			if (newBeantragungElterngeld != null)
				msgs = ((InternalEObject)newBeantragungElterngeld).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BEANTRAGUNG_ELTERNGELD, null, msgs);
			msgs = basicSetBeantragungElterngeld(newBeantragungElterngeld, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BEANTRAGUNG_ELTERNGELD, newBeantragungElterngeld, newBeantragungElterngeld));
	}
	...
	public NotificationChain basicSetKrankenversicherung(KrankenversicherungType newKrankenversicherung, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__KRANKENVERSICHERUNG, oldKrankenversicherung, newKrankenversicherung);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setKrankenversicherung(KrankenversicherungType newKrankenversicherung) {
		if (newKrankenversicherung != krankenversicherung) {
			...
			if (krankenversicherung != null)
				msgs = ((InternalEObject)krankenversicherung).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__KRANKENVERSICHERUNG, null, msgs);
			if (newKrankenversicherung != null)
				msgs = ((InternalEObject)newKrankenversicherung).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__KRANKENVERSICHERUNG, null, msgs);
			msgs = basicSetKrankenversicherung(newKrankenversicherung, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__KRANKENVERSICHERUNG, newKrankenversicherung, newKrankenversicherung));
	}
	...
	public NotificationChain basicSetEinkommenVorGeburt(EinkommenVorGeburtType newEinkommenVorGeburt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__EINKOMMEN_VOR_GEBURT, oldEinkommenVorGeburt, newEinkommenVorGeburt);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEinkommenVorGeburt(EinkommenVorGeburtType newEinkommenVorGeburt) {
		if (newEinkommenVorGeburt != einkommenVorGeburt) {
			...
			if (einkommenVorGeburt != null)
				msgs = ((InternalEObject)einkommenVorGeburt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__EINKOMMEN_VOR_GEBURT, null, msgs);
			if (newEinkommenVorGeburt != null)
				msgs = ((InternalEObject)newEinkommenVorGeburt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__EINKOMMEN_VOR_GEBURT, null, msgs);
			msgs = basicSetEinkommenVorGeburt(newEinkommenVorGeburt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__EINKOMMEN_VOR_GEBURT, newEinkommenVorGeburt, newEinkommenVorGeburt));
	}
	...
	public NotificationChain basicSetEinkommenWaehrendBezugszeitraum(EinkommenWaehrendBezugszeitraumType newEinkommenWaehrendBezugszeitraum, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__EINKOMMEN_WAEHREND_BEZUGSZEITRAUM, oldEinkommenWaehrendBezugszeitraum, newEinkommenWaehrendBezugszeitraum);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEinkommenWaehrendBezugszeitraum(EinkommenWaehrendBezugszeitraumType newEinkommenWaehrendBezugszeitraum) {
		if (newEinkommenWaehrendBezugszeitraum != einkommenWaehrendBezugszeitraum) {
			...
			if (einkommenWaehrendBezugszeitraum != null)
				msgs = ((InternalEObject)einkommenWaehrendBezugszeitraum).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__EINKOMMEN_WAEHREND_BEZUGSZEITRAUM, null, msgs);
			if (newEinkommenWaehrendBezugszeitraum != null)
				msgs = ((InternalEObject)newEinkommenWaehrendBezugszeitraum).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__EINKOMMEN_WAEHREND_BEZUGSZEITRAUM, null, msgs);
			msgs = basicSetEinkommenWaehrendBezugszeitraum(newEinkommenWaehrendBezugszeitraum, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__EINKOMMEN_WAEHREND_BEZUGSZEITRAUM, newEinkommenWaehrendBezugszeitraum, newEinkommenWaehrendBezugszeitraum));
	}
	...
	public NotificationChain basicSetBankverbindung(BankverbindungInhaberOptionalType newBankverbindung, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BANKVERBINDUNG, oldBankverbindung, newBankverbindung);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBankverbindung(BankverbindungInhaberOptionalType newBankverbindung) {
		if (newBankverbindung != bankverbindung) {
			...
			if (bankverbindung != null)
				msgs = ((InternalEObject)bankverbindung).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BANKVERBINDUNG, null, msgs);
			if (newBankverbindung != null)
				msgs = ((InternalEObject)newBankverbindung).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BANKVERBINDUNG, null, msgs);
			msgs = basicSetBankverbindung(newBankverbindung, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BANKVERBINDUNG, newBankverbindung, newBankverbindung));
	}
	...
	public NotificationChain basicSetZustimmungDatenabrufe(ZustimmungDatenabrufeType newZustimmungDatenabrufe, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ZUSTIMMUNG_DATENABRUFE, oldZustimmungDatenabrufe, newZustimmungDatenabrufe);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setZustimmungDatenabrufe(ZustimmungDatenabrufeType newZustimmungDatenabrufe) {
		if (newZustimmungDatenabrufe != zustimmungDatenabrufe) {
			...
			if (zustimmungDatenabrufe != null)
				msgs = ((InternalEObject)zustimmungDatenabrufe).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ZUSTIMMUNG_DATENABRUFE, null, msgs);
			if (newZustimmungDatenabrufe != null)
				msgs = ((InternalEObject)newZustimmungDatenabrufe).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ZUSTIMMUNG_DATENABRUFE, null, msgs);
			msgs = basicSetZustimmungDatenabrufe(newZustimmungDatenabrufe, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ZUSTIMMUNG_DATENABRUFE, newZustimmungDatenabrufe, newZustimmungDatenabrufe));
	}
	...
	public void setZustimmungAuskunftseinholungJobcenterArbeitsamt(boolean newZustimmungAuskunftseinholungJobcenterArbeitsamt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ZUSTIMMUNG_AUSKUNFTSEINHOLUNG_JOBCENTER_ARBEITSAMT, oldZustimmungAuskunftseinholungJobcenterArbeitsamt, zustimmungAuskunftseinholungJobcenterArbeitsamt, !oldZustimmungAuskunftseinholungJobcenterArbeitsamtESet));
	}
	...
	public void unsetZustimmungAuskunftseinholungJobcenterArbeitsamt() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ZUSTIMMUNG_AUSKUNFTSEINHOLUNG_JOBCENTER_ARBEITSAMT, oldZustimmungAuskunftseinholungJobcenterArbeitsamt, ZUSTIMMUNG_AUSKUNFTSEINHOLUNG_JOBCENTER_ARBEITSAMT_EDEFAULT, oldZustimmungAuskunftseinholungJobcenterArbeitsamtESet));
	}
	...
	public EList<ErreichbarkeitType> getKontaktmoeglichkeit() {
		if (kontaktmoeglichkeit == null) {
			kontaktmoeglichkeit = new EObjectContainmentEList<ErreichbarkeitType>(ErreichbarkeitType.class, this, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__KONTAKTMOEGLICHKEIT);
		}
	...
	public void setSteuerlicheIdentifikationsnummer(String newSteuerlicheIdentifikationsnummer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__STEUERLICHE_IDENTIFIKATIONSNUMMER, oldSteuerlicheIdentifikationsnummer, steuerlicheIdentifikationsnummer));
	}
	...
	public NotificationChain basicSetNutzerkonto(NutzerkontoType newNutzerkonto, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__NUTZERKONTO, oldNutzerkonto, newNutzerkonto);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNutzerkonto(NutzerkontoType newNutzerkonto) {
		if (newNutzerkonto != nutzerkonto) {
			NotificationChain msgs = null;
			if (nutzerkonto != null)
				msgs = ((InternalEObject)nutzerkonto).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__NUTZERKONTO, null, msgs);
			if (newNutzerkonto != null)
				msgs = ((InternalEObject)newNutzerkonto).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__NUTZERKONTO, null, msgs);
			msgs = basicSetNutzerkonto(newNutzerkonto, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__NUTZERKONTO, newNutzerkonto, newNutzerkonto));
	}
	...
	public NotificationChain basicSetErwerbstaetigkeitBezugszeitraum(ErwerbstaetigkeitBezugszeitraumType newErwerbstaetigkeitBezugszeitraum, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ERWERBSTAETIGKEIT_BEZUGSZEITRAUM, oldErwerbstaetigkeitBezugszeitraum, newErwerbstaetigkeitBezugszeitraum);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setErwerbstaetigkeitBezugszeitraum(ErwerbstaetigkeitBezugszeitraumType newErwerbstaetigkeitBezugszeitraum) {
		if (newErwerbstaetigkeitBezugszeitraum != erwerbstaetigkeitBezugszeitraum) {
			...
			if (erwerbstaetigkeitBezugszeitraum != null)
				msgs = ((InternalEObject)erwerbstaetigkeitBezugszeitraum).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ERWERBSTAETIGKEIT_BEZUGSZEITRAUM, null, msgs);
			if (newErwerbstaetigkeitBezugszeitraum != null)
				msgs = ((InternalEObject)newErwerbstaetigkeitBezugszeitraum).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ERWERBSTAETIGKEIT_BEZUGSZEITRAUM, null, msgs);
			msgs = basicSetErwerbstaetigkeitBezugszeitraum(newErwerbstaetigkeitBezugszeitraum, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ERWERBSTAETIGKEIT_BEZUGSZEITRAUM, newErwerbstaetigkeitBezugszeitraum, newErwerbstaetigkeitBezugszeitraum));
	}
	...
	public NotificationChain basicSetBescheidzustellungVersandweg(CodeVersandwegType newBescheidzustellungVersandweg, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BESCHEIDZUSTELLUNG_VERSANDWEG, oldBescheidzustellungVersandweg, newBescheidzustellungVersandweg);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBescheidzustellungVersandweg(CodeVersandwegType newBescheidzustellungVersandweg) {
		if (newBescheidzustellungVersandweg != bescheidzustellungVersandweg) {
			...
			if (bescheidzustellungVersandweg != null)
				msgs = ((InternalEObject)bescheidzustellungVersandweg).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BESCHEIDZUSTELLUNG_VERSANDWEG, null, msgs);
			if (newBescheidzustellungVersandweg != null)
				msgs = ((InternalEObject)newBescheidzustellungVersandweg).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BESCHEIDZUSTELLUNG_VERSANDWEG, null, msgs);
			msgs = basicSetBescheidzustellungVersandweg(newBescheidzustellungVersandweg, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BESCHEIDZUSTELLUNG_VERSANDWEG, newBescheidzustellungVersandweg, newBescheidzustellungVersandweg));
	}
	...
	public NotificationChain basicSetGesetzlicheVertretung(GesetzlicheVertretungType newGesetzlicheVertretung, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__GESETZLICHE_VERTRETUNG, oldGesetzlicheVertretung, newGesetzlicheVertretung);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGesetzlicheVertretung(GesetzlicheVertretungType newGesetzlicheVertretung) {
		if (newGesetzlicheVertretung != gesetzlicheVertretung) {
			...
			if (gesetzlicheVertretung != null)
				msgs = ((InternalEObject)gesetzlicheVertretung).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__GESETZLICHE_VERTRETUNG, null, msgs);
			if (newGesetzlicheVertretung != null)
				msgs = ((InternalEObject)newGesetzlicheVertretung).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__GESETZLICHE_VERTRETUNG, null, msgs);
			msgs = basicSetGesetzlicheVertretung(newGesetzlicheVertretung, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__GESETZLICHE_VERTRETUNG, newGesetzlicheVertretung, newGesetzlicheVertretung));
	}
	...
	public NotificationChain basicSetElternzeit(ElternzeitType newElternzeit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ELTERNZEIT, oldElternzeit, newElternzeit);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setElternzeit(ElternzeitType newElternzeit) {
		if (newElternzeit != elternzeit) {
			NotificationChain msgs = null;
			if (elternzeit != null)
				msgs = ((InternalEObject)elternzeit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ELTERNZEIT, null, msgs);
			if (newElternzeit != null)
				msgs = ((InternalEObject)newElternzeit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ELTERNZEIT, null, msgs);
			msgs = basicSetElternzeit(newElternzeit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ELTERNZEIT, newElternzeit, newElternzeit));
	}
	...
	public void setZusammenveranlagungLiegtVor(boolean newZusammenveranlagungLiegtVor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ZUSAMMENVERANLAGUNG_LIEGT_VOR, oldZusammenveranlagungLiegtVor, zusammenveranlagungLiegtVor, !oldZusammenveranlagungLiegtVorESet));
	}
	...
	public void unsetZusammenveranlagungLiegtVor() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ZUSAMMENVERANLAGUNG_LIEGT_VOR, oldZusammenveranlagungLiegtVor, ZUSAMMENVERANLAGUNG_LIEGT_VOR_EDEFAULT, oldZusammenveranlagungLiegtVorESet));
	}
	...
	public void setMitteilungAnBehoerde(String newMitteilungAnBehoerde) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__MITTEILUNG_AN_BEHOERDE, oldMitteilungAnBehoerde, mitteilungAnBehoerde));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__PERSOENLICHE_ANGABEN:
				return basicSetPersoenlicheAngaben(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ANSCHRIFT:
				return basicSetAnschrift(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__GEWOEHNLICHER_AUFENTHALT:
				return basicSetGewoehnlicherAufenthalt(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__KINDSCHAFTSVERHAELTNIS:
				return basicSetKindschaftsverhaeltnis(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__HAUSHALTSZUGEHOERIGKEIT_DES_KINDES:
				return basicSetHaushaltszugehoerigkeitDesKindes(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BEANTRAGUNG_ELTERNGELD:
				return basicSetBeantragungElterngeld(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__KRANKENVERSICHERUNG:
				return basicSetKrankenversicherung(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__EINKOMMEN_VOR_GEBURT:
				return basicSetEinkommenVorGeburt(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__EINKOMMEN_WAEHREND_BEZUGSZEITRAUM:
				return basicSetEinkommenWaehrendBezugszeitraum(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BANKVERBINDUNG:
				return basicSetBankverbindung(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ZUSTIMMUNG_DATENABRUFE:
				return basicSetZustimmungDatenabrufe(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__KONTAKTMOEGLICHKEIT:
				return ((InternalEList<?>)getKontaktmoeglichkeit()).basicRemove(otherEnd, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__NUTZERKONTO:
				return basicSetNutzerkonto(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ERWERBSTAETIGKEIT_BEZUGSZEITRAUM:
				return basicSetErwerbstaetigkeitBezugszeitraum(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__BESCHEIDZUSTELLUNG_VERSANDWEG:
				return basicSetBescheidzustellungVersandweg(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__GESETZLICHE_VERTRETUNG:
				return basicSetGesetzlicheVertretung(null, msgs);
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ELTERNZEIT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ZUSTIMMUNG_AUSKUNFTSEINHOLUNG_JOBCENTER_ARBEITSAMT:
				return isZustimmungAuskunftseinholungJobcenterArbeitsamt();
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__KONTAKTMOEGLICHKEIT:
				return getKontaktmoeglichkeit();
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__STEUERLICHE_IDENTIFIKATIONSNUMMER:
			...
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__ZUSAMMENVERANLAGUNG_LIEGT_VOR:
				return isZusammenveranlagungLiegtVor();
			case ElterngeldPackage.ELTERNTEIL_ZWEI_ELTERNGELDANTRAG_TYPE__MITTEILUNG_AN_BEHOERDE:
...
} //ElternteilZweiElterngeldantragTypeImpl
