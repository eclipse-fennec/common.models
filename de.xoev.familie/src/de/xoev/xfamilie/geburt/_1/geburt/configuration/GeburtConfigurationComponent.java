...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.xoev.xfamilie.geburt._1.geburt\"" })
...
public class GeburtConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(GeburtPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(GeburtPackage.eNS_URI, ePackage);
		}
