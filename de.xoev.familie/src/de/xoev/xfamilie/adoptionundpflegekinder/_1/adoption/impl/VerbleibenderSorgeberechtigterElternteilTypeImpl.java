...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Verbleibender Sorgeberechtigter Elternteil Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.xoev.xfamilie.adoptionundpflegekinder._1.adoption.impl.VerbleibenderSorgeberechtigterElternteilTypeImpl#getPersonendaten <em>Personendaten</em>}</li>
 *   <li>{@link de.xoev.xfamilie.adoptionundpflegekinder._1.adoption.impl.VerbleibenderSorgeberechtigterElternteilTypeImpl#getStaatsangehoerigkeit <em>Staatsangehoerigkeit</em>}</li>
 *   <li>{@link de.xoev.xfamilie.adoptionundpflegekinder._1.adoption.impl.VerbleibenderSorgeberechtigterElternteilTypeImpl#getGeburt <em>Geburt</em>}</li>
 *   <li>{@link de.xoev.xfamilie.adoptionundpflegekinder._1.adoption.impl.VerbleibenderSorgeberechtigterElternteilTypeImpl#getEinkuenfteAusTaetigkeit <em>Einkuenfte Aus Taetigkeit</em>}</li>
 *   <li>{@link de.xoev.xfamilie.adoptionundpflegekinder._1.adoption.impl.VerbleibenderSorgeberechtigterElternteilTypeImpl#getAndereEinkuenfte <em>Andere Einkuenfte</em>}</li>
 *   <li>{@link de.xoev.xfamilie.adoptionundpflegekinder._1.adoption.impl.VerbleibenderSorgeberechtigterElternteilTypeImpl#getSchuldverpflichtungen <em>Schuldverpflichtungen</em>}</li>
 *   <li>{@link de.xoev.xfamilie.adoptionundpflegekinder._1.adoption.impl.VerbleibenderSorgeberechtigterElternteilTypeImpl#getUnterhaltsverpflichtungen <em>Unterhaltsverpflichtungen</em>}</li>
 *   <li>{@link de.xoev.xfamilie.adoptionundpflegekinder._1.adoption.impl.VerbleibenderSorgeberechtigterElternteilTypeImpl#getMonatlicheFixkostenUnterkunft <em>Monatliche Fixkosten Unterkunft</em>}</li>
 *   <li>{@link de.xoev.xfamilie.adoptionundpflegekinder._1.adoption.impl.VerbleibenderSorgeberechtigterElternteilTypeImpl#getAufenthaltsstatus <em>Aufenthaltsstatus</em>}</li>
 *   <li>{@link de.xoev.xfamilie.adoptionundpflegekinder._1.adoption.impl.VerbleibenderSorgeberechtigterElternteilTypeImpl#getGeschlecht <em>Geschlecht</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VerbleibenderSorgeberechtigterElternteilTypeImpl extends MinimalEObjectImpl.Container implements VerbleibenderSorgeberechtigterElternteilType {
	/**
	 ...
	 * @generated
	 */
	protected VerbleibenderSorgeberechtigterElternteilTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AdoptionPackage.Literals.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE;
	}
	...
	public NotificationChain basicSetPersonendaten(PersonendatenType newPersonendaten, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__PERSONENDATEN, oldPersonendaten, newPersonendaten);
	...
	public void setPersonendaten(PersonendatenType newPersonendaten) {
		if (newPersonendaten != personendaten) {
			...
			if (personendaten != null)
				msgs = ((InternalEObject)personendaten).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__PERSONENDATEN, null, msgs);
			if (newPersonendaten != null)
				msgs = ((InternalEObject)newPersonendaten).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__PERSONENDATEN, null, msgs);
			msgs = basicSetPersonendaten(newPersonendaten, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__PERSONENDATEN, newPersonendaten, newPersonendaten));
	}
	...
	public NotificationChain basicSetStaatsangehoerigkeit(CodeStaatsangehoerigkeitType newStaatsangehoerigkeit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__STAATSANGEHOERIGKEIT, oldStaatsangehoerigkeit, newStaatsangehoerigkeit);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStaatsangehoerigkeit(CodeStaatsangehoerigkeitType newStaatsangehoerigkeit) {
		if (newStaatsangehoerigkeit != staatsangehoerigkeit) {
			...
			if (staatsangehoerigkeit != null)
				msgs = ((InternalEObject)staatsangehoerigkeit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__STAATSANGEHOERIGKEIT, null, msgs);
			if (newStaatsangehoerigkeit != null)
				msgs = ((InternalEObject)newStaatsangehoerigkeit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__STAATSANGEHOERIGKEIT, null, msgs);
			msgs = basicSetStaatsangehoerigkeit(newStaatsangehoerigkeit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__STAATSANGEHOERIGKEIT, newStaatsangehoerigkeit, newStaatsangehoerigkeit));
	}
	...
	public NotificationChain basicSetGeburt(GeburtOptionalType newGeburt, NotificationChain msgs) {
		...
		geburt = newGeburt;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__GEBURT, oldGeburt, newGeburt);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGeburt(GeburtOptionalType newGeburt) {
		if (newGeburt != geburt) {
			NotificationChain msgs = null;
			if (geburt != null)
				msgs = ((InternalEObject)geburt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__GEBURT, null, msgs);
			if (newGeburt != null)
				msgs = ((InternalEObject)newGeburt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__GEBURT, null, msgs);
			msgs = basicSetGeburt(newGeburt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__GEBURT, newGeburt, newGeburt));
	}
	...
	public void setEinkuenfteAusTaetigkeit(float newEinkuenfteAusTaetigkeit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__EINKUENFTE_AUS_TAETIGKEIT, oldEinkuenfteAusTaetigkeit, einkuenfteAusTaetigkeit, !oldEinkuenfteAusTaetigkeitESet));
	}
	...
	public void unsetEinkuenfteAusTaetigkeit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__EINKUENFTE_AUS_TAETIGKEIT, oldEinkuenfteAusTaetigkeit, EINKUENFTE_AUS_TAETIGKEIT_EDEFAULT, oldEinkuenfteAusTaetigkeitESet));
	}
	...
	public void setAndereEinkuenfte(float newAndereEinkuenfte) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__ANDERE_EINKUENFTE, oldAndereEinkuenfte, andereEinkuenfte, !oldAndereEinkuenfteESet));
	}
	...
	public void unsetAndereEinkuenfte() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__ANDERE_EINKUENFTE, oldAndereEinkuenfte, ANDERE_EINKUENFTE_EDEFAULT, oldAndereEinkuenfteESet));
	}
	...
	public void setSchuldverpflichtungen(float newSchuldverpflichtungen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__SCHULDVERPFLICHTUNGEN, oldSchuldverpflichtungen, schuldverpflichtungen, !oldSchuldverpflichtungenESet));
	}
	...
	public void unsetSchuldverpflichtungen() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__SCHULDVERPFLICHTUNGEN, oldSchuldverpflichtungen, SCHULDVERPFLICHTUNGEN_EDEFAULT, oldSchuldverpflichtungenESet));
	}
	...
	public void setUnterhaltsverpflichtungen(float newUnterhaltsverpflichtungen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__UNTERHALTSVERPFLICHTUNGEN, oldUnterhaltsverpflichtungen, unterhaltsverpflichtungen, !oldUnterhaltsverpflichtungenESet));
	}
	...
	public void unsetUnterhaltsverpflichtungen() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__UNTERHALTSVERPFLICHTUNGEN, oldUnterhaltsverpflichtungen, UNTERHALTSVERPFLICHTUNGEN_EDEFAULT, oldUnterhaltsverpflichtungenESet));
	}
	...
	public void setMonatlicheFixkostenUnterkunft(float newMonatlicheFixkostenUnterkunft) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__MONATLICHE_FIXKOSTEN_UNTERKUNFT, oldMonatlicheFixkostenUnterkunft, monatlicheFixkostenUnterkunft, !oldMonatlicheFixkostenUnterkunftESet));
	}
	...
	public void unsetMonatlicheFixkostenUnterkunft() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__MONATLICHE_FIXKOSTEN_UNTERKUNFT, oldMonatlicheFixkostenUnterkunft, MONATLICHE_FIXKOSTEN_UNTERKUNFT_EDEFAULT, oldMonatlicheFixkostenUnterkunftESet));
	}
	...
	public NotificationChain basicSetAufenthaltsstatus(CodeAufenthaltsstatusType newAufenthaltsstatus, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__AUFENTHALTSSTATUS, oldAufenthaltsstatus, newAufenthaltsstatus);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAufenthaltsstatus(CodeAufenthaltsstatusType newAufenthaltsstatus) {
		if (newAufenthaltsstatus != aufenthaltsstatus) {
			...
			if (aufenthaltsstatus != null)
				msgs = ((InternalEObject)aufenthaltsstatus).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__AUFENTHALTSSTATUS, null, msgs);
			if (newAufenthaltsstatus != null)
				msgs = ((InternalEObject)newAufenthaltsstatus).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__AUFENTHALTSSTATUS, null, msgs);
			msgs = basicSetAufenthaltsstatus(newAufenthaltsstatus, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__AUFENTHALTSSTATUS, newAufenthaltsstatus, newAufenthaltsstatus));
	}
	...
	public NotificationChain basicSetGeschlecht(CodeGeschlechtType newGeschlecht, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__GESCHLECHT, oldGeschlecht, newGeschlecht);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGeschlecht(CodeGeschlechtType newGeschlecht) {
		if (newGeschlecht != geschlecht) {
			NotificationChain msgs = null;
			if (geschlecht != null)
				msgs = ((InternalEObject)geschlecht).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__GESCHLECHT, null, msgs);
			if (newGeschlecht != null)
				msgs = ((InternalEObject)newGeschlecht).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__GESCHLECHT, null, msgs);
			msgs = basicSetGeschlecht(newGeschlecht, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__GESCHLECHT, newGeschlecht, newGeschlecht));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__PERSONENDATEN:
				return basicSetPersonendaten(null, msgs);
			case AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__STAATSANGEHOERIGKEIT:
				return basicSetStaatsangehoerigkeit(null, msgs);
			case AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__GEBURT:
				return basicSetGeburt(null, msgs);
			case AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__AUFENTHALTSSTATUS:
				return basicSetAufenthaltsstatus(null, msgs);
			case AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__GESCHLECHT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__GEBURT:
				return getGeburt();
			case AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__EINKUENFTE_AUS_TAETIGKEIT:
				return getEinkuenfteAusTaetigkeit();
			case AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__ANDERE_EINKUENFTE:
				return getAndereEinkuenfte();
			case AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__SCHULDVERPFLICHTUNGEN:
				return getSchuldverpflichtungen();
			case AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__UNTERHALTSVERPFLICHTUNGEN:
				return getUnterhaltsverpflichtungen();
			case AdoptionPackage.VERBLEIBENDER_SORGEBERECHTIGTER_ELTERNTEIL_TYPE__MONATLICHE_FIXKOSTEN_UNTERKUNFT:
...
} //VerbleibenderSorgeberechtigterElternteilTypeImpl
