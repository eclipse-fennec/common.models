...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.xoev.xfamilie.adoptionundpflegekinder._1.adoption\"" })
...
public class AdoptionConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(AdoptionPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(AdoptionPackage.eNS_URI, ePackage);
		}
