...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>RDF Subject</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.w3.rdf.impl.RDFSubjectImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RDFSubjectImpl extends MinimalEObjectImpl.Container implements RDFSubject {
		...
		if (statement != null && statement.eIsProxy()) {
			...
			if (statement != oldStatement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RdfPackage.RDF_SUBJECT__STATEMENT, oldStatement, statement));
			}
		}
		return statement;
	}
	...
	public NotificationChain basicSetStatement(RDFStatement newStatement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RdfPackage.RDF_SUBJECT__STATEMENT, oldStatement, newStatement);
	...
	public void setStatement(RDFStatement newStatement) {
		if (newStatement != statement) {
			...
			if (statement != null)
				msgs = ((InternalEObject)statement).eInverseRemove(this, RdfPackage.RDF_STATEMENT__SUBJECT, RDFStatement.class, msgs);
			if (newStatement != null)
				msgs = ((InternalEObject)newStatement).eInverseAdd(this, RdfPackage.RDF_STATEMENT__SUBJECT, RDFStatement.class, msgs);
			msgs = basicSetStatement(newStatement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RdfPackage.RDF_SUBJECT__STATEMENT, newStatement, newStatement));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RdfPackage.RDF_SUBJECT__STATEMENT:
				if (statement != null)
					msgs = ((InternalEObject)statement).eInverseRemove(this, RdfPackage.RDF_STATEMENT__SUBJECT, RDFStatement.class, msgs);
