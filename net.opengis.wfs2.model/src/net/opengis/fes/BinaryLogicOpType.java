 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.BinaryLogicOpType#getFilterPredicates <em>Filter Predicates</em>}</li>
 *   <li>{@link net.opengis.fes.BinaryLogicOpType#getComparisonOpsGroup <em>Comparison Ops Group</em>}</li>
 *   <li>{@link net.opengis.fes.BinaryLogicOpType#getComparisonOps <em>Comparison Ops</em>}</li>
 *   <li>{@link net.opengis.fes.BinaryLogicOpType#getSpatialOpsGroup <em>Spatial Ops Group</em>}</li>
 *   <li>{@link net.opengis.fes.BinaryLogicOpType#getSpatialOps <em>Spatial Ops</em>}</li>
 *   <li>{@link net.opengis.fes.BinaryLogicOpType#getTemporalOpsGroup <em>Temporal Ops Group</em>}</li>
 *   <li>{@link net.opengis.fes.BinaryLogicOpType#getTemporalOps <em>Temporal Ops</em>}</li>
 *   <li>{@link net.opengis.fes.BinaryLogicOpType#getLogicOpsGroup <em>Logic Ops Group</em>}</li>
 *   <li>{@link net.opengis.fes.BinaryLogicOpType#getLogicOps <em>Logic Ops</em>}</li>
 *   <li>{@link net.opengis.fes.BinaryLogicOpType#getExtensionOpsGroup <em>Extension Ops Group</em>}</li>
 *   <li>{@link net.opengis.fes.BinaryLogicOpType#getExtensionOps <em>Extension Ops</em>}</li>
 *   <li>{@link net.opengis.fes.BinaryLogicOpType#getFunction <em>Function</em>}</li>
 *   <li>{@link net.opengis.fes.BinaryLogicOpType#getIdGroup <em>Id Group</em>}</li>
 *   <li>{@link net.opengis.fes.BinaryLogicOpType#getId <em>Id</em>}</li>
 * </ul>
 *
 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType()
...
public interface BinaryLogicOpType extends LogicOpsType {
	 ...
	 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType_FilterPredicates()
	 ...
	 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType_ComparisonOpsGroup()
	 ...
	 * The list contents are of type {@link net.opengis.fes.ComparisonOpsType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Comparison Ops</em>' containment reference list.
	 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType_ComparisonOps()
	 ...
	 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType_SpatialOpsGroup()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true" transient="true" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link net.opengis.fes.SpatialOpsType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Spatial Ops</em>' containment reference list.
	 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType_SpatialOps()
	 * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType_TemporalOpsGroup()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true" transient="true" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link net.opengis.fes.TemporalOpsType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Temporal Ops</em>' containment reference list.
	 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType_TemporalOps()
	 * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType_LogicOpsGroup()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true" transient="true" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link net.opengis.fes.LogicOpsType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Logic Ops</em>' containment reference list.
	 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType_LogicOps()
	 * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType_ExtensionOpsGroup()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true" transient="true" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link net.opengis.fes.ExtensionOpsType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Extension Ops</em>' containment reference list.
	 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType_ExtensionOps()
	 * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link net.opengis.fes.FunctionType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Function</em>' containment reference list.
	 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType_Function()
	 ...
	 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType_IdGroup()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.opengis.fes.FESPackage#getBinaryLogicOpType_Id()
	 * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
