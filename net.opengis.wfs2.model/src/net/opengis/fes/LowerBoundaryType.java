 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.LowerBoundaryType#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link net.opengis.fes.LowerBoundaryType#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @see net.opengis.fes.FESPackage#getLowerBoundaryType()
...
public interface LowerBoundaryType extends EObject {
	 ...
	 * @see net.opengis.fes.FESPackage#getLowerBoundaryType_ExpressionGroup()
	 ...
	 * @see net.opengis.fes.FESPackage#getLowerBoundaryType_Expression()
