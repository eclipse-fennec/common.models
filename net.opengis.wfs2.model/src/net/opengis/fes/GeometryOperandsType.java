 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.GeometryOperandsType#getGeometryOperand <em>Geometry Operand</em>}</li>
 * </ul>
 *
 * @see net.opengis.fes.FESPackage#getGeometryOperandsType()
...
public interface GeometryOperandsType extends EObject {
	 ...
	 * The list contents are of type {@link net.opengis.fes.GeometryOperandType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Geometry Operand</em>' containment reference list.
	 * @see net.opengis.fes.FESPackage#getGeometryOperandsType_GeometryOperand()
