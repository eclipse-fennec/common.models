...
import net.opengis.fes.ComparisonOperatorNameTypeMember0;
...
import net.opengis.fes.SpatialOperatorNameTypeMember0;
...
import net.opengis.fes.TemporalOperatorNameTypeMember0;
...
import net.opengis.fes.VersionActionTokens;

import net.opengis.fes.util.FESValidator;
 ...
 * @generated
 */
public class FESPackageImpl extends EPackageImpl implements FESPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see net.opengis.fes.FESPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private FESPackageImpl() {
		super(eNS_URI, FESFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link FESPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static FESPackage init() {
		if (isInited) return (FESPackage)EPackage.Registry.INSTANCE.getEPackage(FESPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredFESPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		FESPackageImpl theFESPackage = registeredFESPackage instanceof FESPackageImpl ? (FESPackageImpl)registeredFESPackage : new FESPackageImpl();
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(OWSPackage.eNS_URI);
			...
			(theFESPackage,
			 new EValidator.Descriptor() {
				 ...
				 public EValidator getEValidator() {
					 return FESValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theFESPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(FESPackage.eNS_URI, theFESPackage);
		return theFESPackage;
	}
	 ...
	 */
	@Override
	public EAttribute getBBOXType_Group() {
	...
	public EAttribute getBBOXType_Any() {
		return (EAttribute)bboxTypeEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getBinarySpatialOpType_Group() {
	 ...
	 */
	@Override
	public EAttribute getBinaryTemporalOpType_Group() {
	 ...
	 */
	@Override
	public EAttribute getDistanceBufferType_Group() {
	...
	public EAttribute getDistanceBufferType_Any() {
		return (EAttribute)distanceBufferTypeEClass.getEStructuralFeatures().get(3);
	}
	...
	public EReference getDistanceBufferType_Distance() {
		return (EReference)distanceBufferTypeEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public FESFactory getFESFactory() {
		return (FESFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(bboxTypeEClass, BBOX_TYPE__GROUP);
		...
		createEAttribute(binarySpatialOpTypeEClass, BINARY_SPATIAL_OP_TYPE__GROUP);
		...
		createEAttribute(binaryTemporalOpTypeEClass, BINARY_TEMPORAL_OP_TYPE__GROUP);
		...
		createEAttribute(distanceBufferTypeEClass, DISTANCE_BUFFER_TYPE__GROUP);
	...
	public void initializePackageContents() {
		...
		initEReference(getArgumentType_Metadata(), theOWSPackage.getMetadataType(), null, "metadata", null, 0, 1, ArgumentType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAvailableFunctionType_Metadata(), theOWSPackage.getMetadataType(), null, "metadata", null, 0, 1, AvailableFunctionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getBBOXType_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1, BBOXType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBBOXType_ExpressionGroup(), ecorePackage.getEFeatureMapEntry(), "expressionGroup", null, 0, 2, BBOXType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getBBOXType_Expression(), ecorePackage.getEObject(), null, "expression", null, 0, 2, BBOXType.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getBBOXType_Any(), ecorePackage.getEFeatureMapEntry(), "any", null, 0, 2, BBOXType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getBinarySpatialOpType_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1, BinarySpatialOpType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBinarySpatialOpType_ExpressionGroup(), ecorePackage.getEFeatureMapEntry(), "expressionGroup", null, 0, 2, BinarySpatialOpType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getBinarySpatialOpType_Expression(), ecorePackage.getEObject(), null, "expression", null, 0, 2, BinarySpatialOpType.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getBinarySpatialOpType_Any(), ecorePackage.getEFeatureMapEntry(), "any", null, 0, 2, BinarySpatialOpType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getBinaryTemporalOpType_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1, BinaryTemporalOpType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBinaryTemporalOpType_ExpressionGroup(), ecorePackage.getEFeatureMapEntry(), "expressionGroup", null, 0, 2, BinaryTemporalOpType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getBinaryTemporalOpType_Expression(), ecorePackage.getEObject(), null, "expression", null, 0, 2, BinaryTemporalOpType.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getBinaryTemporalOpType_Any(), ecorePackage.getEFeatureMapEntry(), "any", null, 0, 2, BinaryTemporalOpType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getConformanceType_Constraint(), theOWSPackage.getDomainType(), null, "constraint", null, 1, -1, ConformanceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDistanceBufferType_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1, DistanceBufferType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDistanceBufferType_ExpressionGroup(), ecorePackage.getEFeatureMapEntry(), "expressionGroup", null, 0, 2, DistanceBufferType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getDistanceBufferType_Expression(), ecorePackage.getEObject(), null, "expression", null, 0, 2, DistanceBufferType.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getDistanceBufferType_Any(), ecorePackage.getEFeatureMapEntry(), "any", null, 0, 2, DistanceBufferType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPropertyIsNilType_ExpressionGroup(), ecorePackage.getEFeatureMapEntry(), "expressionGroup", null, 1, 1, PropertyIsNilType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPropertyIsNilType_Expression(), ecorePackage.getEObject(), null, "expression", null, 1, 1, PropertyIsNilType.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPropertyIsNullType_ExpressionGroup(), ecorePackage.getEFeatureMapEntry(), "expressionGroup", null, 1, 1, PropertyIsNullType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPropertyIsNullType_Expression(), ecorePackage.getEObject(), null, "expression", null, 1, 1, PropertyIsNullType.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getResourceIdentifierType_Metadata(), theOWSPackage.getMetadataType(), null, "metadata", null, 0, 1, ResourceIdentifierType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
