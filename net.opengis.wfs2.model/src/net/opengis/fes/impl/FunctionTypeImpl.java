 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.impl.FunctionTypeImpl#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link net.opengis.fes.impl.FunctionTypeImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link net.opengis.fes.impl.FunctionTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionTypeImpl extends MinimalEObjectImpl.Container implements FunctionType {
	...
	protected EClass eStaticClass() {
		return FESPackage.Literals.FUNCTION_TYPE;
	}
	...
	public FeatureMap getExpressionGroup() {
		if (expressionGroup == null) {
			expressionGroup = new BasicFeatureMap(this, FESPackage.FUNCTION_TYPE__EXPRESSION_GROUP);
		}
	...
	public EList<EObject> getExpression() {
		return getExpressionGroup().list(FESPackage.Literals.FUNCTION_TYPE__EXPRESSION);
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FESPackage.FUNCTION_TYPE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FESPackage.FUNCTION_TYPE__EXPRESSION_GROUP:
				return ((InternalEList<?>)getExpressionGroup()).basicRemove(otherEnd, msgs);
			case FESPackage.FUNCTION_TYPE__EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FESPackage.FUNCTION_TYPE__NAME:
				return getName();
		}
