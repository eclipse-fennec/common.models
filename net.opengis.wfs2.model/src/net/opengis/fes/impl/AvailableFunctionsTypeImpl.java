 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.impl.AvailableFunctionsTypeImpl#getFunction <em>Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AvailableFunctionsTypeImpl extends MinimalEObjectImpl.Container implements AvailableFunctionsType {
	/**
	...
	protected EClass eStaticClass() {
		return FESPackage.Literals.AVAILABLE_FUNCTIONS_TYPE;
	}
	...
	public EList<AvailableFunctionType> getFunction() {
		if (function == null) {
			function = new EObjectContainmentEList<AvailableFunctionType>(AvailableFunctionType.class, this, FESPackage.AVAILABLE_FUNCTIONS_TYPE__FUNCTION);
		}
		return function;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FESPackage.AVAILABLE_FUNCTIONS_TYPE__FUNCTION:
