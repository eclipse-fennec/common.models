 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.impl.PropertyIsNilTypeImpl#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link net.opengis.fes.impl.PropertyIsNilTypeImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link net.opengis.fes.impl.PropertyIsNilTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyIsNilTypeImpl extends ComparisonOpsTypeImpl implements PropertyIsNilType {
	...
	protected EClass eStaticClass() {
		return FESPackage.Literals.PROPERTY_IS_NIL_TYPE;
	}
	...
	public FeatureMap getExpressionGroup() {
		if (expressionGroup == null) {
			expressionGroup = new BasicFeatureMap(this, FESPackage.PROPERTY_IS_NIL_TYPE__EXPRESSION_GROUP);
		}
	...
	public EObject getExpression() {
		return (EObject)getExpressionGroup().get(FESPackage.Literals.PROPERTY_IS_NIL_TYPE__EXPRESSION, true);
	}
	...
	public NotificationChain basicSetExpression(EObject newExpression, NotificationChain msgs) {
		return ((FeatureMap.Internal)getExpressionGroup()).basicAdd(FESPackage.Literals.PROPERTY_IS_NIL_TYPE__EXPRESSION, newExpression, msgs);
	}
	...
	public void setNilReason(String newNilReason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FESPackage.PROPERTY_IS_NIL_TYPE__NIL_REASON, oldNilReason, nilReason));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FESPackage.PROPERTY_IS_NIL_TYPE__EXPRESSION_GROUP:
				return ((InternalEList<?>)getExpressionGroup()).basicRemove(otherEnd, msgs);
			case FESPackage.PROPERTY_IS_NIL_TYPE__EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FESPackage.PROPERTY_IS_NIL_TYPE__NIL_REASON:
				return getNilReason();
		}
