 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.impl.ResourceIdTypeImpl#getEndDate <em>End Date</em>}</li>
 *   <li>{@link net.opengis.fes.impl.ResourceIdTypeImpl#getPreviousRid <em>Previous Rid</em>}</li>
 *   <li>{@link net.opengis.fes.impl.ResourceIdTypeImpl#getRid <em>Rid</em>}</li>
 *   <li>{@link net.opengis.fes.impl.ResourceIdTypeImpl#getStartDate <em>Start Date</em>}</li>
 *   <li>{@link net.opengis.fes.impl.ResourceIdTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceIdTypeImpl extends AbstractIdTypeImpl implements ResourceIdType {
	...
	protected EClass eStaticClass() {
		return FESPackage.Literals.RESOURCE_ID_TYPE;
	}
	...
	public void setEndDate(XMLGregorianCalendar newEndDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FESPackage.RESOURCE_ID_TYPE__END_DATE, oldEndDate, endDate));
	}
	...
	public void setPreviousRid(String newPreviousRid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FESPackage.RESOURCE_ID_TYPE__PREVIOUS_RID, oldPreviousRid, previousRid));
	}
	...
	public void setRid(String newRid) {
		...
		rid = newRid;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FESPackage.RESOURCE_ID_TYPE__RID, oldRid, rid));
	}
	...
	public void setStartDate(XMLGregorianCalendar newStartDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FESPackage.RESOURCE_ID_TYPE__START_DATE, oldStartDate, startDate));
	}
	...
	public void setVersion(Object newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FESPackage.RESOURCE_ID_TYPE__VERSION, oldVersion, version));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FESPackage.RESOURCE_ID_TYPE__END_DATE:
				return getEndDate();
			case FESPackage.RESOURCE_ID_TYPE__PREVIOUS_RID:
				return getPreviousRid();
			case FESPackage.RESOURCE_ID_TYPE__RID:
				return getRid();
			case FESPackage.RESOURCE_ID_TYPE__START_DATE:
				return getStartDate();
			case FESPackage.RESOURCE_ID_TYPE__VERSION:
				return getVersion();
		}
