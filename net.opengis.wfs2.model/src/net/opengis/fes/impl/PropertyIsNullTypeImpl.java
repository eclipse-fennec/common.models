 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.impl.PropertyIsNullTypeImpl#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link net.opengis.fes.impl.PropertyIsNullTypeImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyIsNullTypeImpl extends ComparisonOpsTypeImpl implements PropertyIsNullType {
	...
	protected EClass eStaticClass() {
		return FESPackage.Literals.PROPERTY_IS_NULL_TYPE;
	}
	...
	public FeatureMap getExpressionGroup() {
		if (expressionGroup == null) {
			expressionGroup = new BasicFeatureMap(this, FESPackage.PROPERTY_IS_NULL_TYPE__EXPRESSION_GROUP);
		}
	...
	public EObject getExpression() {
		return (EObject)getExpressionGroup().get(FESPackage.Literals.PROPERTY_IS_NULL_TYPE__EXPRESSION, true);
	}
	...
	public NotificationChain basicSetExpression(EObject newExpression, NotificationChain msgs) {
		return ((FeatureMap.Internal)getExpressionGroup()).basicAdd(FESPackage.Literals.PROPERTY_IS_NULL_TYPE__EXPRESSION, newExpression, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FESPackage.PROPERTY_IS_NULL_TYPE__EXPRESSION_GROUP:
				return ((InternalEList<?>)getExpressionGroup()).basicRemove(otherEnd, msgs);
			case FESPackage.PROPERTY_IS_NULL_TYPE__EXPRESSION:
