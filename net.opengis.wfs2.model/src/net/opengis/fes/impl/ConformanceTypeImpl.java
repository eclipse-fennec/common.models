 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.impl.ConformanceTypeImpl#getConstraint <em>Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConformanceTypeImpl extends MinimalEObjectImpl.Container implements ConformanceType {
	...
	protected EClass eStaticClass() {
		return FESPackage.Literals.CONFORMANCE_TYPE;
	}
	...
	public EList<DomainType> getConstraint() {
		if (constraint == null) {
			constraint = new EObjectContainmentEList<DomainType>(DomainType.class, this, FESPackage.CONFORMANCE_TYPE__CONSTRAINT);
		}
		return constraint;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FESPackage.CONFORMANCE_TYPE__CONSTRAINT:
