 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.impl.SortByTypeImpl#getSortProperty <em>Sort Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SortByTypeImpl extends MinimalEObjectImpl.Container implements SortByType {
	...
	protected EClass eStaticClass() {
		return FESPackage.Literals.SORT_BY_TYPE;
	}
	...
	public EList<SortPropertyType> getSortProperty() {
		if (sortProperty == null) {
			sortProperty = new EObjectContainmentEList<SortPropertyType>(SortPropertyType.class, this, FESPackage.SORT_BY_TYPE__SORT_PROPERTY);
		}
		return sortProperty;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FESPackage.SORT_BY_TYPE__SORT_PROPERTY:
