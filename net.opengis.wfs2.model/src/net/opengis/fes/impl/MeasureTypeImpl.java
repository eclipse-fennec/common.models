 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.impl.MeasureTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.fes.impl.MeasureTypeImpl#getUom <em>Uom</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasureTypeImpl extends MinimalEObjectImpl.Container implements MeasureType {
	...
	protected EClass eStaticClass() {
		return FESPackage.Literals.MEASURE_TYPE;
	}
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FESPackage.MEASURE_TYPE__VALUE, oldValue, value, !oldValueESet));
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FESPackage.MEASURE_TYPE__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
	}
	...
	public void setUom(String newUom) {
		...
		uom = newUom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FESPackage.MEASURE_TYPE__UOM, oldUom, uom));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FESPackage.MEASURE_TYPE__VALUE:
				return getValue();
			case FESPackage.MEASURE_TYPE__UOM:
				return getUom();
		}
