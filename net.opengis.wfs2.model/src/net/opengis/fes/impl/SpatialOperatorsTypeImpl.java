 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.impl.SpatialOperatorsTypeImpl#getSpatialOperator <em>Spatial Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpatialOperatorsTypeImpl extends MinimalEObjectImpl.Container implements SpatialOperatorsType {
	...
	protected EClass eStaticClass() {
		return FESPackage.Literals.SPATIAL_OPERATORS_TYPE;
	}
	...
	public EList<SpatialOperatorType> getSpatialOperator() {
		if (spatialOperator == null) {
			spatialOperator = new EObjectContainmentEList<SpatialOperatorType>(SpatialOperatorType.class, this, FESPackage.SPATIAL_OPERATORS_TYPE__SPATIAL_OPERATOR);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FESPackage.SPATIAL_OPERATORS_TYPE__SPATIAL_OPERATOR:
