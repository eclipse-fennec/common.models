 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.BBOXType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.fes.BBOXType#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link net.opengis.fes.BBOXType#getExpression <em>Expression</em>}</li>
 *   <li>{@link net.opengis.fes.BBOXType#getAny <em>Any</em>}</li>
 * </ul>
 *
 * @see net.opengis.fes.FESPackage#getBBOXType()
...
public interface BBOXType extends SpatialOpsType {
	 ...
	 * @see net.opengis.fes.FESPackage#getBBOXType_Group()
	 ...
	 * @see net.opengis.fes.FESPackage#getBBOXType_ExpressionGroup()
	 ...
	 * @see net.opengis.fes.FESPackage#getBBOXType_Expression()
	 ...
	 * @see net.opengis.fes.FESPackage#getBBOXType_Any()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" upper="2" transient="true" volatile="true" derived="true"
