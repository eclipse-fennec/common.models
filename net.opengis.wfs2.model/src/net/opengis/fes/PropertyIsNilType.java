 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.PropertyIsNilType#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link net.opengis.fes.PropertyIsNilType#getExpression <em>Expression</em>}</li>
 *   <li>{@link net.opengis.fes.PropertyIsNilType#getNilReason <em>Nil Reason</em>}</li>
 * </ul>
 *
 * @see net.opengis.fes.FESPackage#getPropertyIsNilType()
...
public interface PropertyIsNilType extends ComparisonOpsType {
	 ...
	 * @see net.opengis.fes.FESPackage#getPropertyIsNilType_ExpressionGroup()
	 ...
	 * @see net.opengis.fes.FESPackage#getPropertyIsNilType_Expression()
	 ...
	 * @see net.opengis.fes.FESPackage#getPropertyIsNilType_NilReason()
	...
	/**
	 * Sets the value of the '{@link net.opengis.fes.PropertyIsNilType#getNilReason <em>Nil Reason</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
