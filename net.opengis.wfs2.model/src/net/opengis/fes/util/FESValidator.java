 ...
 * @generated
 */
public class FESValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final FESValidator INSTANCE = new FESValidator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "net.opengis.fes";
	...
	public boolean validateComparisonOperatorNameType_MemberTypes(Object comparisonOperatorNameType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			...
			if (FESPackage.Literals.COMPARISON_OPERATOR_NAME_TYPE_MEMBER0.isInstance(comparisonOperatorNameType)) {
			...
			if (FESPackage.Literals.COMPARISON_OPERATOR_NAME_TYPE_MEMBER1.isInstance(comparisonOperatorNameType)) {
	...
	public boolean validateComparisonOperatorNameTypeMember1_Pattern(String comparisonOperatorNameTypeMember1, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(FESPackage.Literals.COMPARISON_OPERATOR_NAME_TYPE_MEMBER1, comparisonOperatorNameTypeMember1, COMPARISON_OPERATOR_NAME_TYPE_MEMBER1__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validateSchemaElement_Pattern(String schemaElement, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(FESPackage.Literals.SCHEMA_ELEMENT, schemaElement, SCHEMA_ELEMENT__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validateSpatialOperatorNameType_MemberTypes(Object spatialOperatorNameType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
			if (FESPackage.Literals.SPATIAL_OPERATOR_NAME_TYPE_MEMBER0.isInstance(spatialOperatorNameType)) {
			...
			if (FESPackage.Literals.SPATIAL_OPERATOR_NAME_TYPE_MEMBER1.isInstance(spatialOperatorNameType)) {
	...
	public boolean validateSpatialOperatorNameTypeMember1_Pattern(String spatialOperatorNameTypeMember1, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(FESPackage.Literals.SPATIAL_OPERATOR_NAME_TYPE_MEMBER1, spatialOperatorNameTypeMember1, SPATIAL_OPERATOR_NAME_TYPE_MEMBER1__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validateTemporalOperatorNameType_MemberTypes(Object temporalOperatorNameType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
			if (FESPackage.Literals.TEMPORAL_OPERATOR_NAME_TYPE_MEMBER0.isInstance(temporalOperatorNameType)) {
			...
			if (FESPackage.Literals.TEMPORAL_OPERATOR_NAME_TYPE_MEMBER1.isInstance(temporalOperatorNameType)) {
	...
	public boolean validateTemporalOperatorNameTypeMember1_Pattern(String temporalOperatorNameTypeMember1, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(FESPackage.Literals.TEMPORAL_OPERATOR_NAME_TYPE_MEMBER1, temporalOperatorNameTypeMember1, TEMPORAL_OPERATOR_NAME_TYPE_MEMBER1__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validateTypeNamesListType_ItemType(List<?> typeNamesListType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		for (Iterator<?> i = typeNamesListType.iterator(); i.hasNext() && (result || diagnostics != null); ) {
			Object item = i.next();
			if (FESPackage.Literals.TYPE_NAMES_TYPE.isInstance(item)) {
				result &= validateTypeNamesType(item, diagnostics, context);
			}
			else {
				result = false;
				reportDataValueTypeViolation(FESPackage.Literals.TYPE_NAMES_TYPE, item, diagnostics, context);
			}
		}
		return result;
	}
	...
	public boolean validateTypeNamesType_MemberTypes(Object typeNamesType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
			if (FESPackage.Literals.SCHEMA_ELEMENT.isInstance(typeNamesType)) {
			...
			if (XMLTypePackage.Literals.QNAME.isInstance(typeNamesType)) {
				if (xmlTypeValidator.validateQName((QName)typeNamesType, tempDiagnostics, context)) return true;
			}
			for (Diagnostic diagnostic : tempDiagnostics.getChildren()) {
				diagnostics.add(diagnostic);
			}
			...
			if (XMLTypePackage.Literals.QNAME.isInstance(typeNamesType)) {
				if (xmlTypeValidator.validateQName((QName)typeNamesType, null, context)) return true;
			}
		}
		return false;
	}
	...
	public boolean validateUomIdentifier_MemberTypes(String uomIdentifier, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
			if (FESPackage.Literals.UOM_SYMBOL.isInstance(uomIdentifier)) {
				if (validateUomSymbol(uomIdentifier, tempDiagnostics, context)) return true;
			}
			if (FESPackage.Literals.UOM_URI.isInstance(uomIdentifier)) {
	...
	public boolean validateUomSymbol_Pattern(String uomSymbol, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(FESPackage.Literals.UOM_SYMBOL, uomSymbol, UOM_SYMBOL__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validateUomURI_Pattern(String uomURI, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(FESPackage.Literals.UOM_URI, uomURI, UOM_URI__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validateVersionType_MemberTypes(Object versionType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
			if (FESPackage.Literals.VERSION_ACTION_TOKENS.isInstance(versionType)) {
			...
			if (XMLTypePackage.Literals.DATE_TIME.isInstance(versionType)) {
				if (xmlTypeValidator.validateDateTime((XMLGregorianCalendar)versionType, tempDiagnostics, context)) return true;
			}
			for (Diagnostic diagnostic : tempDiagnostics.getChildren()) {
				diagnostics.add(diagnostic);
			}
			...
			if (XMLTypePackage.Literals.DATE_TIME.isInstance(versionType)) {
				if (xmlTypeValidator.validateDateTime((XMLGregorianCalendar)versionType, null, context)) return true;
			}
		}
		return false;
	}
