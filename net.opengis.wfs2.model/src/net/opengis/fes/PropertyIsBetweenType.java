 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.PropertyIsBetweenType#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link net.opengis.fes.PropertyIsBetweenType#getExpression <em>Expression</em>}</li>
 *   <li>{@link net.opengis.fes.PropertyIsBetweenType#getLowerBoundary <em>Lower Boundary</em>}</li>
 *   <li>{@link net.opengis.fes.PropertyIsBetweenType#getUpperBoundary <em>Upper Boundary</em>}</li>
 * </ul>
 *
 * @see net.opengis.fes.FESPackage#getPropertyIsBetweenType()
...
public interface PropertyIsBetweenType extends ComparisonOpsType {
	 ...
	 * @see net.opengis.fes.FESPackage#getPropertyIsBetweenType_ExpressionGroup()
	 ...
	 * @see net.opengis.fes.FESPackage#getPropertyIsBetweenType_Expression()
	 ...
	 * @see net.opengis.fes.FESPackage#getPropertyIsBetweenType_LowerBoundary()
	...
	/**
	 * Sets the value of the '{@link net.opengis.fes.PropertyIsBetweenType#getLowerBoundary <em>Lower Boundary</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.fes.FESPackage#getPropertyIsBetweenType_UpperBoundary()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.fes.PropertyIsBetweenType#getUpperBoundary <em>Upper Boundary</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
