 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.FilterType#getComparisonOpsGroup <em>Comparison Ops Group</em>}</li>
 *   <li>{@link net.opengis.fes.FilterType#getComparisonOps <em>Comparison Ops</em>}</li>
 *   <li>{@link net.opengis.fes.FilterType#getSpatialOpsGroup <em>Spatial Ops Group</em>}</li>
 *   <li>{@link net.opengis.fes.FilterType#getSpatialOps <em>Spatial Ops</em>}</li>
 *   <li>{@link net.opengis.fes.FilterType#getTemporalOpsGroup <em>Temporal Ops Group</em>}</li>
 *   <li>{@link net.opengis.fes.FilterType#getTemporalOps <em>Temporal Ops</em>}</li>
 *   <li>{@link net.opengis.fes.FilterType#getLogicOpsGroup <em>Logic Ops Group</em>}</li>
 *   <li>{@link net.opengis.fes.FilterType#getLogicOps <em>Logic Ops</em>}</li>
 *   <li>{@link net.opengis.fes.FilterType#getExtensionOpsGroup <em>Extension Ops Group</em>}</li>
 *   <li>{@link net.opengis.fes.FilterType#getExtensionOps <em>Extension Ops</em>}</li>
 *   <li>{@link net.opengis.fes.FilterType#getFunction <em>Function</em>}</li>
 *   <li>{@link net.opengis.fes.FilterType#getIdGroup <em>Id Group</em>}</li>
 *   <li>{@link net.opengis.fes.FilterType#getId <em>Id</em>}</li>
 * </ul>
 *
 * @see net.opengis.fes.FESPackage#getFilterType()
...
public interface FilterType extends AbstractSelectionClauseType {
	 ...
	 * @see net.opengis.fes.FESPackage#getFilterType_ComparisonOpsGroup()
	 ...
	 * @see net.opengis.fes.FESPackage#getFilterType_ComparisonOps()
	 ...
	 * @see net.opengis.fes.FESPackage#getFilterType_SpatialOpsGroup()
	 * @model dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="false"
	 ...
	 * @see net.opengis.fes.FESPackage#getFilterType_SpatialOps()
	 * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see net.opengis.fes.FESPackage#getFilterType_TemporalOpsGroup()
	 * @model dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="false"
	 ...
	 * @see net.opengis.fes.FESPackage#getFilterType_TemporalOps()
	 * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see net.opengis.fes.FESPackage#getFilterType_LogicOpsGroup()
	 * @model dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="false"
	 ...
	 * @see net.opengis.fes.FESPackage#getFilterType_LogicOps()
	 * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see net.opengis.fes.FESPackage#getFilterType_ExtensionOpsGroup()
	 * @model dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="false"
	 ...
	 * @see net.opengis.fes.FESPackage#getFilterType_ExtensionOps()
	 * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see net.opengis.fes.FESPackage#getFilterType_Function()
	...
	/**
	 * Sets the value of the '{@link net.opengis.fes.FilterType#getFunction <em>Function</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.fes.FESPackage#getFilterType_IdGroup()
	 ...
	 * @see net.opengis.fes.FESPackage#getFilterType_Id()
	 * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
