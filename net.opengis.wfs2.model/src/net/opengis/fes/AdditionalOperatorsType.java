 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.AdditionalOperatorsType#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @see net.opengis.fes.FESPackage#getAdditionalOperatorsType()
...
public interface AdditionalOperatorsType extends EObject {
	 ...
	 * The list contents are of type {@link net.opengis.fes.ExtensionOperatorType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Operator</em>' containment reference list.
	 * @see net.opengis.fes.FESPackage#getAdditionalOperatorsType_Operator()
