 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.SortByType#getSortProperty <em>Sort Property</em>}</li>
 * </ul>
 *
 * @see net.opengis.fes.FESPackage#getSortByType()
...
public interface SortByType extends EObject {
	 ...
	 * The list contents are of type {@link net.opengis.fes.SortPropertyType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Sort Property</em>' containment reference list.
	 * @see net.opengis.fes.FESPackage#getSortByType_SortProperty()
