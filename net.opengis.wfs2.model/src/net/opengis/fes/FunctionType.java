 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.FunctionType#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link net.opengis.fes.FunctionType#getExpression <em>Expression</em>}</li>
 *   <li>{@link net.opengis.fes.FunctionType#getName <em>Name</em>}</li>
 * </ul>
 *
 * @see net.opengis.fes.FESPackage#getFunctionType()
...
public interface FunctionType extends EObject {
	 ...
	 * @see net.opengis.fes.FESPackage#getFunctionType_ExpressionGroup()
	 ...
	 * @see net.opengis.fes.FESPackage#getFunctionType_Expression()
	 ...
	 * @see #setName(String)
	 * @see net.opengis.fes.FESPackage#getFunctionType_Name()
	...
	/**
	 * Sets the value of the '{@link net.opengis.fes.FunctionType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
