 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.PropertyIsNullType#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link net.opengis.fes.PropertyIsNullType#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @see net.opengis.fes.FESPackage#getPropertyIsNullType()
...
public interface PropertyIsNullType extends ComparisonOpsType {
	 ...
	 * @see net.opengis.fes.FESPackage#getPropertyIsNullType_ExpressionGroup()
	 ...
	 * @see net.opengis.fes.FESPackage#getPropertyIsNullType_Expression()
