 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.fes.BinarySpatialOpType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.fes.BinarySpatialOpType#getExpressionGroup <em>Expression Group</em>}</li>
 *   <li>{@link net.opengis.fes.BinarySpatialOpType#getExpression <em>Expression</em>}</li>
 *   <li>{@link net.opengis.fes.BinarySpatialOpType#getAny <em>Any</em>}</li>
 * </ul>
 *
 * @see net.opengis.fes.FESPackage#getBinarySpatialOpType()
...
public interface BinarySpatialOpType extends SpatialOpsType {
	 ...
	 * @see net.opengis.fes.FESPackage#getBinarySpatialOpType_Group()
	 ...
	 * @see net.opengis.fes.FESPackage#getBinarySpatialOpType_ExpressionGroup()
	 ...
	 * @see net.opengis.fes.FESPackage#getBinarySpatialOpType_Expression()
	 ...
	 * @see net.opengis.fes.FESPackage#getBinarySpatialOpType_Any()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" upper="2" transient="true" volatile="true" derived="true"
