 ...
 *   <li>{@link net.opengis.wfs.TransactionType#getAbstractTransactionActionGroup <em>Abstract Transaction Action Group</em>}</li>
 *   <li>{@link net.opengis.wfs.TransactionType#getAbstractTransactionAction <em>Abstract Transaction Action</em>}</li>
 ...
 *   <li>{@link net.opengis.wfs.TransactionType#getSrsName <em>Srs Name</em>}</li>
 * </ul>
 *
...
public interface TransactionType extends BaseRequestType {
	 ...
	 * @see net.opengis.wfs.WFSPackage#getTransactionType_AbstractTransactionActionGroup()
	 ...
	 * The list contents are of type {@link net.opengis.wfs.AbstractTransactionActionType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Abstract Transaction Action</em>' containment reference list.
	 * @see net.opengis.wfs.WFSPackage#getTransactionType_AbstractTransactionAction()
	 ...
	 * @see net.opengis.wfs.WFSPackage#getTransactionType_SrsName()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.TransactionType#getSrsName <em>Srs Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
