 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.InsertTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.InsertTypeImpl#getInputFormat <em>Input Format</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.InsertTypeImpl#getSrsName <em>Srs Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InsertTypeImpl extends AbstractTransactionActionTypeImpl implements InsertType {
	...
	protected EClass eStaticClass() {
		return WFSPackage.Literals.INSERT_TYPE;
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, WFSPackage.INSERT_TYPE__ANY);
		}
		return any;
	}
	...
	public void setInputFormat(String newInputFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.INSERT_TYPE__INPUT_FORMAT, oldInputFormat, inputFormat, !oldInputFormatESet));
	}
	...
	public void unsetInputFormat() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WFSPackage.INSERT_TYPE__INPUT_FORMAT, oldInputFormat, INPUT_FORMAT_EDEFAULT, oldInputFormatESet));
	}
	...
	public void setSrsName(String newSrsName) {
		...
		srsName = newSrsName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.INSERT_TYPE__SRS_NAME, oldSrsName, srsName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WFSPackage.INSERT_TYPE__ANY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WFSPackage.INSERT_TYPE__INPUT_FORMAT:
				return getInputFormat();
			case WFSPackage.INSERT_TYPE__SRS_NAME:
				return getSrsName();
		}
