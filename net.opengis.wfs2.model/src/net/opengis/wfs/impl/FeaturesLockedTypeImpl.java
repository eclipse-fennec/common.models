 ...
 *   <li>{@link net.opengis.wfs.impl.FeaturesLockedTypeImpl#getResourceId <em>Resource Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeaturesLockedTypeImpl extends MinimalEObjectImpl.Container implements FeaturesLockedType {
	/**
	...
	public EList<ResourceIdType> getResourceId() {
		return getGroup().list(WFSPackage.Literals.FEATURES_LOCKED_TYPE__RESOURCE_ID);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case WFSPackage.FEATURES_LOCKED_TYPE__RESOURCE_ID:
