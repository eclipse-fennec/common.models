 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.TupleTypeImpl#getMember <em>Member</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleTypeImpl extends MinimalEObjectImpl.Container implements TupleType {
	...
	protected EClass eStaticClass() {
		return WFSPackage.Literals.TUPLE_TYPE;
	}
	...
	public EList<MemberPropertyType> getMember() {
		if (member == null) {
			member = new EObjectContainmentEList<MemberPropertyType>(MemberPropertyType.class, this, WFSPackage.TUPLE_TYPE__MEMBER);
		}
		return member;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WFSPackage.TUPLE_TYPE__MEMBER:
