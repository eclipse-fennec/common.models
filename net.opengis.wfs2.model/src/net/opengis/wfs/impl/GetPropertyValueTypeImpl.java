 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.GetPropertyValueTypeImpl#getAbstractQueryExpressionGroup <em>Abstract Query Expression Group</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.GetPropertyValueTypeImpl#getAbstractQueryExpression <em>Abstract Query Expression</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.GetPropertyValueTypeImpl#getCount <em>Count</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.GetPropertyValueTypeImpl#getOutputFormat <em>Output Format</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.GetPropertyValueTypeImpl#getResolve <em>Resolve</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.GetPropertyValueTypeImpl#getResolveDepth <em>Resolve Depth</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.GetPropertyValueTypeImpl#getResolvePath <em>Resolve Path</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.GetPropertyValueTypeImpl#getResolveTimeout <em>Resolve Timeout</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.GetPropertyValueTypeImpl#getResultType <em>Result Type</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.GetPropertyValueTypeImpl#getStartIndex <em>Start Index</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.GetPropertyValueTypeImpl#getValueReference <em>Value Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetPropertyValueTypeImpl extends BaseRequestTypeImpl implements GetPropertyValueType {
	...
	protected EClass eStaticClass() {
		return WFSPackage.Literals.GET_PROPERTY_VALUE_TYPE;
	}
	...
	public FeatureMap getAbstractQueryExpressionGroup() {
		if (abstractQueryExpressionGroup == null) {
			abstractQueryExpressionGroup = new BasicFeatureMap(this, WFSPackage.GET_PROPERTY_VALUE_TYPE__ABSTRACT_QUERY_EXPRESSION_GROUP);
		}
	...
	public AbstractQueryExpressionType getAbstractQueryExpression() {
		return (AbstractQueryExpressionType)getAbstractQueryExpressionGroup().get(WFSPackage.Literals.GET_PROPERTY_VALUE_TYPE__ABSTRACT_QUERY_EXPRESSION, true);
	}
	...
	public NotificationChain basicSetAbstractQueryExpression(AbstractQueryExpressionType newAbstractQueryExpression, NotificationChain msgs) {
		return ((FeatureMap.Internal)getAbstractQueryExpressionGroup()).basicAdd(WFSPackage.Literals.GET_PROPERTY_VALUE_TYPE__ABSTRACT_QUERY_EXPRESSION, newAbstractQueryExpression, msgs);
	}
	...
	public void setCount(BigInteger newCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.GET_PROPERTY_VALUE_TYPE__COUNT, oldCount, count));
	}
	...
	public void setOutputFormat(String newOutputFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.GET_PROPERTY_VALUE_TYPE__OUTPUT_FORMAT, oldOutputFormat, outputFormat, !oldOutputFormatESet));
	}
	...
	public void unsetOutputFormat() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WFSPackage.GET_PROPERTY_VALUE_TYPE__OUTPUT_FORMAT, oldOutputFormat, OUTPUT_FORMAT_EDEFAULT, oldOutputFormatESet));
	}
	...
	public void setResolve(ResolveValueType newResolve) {
		...
		resolveESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.GET_PROPERTY_VALUE_TYPE__RESOLVE, oldResolve, resolve, !oldResolveESet));
	}
	...
	public void unsetResolve() {
		...
		resolveESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WFSPackage.GET_PROPERTY_VALUE_TYPE__RESOLVE, oldResolve, RESOLVE_EDEFAULT, oldResolveESet));
	}
	...
	public void setResolveDepth(Object newResolveDepth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.GET_PROPERTY_VALUE_TYPE__RESOLVE_DEPTH, oldResolveDepth, resolveDepth, !oldResolveDepthESet));
	}
	...
	public void unsetResolveDepth() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WFSPackage.GET_PROPERTY_VALUE_TYPE__RESOLVE_DEPTH, oldResolveDepth, RESOLVE_DEPTH_EDEFAULT, oldResolveDepthESet));
	}
	...
	public void setResolvePath(String newResolvePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.GET_PROPERTY_VALUE_TYPE__RESOLVE_PATH, oldResolvePath, resolvePath));
	}
	...
	public void setResolveTimeout(BigInteger newResolveTimeout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.GET_PROPERTY_VALUE_TYPE__RESOLVE_TIMEOUT, oldResolveTimeout, resolveTimeout, !oldResolveTimeoutESet));
	}
	...
	public void unsetResolveTimeout() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WFSPackage.GET_PROPERTY_VALUE_TYPE__RESOLVE_TIMEOUT, oldResolveTimeout, RESOLVE_TIMEOUT_EDEFAULT, oldResolveTimeoutESet));
	}
	...
	public void setResultType(ResultTypeType newResultType) {
		...
		resultTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.GET_PROPERTY_VALUE_TYPE__RESULT_TYPE, oldResultType, resultType, !oldResultTypeESet));
	}
	...
	public void unsetResultType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WFSPackage.GET_PROPERTY_VALUE_TYPE__RESULT_TYPE, oldResultType, RESULT_TYPE_EDEFAULT, oldResultTypeESet));
	}
	...
	public void setStartIndex(BigInteger newStartIndex) {
		...
		startIndexESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.GET_PROPERTY_VALUE_TYPE__START_INDEX, oldStartIndex, startIndex, !oldStartIndexESet));
	}
	...
	public void unsetStartIndex() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WFSPackage.GET_PROPERTY_VALUE_TYPE__START_INDEX, oldStartIndex, START_INDEX_EDEFAULT, oldStartIndexESet));
	}
	...
	public void setValueReference(String newValueReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.GET_PROPERTY_VALUE_TYPE__VALUE_REFERENCE, oldValueReference, valueReference));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WFSPackage.GET_PROPERTY_VALUE_TYPE__ABSTRACT_QUERY_EXPRESSION_GROUP:
				return ((InternalEList<?>)getAbstractQueryExpressionGroup()).basicRemove(otherEnd, msgs);
			case WFSPackage.GET_PROPERTY_VALUE_TYPE__ABSTRACT_QUERY_EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WFSPackage.GET_PROPERTY_VALUE_TYPE__COUNT:
				return getCount();
			case WFSPackage.GET_PROPERTY_VALUE_TYPE__OUTPUT_FORMAT:
				return getOutputFormat();
			case WFSPackage.GET_PROPERTY_VALUE_TYPE__RESOLVE:
				return getResolve();
			case WFSPackage.GET_PROPERTY_VALUE_TYPE__RESOLVE_DEPTH:
				return getResolveDepth();
			case WFSPackage.GET_PROPERTY_VALUE_TYPE__RESOLVE_PATH:
				return getResolvePath();
			case WFSPackage.GET_PROPERTY_VALUE_TYPE__RESOLVE_TIMEOUT:
				return getResolveTimeout();
			case WFSPackage.GET_PROPERTY_VALUE_TYPE__RESULT_TYPE:
				return getResultType();
			case WFSPackage.GET_PROPERTY_VALUE_TYPE__START_INDEX:
				return getStartIndex();
			case WFSPackage.GET_PROPERTY_VALUE_TYPE__VALUE_REFERENCE:
