 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.AdditionalValuesTypeImpl#getValueCollection <em>Value Collection</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.AdditionalValuesTypeImpl#getSimpleFeatureCollectionGroup <em>Simple Feature Collection Group</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.AdditionalValuesTypeImpl#getSimpleFeatureCollection <em>Simple Feature Collection</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdditionalValuesTypeImpl extends MinimalEObjectImpl.Container implements AdditionalValuesType {
	/**
	...
	protected EClass eStaticClass() {
		return WFSPackage.Literals.ADDITIONAL_VALUES_TYPE;
	}
	...
	public NotificationChain basicSetValueCollection(ValueCollectionType newValueCollection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WFSPackage.ADDITIONAL_VALUES_TYPE__VALUE_COLLECTION, oldValueCollection, newValueCollection);
	...
	public void setValueCollection(ValueCollectionType newValueCollection) {
		if (newValueCollection != valueCollection) {
			...
			if (valueCollection != null)
				msgs = ((InternalEObject)valueCollection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WFSPackage.ADDITIONAL_VALUES_TYPE__VALUE_COLLECTION, null, msgs);
			if (newValueCollection != null)
				msgs = ((InternalEObject)newValueCollection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WFSPackage.ADDITIONAL_VALUES_TYPE__VALUE_COLLECTION, null, msgs);
			msgs = basicSetValueCollection(newValueCollection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.ADDITIONAL_VALUES_TYPE__VALUE_COLLECTION, newValueCollection, newValueCollection));
	}
	...
	public FeatureMap getSimpleFeatureCollectionGroup() {
		if (simpleFeatureCollectionGroup == null) {
			simpleFeatureCollectionGroup = new BasicFeatureMap(this, WFSPackage.ADDITIONAL_VALUES_TYPE__SIMPLE_FEATURE_COLLECTION_GROUP);
		}
	...
	public SimpleFeatureCollectionType getSimpleFeatureCollection() {
		return (SimpleFeatureCollectionType)getSimpleFeatureCollectionGroup().get(WFSPackage.Literals.ADDITIONAL_VALUES_TYPE__SIMPLE_FEATURE_COLLECTION, true);
	}
	...
	public NotificationChain basicSetSimpleFeatureCollection(SimpleFeatureCollectionType newSimpleFeatureCollection, NotificationChain msgs) {
		return ((FeatureMap.Internal)getSimpleFeatureCollectionGroup()).basicAdd(WFSPackage.Literals.ADDITIONAL_VALUES_TYPE__SIMPLE_FEATURE_COLLECTION, newSimpleFeatureCollection, msgs);
	}
	...
	public void setSimpleFeatureCollection(SimpleFeatureCollectionType newSimpleFeatureCollection) {
		((FeatureMap.Internal)getSimpleFeatureCollectionGroup()).set(WFSPackage.Literals.ADDITIONAL_VALUES_TYPE__SIMPLE_FEATURE_COLLECTION, newSimpleFeatureCollection);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WFSPackage.ADDITIONAL_VALUES_TYPE__VALUE_COLLECTION:
				return basicSetValueCollection(null, msgs);
			case WFSPackage.ADDITIONAL_VALUES_TYPE__SIMPLE_FEATURE_COLLECTION_GROUP:
				return ((InternalEList<?>)getSimpleFeatureCollectionGroup()).basicRemove(otherEnd, msgs);
			case WFSPackage.ADDITIONAL_VALUES_TYPE__SIMPLE_FEATURE_COLLECTION:
