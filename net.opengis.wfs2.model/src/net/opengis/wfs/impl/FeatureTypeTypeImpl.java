 ...
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getDefaultCRS <em>Default CRS</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getOtherCRS <em>Other CRS</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getNoCRS <em>No CRS</em>}</li>
 ...
 *   <li>{@link net.opengis.wfs.impl.FeatureTypeTypeImpl#getExtendedDescription <em>Extended Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureTypeTypeImpl extends MinimalEObjectImpl.Container implements FeatureTypeType {
	...
	public EList<TitleType> getTitle() {
		if (title == null) {
			title = new EObjectContainmentEList<TitleType>(TitleType.class, this, WFSPackage.FEATURE_TYPE_TYPE__TITLE);
		}
		return title;
	}
	...
	public EList<AbstractType> getAbstract() {
		if (abstract_ == null) {
			abstract_ = new EObjectContainmentEList<AbstractType>(AbstractType.class, this, WFSPackage.FEATURE_TYPE_TYPE__ABSTRACT);
		}
		return abstract_;
	}
	...
	public EList<KeywordsType> getKeywords() {
		if (keywords == null) {
			keywords = new EObjectContainmentEList<KeywordsType>(KeywordsType.class, this, WFSPackage.FEATURE_TYPE_TYPE__KEYWORDS);
		}
		return keywords;
	}
	...
	public void setDefaultCRS(String newDefaultCRS) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.FEATURE_TYPE_TYPE__DEFAULT_CRS, oldDefaultCRS, defaultCRS));
	}
	...
	public EList<String> getOtherCRS() {
		if (otherCRS == null) {
			otherCRS = new EDataTypeEList<String>(String.class, this, WFSPackage.FEATURE_TYPE_TYPE__OTHER_CRS);
		}
		return otherCRS;
	}
	...
	public NotificationChain basicSetNoCRS(NoCRSType newNoCRS, NotificationChain msgs) {
		...
		noCRS = newNoCRS;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WFSPackage.FEATURE_TYPE_TYPE__NO_CRS, oldNoCRS, newNoCRS);
	...
	public void setNoCRS(NoCRSType newNoCRS) {
		if (newNoCRS != noCRS) {
			...
			if (noCRS != null)
				msgs = ((InternalEObject)noCRS).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WFSPackage.FEATURE_TYPE_TYPE__NO_CRS, null, msgs);
			if (newNoCRS != null)
				msgs = ((InternalEObject)newNoCRS).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WFSPackage.FEATURE_TYPE_TYPE__NO_CRS, null, msgs);
			msgs = basicSetNoCRS(newNoCRS, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.FEATURE_TYPE_TYPE__NO_CRS, newNoCRS, newNoCRS));
	}
	...
	public EList<WGS84BoundingBoxType> getWGS84BoundingBox() {
		if (wGS84BoundingBox == null) {
			wGS84BoundingBox = new EObjectContainmentEList<WGS84BoundingBoxType>(WGS84BoundingBoxType.class, this, WFSPackage.FEATURE_TYPE_TYPE__WGS84_BOUNDING_BOX);
		}
	...
	public EList<MetadataURLType> getMetadataURL() {
		if (metadataURL == null) {
			metadataURL = new EObjectContainmentEList<MetadataURLType>(MetadataURLType.class, this, WFSPackage.FEATURE_TYPE_TYPE__METADATA_URL);
		}
		return metadataURL;
	}
	...
	public NotificationChain basicSetExtendedDescription(ExtendedDescriptionType newExtendedDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WFSPackage.FEATURE_TYPE_TYPE__EXTENDED_DESCRIPTION, oldExtendedDescription, newExtendedDescription);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setExtendedDescription(ExtendedDescriptionType newExtendedDescription) {
		if (newExtendedDescription != extendedDescription) {
			...
			if (extendedDescription != null)
				msgs = ((InternalEObject)extendedDescription).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WFSPackage.FEATURE_TYPE_TYPE__EXTENDED_DESCRIPTION, null, msgs);
			if (newExtendedDescription != null)
				msgs = ((InternalEObject)newExtendedDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WFSPackage.FEATURE_TYPE_TYPE__EXTENDED_DESCRIPTION, null, msgs);
			msgs = basicSetExtendedDescription(newExtendedDescription, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.FEATURE_TYPE_TYPE__EXTENDED_DESCRIPTION, newExtendedDescription, newExtendedDescription));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case WFSPackage.FEATURE_TYPE_TYPE__NO_CRS:
			...
			case WFSPackage.FEATURE_TYPE_TYPE__EXTENDED_DESCRIPTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WFSPackage.FEATURE_TYPE_TYPE__KEYWORDS:
				return getKeywords();
			case WFSPackage.FEATURE_TYPE_TYPE__DEFAULT_CRS:
				return getDefaultCRS();
			case WFSPackage.FEATURE_TYPE_TYPE__OTHER_CRS:
				return getOtherCRS();
			case WFSPackage.FEATURE_TYPE_TYPE__NO_CRS:
				return getNoCRS();
			case WFSPackage.FEATURE_TYPE_TYPE__OUTPUT_FORMATS:
