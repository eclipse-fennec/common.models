 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.PropertyNameTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.PropertyNameTypeImpl#getResolve <em>Resolve</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.PropertyNameTypeImpl#getResolveDepth <em>Resolve Depth</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.PropertyNameTypeImpl#getResolvePath <em>Resolve Path</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.PropertyNameTypeImpl#getResolveTimeout <em>Resolve Timeout</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyNameTypeImpl extends MinimalEObjectImpl.Container implements PropertyNameType {
	/**
	...
	protected EClass eStaticClass() {
		return WFSPackage.Literals.PROPERTY_NAME_TYPE;
	}
	...
	public void setValue(QName newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.PROPERTY_NAME_TYPE__VALUE, oldValue, value));
	}
	...
	public void setResolve(ResolveValueType newResolve) {
		...
		resolveESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.PROPERTY_NAME_TYPE__RESOLVE, oldResolve, resolve, !oldResolveESet));
	}
	...
	public void unsetResolve() {
		...
		resolveESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WFSPackage.PROPERTY_NAME_TYPE__RESOLVE, oldResolve, RESOLVE_EDEFAULT, oldResolveESet));
	}
	...
	public void setResolveDepth(Object newResolveDepth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.PROPERTY_NAME_TYPE__RESOLVE_DEPTH, oldResolveDepth, resolveDepth, !oldResolveDepthESet));
	}
	...
	public void unsetResolveDepth() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WFSPackage.PROPERTY_NAME_TYPE__RESOLVE_DEPTH, oldResolveDepth, RESOLVE_DEPTH_EDEFAULT, oldResolveDepthESet));
	}
	...
	public void setResolvePath(String newResolvePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.PROPERTY_NAME_TYPE__RESOLVE_PATH, oldResolvePath, resolvePath));
	}
	...
	public void setResolveTimeout(BigInteger newResolveTimeout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.PROPERTY_NAME_TYPE__RESOLVE_TIMEOUT, oldResolveTimeout, resolveTimeout, !oldResolveTimeoutESet));
	}
	...
	public void unsetResolveTimeout() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WFSPackage.PROPERTY_NAME_TYPE__RESOLVE_TIMEOUT, oldResolveTimeout, RESOLVE_TIMEOUT_EDEFAULT, oldResolveTimeoutESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WFSPackage.PROPERTY_NAME_TYPE__VALUE:
				return getValue();
			case WFSPackage.PROPERTY_NAME_TYPE__RESOLVE:
				return getResolve();
			case WFSPackage.PROPERTY_NAME_TYPE__RESOLVE_DEPTH:
				return getResolveDepth();
			case WFSPackage.PROPERTY_NAME_TYPE__RESOLVE_PATH:
				return getResolvePath();
			case WFSPackage.PROPERTY_NAME_TYPE__RESOLVE_TIMEOUT:
