 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.PropertyTypeImpl#getValueReference <em>Value Reference</em>}</li>
...
public class PropertyTypeImpl extends MinimalEObjectImpl.Container implements PropertyType {
	...
	public NotificationChain basicSetValueReference(ValueReferenceType newValueReference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WFSPackage.PROPERTY_TYPE__VALUE_REFERENCE, oldValueReference, newValueReference);
	...
	public void setValueReference(ValueReferenceType newValueReference) {
		if (newValueReference != valueReference) {
			...
			if (valueReference != null)
				msgs = ((InternalEObject)valueReference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WFSPackage.PROPERTY_TYPE__VALUE_REFERENCE, null, msgs);
			if (newValueReference != null)
				msgs = ((InternalEObject)newValueReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WFSPackage.PROPERTY_TYPE__VALUE_REFERENCE, null, msgs);
			msgs = basicSetValueReference(newValueReference, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.PROPERTY_TYPE__VALUE_REFERENCE, newValueReference, newValueReference));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WFSPackage.PROPERTY_TYPE__VALUE_REFERENCE:
