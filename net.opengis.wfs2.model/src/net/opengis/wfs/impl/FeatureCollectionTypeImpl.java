 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wfs.impl.FeatureCollectionTypeImpl#getAdditionalObjects <em>Additional Objects</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.FeatureCollectionTypeImpl#getTruncatedResponse <em>Truncated Response</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.FeatureCollectionTypeImpl#getLockId <em>Lock Id</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.FeatureCollectionTypeImpl#getNext <em>Next</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.FeatureCollectionTypeImpl#getNumberMatched <em>Number Matched</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.FeatureCollectionTypeImpl#getNumberReturned <em>Number Returned</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.FeatureCollectionTypeImpl#getPrevious <em>Previous</em>}</li>
...
public class FeatureCollectionTypeImpl extends SimpleFeatureCollectionTypeImpl implements FeatureCollectionType {
	...
	public NotificationChain basicSetAdditionalObjects(AdditionalObjectsType newAdditionalObjects, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WFSPackage.FEATURE_COLLECTION_TYPE__ADDITIONAL_OBJECTS, oldAdditionalObjects, newAdditionalObjects);
	...
	public void setAdditionalObjects(AdditionalObjectsType newAdditionalObjects) {
		if (newAdditionalObjects != additionalObjects) {
			...
			if (additionalObjects != null)
				msgs = ((InternalEObject)additionalObjects).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WFSPackage.FEATURE_COLLECTION_TYPE__ADDITIONAL_OBJECTS, null, msgs);
			if (newAdditionalObjects != null)
				msgs = ((InternalEObject)newAdditionalObjects).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WFSPackage.FEATURE_COLLECTION_TYPE__ADDITIONAL_OBJECTS, null, msgs);
			msgs = basicSetAdditionalObjects(newAdditionalObjects, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.FEATURE_COLLECTION_TYPE__ADDITIONAL_OBJECTS, newAdditionalObjects, newAdditionalObjects));
	}
	...
	public NotificationChain basicSetTruncatedResponse(TruncatedResponseType newTruncatedResponse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WFSPackage.FEATURE_COLLECTION_TYPE__TRUNCATED_RESPONSE, oldTruncatedResponse, newTruncatedResponse);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTruncatedResponse(TruncatedResponseType newTruncatedResponse) {
		if (newTruncatedResponse != truncatedResponse) {
			...
			if (truncatedResponse != null)
				msgs = ((InternalEObject)truncatedResponse).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WFSPackage.FEATURE_COLLECTION_TYPE__TRUNCATED_RESPONSE, null, msgs);
			if (newTruncatedResponse != null)
				msgs = ((InternalEObject)newTruncatedResponse).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WFSPackage.FEATURE_COLLECTION_TYPE__TRUNCATED_RESPONSE, null, msgs);
			msgs = basicSetTruncatedResponse(newTruncatedResponse, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.FEATURE_COLLECTION_TYPE__TRUNCATED_RESPONSE, newTruncatedResponse, newTruncatedResponse));
	}
	...
	public void setNext(String newNext) {
		...
		next = newNext;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.FEATURE_COLLECTION_TYPE__NEXT, oldNext, next));
	}
	...
	public void setNumberMatched(Object newNumberMatched) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.FEATURE_COLLECTION_TYPE__NUMBER_MATCHED, oldNumberMatched, numberMatched));
	}
	...
	public void setNumberReturned(BigInteger newNumberReturned) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.FEATURE_COLLECTION_TYPE__NUMBER_RETURNED, oldNumberReturned, numberReturned));
	}
	...
	public void setPrevious(String newPrevious) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.FEATURE_COLLECTION_TYPE__PREVIOUS, oldPrevious, previous));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WFSPackage.FEATURE_COLLECTION_TYPE__ADDITIONAL_OBJECTS:
				return basicSetAdditionalObjects(null, msgs);
			case WFSPackage.FEATURE_COLLECTION_TYPE__TRUNCATED_RESPONSE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WFSPackage.FEATURE_COLLECTION_TYPE__LOCK_ID:
				return getLockId();
			case WFSPackage.FEATURE_COLLECTION_TYPE__NEXT:
				return getNext();
			case WFSPackage.FEATURE_COLLECTION_TYPE__NUMBER_MATCHED:
				return getNumberMatched();
			case WFSPackage.FEATURE_COLLECTION_TYPE__NUMBER_RETURNED:
				return getNumberReturned();
			case WFSPackage.FEATURE_COLLECTION_TYPE__PREVIOUS:
				return getPrevious();
