 ...
 *   <li>{@link net.opengis.wfs.impl.TransactionSummaryTypeImpl#getTotalReplaced <em>Total Replaced</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.TransactionSummaryTypeImpl#getTotalDeleted <em>Total Deleted</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransactionSummaryTypeImpl extends MinimalEObjectImpl.Container implements TransactionSummaryType {
	/**
	...
	public void setTotalReplaced(BigInteger newTotalReplaced) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.TRANSACTION_SUMMARY_TYPE__TOTAL_REPLACED, oldTotalReplaced, totalReplaced));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WFSPackage.TRANSACTION_SUMMARY_TYPE__TOTAL_REPLACED:
