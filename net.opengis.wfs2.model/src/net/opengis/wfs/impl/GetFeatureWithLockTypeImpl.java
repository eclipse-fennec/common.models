 ...
 *   <li>{@link net.opengis.wfs.impl.GetFeatureWithLockTypeImpl#getLockAction <em>Lock Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetFeatureWithLockTypeImpl extends GetFeatureTypeImpl implements GetFeatureWithLockType {
	...
	public void setLockAction(AllSomeType newLockAction) {
		...
		lockActionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.GET_FEATURE_WITH_LOCK_TYPE__LOCK_ACTION, oldLockAction, lockAction, !oldLockActionESet));
	}
	...
	public void unsetLockAction() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WFSPackage.GET_FEATURE_WITH_LOCK_TYPE__LOCK_ACTION, oldLockAction, LOCK_ACTION_EDEFAULT, oldLockActionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WFSPackage.GET_FEATURE_WITH_LOCK_TYPE__EXPIRY:
				return getExpiry();
			case WFSPackage.GET_FEATURE_WITH_LOCK_TYPE__LOCK_ACTION:
