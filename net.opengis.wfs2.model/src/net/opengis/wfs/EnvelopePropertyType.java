 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wfs.EnvelopePropertyType#getAny <em>Any</em>}</li>
 * </ul>
 *
 * @see net.opengis.wfs.WFSPackage#getEnvelopePropertyType()
...
public interface EnvelopePropertyType extends EObject {
	 ...
	 * @see net.opengis.wfs.WFSPackage#getEnvelopePropertyType_Any()
