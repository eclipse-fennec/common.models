 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wfs.GetFeatureType#getAbstractQueryExpressionGroup <em>Abstract Query Expression Group</em>}</li>
 *   <li>{@link net.opengis.wfs.GetFeatureType#getAbstractQueryExpression <em>Abstract Query Expression</em>}</li>
 *   <li>{@link net.opengis.wfs.GetFeatureType#getCount <em>Count</em>}</li>
 *   <li>{@link net.opengis.wfs.GetFeatureType#getOutputFormat <em>Output Format</em>}</li>
 *   <li>{@link net.opengis.wfs.GetFeatureType#getResolve <em>Resolve</em>}</li>
 *   <li>{@link net.opengis.wfs.GetFeatureType#getResolveDepth <em>Resolve Depth</em>}</li>
 *   <li>{@link net.opengis.wfs.GetFeatureType#getResolveTimeout <em>Resolve Timeout</em>}</li>
...
public interface GetFeatureType extends BaseRequestType {
	 ...
	 * @see net.opengis.wfs.WFSPackage#getGetFeatureType_AbstractQueryExpressionGroup()
	 ...
	 * @see net.opengis.wfs.WFSPackage#getGetFeatureType_AbstractQueryExpression()
	 ...
	 * @see net.opengis.wfs.WFSPackage#getGetFeatureType_Count()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.GetFeatureType#getCount <em>Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.WFSPackage#getGetFeatureType_Resolve()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.GetFeatureType#getResolve <em>Resolve</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wfs.GetFeatureType#getResolve <em>Resolve</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetResolve()
	 * @see #getResolve()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wfs.GetFeatureType#getResolve <em>Resolve</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.WFSPackage#getGetFeatureType_ResolveDepth()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.GetFeatureType#getResolveDepth <em>Resolve Depth</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wfs.GetFeatureType#getResolveDepth <em>Resolve Depth</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetResolveDepth()
	 * @see #getResolveDepth()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wfs.GetFeatureType#getResolveDepth <em>Resolve Depth</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.WFSPackage#getGetFeatureType_ResolveTimeout()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.GetFeatureType#getResolveTimeout <em>Resolve Timeout</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wfs.GetFeatureType#getResolveTimeout <em>Resolve Timeout</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetResolveTimeout()
	 * @see #getResolveTimeout()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wfs.GetFeatureType#getResolveTimeout <em>Resolve Timeout</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.WFSPackage#getGetFeatureType_StartIndex()
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wfs.GetFeatureType#getStartIndex <em>Start Index</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetStartIndex()
	 * @see #getStartIndex()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wfs.GetFeatureType#getStartIndex <em>Start Index</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
