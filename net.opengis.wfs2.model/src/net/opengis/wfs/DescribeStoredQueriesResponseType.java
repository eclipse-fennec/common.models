 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wfs.DescribeStoredQueriesResponseType#getStoredQueryDescription <em>Stored Query Description</em>}</li>
 * </ul>
 *
 * @see net.opengis.wfs.WFSPackage#getDescribeStoredQueriesResponseType()
...
public interface DescribeStoredQueriesResponseType extends EObject {
	 ...
	 * @see net.opengis.wfs.WFSPackage#getDescribeStoredQueriesResponseType_StoredQueryDescription()
