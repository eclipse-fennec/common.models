...
public class WFSValidator extends EObjectValidator {
	...
	public boolean validateNonNegativeIntegerOrUnknown_MemberTypes(Object nonNegativeIntegerOrUnknown, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			...
			if (WFSPackage.Literals.NON_NEGATIVE_INTEGER_OR_UNKNOWN_MEMBER0.isInstance(nonNegativeIntegerOrUnknown)) {
			...
			if (WFSPackage.Literals.NON_NEGATIVE_INTEGER_OR_UNKNOWN_MEMBER1.isInstance(nonNegativeIntegerOrUnknown)) {
	...
	public boolean validatePositiveIntegerWithStar_MemberTypes(Object positiveIntegerWithStar, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			...
			if (WFSPackage.Literals.STAR_STRING_TYPE.isInstance(positiveIntegerWithStar)) {
	...
	public boolean validateStateValueType_MemberTypes(Object stateValueType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
			if (WFSPackage.Literals.STATE_VALUE_TYPE_MEMBER0.isInstance(stateValueType)) {
				if (validateStateValueTypeMember0((StateValueTypeMember0)stateValueType, tempDiagnostics, context)) return true;
			}
			if (WFSPackage.Literals.STATE_VALUE_TYPE_MEMBER1.isInstance(stateValueType)) {
	...
	public boolean validateStateValueTypeMember1_Pattern(String stateValueTypeMember1, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(WFSPackage.Literals.STATE_VALUE_TYPE_MEMBER1, stateValueTypeMember1, STATE_VALUE_TYPE_MEMBER1__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validateVersionStringType_Pattern(String versionStringType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(WFSPackage.Literals.VERSION_STRING_TYPE, versionStringType, VERSION_STRING_TYPE__PATTERN__VALUES, diagnostics, context);
	}
