 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ows.ValueType#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @see net.opengis.ows.OWSPackage#getValueType()
...
public interface ValueType extends EObject {
	 ...
	 * @see #setValue(String)
	 * @see net.opengis.ows.OWSPackage#getValueType_Value()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.ValueType#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
