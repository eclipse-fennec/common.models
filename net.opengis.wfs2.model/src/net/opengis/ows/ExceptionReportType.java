 ...
 *   <li>{@link net.opengis.ows.ExceptionReportType#getLang <em>Lang</em>}</li>
...
public interface ExceptionReportType extends EObject {
	 ...
	 * @see #setLang(String)
	 * @see net.opengis.ows.OWSPackage#getExceptionReportType_Lang()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.ExceptionReportType#getLang <em>Lang</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @model dataType="net.opengis.ows.VersionType1" required="true"
