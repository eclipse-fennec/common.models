...
public class OWSValidator extends EObjectValidator {
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			case OWSPackage.ABSTRACT_REFERENCE_BASE_TYPE:
			...
			case OWSPackage.CONTENTS_BASE_TYPE:
				return validateContentsBaseType((ContentsBaseType)value, diagnostics, context);
			case OWSPackage.DATASET_DESCRIPTION_SUMMARY_BASE_TYPE:
			...
			case OWSPackage.DOMAIN_METADATA_TYPE:
			...
			case OWSPackage.GET_RESOURCE_BY_ID_TYPE:
			...
			case OWSPackage.NO_VALUES_TYPE:
			...
			case OWSPackage.SERVICE_REFERENCE_TYPE:
	...
	public boolean validateVersionType_Pattern(String versionType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(OWSPackage.Literals.VERSION_TYPE, versionType, VERSION_TYPE__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validateVersionType1_Pattern(String versionType1, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(OWSPackage.Literals.VERSION_TYPE1, versionType1, VERSION_TYPE1__PATTERN__VALUES, diagnostics, context);
	}
