 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ows.ContactType#getPhone <em>Phone</em>}</li>
 *   <li>{@link net.opengis.ows.ContactType#getAddress <em>Address</em>}</li>
 *   <li>{@link net.opengis.ows.ContactType#getOnlineResource <em>Online Resource</em>}</li>
 *   <li>{@link net.opengis.ows.ContactType#getHoursOfService <em>Hours Of Service</em>}</li>
 *   <li>{@link net.opengis.ows.ContactType#getContactInstructions <em>Contact Instructions</em>}</li>
 * </ul>
 *
 * @see net.opengis.ows.OWSPackage#getContactType()
...
public interface ContactType extends EObject {
	 ...
	 * @see net.opengis.ows.OWSPackage#getContactType_Phone()
	 ...
	 * @see net.opengis.ows.OWSPackage#getContactType_Address()
	 * @model containment="true"
	 ...
	 * @see net.opengis.ows.OWSPackage#getContactType_OnlineResource()
	 * @model containment="true"
	 ...
	 * @see net.opengis.ows.OWSPackage#getContactType_HoursOfService()
	 ...
	 * @see net.opengis.ows.OWSPackage#getContactType_ContactInstructions()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
