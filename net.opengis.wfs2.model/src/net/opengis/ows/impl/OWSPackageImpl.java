...
import net.opengis.ows.util.OWSValidator;
...
public class OWSPackageImpl extends EPackageImpl implements OWSPackage {
	 ...
	 * @see net.opengis.ows.OWSPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 *
	 * <p>This method is used to initialize {@link OWSPackage#eINSTANCE} when that field is accessed.
	...
	public static OWSPackage init() {
		if (isInited) return (OWSPackage)EPackage.Registry.INSTANCE.getEPackage(OWSPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredOWSPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		OWSPackageImpl theOWSPackage = registeredOWSPackage instanceof OWSPackageImpl ? (OWSPackageImpl)registeredOWSPackage : new OWSPackageImpl();
		...
		EPackage.Registry.INSTANCE.put(OWSPackage.eNS_URI, theOWSPackage);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAbstractReferenceBaseType_Arcrole(), theXlinkPackage.getArcroleType(), "arcrole", null, 0, 1, AbstractReferenceBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAbstractReferenceBaseType_Href(), theXlinkPackage.getHrefType(), "href", null, 1, 1, AbstractReferenceBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAbstractReferenceBaseType_Role(), theXlinkPackage.getRoleType(), "role", null, 0, 1, AbstractReferenceBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAbstractReferenceBaseType_Title(), theXlinkPackage.getTitleAttrType(), "title", null, 0, 1, AbstractReferenceBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMetadataType_Arcrole(), theXlinkPackage.getArcroleType(), "arcrole", null, 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMetadataType_Href(), theXlinkPackage.getHrefType(), "href", null, 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMetadataType_Role(), theXlinkPackage.getRoleType(), "role", null, 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMetadataType_Title(), theXlinkPackage.getTitleAttrType(), "title", null, 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMetadataType_Type(), theXlinkPackage.getTypeType(), "type", "simple", 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
