 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ows.impl.ValueTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueTypeImpl extends MinimalEObjectImpl.Container implements ValueType {
	...
	protected EClass eStaticClass() {
		return OWSPackage.Literals.VALUE_TYPE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWSPackage.VALUE_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OWSPackage.VALUE_TYPE__VALUE:
				return getValue();
		}
