 ...
 *   <li>{@link net.opengis.ows.impl.ExceptionReportTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link net.opengis.ows.impl.ExceptionReportTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExceptionReportTypeImpl extends MinimalEObjectImpl.Container implements ExceptionReportType {
	/**
	...
	public EList<ExceptionType> getException() {
		if (exception == null) {
			exception = new EObjectContainmentEList<ExceptionType>(ExceptionType.class, this, OWSPackage.EXCEPTION_REPORT_TYPE__EXCEPTION);
		}
		return exception;
	}
	...
	public void setLang(String newLang) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWSPackage.EXCEPTION_REPORT_TYPE__LANG, oldLang, lang));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OWSPackage.EXCEPTION_REPORT_TYPE__EXCEPTION:
				return getException();
			case OWSPackage.EXCEPTION_REPORT_TYPE__LANG:
				return getLang();
