...
import net.opengis.ows.DomainMetadataType;
...
import net.opengis.ows.ServiceReferenceType;
import net.opengis.ows.ValueType;
import net.opengis.ows.ValuesReferenceType;
 ...
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getAbstractReferenceBase <em>Abstract Reference Base</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getAccessConstraints <em>Access Constraints</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getAllowedValues <em>Allowed Values</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getAnyValue <em>Any Value</em>}</li>
 ...
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getDatasetDescriptionSummary <em>Dataset Description Summary</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getDCP <em>DCP</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getDefaultValue <em>Default Value</em>}</li>
 ...
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getGetResourceByID <em>Get Resource By ID</em>}</li>
 ...
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getInputData <em>Input Data</em>}</li>
 ...
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getManifest <em>Manifest</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getMaximumValue <em>Maximum Value</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getMeaning <em>Meaning</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getMinimumValue <em>Minimum Value</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getNoValues <em>No Values</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getOperationResponse <em>Operation Response</em>}</li>
 ...
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getOtherSource <em>Other Source</em>}</li>
 ...
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getRange <em>Range</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getReferenceGroup <em>Reference Group</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getReferenceSystem <em>Reference System</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getResource <em>Resource</em>}</li>
 ...
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getServiceReference <em>Service Reference</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getSpacing <em>Spacing</em>}</li>
 ...
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getUOM <em>UOM</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getValuesReference <em>Values Reference</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getWGS84BoundingBox <em>WGS84 Bounding Box</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getRangeClosure <em>Range Closure</em>}</li>
 *   <li>{@link net.opengis.ows.impl.DocumentRootImpl#getReference1 <em>Reference1</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
	...
	public LanguageStringType getAbstract() {
		return (LanguageStringType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__ABSTRACT, true);
	}
	...
	public NotificationChain basicSetAbstract(LanguageStringType newAbstract, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__ABSTRACT, newAbstract, msgs);
	}
	...
	public AbstractReferenceBaseType getAbstractReferenceBase() {
		return (AbstractReferenceBaseType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__ABSTRACT_REFERENCE_BASE, true);
	}
	...
	public NotificationChain basicSetAbstractReferenceBase(AbstractReferenceBaseType newAbstractReferenceBase, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__ABSTRACT_REFERENCE_BASE, newAbstractReferenceBase, msgs);
	}
	...
	public AllowedValuesType getAllowedValues() {
		return (AllowedValuesType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__ALLOWED_VALUES, true);
	}
	...
	public NotificationChain basicSetAllowedValues(AllowedValuesType newAllowedValues, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__ALLOWED_VALUES, newAllowedValues, msgs);
	}
	...
	public void setAllowedValues(AllowedValuesType newAllowedValues) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__ALLOWED_VALUES, newAllowedValues);
	}
	...
	public AnyValueType getAnyValue() {
		return (AnyValueType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__ANY_VALUE, true);
	}
	...
	public NotificationChain basicSetAnyValue(AnyValueType newAnyValue, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__ANY_VALUE, newAnyValue, msgs);
	}
	...
	public void setAnyValue(AnyValueType newAnyValue) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__ANY_VALUE, newAnyValue);
	}
	...
	public DatasetDescriptionSummaryBaseType getDatasetDescriptionSummary() {
		return (DatasetDescriptionSummaryBaseType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__DATASET_DESCRIPTION_SUMMARY, true);
	}
	...
	public NotificationChain basicSetDatasetDescriptionSummary(DatasetDescriptionSummaryBaseType newDatasetDescriptionSummary, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__DATASET_DESCRIPTION_SUMMARY, newDatasetDescriptionSummary, msgs);
	}
	...
	public void setDatasetDescriptionSummary(DatasetDescriptionSummaryBaseType newDatasetDescriptionSummary) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__DATASET_DESCRIPTION_SUMMARY, newDatasetDescriptionSummary);
	}
	...
	public DomainMetadataType getDataType() {
		return (DomainMetadataType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__DATA_TYPE, true);
	}
	...
	public NotificationChain basicSetDataType(DomainMetadataType newDataType, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__DATA_TYPE, newDataType, msgs);
	}
	...
	public void setDataType(DomainMetadataType newDataType) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__DATA_TYPE, newDataType);
	}
	...
	public ValueType getDefaultValue() {
		return (ValueType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__DEFAULT_VALUE, true);
	}
	...
	public NotificationChain basicSetDefaultValue(ValueType newDefaultValue, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__DEFAULT_VALUE, newDefaultValue, msgs);
	}
	...
	public void setDefaultValue(ValueType newDefaultValue) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__DEFAULT_VALUE, newDefaultValue);
	}
	...
	public GetResourceByIdType getGetResourceByID() {
		return (GetResourceByIdType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__GET_RESOURCE_BY_ID, true);
	}
	...
	public NotificationChain basicSetGetResourceByID(GetResourceByIdType newGetResourceByID, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__GET_RESOURCE_BY_ID, newGetResourceByID, msgs);
	}
	...
	public void setGetResourceByID(GetResourceByIdType newGetResourceByID) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__GET_RESOURCE_BY_ID, newGetResourceByID);
	}
	...
	public ManifestType getInputData() {
		return (ManifestType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__INPUT_DATA, true);
	}
	...
	public NotificationChain basicSetInputData(ManifestType newInputData, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__INPUT_DATA, newInputData, msgs);
	}
	...
	public void setInputData(ManifestType newInputData) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__INPUT_DATA, newInputData);
	}
	...
	public ManifestType getManifest() {
		return (ManifestType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__MANIFEST, true);
	}
	...
	public NotificationChain basicSetManifest(ManifestType newManifest, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__MANIFEST, newManifest, msgs);
	}
	...
	public void setManifest(ManifestType newManifest) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__MANIFEST, newManifest);
	}
	...
	public ValueType getMaximumValue() {
		return (ValueType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__MAXIMUM_VALUE, true);
	}
	...
	public NotificationChain basicSetMaximumValue(ValueType newMaximumValue, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__MAXIMUM_VALUE, newMaximumValue, msgs);
	}
	...
	public void setMaximumValue(ValueType newMaximumValue) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__MAXIMUM_VALUE, newMaximumValue);
	}
	...
	public DomainMetadataType getMeaning() {
		return (DomainMetadataType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__MEANING, true);
	}
	...
	public NotificationChain basicSetMeaning(DomainMetadataType newMeaning, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__MEANING, newMeaning, msgs);
	}
	...
	public void setMeaning(DomainMetadataType newMeaning) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__MEANING, newMeaning);
	}
	...
	public ValueType getMinimumValue() {
		return (ValueType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__MINIMUM_VALUE, true);
	}
	...
	public NotificationChain basicSetMinimumValue(ValueType newMinimumValue, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__MINIMUM_VALUE, newMinimumValue, msgs);
	}
	...
	public void setMinimumValue(ValueType newMinimumValue) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__MINIMUM_VALUE, newMinimumValue);
	}
	...
	public NoValuesType getNoValues() {
		return (NoValuesType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__NO_VALUES, true);
	}
	...
	public NotificationChain basicSetNoValues(NoValuesType newNoValues, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__NO_VALUES, newNoValues, msgs);
	}
	...
	public void setNoValues(NoValuesType newNoValues) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__NO_VALUES, newNoValues);
	}
	...
	public ManifestType getOperationResponse() {
		return (ManifestType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__OPERATION_RESPONSE, true);
	}
	...
	public NotificationChain basicSetOperationResponse(ManifestType newOperationResponse, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__OPERATION_RESPONSE, newOperationResponse, msgs);
	}
	...
	public void setOperationResponse(ManifestType newOperationResponse) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__OPERATION_RESPONSE, newOperationResponse);
	}
	...
	public MetadataType getOtherSource() {
		return (MetadataType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__OTHER_SOURCE, true);
	}
	...
	public NotificationChain basicSetOtherSource(MetadataType newOtherSource, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__OTHER_SOURCE, newOtherSource, msgs);
	}
	...
	public void setOtherSource(MetadataType newOtherSource) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__OTHER_SOURCE, newOtherSource);
	}
	...
	public RangeType getRange() {
		return (RangeType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__RANGE, true);
	}
	...
	public NotificationChain basicSetRange(RangeType newRange, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__RANGE, newRange, msgs);
	}
	...
	public void setRange(RangeType newRange) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__RANGE, newRange);
	}
	...
	public ReferenceType getReference() {
		return (ReferenceType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__REFERENCE, true);
	}
	...
	public NotificationChain basicSetReference(ReferenceType newReference, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__REFERENCE, newReference, msgs);
	}
	...
	public void setReference(ReferenceType newReference) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__REFERENCE, newReference);
	}
	...
	public ReferenceGroupType getReferenceGroup() {
		return (ReferenceGroupType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__REFERENCE_GROUP, true);
	}
	...
	public NotificationChain basicSetReferenceGroup(ReferenceGroupType newReferenceGroup, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__REFERENCE_GROUP, newReferenceGroup, msgs);
	}
	...
	public void setReferenceGroup(ReferenceGroupType newReferenceGroup) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__REFERENCE_GROUP, newReferenceGroup);
	}
	...
	public DomainMetadataType getReferenceSystem() {
		return (DomainMetadataType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__REFERENCE_SYSTEM, true);
	}
	...
	public NotificationChain basicSetReferenceSystem(DomainMetadataType newReferenceSystem, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__REFERENCE_SYSTEM, newReferenceSystem, msgs);
	}
	...
	public void setReferenceSystem(DomainMetadataType newReferenceSystem) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__REFERENCE_SYSTEM, newReferenceSystem);
	}
	...
	public EObject getResource() {
		return (EObject)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__RESOURCE, true);
	}
	...
	public NotificationChain basicSetResource(EObject newResource, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__RESOURCE, newResource, msgs);
	}
	...
	public void setResource(EObject newResource) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__RESOURCE, newResource);
	}
	...
	public ServiceReferenceType getServiceReference() {
		return (ServiceReferenceType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__SERVICE_REFERENCE, true);
	}
	...
	public NotificationChain basicSetServiceReference(ServiceReferenceType newServiceReference, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__SERVICE_REFERENCE, newServiceReference, msgs);
	}
	...
	public void setServiceReference(ServiceReferenceType newServiceReference) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__SERVICE_REFERENCE, newServiceReference);
	}
	...
	public ValueType getSpacing() {
		return (ValueType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__SPACING, true);
	}
	...
	public NotificationChain basicSetSpacing(ValueType newSpacing, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__SPACING, newSpacing, msgs);
	}
	...
	public void setSpacing(ValueType newSpacing) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__SPACING, newSpacing);
	}
	...
	public LanguageStringType getTitle() {
		return (LanguageStringType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__TITLE, true);
	}
	...
	public NotificationChain basicSetTitle(LanguageStringType newTitle, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__TITLE, newTitle, msgs);
	}
	...
	public DomainMetadataType getUOM() {
		return (DomainMetadataType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__UOM, true);
	}
	...
	public NotificationChain basicSetUOM(DomainMetadataType newUOM, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__UOM, newUOM, msgs);
	}
	...
	public void setUOM(DomainMetadataType newUOM) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__UOM, newUOM);
	}
	...
	public ValueType getValue() {
		return (ValueType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__VALUE, true);
	}
	...
	public NotificationChain basicSetValue(ValueType newValue, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__VALUE, newValue, msgs);
	}
	...
	public void setValue(ValueType newValue) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__VALUE, newValue);
	}
	...
	public ValuesReferenceType getValuesReference() {
		return (ValuesReferenceType)getMixed().get(OWSPackage.Literals.DOCUMENT_ROOT__VALUES_REFERENCE, true);
	}
	...
	public NotificationChain basicSetValuesReference(ValuesReferenceType newValuesReference, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(OWSPackage.Literals.DOCUMENT_ROOT__VALUES_REFERENCE, newValuesReference, msgs);
	}
	...
	public void setValuesReference(ValuesReferenceType newValuesReference) {
		((FeatureMap.Internal)getMixed()).set(OWSPackage.Literals.DOCUMENT_ROOT__VALUES_REFERENCE, newValuesReference);
	}
	...
	public void setRangeClosure(RangeClosureType newRangeClosure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWSPackage.DOCUMENT_ROOT__RANGE_CLOSURE, oldRangeClosure, rangeClosure, !oldRangeClosureESet));
	}
	...
	public void unsetRangeClosure() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OWSPackage.DOCUMENT_ROOT__RANGE_CLOSURE, oldRangeClosure, RANGE_CLOSURE_EDEFAULT, oldRangeClosureESet));
	}
	...
	public void setReference1(String newReference1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWSPackage.DOCUMENT_ROOT__REFERENCE1, oldReference1, reference1));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case OWSPackage.DOCUMENT_ROOT__ABSTRACT_REFERENCE_BASE:
				return basicSetAbstractReferenceBase(null, msgs);
			case OWSPackage.DOCUMENT_ROOT__ALLOWED_VALUES:
				return basicSetAllowedValues(null, msgs);
			case OWSPackage.DOCUMENT_ROOT__ANY_VALUE:
			...
			case OWSPackage.DOCUMENT_ROOT__DATASET_DESCRIPTION_SUMMARY:
				return basicSetDatasetDescriptionSummary(null, msgs);
			case OWSPackage.DOCUMENT_ROOT__DATA_TYPE:
				return basicSetDataType(null, msgs);
			case OWSPackage.DOCUMENT_ROOT__DCP:
				return basicSetDCP(null, msgs);
			case OWSPackage.DOCUMENT_ROOT__DEFAULT_VALUE:
			...
			case OWSPackage.DOCUMENT_ROOT__GET_RESOURCE_BY_ID:
			...
			case OWSPackage.DOCUMENT_ROOT__OTHER_SOURCE:
			...
			case OWSPackage.DOCUMENT_ROOT__RANGE:
				return basicSetRange(null, msgs);
			case OWSPackage.DOCUMENT_ROOT__REFERENCE:
				return basicSetReference(null, msgs);
			case OWSPackage.DOCUMENT_ROOT__REFERENCE_GROUP:
				return basicSetReferenceGroup(null, msgs);
			case OWSPackage.DOCUMENT_ROOT__REFERENCE_SYSTEM:
				return basicSetReferenceSystem(null, msgs);
			case OWSPackage.DOCUMENT_ROOT__RESOURCE:
			...
			case OWSPackage.DOCUMENT_ROOT__SERVICE_REFERENCE:
				return basicSetServiceReference(null, msgs);
			case OWSPackage.DOCUMENT_ROOT__SPACING:
				return basicSetSpacing(null, msgs);
			case OWSPackage.DOCUMENT_ROOT__TITLE:
				return basicSetTitle(null, msgs);
			case OWSPackage.DOCUMENT_ROOT__UOM:
				return basicSetUOM(null, msgs);
			case OWSPackage.DOCUMENT_ROOT__VALUE:
				return basicSetValue(null, msgs);
			case OWSPackage.DOCUMENT_ROOT__VALUES_REFERENCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OWSPackage.DOCUMENT_ROOT__RANGE_CLOSURE:
				return getRangeClosure();
			case OWSPackage.DOCUMENT_ROOT__REFERENCE1:
