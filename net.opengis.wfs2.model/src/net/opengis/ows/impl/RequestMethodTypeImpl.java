 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.ows.impl.RequestMethodTypeImpl#getConstraint <em>Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequestMethodTypeImpl extends OnlineResourceTypeImpl implements RequestMethodType {
	...
	public EList<DomainType> getConstraint() {
		if (constraint == null) {
			constraint = new EObjectContainmentEList<DomainType>(DomainType.class, this, OWSPackage.REQUEST_METHOD_TYPE__CONSTRAINT);
		}
		return constraint;
	}
