...
public class AtomAdapterFactory extends AdapterFactoryImpl {
	...
	protected AtomSwitch<Adapter> modelSwitch =
		new AtomSwitch<Adapter>() {
			...
			@Override
			public Adapter caseAtomDocumentRoot(AtomDocumentRoot object) {
				return createAtomDocumentRootAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.w3._2005.atom.AtomDocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
