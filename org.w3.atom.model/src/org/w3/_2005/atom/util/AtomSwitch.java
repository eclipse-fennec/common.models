...
public class AtomSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case AtomPackage.ATOM_DOCUMENT_ROOT: {
				AtomDocumentRoot atomDocumentRoot = (AtomDocumentRoot)theEObject;
				T result = caseAtomDocumentRoot(atomDocumentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseAtomDocumentRoot(AtomDocumentRoot object) {
		return null;
	}
